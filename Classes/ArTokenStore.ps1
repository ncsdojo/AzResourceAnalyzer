...
# Functions instead of class for Constrained Language Mode compatibility.

$script:_ArScopes = @{
    Arm      = 'https://management.azure.com/.default'
    Graph    = 'Policy.Read.All User.Read.All Directory.Read.All UserAuthenticationMethod.Read.All'
...
function New-ArTokenStore {
    ...
    return @{
        TenantId = $TenantId
        Tokens   = @{}  # scope -> @{ credential (PSCredential), expiry (datetime) }
    }
}

function Invoke-ArDeviceCodeAuth {
    param(
        [hashtable]$Store,
        [string]$Scope,
        [string]$ClientId,
    ...
    $dcResponse = Invoke-RestMethod -Method Post `
        -Uri "https://login.microsoftonline.com/$($Store.TenantId)/oauth2/v2.0/devicecode" `
    ...
    $maxWait  = [math]::Min($dcResponse.expires_in, $TimeoutSeconds)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCHmBuiR8C+IOYO
# /WH4wtbdTXsXaxBrdieNWL3xbqLKg6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIHJSRIxU8nmjb1cLHDSmy5S6tuobHZ1762lCBEs+
# ZLtEMA0GCSqGSIb3DQEBAQUABIIBgKMaRS9P7Btv7erh07ZEVzvVwh9HV2pye5O5
# gwW99XfhAjneTmCjXlUHOIawcqpn4AiPw+ZolVs1l08/MM3g/1qGV2A/jD2oaOYG
# RVIItj8NL2PctokGAnultEihuOuJbr+5BMfhhI5O0+D5hdIehvh8ye6a6h/Vg9pV
# 0a0/bs7L4/fguZzMR0xq+ztCAEmURhggI7aHD07aFAgm/xEBcQXH4XT1veghY9/p
# j3h7KjjhU3W1keCh5r9lrRW8u+yBjAvKPjQpOjAiUEWHuNiHL3QyIYspRrsZPG6h
# CbPY12TSErV/RHVEbnI3KBiU1NwCVVw40ipJSOM95DnKZTYqql7wG6zSi6fDiRi+
# t+yxYIx2Pg5Kf02m0c9dSpfU2ncsueF4bsa8U1o81Pc8wx7wX8fc8Q1ykwwOv/F+
# kQDwNQhjoAREg6+De+WxcADZcObmP7/hD4C57EeC3/VEw6rW19MZERtfn/UAQ++Q
# m6KDwxD7r4wzWjGLc1t2Gh1XlzlcDKGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCDOOqNVzw7Dr4Q+exsq30IFriVhN/XrE2+/hz17njekEgIGaeiBPamK
# GBMyMDI2MDUyMjE4NDQyOC4zODJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE4NDQyOFowLwYJKoZI
# hvcNAQkEMSIEIITeeAgwa018OZ2sN6wKRFdFNAJ46+HhvwkaqUnj24/BMIG5Bgsq
...
# 9w0BAQEFAASCAgB7WOFDlyhh5W6//xEkkTdUaTqapJYyWOIrpcLGfkwP4FkoflQq
# +Xbnzx0FTjK0s4qKOXIQful4sT2wWPpplNZik56PRzTPMoE7F7YV2RSfWSsIu1ZU
# L2yC2DodD0RnD3nA6kcFlMw9qfusnX8odNx1EgbmofRb8OBRVJFyETqQ5vFWRq1h
# 7gp6kVh31o3+YN/13B38p36zO9Awr2tgRd87t7/cbJgiYn33QBsqLVMEPRY/0+Uu
# tBeBvRrStFkG1gacCazPOoEkRbE4Zb6bWPGYkTUGxKVRaa7Vr/bcMj90bAygylN0
# r/pgwdB/j+OZYGNSLL4AA8GVfOO71HrLwRLWPW5STo+QBukBIFtSv860vkDfrwi8
# qymcAp5pmHuBwXBheRTETzo/yvVboSuWhuzwJZ0BFM1g/EBLffY3vmwNrZi5qhtr
# MDuIN6H2wCcQGjKC7Kwl0D3IgbYu7+0WXDl8ayojAl0+k3NQPmBJ3Gs3q4ITa/Fc
# hOY38+QZhEbOlZM2EBwg9YfIMnueSks/XQrMyDOdtkEmHDqGYO1T8NHIkGUCU2Uz
# emjzBvBPE+UANOQE2Dfden8XJqaDd7mP/2ofqSOsePOXpojhKyPuFwDzQG908gxH
# jbKws5JYiZ68fMKOdQ3B4vOBwcd3rzeS15jYBxWuTJuEpzKWGUZwAWj6MA==
