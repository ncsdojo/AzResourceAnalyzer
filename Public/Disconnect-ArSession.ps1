function Disconnect-ArSession {
    <#
    .SYNOPSIS
        Disposes the session and clears all token material from memory.
    .EXAMPLE
        Disconnect-ArSession
    #>
    [CmdletBinding()]
    param()
    if ($script:_ArSession) {
        $script:_ArSession.Dispose(); $script:_ArSession = $null; $script:_ArTenantId = $null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB0Paoy0Ya4Vvip
# 6js/zAcgW6naTtBmca+KefV9O3VyT6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIOLqsBOaLLUuElq0mnrAtYn8wLvHU1ZzAqBD5jl9
# WRDOMA0GCSqGSIb3DQEBAQUABIIBgChZWFZkAKTmT/dvMhr6gbGcAO4/WM/Jpe7N
# F1tpuDIE86GclP4tfjRdMfzCrKufj5qBpuQ0cWo6Gr4ywgjjzLG33Ii7d5hxEAzv
# nr9JO0T+mSbZTwTJF1115bmFozRlC1qM96vZz9JWhPAEUi0QHj+F3+5b/8DjVMz1
# 4XeXvj2M4fUemcqXxi6RyHoi/f0LNfGaatSbiiyMSCrrCQP/Xz88Q4lF1Nam1fJO
# h3fo+a3qikkeewwym0Hm9rGMhboaINUDY85dPAg3ii0/b53jzsCX8Gou7mYIN+Uw
# GRjt0Ag5Wk3N5/cS7ymQpr4RMCmTRNFrGr6VaijNLTMwdizEzuUk6RhysfBR27ul
# 86yuUARBgPn/dAbII8Zuu6UC82zNfOp4JWYIhgLqzdF9aB8JRXWNTATvfPReQKTg
# 70ls4YkiFOE87NT/K/uJOwK85eEQAkfnoHEfEt+HacMA6WnLYF6RBaERm5IagZNg
# 04jBdHKRqnx3RWocs+6hZDbIBrUFKaGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCBmYGX8+jzgxg+8ZsvLZeSAnbQ5tO0CGo7A9J36KuN1FAIGaeiBPO9N
# GBMyMDI2MDUyMjE1NDgxNS44MDRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1NDgxNVowLwYJKoZI
# hvcNAQkEMSIEIPwYdMMaQnVogMSM59CjDhZ85mC6VVyNr1VhWMMlKC7lMIG5Bgsq
...
# 9w0BAQEFAASCAgA2TuZZcEz36EHMNLM39oBuMEkQJoCcgRczTpQ8lBAQS+zVYiEk
# FlwY1EYqwSCC21HKPfMbwbusmk197Sf2/dWXJnx4zdoqzdg7RpqoUqyFVVlv14Rt
# F73S9K9CIaAk/FkRbRm7LX1D56qp/ra7k8snmw6Ec9jystK8l4p15bIkJKhx9XED
# giPvCUESlrDBz82wQHoKERPpssSEQYH8ZPjEz3CsD9WFDjWAOjzmkBMFayhpSxUp
# sSdS7Qs+caQ0ch/DsBQyekSQqQZugbICcILkAeu9Pv6aagpun32TwRK1zvEscBmm
# fEjNPWVvrxXEEQo190tmwNrQ50i3d1OcCi7K/cAylOhTv6lntssYSwdWZuouzKix
# QwVGSqSf4QQ28FqVU3dIEs6fKk5zy8j0QpEbxJu/epu1vVJu7Vb/bhuPvdlo4k8v
# 6AFZsa6EbAu5ExkYD6MA2hcAiDaidLph4C8khrCG2LUywn8TW3SEoZwZSXcStinM
# vjj9P3gtzx8/xeTFOhXGcLvdP8MGP4dhWNnGG99p9YM1G+xlJMlEUfb31BlrXJH8
# hobTUTJ1b9PpV5Qp9SJy3tTq0gaJNxu468YUfyHW89WRhtOKPxbZ0BeM5s3QBkYy
# JLDNiJcCVoZDxRrUGTdmS2/cSEgvFT8SeFd2U8fcp9RH6SmB6M3PTKkAng==
