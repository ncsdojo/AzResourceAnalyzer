...
if (-not $OutputPath) { $OutputPath = Join-Path ([System.IO.Path]::GetTempPath()) 'NCS/AzResourceAnalyzer' }
...
if (-not $script:_ArSession -or -not $script:_ArTenantId) {
    Write-Warning "No active session. Run Connect-ArSession first to authenticate.`n`n  Example:`n    Connect-ArSession -TenantId 'contoso.onmicrosoft.com'`n    Invoke-ArExport`n"
    return
}
...
# ARM access
try {
    $armToken = $script:_ArSession.MarshalToken([ArTokenStore]::ArmScope)
...
if ($graphCollectors.Count -gt 0) {
    try {
        $graphToken = $script:_ArSession.MarshalToken([ArTokenStore]::GraphScope)
...
if ($rgCollectors.Count -gt 0 -and $subBatches.Count -gt 0) {
    ...
    $accessToken = $script:_ArSession.MarshalToken([ArTokenStore]::ArmScope)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCCUkr7Zms1PwLD
# eakUPa1cvgG+VOXIWGM1WPF1reAq7qCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIEzYaEdqvgqnjV6sQZEzIDHtLCk01f1HMcawptvf
# KMb4MA0GCSqGSIb3DQEBAQUABIIBgH1lX8WUd7IvYC8/10fxIhrNU+m6mzqgRy3C
# q8jMGnt4fcB2vROzwVcLlytGegY7YwvO+1+Tyu8KvcGw9x4AWwBnLqh0Iv/mANtY
# rVxo4BDbbr2arz1ZCdmaNNvU3psGQ1GHYOnY0s1pCiHVemFlGks1erHuS+QWNQOE
# FsJn6sAvdxmKa+pB1SfICRZXiLSuHWzSeT6OcWtOxeY55tyEp9xh6eZx0bnSQ4o5
# JDFF46GBqq2Msiefx/yLj8NtoB3kH3w8e8KVW9ux82f/Ti22bKjBkBYu6OJeCZ68
# ezsnLW4Hm0sDdWdzSq8bdqBP0tsgBCKD+o7UqCUk39Krhmqj2L7jBVt3Vl5KaiAL
# T2uMKvRAgvOspDi1+vFxih4Nqbkpqvc359NQ/eQCuCWkS52d7oY7e/1rNEwMkzgY
# tuaPotEQf+HncSGxV3aPC4W/fjaf/+k2JMqMsehlveJL7dYO7282y5VxEG7TPwu/
# n33lusdsAWrN2VHa/ze8Y1qNqeWJWqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBlg+894m/pSJaaMYNv3witaxhpT70JvJrxnQurVVkomgIGagxE15/B
# GBMyMDI2MDUyMjE1NDkwNC40NjFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1NDkwNFowLwYJKoZI
# hvcNAQkEMSIEICb2Ipe9QG4u7z/n7keaz1z9uzhYcB7wJdI+JLdTF+cGMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBBjzrCYrbqlLfSh+E5l+FuNYK6sGsYAfAQrIwI+ENli6i2
# o1zyLXdbj9xOIcVWvOpdsblwAzMcQggGH/HlqmI6CEhhgwRZyBW1zzE+5DLrgES1
# auVOx+DXAHK2g1HlFXds+4oCVtDaTHRllkofVbOeAMY2gk2qyapPP4qnACrmuDWb
# Nz2iqE9ph8RYrIKb0Uj2wF5YWqkaYPyw09UbcsGto+z2IG2Xm1bdhk4sIsCTkAzI
# R5KBlmgwpjcNA93ssdAXlYoeDuDtGPjZbGX6/37eOpd9pDXtMMguj9MfLhCqNOYH
# Vrz7G2Jg6O1gYVrBHqzb/tvIP1U87l5ZwoFZ+GK9dqVn5ar7zrwTvHnpo5J/w0i7
# ccpByzKipKcniDj/xuvwQMv/AEODp15a0uvgJCYj58AWo0jswGhavDM7KiqsfUCR
# doDrf28Etc3uSpB7jBgzjGUGeeHdRmEx7Wzanb5ILlQGD3A50LHggkoUAKgaIZ8Y
# PwRTXhz6vt7XxPrqyYiPe3f5XOdKtHSnh21iBztBP/e1bovbnrxZdkXY64hTxdj1
# gyz1qok/xuPozM1PlHmFD2HzdPJfrv3lM1OaB3Y/aWNFdDVfECpccRVF6jQhkUHX
# csmYi2BzcmqdJ00NTJY7bejEM22WlI/c019Wn7oB3NIr48JPnDSFEJp/3R4uJg==
