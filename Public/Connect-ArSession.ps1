function Connect-ArSession {
    <#
    .SYNOPSIS
        Authenticates to Azure for resource collection.
    .PARAMETER TenantId
    ...
    try {
        ...
        Invoke-ArDeviceCodeAuth -Store $session -Scope $script:_ArScopes.Arm -ClientId $script:_ArClients.Arm -TimeoutSeconds $AuthTimeout

        Write-Information '  Acquiring Graph token...' -InformationAction Continue
        Invoke-ArDeviceCodeAuth -Store $session -Scope $script:_ArScopes.Graph -ClientId $script:_ArClients.Graph -TimeoutSeconds $AuthTimeout

        Write-Information '  Acquiring Vault token...' -InformationAction Continue
        Invoke-ArDeviceCodeAuth -Store $session -Scope $script:_ArScopes.Vault -ClientId $script:_ArClients.Arm -TimeoutSeconds $AuthTimeout
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDyMdd6tosn+QCH
# k+Bl0Pvz9PpyQ+BNNH9i186yyjKbR6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIDpOJDWZ7e4Bryy9A0pNoUSi6c7+kNP56NubvZ5T
# bN0sMA0GCSqGSIb3DQEBAQUABIIBgGpuDebAm1jyBYXcZD6G/iE3WNjEIe6A9IO9
# kpUgA2gG2LtKBda3dmQASAlVd/gTCvVpUiSkLjnH0YPVnRIVogfOCM8jQp+XPAes
# Ywf2d0HlahfTmkpd03vLJ/a7qmQPfTPDmOoYZXNqcHggMPugI835oY7LA4qu11mp
# 5Cn52mW34Y3U8VQwx6X0MZeqGyos5Y4ryuQ8eXDEz34HKgUf2RUoN8rAOZd+WqpR
# DwBSa91naEOhemngekwWMLAQfkWGNTkj5KmfBR9vtfQgH7mt3lfdslIf1GvB3xmW
# V1En8GQdFPuQoGZsYm5kAch4wVsL2NuUoMiZPFlyexnIsvBBCr3Do9PRHd54lrNE
# Yk+yZMRQo1U40C3sW55soE4aivwZChxmpPX/mpS449K+J89m3Q+DRsCpHkkoeVXk
# Theyvfk5iVx5PTcX15AHjG7G/Mx4OroGquM6af0O2TZECT9yvIy6UhAo24blFOlf
# w+JuXoo2YxG1H5RZJ0Cr50vDO6u7KKGCGBMwghgPBgorBgEEAYI3AwMBMYIX/zCC
...
# AwQCAQUABCAwLAGWGCB2L6abvcc8s0GW7eN43zphbGQznIeSk5XAQQIGagxE2FYq
# GBIyMDI2MDUyMjE4NDU1My44N1owBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIyMTg0NTUzWjAvBgkqhkiG
# 9w0BCQQxIgQgr8EhqqMFLwmjKYPkzTfRl6z+sxjxnSCHHLmok+GVSGgwgbkGCyqG
...
# SIb3DQEBAQUABIICAI+tmfbxFeUcYq9KtkQyE3D9BYRs1y75YSm5V8GQemuhryqG
# CppHZ6x+vhRzDKmK6ArV9cyDo8j6iVfTWfR8+IUeUHA1WN93smZZm7WYiCjCklg3
# lgDSHnWpKiQR1DJOfXb5aAyl+WBpqyfAca/r0ugT5XLykj5WjI0z1x4DXCZn7m6Q
# 3qnMD6CdpEoHWJ2VoYBHZKwGWe0TArTUhAy4uM0e8Xp2iNsc1HNgb7/E3FUH5NXg
# v2o5RoHd1b3iMzqxzboH5yJ2vBzhmlCfkx2jrOCMCXqGZFPbvbcXdFyR8EhoG7mO
# WciIWNjFb5ksp7XKwaVBBIuVmeDiS8oXkQGHV9T0R+Bw6uU8J7i9630Fl5+Y6LRD
# 19Ncw+Qyq79DYO/Wq+4Z4tnWpjTKc59x/nh5YnD48RIpQmxL9aWU6CgissWeyTb6
# vxHuuNFSPbyJrH0YgNahWxbQHYsWM7ucJeM0A7+hTAX1JesMkGks4207iJuBe+pa
# C/zhWaz6LkFyyfZn8y2GAFW96RDuMOMBPcYvyZh8dPH5/mgQxiK4xRvkkuNXiZ6F
# qZQ7xGiLB51u5ePJpxt41O9ehmCb/wJPWgIVXh+jJwqgzimXNLmxBbRZT5Q2ek6e
# 1+YsAhAahZ2vWSBmXwKjHaTT3n+3zsLY8yRNyspBiProkyaST+/VYIoab5M+
