# CIS 6.1.2.1 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "6.1.2.1"
        Title       = "Activity log alert: Create Policy Assignment"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $alerts = $D.ActivityLogAlerts
        ...
        foreach ($a in @($alerts | Where-Object { $_.enabled })) {
            if ($a.conditions -match [regex]::Escape('Microsoft.Authorization/policyAssignments/write')) { $found = $true; break }
        }
        if (-not $found) {
            return @(@{ AffectedResources=@("Microsoft.Authorization/policyAssignments/write"); Description="No enabled activity log alert for Create Policy Assignment." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCApaX+KjF6nJLsc
# W/iUFSWfyc5FanoUphWY6PvVA8rQfKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIHIdK57wMQTJ8Si+Js4WkrSd03V8hlqiWmJT+Ubh
# sih/MA0GCSqGSIb3DQEBAQUABIIBgBIwUa3P3YxdQ1hnjbez7xRK6tyMm45Y+pnM
# rvpJs3GOJ3M4FyEDPa7IVnR0MghamXSEIBrf1Re+uCuCCKSuwuKyK9gj/laq/CcR
# JjLJW4vEyqMlE0z73iIZZ4SLxdiBHNZk5GDr+komxCj5+oBx2ZbA3AysxhFou2NM
# P1p7t9z1IQXqxTkqC0RnD7sG1plammUNpX03R8+d0fDD20tMvC1xgZUI6pk9h7HU
# PnSfGPXS6Z+Pfvikvdsx8Gkuk+BP4pQZAECudPVchlwJ5aPYrMPTtDRoZxRjkoYh
# xol/+RkDbafv0oNhoIhZAtdTA1bAmPv/Rx1ZToOEo5l7QFIGYWPuwp1ZfbuHkTMe
# gqzHfz29IzGModrj042cop9XEoJNAicDzZ/mO6HRhyQaga7QTORMihmL2sBZUqNH
# tPLqjvZalrgJGiD0z1axm+oVthZVS/pGg24KpxQmH/D9AVAH1EQRjr7yHg2UMtSw
# TJ+SL2C/K8tGTkJV0a0Y6yLXwcVPIqGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCCNmgm9/vDcCVrewLxGK4DiEKsqpT0EORxdIdwtuyYYlwIGaeiBPKYH
# GBMyMDI2MDUyMjE0NDMyMy40NzFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NDMyM1owLwYJKoZI
# hvcNAQkEMSIEIEXcbCjYJrz3/70G47jHnQxB+eG1qSCFdEUYPoerd+GWMIG5Bgsq
...
# 9w0BAQEFAASCAgBetbdxgm1LG+SXY/XApOXexuVc6Qdcg/2IdwgvWjyzPXSW4W0X
# k5DPLsWa/YzdVVQ8qXHUK30+kXHn4fewJBDpFp8AlyvsAw4S93MnuxXlIO2fZYAQ
# 74IppS0y+MDgXUiLbQPOvlYfqt51PLG/a29oVj8qvh2t+/q8H44omTi/G8cDzxu2
# b3DHF2v0l60Mu5bjR1zaSX6+8SASffCWnbdQuBySmSx9At+HBNJfXI/cFXuv2+fB
# boc4DAtOTr+/l+9Fnq6X4r2MyvbOFm2hJ6r2MaqiHbYmo8PAyTcZo4COfzOEJauE
# 16fGryk4ekOuwAq8ZAxFjtwpMvNaaALY3LEIV0vbn0HRm2ct3uznU4rLwZe65kDM
# enWmQt5gGkS6jNWf2uR64LtLYhuRGT/cldH47TGfHFEFGl9vw2v8oJoc+geQoTKf
# 6mjRtWwevUxUK4SUgADdbhSGd58roaHUp2XXFRQA2Xn3eY+5FX3Hq+6kGLh663GC
# mhZtRp79R/BTeCK9Cr1U3+UMpQFk3C6lmr6Nq+BMlOfL6SIH6mZLxwdeSuN0yreD
# GgHUleDME4GjWlYdyG9q8py1//SUyox9nA4VkRdNMZFX7nveStrN9vkzvmVvL42T
# MfbwaMSvCHqbntguJb0mKjAL3Egv/q9mjz51gsJhzApa3vJRJCV/sXjn+Q==
