# CIS 6.1.2.4 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "6.1.2.4"
        Title       = "Activity log alert: Delete NSG"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $alerts = $D.ActivityLogAlerts
        ...
        foreach ($a in @($alerts | Where-Object { $_.enabled })) {
            if ($a.conditions -match [regex]::Escape('Microsoft.Network/networkSecurityGroups/delete')) { $found = $true; break }
        }
        if (-not $found) {
            return @(@{ AffectedResources=@("Microsoft.Network/networkSecurityGroups/delete"); Description="No enabled activity log alert for Delete NSG." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBpIrk5WPFKMeqs
# 2IsgPWUXOzWDIU9UBsd7qhosHdNwwqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIHDNNCWquvtHYZ0KIITiqGORNHE460u54Dx4r9zJ
# ISaAMA0GCSqGSIb3DQEBAQUABIIBgE4EbAzNQYbxG1kSWgTsLsjKfCsgRFFjChEn
# PnbZv9XOWwmuGPxlYwr78dzxi6zxfMcj8RA0Uw/2NV4XZXLl3qYo5nkR5jYrU8GI
# /q1YwgTwDaQ/4i7CwG+MwPhuVIQdZPp575nXqns3CptskQUsFPegL+x7wtvLI3i8
# ZFU9Jcw2RQV3dSPiUfRptZL3sAbIlT42XrJiy44Z195Mqy4VKNGzU0BFQuswhz8u
# Ht1U4NWodATM6CdrMHGlXBPutls6xdtxoBZGE3fKix2ua/6VcPTbSLbHkYRak7ar
# yAc2b1ue09yqgKkqeSJF0iHYBof53SlZ5TYyqeIvDXi4W178QQAd0pPfFImGbHX0
# uktwx578z1VLS/IYIjpcFcC06WjHAFynbtEZx9BkxiWoIDchJ+hWQeuhONU8jOeO
# lNaGBQB7vbO4h4xsgwbCHjGQN6OcF5OpBiMd3azxREgvcSUKL+KF9zkYKYFQ2bGt
# xRXArrHpNLsJ/8rtUVIJSXEl6dKDbKGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCBM+neIaUxrCKkUr+1M5gUiCT2pFqObGJxzr1sSRbxbtwIGaeiBPKbS
# GBMyMDI2MDUyMjE0NDQ0Mi45MzdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NDQ0MlowLwYJKoZI
# hvcNAQkEMSIEID8NqOwxwwJWclyGdNoGBmvv7HguFFxvacjxNZBindFjMIG5Bgsq
...
# 9w0BAQEFAASCAgAomKEgPRAVR5fMQ6GaNpr2Nq/VmMFyei8lupvUXcOxfhAXbqgv
# +Kgcfq2Cg23TE4OZRY16nce7hAAFqzJMACmAf3QNlZaFVo2epl4Qc3HbufUf0t5K
# gM/1ZqwGgF5SDpuSHv3eMl5+e6LrrJ3wCKBFyJf9azv7cSvSjEquaFR8k3G/cnic
# 0p6v7HTApmNhJEK6CsHUODADaHwM0gPcX87MEP1uAoAtSxoUeb5N9R0nzAQKyiQJ
# NRW0crPUxdsE3G/TklklcbYjjxayhz5RS+JlBv6wdgftdEqnNAGbzlUmD2oCGvJ4
# sxYrijArrZRA668sRI+sJUhKWhFJu7kN0COCAI5V/ksIfya2O/96XJw1eTvQKuwq
# YEhNHbVW9yDVeme3UZF/GjqzlLLx9KGJ5bJsKlZhtTUU/bFGiT7W1r8NGltv1BBZ
# PzCBfE7y49Mz701wxy0zajOHhNayqHH1sKCokItwE1Ig6UY1o1wSzAPoaaU6on1k
# iI5Hy7KeBmw4OfphVbW1nx7CU4sCcIq4O528AGaINTsGSnovczn+hYUkx6Xc8fq4
# i0YyEH1yAEFQvhRXeiBLwngjA5FGL13x3svRD+4EQGnj4wjoTlIvgKOy9cz4T7ZO
# uv1bh0Ekj6MRXqjx/W/QsuJai5pVeDQj1WBRoyYjc2/aJAEiMF2CjZGd+A==
