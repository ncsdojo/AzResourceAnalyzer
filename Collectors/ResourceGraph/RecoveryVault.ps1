# RecoveryVault collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "RecoveryVault"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "RecoveryVaults"
        Label       = "Recovery Services vault(s)"
        UniqueField = "vaultName"
        Query       = @"
resources
...
| extend skuName                    = tostring(sku.name),
         ...
         crossSubRestoreState       = tostring(properties.restoreSettings.crossSubscriptionRestoreSettings.crossSubscriptionRestoreState),
         ...
         enhancedSecurityState      = tostring(properties.securitySettings.softDeleteSettings.enhancedSecurityState),
         immutabilityState          = tostring(properties.securitySettings.immutabilitySettings.state),
         multiUserAuth              = tostring(properties.securitySettings.multiUserAuthorization),
         infraEncryption            = tostring(properties.encryption.infrastructureEncryption),
         encryptionKeyUri           = tostring(properties.encryption.keyVaultProperties.keyUri),
         monitorAlerts              = tostring(properties.monitoringSettings.azureMonitorAlertSettings.alertsForAllJobFailures),
         classicAlerts              = tostring(properties.monitoringSettings.classicAlertSettings.alertsForCriticalOperations),
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD4HpHYuJq69PwE
# +7cw9FBkPjRgBrb1W1NJZ/uklU6iWaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIGHEYoR0rKyShOKCIzJi87DKnNpiYIOxIu+rkgxE
# Y5d2MA0GCSqGSIb3DQEBAQUABIIBgJqRcTXEhlGaTgSO2LRNCeZ+ERrIlsotxEOi
# KIMPcDHYX31pdSl0Eglpc2JujFM9t3OPQ1xXvpiEQ8BZiXyygV0paSqTdckbKTZG
# /GGbQ1p6chKft7qYOA/Petr5Hb62r78PxusPGx7L4wVdTQoKUDTulz2qWQRL6xv3
# oBiOPbNMojKbX35uLQENXmQTsRJneOuhNMQ6o07ZY2txADMV3iz4D1y9kLKaUmDQ
# 6vNVAwkaBiXp5SC1F1lAuLSih1LH2QEmH+tJNjP67ncQeWJBKkiNGBEjw1D92NDM
# BxJTxVTi4v6oNXFVPoPvC+a0cqFbXSFfwJG3NXvaPkAwWJjzVlkNWkgPD1XJAso3
# xnPn8/jjHcThNztKVWAUb+FhsiEgCqgSs02Ied4WJ6uZsMhyLssduKmDef8p60/d
# H6PiytMXrTjiM3En2ifoLxPp885xjXNqtVdhMAnfbb8MYpApdqTEuCfkGUx2VOUq
# hgRgKVdF8rkQOpP51fN/Egh0DrrbR6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCA40uPxiJqm4aGq7jldiAOXI9+n7paNjLDJB7JcmWpoUAIGagxE15dO
# GBMyMDI2MDUyMjE1NDEzNy4zNjNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1NDEzN1owLwYJKoZI
# hvcNAQkEMSIEICiA/C239q4NOy3RlTxq3TcSDhUQiVVJ7NCNAtgr0l+fMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgB+LkG0yr+V2rg9XeJQulA18oUkXxKezrd3/P5pAC7s17N4
# 3sLHXglDBD8EAYNYCSUdlS45zkdnX/DhyMS8OwWzhy3G+k2+AGtaZLT+ZxUJFFEA
# rQtVdAPnZlsWQmbd8qCRi9iFHRmqFvrasX9FjnaRt0R8abvl1yeRzpZl1PrfTfkc
# /8PfmdxaDu+wr85CG2TZDwhiir5HCbbIXrPgIKA4Y6g5iQ0KjTUWbDIL07uMLUZ1
# esarlehi1nT1O7MX985A3CayS/jgmgHhxUpGPabVNfy/zNQSbYs9NsbVbSQNG0sU
# Szz3AWD2UnsNT5wR8soXrmY/Kl9jGvDg+5kN2jIiRXHNEZbXRqvWCtK6Y+eeoIhb
# cYnYLCIh8RgUruO08wXBWBDldzxKEPmZUVyAVNUTCk/CBmxsO4sYl+hh5Flk3IuU
# /1f7a+hXtCBNywNjlTxNuYQ3xDCuV71NzlURQNlDbInLvArg0O+aGzqPVF/VK81P
# JjAwUmxJsWPV5lORT0d07lZuSn1q5nloyDQRACPTwtjMpuYbEi43XMT04QrRFQKY
# L6sJvfIHhAIJDYTlNQ0MGsrScH+D7IDh0xKVFcAn1XzHcLgVoOzDg4VPlwEYNtXY
# fOBW8ABNtIQAhGWP8ntsuCqAmxKrdd/jr4SPP7JGcghnLGc69gZFBKybgxXIRw==
