# SecurityContact collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "SecurityContact"
        ApiType     = "ResourceGraph"
        Table       = "securityresources"
        FileName    = "SecurityContacts"
        Label       = "security contact(s)"
        UniqueField = "contactName"
        Query       = @"
securityresources
| where type =~ 'microsoft.security/securitycontacts'
| extend contactName        = name,
         emails              = tostring(properties.emails),
         phone               = tostring(properties.phone),
         alertNotifications  = tostring(properties.alertNotifications.state),
         alertMinSeverity    = tostring(properties.alertNotifications.minimalSeverity),
         notifyByRole        = tostring(properties.notificationsByRole.state),
         notifyRoles         = tostring(properties.notificationsByRole.roles)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB6cfUjs6XN1GEJ
# L81XJn0OknQyuoXANlKoS/M0xOmrJqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIEdNRqxGkNvwdorVg6pSpkWLM9FCG6/qF+IMuTNt
# eM2CMA0GCSqGSIb3DQEBAQUABIIBgJDxvy80/DqGTjmZkfaJxScLRotO/rJNFki1
# 1+AkjtSD8JTQNE3LQOwu6PqVA14Tp2a7sFok9RzOvePss6axnIusd8CC0t45kAcT
# l7WIo/kg9e5e5UmjIqTVQTaZYQ3D1c4nkFBgziSAD428uTKj95Ume7XGPZ3256FX
# s6flzxewYmPuWQtfH94BdEixFjcn2SZ35ktmDNlK+vo3Ar3w0S1hzCysN4Z+/84T
# 0/zHhQl8i2kZ0mdRQXzeSUxqIypASelh/fwhOE7hwxmM3O8j576XELsNfRv8ZiRG
# EgcxApMaUq0KUFfI2UFwVVQBIh/6uz8LMYAes5LFzSp6sYD/AEK29RhC3gjBF/cy
# 0APgzYj9Hhn+DEjz9yX5/yvZWO2WNDoqbqNWU9VPA7jUsh7Es8rooLfGeV3rFOIV
# cI51Gf7FOteFh70A1v4Ln62BTxuZm13ZZIEyBs7eFgFjDemq0SjhL72EcULBeYAQ
# 3+2aW6HYHKUj5XJFX5UlgEXquIkc+KGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCD1f7smLzioYJIlRfG+RPCm0QPqQ1rhscIRklZx2yXjQgIGaeiBPOkD
# GBMyMDI2MDUyMjE1NDI1Mi42ODhaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1NDI1MlowLwYJKoZI
# hvcNAQkEMSIEIMDIbhmT9MOqVy3J7BFFTFnDR1eyhKyw6XYpdjSFC1xYMIG5Bgsq
...
# 9w0BAQEFAASCAgCYfT69z5P47j/vHKm4wSbcspXu6gHmA7PuCzu6Ul5SRt7LirNa
# E8Tzu1QbzAhfKbLjHCaLY/tWK0HiMsVMoP+pRwT25LgDP2Oz2FyFD6gbnOCfJQZQ
# SjkEG8a+AiusRF/U8Pd0iX+MrVMCSfqjLwuFUb0U830QZg+6S10bA7ue5QUyY1p6
# sjEGwVmbmtuCZpcQ3lX5cEY2NSm2jhBJ1rUH+AfN63AcvJP3uaB0hniiSTWUwJtB
# RKPBx6+4yZfQby2HSm8D/Nyw3uUtlQHWjsknRf5WsQiF9Ae7E+0zN4gLe8koDMVu
# +OVZP5oWR0O1vj5bpucisoth9EaR/ZlkE0azy4GaFPkEgIYZmwcXXh3TZzGXOeri
# 2UCm7VGjSBtfOIE6ZpPOnRTYrak+glWWXOw/MsxvZqO9WBXvGI47Wd4lVfR1LdP/
# E5SN08cUcjymCG6smwvWyufE1Qo9wNpzWJhrb49703QDj3TIWBWBgjcFMA0tvdD8
# PMGFDhW4ZOPMH1PndA9gEDVO9fLkiCXwcCXdyPmJ0XJD0fwFYBXCZ13ka+ZUaq9a
# aqBgHNVxAU1dMT9A37CMfc6SJrTsPKoGMo3y6n97/JCzh3/4iQrj3nXu+3Q5g4U+
# IkY/OyqemBJnSMD0bTMQnwwYzO1UU0lDWw2OZcqmqJmSkGX/0iVnYYsOcg==
