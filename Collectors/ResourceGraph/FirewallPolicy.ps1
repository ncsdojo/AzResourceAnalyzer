# FirewallPolicy collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "FirewallPolicy"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "FirewallPolicies"
        Label       = "firewall policy/policies"
        UniqueField = "policyName"
        Query       = @"
resources
...
| extend skuTier                   = tostring(properties.sku.tier),
         ...
         threatIntelWhitelist      = properties.threatIntelWhitelist,
         basePolicyId              = tostring(properties.basePolicy.id),
         dnsProxyEnabled           = tobool(properties.dnsSettings.enableProxy),
         dnsServers                = properties.dnsSettings.servers,
         dnsRequireProxyForNetRules = tobool(properties.dnsSettings.requireProxyForNetworkRules),
         idpsMode                  = tostring(properties.intrusionDetection.mode),
         idpsConfig                = properties.intrusionDetection.configuration,
         transportSecurityCaCertId = tostring(properties.transportSecurity.certificateAuthority.keyVaultSecretId),
         explicitProxyEnabled      = tobool(properties.explicitProxy.enableExplicitProxy),
         explicitProxyPort         = toint(properties.explicitProxy.httpPort),
         explicitProxyHttpsPort    = toint(properties.explicitProxy.httpsPort),
         explicitProxyPacFile      = tostring(properties.explicitProxy.pacFile),
         sqlRedirectEnabled        = tobool(properties.['sql'].allowSqlRedirect),
         associatedFirewalls       = properties.firewalls,
         associatedFirewallCount   = coalesce(array_length(properties.firewalls), 0),
...
| project subscriptionId,
          ...
          dnsProxyEnabled,
          dnsServers,
          dnsRequireProxyForNetRules,
          idpsMode,
          idpsConfig,
          transportSecurityCaCertId,
          explicitProxyEnabled,
          explicitProxyPort,
          explicitProxyHttpsPort,
          explicitProxyPacFile,
          sqlRedirectEnabled,
          associatedFirewalls,
          associatedFirewallCount,
          childPolicies,
          childPolicyCount,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBzZpJSJAfza4Oe
# HRtJAXTMwrpNfUlJ7PSiTUnuFRkTBaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEII9mchSNQIYZyut9+4ZBVTk1p0JznelLBsfDCz01
# jqXAMA0GCSqGSIb3DQEBAQUABIIBgIZZcDpu7qTwjAYHi9gGerpk/8KY5ueJvnaO
# BSN7QWW+wN+gIbz7P19uqOCu51QDah+KoalOOHHidLl2XOnweYLH2jqwwR3X6F+d
# 6C4G2xwkH4/Or4Xy+GP0nn641SivdMuqUNI5O1UWfpPZmgL3z91bbR3FJ+m3GO2k
# 0qepl9WflF92kUWZq/L1aoBInHJPbY8x95PgpkMeJ+jR7Uj+c0r4ui0PNTGqUl3/
# tvF5WN3eMgExcxmWx2R7wGw0DNBFI42k6CvVjqvQQQRDpA2SaevjDTf/g2wr849e
# +tGsTwCfoN8bDUMwDHDyA2w5K/kzxrtSH/Q7jlHXFSQt+5AvRI0ni5MKqXpYDWRi
# O3x5h+prj1Mn4Omi3giiCLFcZ+5mRqixyY/jY+Jxk2g4uSR2x/1qGR5ntpzzojTU
# GSHlqy2otEKfahjhFzpoUZJNyInuzgq3FEEqHOP0RrLWL97N3ajX/6DgIIO3JXlN
# pkGTueg70gHUjyAy4JC295sPnd4hp6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCm4NbRqhvDCFlsHOT8Fv/TXLCoVYFhn/bDX33VzhRErgIGagxE2a/U
# GBMyMDI2MDUyMzAyNTUxMS40MzRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNTUxMVowLwYJKoZI
# hvcNAQkEMSIEIMmIGNtxKrZXWmm16O08IdxVi+ohCdJsXMsgEunluQwIMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCUZoTqMWNGbk7tHd/M07tBCbWGoa5hOgr61eJkSyS9uCv3
# S4d6O03PLsuSriKWxSlncM2szBp8zyhP2KpZ5NpmzYSrqKUtLJ7e+YG3wfJ3t8Kc
# YjqZolbzT1bw2W6fuyX4xCz9IOa22fwFBLjO46F3xix4RBn8Jwlaj8kATyY//Ft8
# 1ND/siZYaKxm/AL5HnLC6D0ucScH67X2T+aa5TjqPhpk5VQWbl0I+UdFAHytHoyY
# ALFG5PdW6VKzieoGfl6ALaVAlYh3rLbaomVzvv/5mJszVthAh7X8IED62nnbNnhm
# sv+1qM976yW9lmYrlgZPOWadXcw7xY00iSK7y5dSE36W6LCoUCwX/USkiJaeAei7
# qtAkLMsqGbGaDMMUZFjPzA8YnFqUOX96vQ/SL1W6zvIzz598VAzGOkDY1ZaHRjKp
# 5jiyg10QixYhtbGxlZ3TB/P/F2qbgFmm3AvU1Oc8Kr/m28T5B4ugdRzsHKgvp1yG
# hm2/JEFxLM9q24P4DWoOLRa2rOBPCq9B8UCZap7TrnxQl5xXQrbQRYwAjixHnVhN
# cg2v3yH+J3PzkW8vMB1rPz2uK7mvX7BCkYETNfsJh1M3apNwoeRXLlTrxJpjCKec
# RUrkb8PSQgqqQqRqj/4cbvaM3Hgi2zt4460Ju3C7wim4TX2LgMIsLYcfUhLUng==
