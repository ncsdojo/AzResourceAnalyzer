# WAFPolicy collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "WAFPolicy"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "WAFPolicies"
        Label       = "WAF policy/policies"
...
| extend policyName       = name,
         ...
         requestBodyCheck  = tobool(properties.policySettings.requestBodyCheck),
         maxRequestBodyKb  = toint(properties.policySettings.maxRequestBodySizeInKb),
         managedRulesets    = tostring(properties.managedRules.managedRuleSets),
         botProtection     = tostring(properties.managedRules.managedRuleSets)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBb6I3N4I3yM2p4
# 1mogiJryO76EQ4WKUsmgxp1QZvy5UKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIIMpHoz5b/lWmQxQqkRxuce4HC664SOrsZehv3hs
# +49uMA0GCSqGSIb3DQEBAQUABIIBgEyN/aXNBYRkx4cLkVx8XvEpLR5+xvTWluZC
# w2JIEBLZ/C2ciQ9T/BQn6GSFREjPEjub6cyfj/kMoXeUpO6SLX0R0DiDZNaqjkci
# ir64Ze9U2d9Kbj+kULnXwt1rnNRRelNVv0ARZzB73t1S88rgWHlqUXRWYuQEO/RQ
# VqCeEXRtVOEBpfVUZ+zNxrw2jitX7Kdk2Ni2Fdzgiefobh8ThFYeo12ruzOis2WJ
# OTJb7NJRxdqGJ2YA/C3NsgmpAKt58GVfhK961PZCx7XQqnk8Dzfcr6hbukIcFrHz
# hlDpVfmtnohMvyoYZtoX063UyH9jAMgSQnX2tcw3NE3M4YnbO87x0fRMwFS294x7
# uF9wtigJET4U/KmMWX3WCnRMU4n+xFnjgxMOijvXW7RnA2t5il0EBEKM+mDMY9pA
# 6MBGxnOt82cCBJ/o1/ahAzz4qQWkkgX1emcJbYxT393SDoWsikTdw5TCr70kBl1j
# u7SUy6zmXqFCieDbugA0tDCuW6QCmKGCGBMwghgPBgorBgEEAYI3AwMBMYIX/zCC
...
# AwQCAQUABCAHH9LlQBvKoIUSQh89sRlLHijKBydQMuQBXBfri72t7AIGagxE2bIk
# GBIyMDI2MDUyMzAzMDUzOC44MlowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDMwNTM4WjAvBgkqhkiG
# 9w0BCQQxIgQgPULzuzWznDzob92w4fLA9UlxAakIwblJO3xMCBEtLqUwgbkGCyqG
...
# SIb3DQEBAQUABIICAFBgagMBibWhhmt0xc5eBz6kfEs49j9fLoWolCsdycsF7DxA
# NfTDAwZ+jqn23pKqc/ScBjNHB26uBK9YG8+n8e3HrHTJ6MDgehcOGDOobDHsjJtc
# n2owHyhWByTCpvLjlodR7DOncy1xebHdlbYGAMHv4cyIrp/0+h4a1SnrUmxAh8ON
# LpA5nmNkAfCpdV0JRAul58QFLEVwN98cq4zJP3skD+LuMbr1CgRrFX2WurDo7Tjr
# CY74ZfHvHZNMRsdb2O461VFSTbasSVE16EdWnhzeaC7dgsntzNn/LX3iYq4JrVRc
# G9jo3fn5EMjXovIIByULbnO7LxMGd88hXMxYER41nAfgnUpWz1rxYJgWQxLdHtCj
# mF9xxtY28Iudmhld4EBS3IRaDln+PeUzTTHXTk1WHdL30EZf9ZJSz5u3gJxiQArO
# +RicbLSEmTG4P7vK4fE/9VlZFJIbwWOSdSLYupvbRvyIjo39pKTl0x8w600lO3j1
# UIkj93eoviTZ8D154HbWxMANaE6wWQjgtLfieXF1cY40Jsk1zVxWcK7jOO1QbJBv
# hp+IA0+A+YYhmaryEaPWJst2wtnrFKCqc2SIcHL2i+YdQMHfwRO7VhUUb1hnKn/P
# 4JIws12b3K9Hvz5eL2iGEcL1K21UJ6c0oH/u/oPoT8h3pg4CbyNVX7RCX2Gd
