# AzureFirewall collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "AzureFirewall"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "AzureFirewalls"
        Label       = "Azure Firewall(s)"
        UniqueField = "firewallName"
        Query       = @"
resources
...
| extend skuName               = tostring(properties.sku.name),
         ...
         hubVnetId             = tostring(properties.virtualHub.id),
         dnsProxyEnabled       = tobool(properties.additionalProperties.['Network.DNS.EnableProxy']),
         ipConfigurations      = properties.ipConfigurations,
         managementIpConfig    = properties.managementIpConfiguration,
         natRuleCount          = coalesce(array_length(properties.natRuleCollections), 0),
         networkRuleCount      = coalesce(array_length(properties.networkRuleCollections), 0),
         applicationRuleCount  = coalesce(array_length(properties.applicationRuleCollections), 0),
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBfzUMTmjClDrN5
# DCR8pDYIkfgxQlNcuKIHCFt6E0qzk6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIOBiC4oLoG79vVXBQ1nZfGmLJsyxYiXYp0ECxs/e
# 1YTiMA0GCSqGSIb3DQEBAQUABIIBgHTn+E6DiY1o2dmsGgPrUJYrw5q7GaiYACJY
# jFeojtt3PMUQDIKLp7jgDTYqS0kiRSPHE4zBQgwYE3kW5FopeViady75QiUbMpmH
# AJnOJNM1gUnQlcJOyIwHPJ53sQYFPhb9jnQZ5IGvA5cR1xSjgzM9/riEuR6ZpP05
# oKQfM57OWqzdrJySTOYkW52eLxCK8RYVmWMxPlUhUuiBJEm+WAcoR0K7KxqIEX5m
# ceFKNa170tsCgNDh+W6VrIOZ0K06mHNmzLOV/5x3oXMe1QuYxq/dHIWhZyK//zxY
# Vl7focobCtHRRiDN3lkX/x74IEaoEuMZdtV4trXR2g1CwzvGgu9SKf697aIjt5oz
# h6/A9WME372CUIo8UTyWQh0+kEYTzTl2E8fyRrrU0O53z2UQJeeRgZdM6BRBF9jZ
# h6BaE4prAe7y7H0AQOq/nZoXHkBCvTGKQ7E6ONaaFS41fZFsaNVWZwSCPfQNmejI
# dgKCJftBSrcbrXcwkoUR3sFZNaINZaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCD3xoP6i+FUfqQQf5WDasekcr+dLxUWbXYCxCHSKK4OgwIGagxE2a6x
# GBMyMDI2MDUyMzAyNTAxMS44OTVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNTAxMVowLwYJKoZI
# hvcNAQkEMSIEINEPIqK42X5Y7Xl9GUjAycu/zMEigME/luWG7K/rInLUMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAx37PRg9sr/GM1twD8gpktzg478G8Vp56FtElr6ZGjbfdc
# +WcRU385oTebGYGptJ0SpR4zXVIiZW0uefNBhBsptaJp8k524e1sOjTI+uq+dcnE
# H0Q5KE+f8OMCF4/P6V/KHrRDjG9o34RBKaEsVtD09idg6WtktZq2SUoxxiIiYn52
# KxufYYZ5FDLZlf0pfQ4nUquxDLffZUQEP2A3wqMFw6dfg6gIvvYi+7sWkacnONEb
# cPZYh3THIGQZCyznhfngrHIerPvMQY/JLojpGxFQxOHu3uqdv+YCz9GXWzi1PW2Z
# tucGABOApbXdXstPe8LfK7cr0HXfE9uAI6S/gxhhZUYuVQY1Zp4y6X5db2uYPewO
# Tdlz8gWMqwFDDRp0+fwuMhf2ljMPI6qCIi7tL1IfAmx5887h0czRn3aNNGDDyJvk
# 6YahXg81ttY2Nb7K1iCWSdG56tleAAH/4R1SUqyJI16bK9G30hdY6AL/Cj9GqbzC
# aVBuJ8zTomY2MOnhmS0JL4NMV5sOwTvVSLnDoZy4ZVplpciJT9IEJbrw6GdEt7FW
# nllV821OPNKmq45Xg6vXAZtFEgZFKzvo4NykuDsIIZzSHXlzyvFK85EFi2am43c5
# NujR/69YJ93LdfQWlEGSMR2GImZM0n09z2sOuxSZQY+kwHWMMGZI603TjqnRzQ==
