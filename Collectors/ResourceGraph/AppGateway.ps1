# AppGateway collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "AppGateway"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "ApplicationGateways"
        Label       = "application gateway(s)"
        UniqueField = "gatewayName"
        Query       = @"
resources
| where type =~ 'microsoft.network/applicationgateways'
| extend gatewayName     = name,
         skuName         = tostring(properties.sku.name),
         skuTier         = tostring(properties.sku.tier),
         sslPolicyType   = tostring(properties.sslPolicy.policyType),
         sslPolicyName   = tostring(properties.sslPolicy.policyName),
         minProtocol     = tostring(properties.sslPolicy.minProtocolVersion),
         http2State      = tostring(properties.httpListeners[0].properties.protocol),
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBheNNflE710YAN
# cX07EUUIigOP9XxnbP0Q3bqfQrZBz6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEINtS58LKPHR0BawMzGRhetnWB1OiRxpwhN0Al09H
# s0JtMA0GCSqGSIb3DQEBAQUABIIBgHNnhL4wdKVxikDFOD6odXw2SkWajHordoJO
# AQzj0ZzjiMUFV6Ox9ERFj8Hnh9Ga1ZBIKOC1wkR0ENfaXFRtKX+xCbzrhDWTkFpb
# ueOS4E/pTFB1uJKbOb4dtyE6yx0LHBe/RUBkPV8vHcsfGKcfWg3YBZalc4zlwYq3
# WXrRoMTHCGMlAhp7LycdCZtdIo7FqFVFle1w9eHgmSs6IzOyV8TTAKEgtrvSiUrn
# b4F7dvj2KM12dbkBhCv3c33Et2g0WDZm96zTQGpQkj/6ZKo6EOS27yhghIDk+9zV
# 4WxNiDfZ53XFmcngIimWMOSwMAPou8Cty/ieymGt1kjBThwSOknudFq1u+FwNu/T
# 4dlvHyA9YrEPybslpoD94Ytt+6h43Mfa6oUFcgTWOgrLI+uD5x61xv4og1Cy5H+9
# SF3KfgTk8hzuFQB8Q6q5eEn8ji1/nZl9ZngabDDo/QpWzynFJfzEK59aux0Q1o8M
# VxDqsptGJbxoV5gkoa7XSW1yz965b6GCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCCGBIxUAaRePtRFgOTD85kjF9TtEb0R9FJQI+ENIGcyHAIGaeiBPN6W
# GBMyMDI2MDUyMjE1MzEwNy40MTlaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MzEwN1owLwYJKoZI
# hvcNAQkEMSIEIBGVvJlM6GcBQ0cDGRgtbK4BzoClr9jbi97npqWzBTYJMIG5Bgsq
...
# 9w0BAQEFAASCAgArAGebrdJ3INGxFcCBTeMzqWRinkxYxZ+w+Uu7neJ7oG6YBBn2
# X3W4PmZEsT1grx84fqZrfmI1vpMQkMi5K+L2WCWNTa2hkdXDriIhhKtwYuiecDVn
# LtX5KQQ5GR6A85uV1NEFBJtsTn68h7wBFE6/qfdnNmP3bvevMNm6HE5pCM//sAub
# elqzlD5Sy5Bp/d10xVt4qFyt9nYh/uwhl6/G4L4NEKCKvNdzURgcQ+okxqNc+UbM
# Nimd2/bgFXe73+o6H3TIuHIHhmlq+/InN7Zard72g2sc/c+D4oEg3min9YJTKdu5
# Obi7aVxpSEbIcOqXxh9v+lTIbELNzKelfbdJ9bnXd7DIX8DmhcniaCE3sUrfqlXG
# ZUUxWH1TYYdQUrRbtx92qXFSLtJ1CkUjyREGXYxAsJ3vabM9GD7g4aIx/6QFacE3
# 8wDeGDP1fI3lG2hU65SxuWNhNBVSOGRCqJsIjpymmRASPOcHzi7wMNqw09NP17OE
# t5JDWFoc3ScGdxvRHhrUYhxiZe6XUDdMbJifG9SP9nYqnN/tuS3UlEZDwFs2tXo5
# 8cg8oYG6z/7xqGCH6DCCwITT7ZkaRfRT1Pzy1N/+60zmIKJq3qPaaYsGFbxf8SEo
# zCr9crdOxA0uou7dH2f0Lo/4ho5L7qyxPyg4yiway95YxY1OuTuJ7VpniQ==
