# ContainerInstance collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "ContainerInstance"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "ContainerInstances"
        Label       = "container group(s)"
        UniqueField = "groupName"
        Query       = @"
resources
| where type =~ 'microsoft.containerinstance/containergroups'
| extend osType               = tostring(properties.osType),
         ipType               = tostring(properties.ipAddress.type),
         ...
         encryptionKeyId      = tostring(properties.encryptionProperties.keyEncryptionKeyUrl),
         provisioningState    = tostring(properties.provisioningState)
| project subscriptionId, resourceGroup, groupName=name, groupId=id, location,
          osType, ipType, restartPolicy, skuName, containerCount,
          managedIdentityType, subnetIds, encryptionKeyId, provisioningState, tags
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCXOwazcNZaXLHK
# Y7ixXtZiq1nAAnozZQFbw7rLyugMWKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEINVpzT2/QdZ3kAT78r33nm4g5NHD1dU/VaQqfPrm
# QYY0MA0GCSqGSIb3DQEBAQUABIIBgJKPCREXzHluKLZOxgykqHKgq39PA8NjZ/J2
# M9G5DTcWXJgLS2RefoZ+cpzuvTRSC8YvXeZK+NcrnKcyWTJDbQh+eg6H7la+9CUI
# Egz4gaOM8qhH8C4J97VialiFk7tsxCNVPz+fwEdMsbOA1i8JH/OXsIh1CzP6qsq7
# kd9TFN0ukzzDEqsnNOjuKpPR7eGkyUdQe4zihNeLWiOgqT1ZuwukXreZRtDliudU
# sOct6+q42PCKfAnUh0IJuoLb+HSRdL/ssMexwwrbXd3eitPEPOIsIVrEEYfEK8tZ
# nUNxcTn5Uu50c42Sr7KleJFTWgXuqd2TJtgg5ba/Y0FCJg4D8NPo5EYV7mQAQZHE
# r7x0ncRw9mwOr6zJRBiMzIW8AsUqFtPPrTtdVu3DqfeEWukPbbrIbvL8JLl1xhwy
# JzwEYQb4Ifx1Tod43XlltVUJrsmrOlUChbnkuQVXlGpp7/cUfdJgI8ypVUW3wYXv
# QzhK2GQEXrzRQZhJus4HQwjEBu+WL6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCNyEYvz+AoNHxl9lHGDzTJDnEOyz+/L2z86thxrzpknwIGagxE15Ci
# GBMyMDI2MDUyMjE1MzM1Ny45ODVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MzM1N1owLwYJKoZI
# hvcNAQkEMSIEIMetPjV52+alYrPguQ47mf3AAPpupUZZxLzaqGWrPI5fMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAustsWo/1DEyPQLv3Z7URDcELe3zSQNi8fd+TAjJgdNZxC
# 1I9du26vYf9ODFeghAZxwsv3ZxWUFedTje7kCfVmgnpbpeFoTymMozKby26rwM1h
# uFZevZp0oUfwCKpeq6URMfL0Bipozkqr0Env9wsQEL/kZV/NUCtoGbtwkMtNhmtD
# wm/P5zLIWVeUQw50e5GdN8cUCu+XIeJwfHedlae01iOBW0v9N9whPbM+7fFPF+wv
# DtnwtAxRcPCiPWn5ImiWA+KlONVVHkzkaHlF0uPwftMw3wm4s8jueiHw4AyFRz55
# C3b7cVQpTc81ngQST2Oe6hmieLgx8KqlUQ86a0GNLtJRtQ3jOKiZSJfh8kjvEx6L
# UkC+VZzMpcRwWQK/xSUzQ7bRPs7vSNmTwl3W31z5gD1iBy84MG2RbBp3KKTIlvH7
# TGmYMwHQwN8Jl+LrDaL1+flbDCzuF1DpjVmVYMzvkETx9al5Dn8i2GT7CRoUWRp2
# jGHnhVTlh4AOjzSq5Vv8RnW1U8jM3+RswXX55DYAm3JErBvAkVEHevBzYYH6t8Mf
# GIhZmyDFKryr36TD5L67M5jdh8Ete3UogzyLB7sxSjdCW5AlBl6wXbdbnwc55Dum
# 2ebrROpHavVZA77HD6ZjebBvi8EzQuWuhbEFlCPSevd1SrZ7/PpBQt4Kzvlwpg==
