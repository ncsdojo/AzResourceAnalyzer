# BlobService collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "BlobService"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "BlobServices"
        Label       = "blob service config(s)"
        UniqueField = "storageAccountName"
        Query       = @"
resources
| where type =~ 'microsoft.storage/storageaccounts/blobservices'
| extend storageAccountName = tostring(split(id, '/')[8]),
         deleteRetentionEnabled = tobool(properties.deleteRetentionPolicy.enabled),
         deleteRetentionDays    = toint(properties.deleteRetentionPolicy.days),
         containerDeleteEnabled = tobool(properties.containerDeleteRetentionPolicy.enabled),
         containerDeleteDays    = toint(properties.containerDeleteRetentionPolicy.days),
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDeO29QhwFX1QTJ
# 2zuyfC79DS52oB67x/SWtzBpYPqbtaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIEStuyOc/YpEgNgJfz3tJtQcQbnciQMHZG46YqLV
# IH8RMA0GCSqGSIb3DQEBAQUABIIBgCPOgg5D89ySu91df1O/fu/Gx/ihoNpYfW3D
# ojfX7OBVcHO/pwKDqqmX6bX/zcM/met5OhZE5SpbJCV0225v2jg/Zzq4iXIBIosv
# LJAYqZQbbdhn5olTX6wVjIXHWOR2FTNR1Xh9eERtMwrY0kEkxmRY73Lmj6F5JW5a
# t4DEigYlojoN5asUzcSCPNiuc5M7pkj6+nGrMO07RbMh+lcIVKgLkFXYMh6vsrlY
# JVSuoHjPZQdWqDFnjSwxCN8D+L1XVvUw+emu83n+zld+kPu9u6Ck49q660c7YsLO
# hsm2HjM/zdU3kfizZTwpjGdlcA6nTYaNmAT5EqevCPwyUNH/0SZso23v0qNm6nIG
# TZsliFgDJLZmw/UZWoPQk+Ny5RkXzE8Wh+YtXMqQ7wZNPLPbsZWAHNo72W+9TTbm
# rNedIdidivxbnyQNJaCbadW3UvvUTruzFEENR9v3qeI0XIjiar3JaDvbdXOSy/mG
# 9MnP3c2R24EpKDBZhGjLudjEakpgLqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBKH/arGFhOPOn2nF1RlC6Av92gfXN+rBGr9cI5B4s3IQIGagxE2a8A
# GBMyMDI2MDUyMzAyNTE1MS4yMzFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNTE1MVowLwYJKoZI
# hvcNAQkEMSIEIAspuQQA9IdL+P94sWgcttL89Ouc0FYxJu4T6oZYtjQhMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgA9KsiW+bXMB1ea/m9HpN1Drx2UMvIhauclyqyh3RIca5az
# 1UeucP5wsFRtZz47H/QOMVwmAVmhQ1XVbKHbZ6v0xnySwjQs2Co8956C6NeFcwxx
# v/LnEaqB7uLj6t78BcbD6WHCLOaxcRtXK1ZJ4DpOF4isxkClMQz0AUbOiiJl5h8A
# UMAqyUdFpjINt7Ur/kR8FEuPxCAXGgzbLK2ZAjytPMjFyYUKfVRSnBbEqaGYEIoZ
# zmIomU4O/MhDbds29wC3BoYIl4u70TAMC/A/j3gSX7HvHX7gs1EpiOWA/p1e9NfA
# Df3kTR7IKZr4BmjkyErKWbcwvGESW++9Uv+W3FBHwXZUqowXUSoXVDp0lirH8vRF
# t0Y7uDhQSBxzMdD+/ttozrGQ+h6nnoYaOi3QRV9pXxL+yPZ1ZG3XQaChgqtdnkcx
# 5g40O+h7FLscB4zcQeHCt12bAkABEd3Nl4a5UhQKpAPCQ2zuTVX9Tf2xze8OcwVK
# KipKUXM0oqzn+LPvkIpJwaRmcQ1IC4mIKp+GhOYSGn3dAZMYvvFPNY0m8uB964pD
# SII7v4NfyyXIhUxx0Rmp9jx5ouXLSzUt8ZKWDVpDva1JXWAkZLVTTDd/bN0nmX/5
# QX8pUhJqSAH04l3af+kwcK8CIqpyNrDmqpJFP3PHvgmWd9FnaUWnge2s1YfvEw==
