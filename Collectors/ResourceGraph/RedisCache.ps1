# RedisCache collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "RedisCache"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "RedisCaches"
        Label       = "Redis cache(s)"
        UniqueField = "cacheName"
        Query       = @"
resources
| where type =~ 'microsoft.cache/redis'
| extend skuName             = tostring(sku.name),
         skuCapacity         = toint(sku.capacity),
         enableNonSslPort    = tobool(properties.enableNonSslPort),
         ...
         replicasPerPrimary  = toint(properties.replicasPerPrimary),
         provisioningState   = tostring(properties.provisioningState)
| project subscriptionId, resourceGroup, cacheName=name, cacheId=id, location,
          skuName, skuCapacity, enableNonSslPort, minimumTlsVersion,
          publicNetworkAccess, redisVersion, privateEndpoints,
          replicasPerPrimary, provisioningState, tags
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDJEmrvuGkTlxMF
# 4YMr9nztCKzX4dToY0GRWIG6//UgWaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIAL/NHVG51Q1eK6cc4yW/nyvvInkPyt6hdLbZvFZ
# qbhoMA0GCSqGSIb3DQEBAQUABIIBgH4IJ4p8+uEsVfo9V5RnMR3KTY92k82b4qAC
# nGLNMHC/LUNFwkv0wjfuEDcgnqyX5wMBS4gqR3kkGmNXe6pqGkvPCQu9oHDwpg+x
# 4xd2K4PeRswG+Brp2jNQBVTGSbglLUtGruweQhAiC6j+cY32ZxtcA+m1FdAddNYt
# 3Nlr1Q8ePTU01X1OC9F/WpwuuRURhrEuxfkFfJnKdm4YOKK0wRiI85V/7xNJk/AC
# P8E9tRtXuluQP9OoLGRUSrv586DjGQe4j32CyBbZl6Ojo/S/4a2nSmC5bzNMx42q
# 5dFqybEWqGLMaSuRIm0fm7e8SNdTUtaMJQrCA3oMApBTCG9M+WBJLfPa7/tFu4Ap
# bvhkrF7EfZNLNo1XRZAcVHXwZ1huErdmRehE3+x454prMmdQHw5O0PuUw5sDZiHk
# 3SbTJWcR39MQuWhOZLhSfMYOcFnzVBWvtW7oYeBjz8uYgpDsQxAhi6df1O5oo7VX
# cZpMG/qb/GfhIklUbXqjxwyJTICHUKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCATRfTJ1CIl+mJxASE6Sq3OficJQkZEI6n4Xp9Bh9Rh8QIGagxE2bEo
# GBMyMDI2MDUyMzAzMDAyMi44NDFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAzMDAyMlowLwYJKoZI
# hvcNAQkEMSIEILjyAlse/xMUpHXT/bgHYzKj6wrMY6OT/Feh8Gw0promMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgB34I8wMFfVUg4IjtiCuPmWyiWhdCiMSDPlH5QGFqZJOh7e
# +IY+ftH6i+rU0RtIwguRk1t1/bFGjoWqaJxz3VkJcW/BsAekCimv2VXXhryrP/Kn
# 232YYHq/mEPq7cU+9QpR43aH6TJYKE8Q5XbywBIb+DKM91x7W93Gh5O6acctOuLe
# hKd9uPOveh/m9E7UgNC6l0mPnSvExc7PMm22COXFh4ILkihRTrLbQ+3vuQIY/Rfm
# 0YpRIymvRr5rOzGeS+0J0US3MAUnBwPWnz+9EQ6/bUpkEOVWHn0M2e7nyNZL8o8l
# N4Xb1oPYRAJbOkOXx3Bi3IWEtUr7wvQoAWjCLBLtpJDrfIcACE5NJHLwBmpedu7R
# 3vokhsxN380XQCSNHOan0Mv1QKUGglHeh8RaC0kAPUl63Jpv9szk46cgsgIGVWIF
# 7UISL7huEuG8RNJ12vWQ/sUot/9Csa1QmydxkgsBK4ybXmx//nHe+IS7DNqZ9QcA
# +rHLXMUpiqPgPJs7cxYFMMZOHu4VSwWeXxWXmi0+q62MEiiyUBaf7Jxtq3fNctmf
# QG9LnnDu/W9XzSwK+6QTji9w+B6/yQsD8HWHU1Bjv1Y2COKIlq4X2v1+KGyOCPye
# ku0nlw98l/56pcCgm2Na13SWni4GJLvgl3qGFtpwc3O3s3zBIJ2LTB4W8XnspA==
