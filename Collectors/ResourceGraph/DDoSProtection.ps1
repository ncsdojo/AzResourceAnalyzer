# DDoSProtection collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "DDoSProtection"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "DDoSProtectionPlans"
        Label       = "DDoS protection plan(s)"
        UniqueField = "planName"
        Query       = @"
resources
| where type =~ 'microsoft.network/ddosprotectionplans'
| extend provisioningState   = tostring(properties.provisioningState),
         resourceGuid        = tostring(properties.resourceGuid),
         associatedVnets     = properties.virtualNetworks,
         associatedVnetCount = coalesce(array_length(properties.virtualNetworks), 0)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDY7H7vz4XGDjGk
# fIfV7DOWeAZzTyxR+8ijNWZZ/h/8qqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEICxgOMZuy+HOTdSNWV01dmTZ6+6amE2GULOY7K+Q
# 6jrwMA0GCSqGSIb3DQEBAQUABIIBgJ7yjK4I3i/hRZOac65zrcq7sbHQ13c+n6MJ
# TE5uORlHdmycV9D4ej9K2ZR2XufkivyjjA79Bvb2ievAPZ1IUpYKg1UkNUmGf+Cn
# UcJTc9jHUkIcRWMXBaXdqCEgwUay2It6JW0Q+JObTuRu4a60kUkRwtwXh4cGjPky
# +g2UmY4N8L54naZjqbaDU6jTmfTCQB4dubSDqaHW9tly+Qc14pNl2fLbwa5dqtbz
# 4dwVPJi38FC3OplSdhS3sfaPtkGS9bKWV57Rlhza++pZOVSnV15yJE2NZaaLM+sv
# /3YBirp1ej+HF8fvLgG0c9OJO6/I8z/5/AlGINBOgPIPRAJw4CGhZ3hKIdS0nie/
# 18s8DoJWKcDD7lEcztEhz/KYsfwFD1BqFQwN/LRUJsBZh2Y9lz1qCf2WwucKZvf1
# 4Rv+7OSt9ja/JDbOWxGp96LC4LR8irGbVWhGMJjYgVR9AfR4r94vJb//pMkPTvbL
# +gBt/bO5vsN+L0xU98ZY6f1SD00ByqGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCBGXQYKFHz928nl00AgMEboEYzudIrK96mxrqkYtTp35wIGaeiBPOML
# GBIyMDI2MDUyMjE1MzUxOC4wN1owBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIyMTUzNTE4WjAvBgkqhkiG
# 9w0BCQQxIgQge4J/J4zMSiNtsMYM4GMxDjFwp3A4UF0p4MwUPxNG9vswgbkGCyqG
...
# DQEBAQUABIICADMetu2/aumcTUyXWU8IBl7CxhdQHdyJuZ6c+rMUW9AQn/7HQUll
# oouuyAy2BHH6xXekyKMbOAg0dtVVKYza+kxpUA1pPBo4Ow2BrAYXiCguCFszvYvK
# kwjpj4cjrDfXFatnr/1SddGWTLzX5L7zaCq7RbfTMsJLQNA6p/rw6V6uoDRGlyAh
# OC6kvr9dSZzVINZGqPFLMDYnyZgV91cX0V2Xom7AT4HaFQr7kH47lZaIXd+ItSDZ
# Nk9Nxth2m79eYMRpqDPEFt87PA3m+GNLW18pa7PjEsddXKZ7LhJnnWxIS+TO3e8Q
# aLTUrmEVPR45BZRCMD3LwxiOdpUZk+XO/IKEEurActxnHAvemz260i/2FKQZrtCq
# KchLsCKbkaVcpS8Z0d9ENUAlMgjgwKwFQ5ASo7BcTV1ery7In5bCckPyHe4iI4Oe
# bPafAIKhl8f1Ra8DmrIbPAClwf+yqUYtGJJXm8onnBu8f0BXXVjRyGlk3Ma5QWUN
# fJvMmtBC7zT4Igvi61fEYeKHKoY1yAY4hLKFW6kwNY7VrxZVCWRdFLdn9GGTmCM6
# je+ZME88RbWVxsWnkXnogpAr/2Porfq+sEOsT9QyVtPC5ytZDdp0bXOPdl4ph9AS
# i8KEqCakKFmuEsRAZ0a+gul9Ug8AZhppDe3Tblhl4S8sMPGIaPGahEyB
