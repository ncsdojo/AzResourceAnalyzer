# VMSS collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "VMSS"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "VMScaleSets"
        Label       = "VM scale set(s)"
        UniqueField = "vmssName"
        Query       = @"
resources
...
| extend skuName                = tostring(sku.name),
         ...
         autoUpgradePolicy      = tostring(properties.upgradePolicy.automaticOSUpgradePolicy.enableAutomaticOSUpgrade),
         provisioningState      = tostring(properties.provisioningState),
         overprovision          = tobool(properties.overprovision),
         singlePlacementGroup   = tobool(properties.singlePlacementGroup),
         zoneBalance            = tobool(properties.zoneBalance),
         ...
         osPublisher            = tostring(properties.virtualMachineProfile.storageProfile.imageReference.publisher),
         ...
         osVersion              = tostring(properties.virtualMachineProfile.storageProfile.imageReference.version),
         vmSize                 = tostring(properties.virtualMachineProfile.hardwareProfile.vmSize),
         nicConfigCount         = coalesce(array_length(properties.virtualMachineProfile.networkProfile.networkInterfaceConfigurations), 0),
         nicConfigs             = properties.virtualMachineProfile.networkProfile.networkInterfaceConfigurations,
         dataDiskCount          = coalesce(array_length(properties.virtualMachineProfile.storageProfile.dataDisks), 0),
         extensionCount         = coalesce(array_length(properties.virtualMachineProfile.extensionProfile.extensions), 0),
         securityType           = tostring(properties.virtualMachineProfile.securityProfile.securityType),
         encryptionAtHost       = tobool(properties.virtualMachineProfile.securityProfile.encryptionAtHost),
         secureBootEnabled      = tobool(properties.virtualMachineProfile.securityProfile.uefiSettings.secureBootEnabled),
         vtpmEnabled            = tobool(properties.virtualMachineProfile.securityProfile.uefiSettings.vTpmEnabled),
         proximityGroup         = tostring(properties.proximityPlacementGroup.id),
         managedIdentityType    = tostring(identity.type),
         scaleInPolicy          = properties.scaleInPolicy,
         automaticRepairsEnabled = tobool(properties.automaticRepairsPolicy.enabled)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAgKkhZh6NkXy9p
# Uc/EaNuS7sG+MFbeIBCkG+3hTmwZqKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIHjYaW4jKHMaYx3PaUGKGGVEO38HFTv3RuyVflB5
# pWTJMA0GCSqGSIb3DQEBAQUABIIBgC7+fdCYeeThqp2tfyw5UxhA4vP1qjj5j1mK
# /Zrmrq7aEUC0i9Hhy8XWaY/cimSDL0UOv7Tl3vWFGJNfjB84SbkuM1aeO9EC03bp
# aDUga6OGkG3FDGVwbgZclvXZ8TvRPND/C4WBczSqtb/gl1PCg8XJ4AZFdGvPFp8O
