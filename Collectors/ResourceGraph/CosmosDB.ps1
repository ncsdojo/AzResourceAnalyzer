# CosmosDB collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "CosmosDB"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "CosmosDBAccounts"
        Label       = "Cosmos DB account(s)"
        UniqueField = "accountName"
        Query       = @"
resources
| where type =~ 'microsoft.documentdb/databaseaccounts'
| extend isVNetFilterEnabled  = tobool(properties.isVirtualNetworkFilterEnabled),
         publicNetworkAccess  = tostring(properties.publicNetworkAccess),
         autoFailover         = tobool(properties.enableAutomaticFailover),
         ...
         keyVaultUri          = tostring(properties.keyVaultKeyUri)
| project subscriptionId, resourceGroup, accountName=name, accountId=id, location,
          isVNetFilterEnabled, publicNetworkAccess, autoFailover,
          disableLocalAuth, multiWrite, minTlsVersion, privateEndpoints, keyVaultUri, tags
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB1unLrKNEFL80l
# WdezQ3qIJA1eCb/lk8W50L+ghghJeaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIHABNzATa4Z2yoLW4G6RO32QY82pQjU4alSZRaYx
# 8F50MA0GCSqGSIb3DQEBAQUABIIBgFSngUnwFxgBv1BxCwC7dls05S607a953s7A
# nYXE6jJN7sGu4wBGH8drDHT5TrGmlSyqhwWfhBrINzlaYyAiEIKBT4dTOyKfmodC
# c9yH2JpslCOfZR+lAVIXG02/BzzmM6SLPraRmzYfChMTPbDylu1sdK5a/eCAMzGL
# AbCrsexmG/nOAK9m8XRVsnC42UYkPo/hNQ9VHtey7njeJB1KcFaZ4kyB2usJcx4x
# 1SpiQGHiA4scv1mqBjMyxjNfdxBwQcYS39InY6JDW4xGH33pOGqfO5LjnugTN9xE
# 3ET+9EOLJeROxLuDPPOKqcyQKyKLAIHAs0tkjn9ZVRmPULJAkwecbXEKNay8yePz
# xUCPYL4gJ5zfxOIQrRMbMWmp/zEYkenG/Ve5mdyk9xJfNanIB1ZK/LAjbp/1syUE
# UYBytx6VHv8k9eTyiOqzKwxme3JwPsNb9R1B1RSPo82ke00KY6wXTsaaejivJEF2
# bkPstbVgKjUe2sGMCZ9sBNA5ez4YcqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCoiKpqrEDRq73AMJcuIcSAyd/ttGOb2z+m0OXaDB6NdgIGagxE2a9B
# GBMyMDI2MDUyMzAyNTI0MS4xNzFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNTI0MVowLwYJKoZI
# hvcNAQkEMSIEIMYGoMduZ9gTA+KJa3vqX4xmbjfQ2sTCYkFlEnZA9OPKMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAg8+lfqgfdxD3s73QAO2RRBQRHgX46OYXwh0ggLoO4gwjS
# N0K4b4IyQKKy0dNT8BllAwgXreLvWyrYNQV9g/KS+y1pSAgmfRGkAodfenDNzwIh
# DZJDwTlxe8lQ7ytsRuTeugVAxx2MzJOgboSqW5ne5xBxBcI0otiI4XH21WyzC25x
# YUHpQnCqbymUk8x8Zdv2GEI9gtvOOC0qzsvyM684OuPBbtxkSyAwBOgh071A6bHn
# JTeaL+U0YFh6MQfVipyFOq+MNhThOdX++bhOEgdrKfpcE4cINvY1OqiF9RYkYfUd
# i8YG7pzQcYFC10InxR7mjfnN10E1LX16dQbYYL2GmuwDrtinbxvF2L4LudXhA/Xq
# kXYUp2t+9vWXzZJAXSlfkaZAOXmnZVEkydSBXdzI2MD/aog1tgjnAWVNTHIG3+Ur
# bkZrFswQkHwSdRZwDGmFY3tT814J5TfqMT2+ETo1M7dMZK8VN4252eGlt3+exE+j
# rVffxDzq6Pv+3VOehlA2GQH9kWIsYpbnphe9DOADYpBrDnbxIYi94LXB+vptUXct
# nZnLZ3N7OtaKk60UbVkKxU20mROlAzjZ+ckp/uQneIQkeo5xhFVVM+AM/dUzY3U7
# 1yGALfsAx8f8e3DR74qvQ370Fp1pSXuGczEj3C40tIpK3y61i4qRQENGkRnaTQ==
