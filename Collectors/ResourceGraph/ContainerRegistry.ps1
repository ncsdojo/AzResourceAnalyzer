# ContainerRegistry collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "ContainerRegistry"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "ContainerRegistries"
        Label       = "container registr(ies)"
        UniqueField = "registryName"
        Query       = @"
resources
| where type =~ 'microsoft.containerregistry/registries'
| extend adminUserEnabled    = tobool(properties.adminUserEnabled),
         publicNetworkAccess = tostring(properties.publicNetworkAccess),
         networkDefaultAction = tostring(properties.networkRuleSet.defaultAction),
         skuName             = tostring(sku.name),
         anonymousPullEnabled = tobool(properties.anonymousPullEnabled),
         privateEndpoints    = properties.privateEndpointConnections,
         quarantinePolicy    = tostring(properties.policies.quarantinePolicy.status),
         trustPolicy         = tostring(properties.policies.trustPolicy.status),
         retentionDays       = toint(properties.policies.retentionPolicy.days),
         zoneRedundancy      = tostring(properties.zoneRedundancy)
| project subscriptionId, resourceGroup, registryName=name, registryId=id, location,
          adminUserEnabled, publicNetworkAccess, networkDefaultAction, skuName,
          anonymousPullEnabled, privateEndpoints, quarantinePolicy, trustPolicy,
          retentionDays, zoneRedundancy, tags
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBBbvT2MhAFbgCz
# 6rikNAviyKsXrMiHpslaiVS3O+qFU6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIPDAxEG9FcSvNb5qE2KfpDDdnzK2335ZlZ6wyqrq
# VLi9MA0GCSqGSIb3DQEBAQUABIIBgCpvF1pov+Mt3ytk9qxeDKbO6/ZY3CcsALVS
# 1ORlo65z4AhXZhDF3ISxhmyprxN00z5JQ5jjJ18eaXmgf23RcPHXagb6kMtZEt1h
# WN0JtzMEk9fw58EHGJWGJmDbXp8YKaDsa2kA85u1lSNXr3tLFf82Fer1pSVoKMTw
# ucvXYiLpOdr/YxUM/C3FfnOEV73ZNJWgzBfSryMnyLLPzQZ+OX+Qr+XuLPq2iU3c
# xteENgSBINVLpFzgIyNA2jQDS2NtcEAZE5T0eH/sqq4fLOFvotCq3iyLLeHKVwVU
# SMoyUmx98g3vLXsf8EXMbQ9walP3nhgp0XUi5DEty+u0N4nWEU9tDSZX2mbBPx26
# foxo/1g05uLJMludFtRyFNgLM94OJ6GyMF8DroxZJqtqeTh1gAY9tuCe8Lud0Zsj
# XSeFHDuElGosvRRk4M06fYiZBmkZ3flXnSrCtJO9KG0cnZ1y/qiE3hZaY0mg9qzy
# CGLIz30ytuizFDGiInEWJtDkaLTCTaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCB+YdfG9S+v8DMoxllr46vey/bJWu/hTfO16c4+V1gXGgIGagxE15Du
# GBMyMDI2MDUyMjE1MzQxMy41MDhaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MzQxM1owLwYJKoZI
# hvcNAQkEMSIEIOoRqYkDRrDnJkFCqxQQsUnWSRFxKznaT4mkOmQqwO8OMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAThlKnW4I9LJgz4zg2jGZEGw3bJpX9ZPUetoIAYcBMexSH
# vuLf3X/UtaAdNdOUB2mmkDhg26J3wlGHnuRcTMPDGwBCUvMZPxGFH/4l/wvuYp7k
# +py8T8ftNysg2fgTf9g5MVW663t7Nk8MG2JBg9ml7ci1kBaFsBijSd1v+AHyMrzG
# qQO+xFgmD22f8NrYAPC1FdKyir0V4jrgmdzuyHbMxFMlE8RDh/uMgZp9rjJ2mDmD
# qbVDLC2eefRsnycoKPZ8uxOjQbA7jNu4Ch4SgIKnTx+HuBYPYhSwZLNfdIoCSV34
# IGsi7bT2AMGklzdL8XVYvDGm0EeFbyndjEZnge5lpCOnxTiGF4kpvqcmYvQ7vxf8
# 8/CKfKVAt6UU3uhpzSTtSu85C3ubPeXp9DcRWPOODmpzuXAx5nnfZJjixYjTTscl
# lfMejTKKgs6EUsyoYGSVK4cXb2xZ11mz/raPbzz83Dlt5Iu1j/2M+O+Tnq+Bh3HI
# HNIqe4OjyCJoNDEsQaqmuJHw+9r6d6rE+L/DYuxOnfRe6I2EbodqSo2VQIKWBbBT
# IbKIeepQ3YpobKY5x+kURWDEQvh/KmreHEIQET5GpHFdWguI1OHzxPqvuxISmBqZ
# dRqBAxyyxFmUKCXSYnOtDDO6c37J3C2RaycslzLzVeo1sQzDiz7SzhgPJBoLtA==
