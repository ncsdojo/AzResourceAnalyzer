# FlowLog collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "FlowLog"
        ...
        FileName    = "FlowLogs"
        Label       = "flow log(s)"
        UniqueField = "flowLogName"
        Query       = @"
resources
| where type =~ 'microsoft.network/networkwatchers/flowlogs'
| extend flowLogName     = name,
         enabled          = tobool(properties.enabled),
         targetResourceId = tostring(properties.targetResourceId),
         storageId        = tostring(properties.storageId),
         retentionEnabled = tobool(properties.retentionPolicy.enabled),
         retentionDays    = toint(properties.retentionPolicy.days),
         analyticsEnabled = tobool(properties.flowAnalyticsConfiguration.networkWatcherFlowAnalyticsConfiguration.enabled),
         analyticsInterval = toint(properties.flowAnalyticsConfiguration.networkWatcherFlowAnalyticsConfiguration.trafficAnalyticsInterval),
         formatVersion    = toint(properties.format.version)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBeOkJFjtJDLFxH
# zOuTyJlONy/kga57LTX6Rv87OaOBUqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEINGEAjovw+ZrjNN8axfy9CtyZpblLfxEsjPlYukM
# y6AHMA0GCSqGSIb3DQEBAQUABIIBgAgtMcuCTXJOjMHsTfdA5kkIu7G3+rV5FhhC
# 99TjMALYBH+avv1YLM0Dx0TxzG6THDXSJa8dXbcy2xZ/PuE/+eAciJ7T5Cnmly3f
# nPOf730CIv+sceKlUmqyfkqww+s12p+XyvI56PEVOUQBOPmtcNRek6xbSFUpPH6t
# IFMDD4VEsGgUzSIY1mQu7gpwUHCLO0SEyxN4DMxSof5GYb9HAeT9pRqMJlLjxoPJ
# mbg8nRa+VjP4ZHkx038QAfNfQQaNDt38uETbES2MgPSKy4wqijkyMUJxljS/hUDB
# yGJIWwQvokYdFoJamzJefyg+BTHgM6Xsw+l0P4fLmVAF6U01rc5gXg3gSnAwRFaG
# EFQ+JOhilYQG0fk8zi34iEDWX8quYo8RUJgK+nUdixmEg2Z6A+ooDTwFIpTsjb7Q
# Z2nsemeBeYZuYgiDNtHokSUoUxctKrnYza0lb3Z6ZEu+Z5O3sUoNIhN+d3Wbl788
# 7pvDZtD8PPOjWxliMPhO7U/1Un35HKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDq6Bf6adTVXxQpHRrm+/9ZflQyTkQ4Mf56bsg8XzUh1wIGagxE2a/0
# GBMyMDI2MDUyMzAyNTUyOC42MThaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNTUyOFowLwYJKoZI
# hvcNAQkEMSIEIHXQxww2lEMYK7W1x8zouwsiz3Uw2OVU36PGyYWaRU3sMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAtaftq5W9jdUO7G6PMvKAxrNLZsf8yghKsyjeygULMTB+4
# 3nxTxh5zjClxvfl3eClsLJZM++OvLZmp5SG9uQabHtJ8W0YM/a6ol0FHappdx/D7
# m2kUBo7q0cUhJqfAqwX2rpq9a5LrkA65GGFPw7A1MlgvRyckziLI21xqG9DsExC/
# UeIKP+yd/FUOGqz3Nxtdv5j8zUs/Z7YXWDLlS9Wq7gdAMwQv+6wRpkbFk8anT5Kr
# FIw9ThrnTCRIHwIBu+NGRKcVcBH2ZEVK4dkNHAoHMZjwwW5uwPmmt+VToTwuOxs9
# EUVJ3RZFfYB7+2UESnwxgR5iY/bjMbAhIWbvipxP0hreYSvLd1+luL/ZCQXKOzQz
# cRnXjRpzGpVVPbDboneZ76J83lArtSmqTHUtLou6nFutsn/jS0EkCO8ePOMMTyBp
# HOvX7Z5xEQr6IBHgvZI4mpzOdFVB9AnfrlDDnm11egJ3bIpy98hMe+YMWMmm/9z4
# N03lQrwUXILVIydmgXNNjkGrDZQhmKIVXh66qqTjElC462u/uu8MEs98KSeWfQ1k
# Q4NTHenpKzyGCQWAsPm7OPGgovdU2dZER2SCDWLvQNJ7U0uLppM1oyaWEwaD9M8w
# jZ4IuPMzqXh5xVk8FDubftiMuArAyWIVnuMsykacAODQiy4odgZ6vfRi9c8HGw==
