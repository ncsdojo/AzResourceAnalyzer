# SQLDatabaseDetail collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "SQLDatabaseDetail"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "SQLDatabaseDetails"
...
| extend serverName          = tostring(split(id,'/')[8]),
         ...
         backupStorageRedundancy = tostring(properties.requestedBackupStorageRedundancy),
         transparentDataEncryption = tostring(properties.currentTransparentDataEncryptionStatus),
         minCapacity         = todouble(properties.minCapacity),
         autoPauseDelay      = toint(properties.autoPauseDelay)
| project subscriptionId, resourceGroup, databaseName=name, databaseId=id, location,
          serverName, skuName, skuTier, status, zoneRedundant, readScale,
          maxSizeBytes, isLedgerOn, backupStorageRedundancy,
          transparentDataEncryption, minCapacity, autoPauseDelay, tags
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAcGjldfDsbnPxm
# fqsjSs5/lsPzv24EJjbUl3Y38jUENaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIJZtxPd9rSoXxxBAxjm6UNewzErPSeHhks+WIRVh
# xK9nMA0GCSqGSIb3DQEBAQUABIIBgKDd/hegbe9q+/y2+ST9haGHSOoWXKoRbesK
# brZTjMKkqLmDUvny9klx/Z58gK9x/i2c2VoSR3JFM1mabzsV5uwX7nLe0Aayr9Q6
# ww0EasV1q3EeGjdNAotZEas3wftP7TJKsH08TR58cMGn+ggWVKy3a6DUvwE/G6Fm
# Z3xBNTkwRytIdE4r1F2nVoEOKq2qAhhNSJXMFiNL1jPYckG0LshXiKpDA9cCt8FT
# a1ArGUXAnlbnj7YMXG593OpXI2Wy9cL5MpV1MZr4WiEFfCkZMlSC/XJq+yWxt7cT
# HeqbUnWJPt3drRx/S1wPrLTEEan6tsKwAdHLvT8bESETmZ8ZNfnoqstdU/g6zJO8
# mcmUNCW3M7roaQnIIIgthFup3mEuURYBvupQnxZ5Qg00CVVNPONSXV1ocadOc5VO
# G6Ld8cUKZ8HyMqzX4+0P80DPQlCvhcg7gdbba2DJUNYZcL9E659dg7P4GqH3Q5sC
# JIVJ+Hip1RoEFSyDl18tcQEQ0kwmOKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCIFOD3SFpUl7tbzRTmzI/bFbKWWLnMP+LiJFrKNeTtQQIGagxE2bGN
# GBMyMDI2MDUyMzAzMDIyMS41NDVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAzMDIyMVowLwYJKoZI
# hvcNAQkEMSIEIMblp6K5B6dWZaszD9ryI39M00Mv7X+JroSTP6r8cFKOMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgApsPaM/qp5wsWbRzXh3cMBsk7m7GksN40VdAB7eJXHFF17
# qns6lU5/S+H0+k6jIVOYDuKvqn64kuLbwjzjkER7PSM97LeDVh4CwuljZx8h72gX
# LGj5ybMXlOwFCM3Rs9m55/aXsj9BIS76X5LbxvNV9gejGzLAtQhuvkW68QzRWJHi
# MeK3mnbvZWxrj2MPNx6y3O4U/GPeMcTAxa/S37lBANEZhjw/b4t01tsSoThAhyxS
# VU+3BXzKhNwdBkGv/I2rVbYEhyAmby9AS0pfqjxndnhjkfDriAG5mwQ/xK1eN6L+
# 8GCK45KeSaBIH9fviFeMYrgTavYKkhVc6PvOmRztL4X5nWEZygLKVWiH3RVs1ZHW
# DSXUX3PzZBJK21+AxXzEIOiuKNThrMEBF/iiTjGGlHRzm3mbFLHHj5Wqz1Z8EvhP
# nVXL0ahjUGTar/g/8q4Yi+VlWozJ+N58yorvX0iElUgoOd3snWXwNzroorFBHq3b
# HMv7nJqK0LLccnh+Mc+PFH0okIAckw8y8c4F8S8a/8dCcEb9p+MbSdFZohw0IRf9
# bkPONPKUoevTalJc+FPEiV0p+SQ6HJU8kmX0aT2f0okFR/kymLi5G8G9kvWUrHuy
# brUkZ+RMj+/mUi89TXICtwALLn0sRxOg6hHZjDOjLkf4u/DiTH9KH6fTDPz8HA==
