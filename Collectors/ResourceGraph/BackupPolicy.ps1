# BackupPolicy collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "BackupPolicy"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "BackupPolicies"
        Label       = "backup polic(ies)"
...
| extend vaultName             = tostring(split(id,'/')[8]),
         ...
         schedulePolicy        = tostring(properties.schedulePolicy.schedulePolicyType),
         ...
         instantRpRetention    = toint(properties.instantRpRetentionRangeInDays),
         protectedItemsCount   = toint(properties.protectedItemsCount)
| project subscriptionId, resourceGroup, policyName=name, policyId=id,
          vaultName, backupManagementType, schedulePolicy,
          retentionDailyCount, retentionWeeklyCount, retentionMonthlyCount,
          retentionYearlyCount, instantRpRetention, protectedItemsCount
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDOymK5kwbmMKxk
# bnBKg+jc9lUK2b5VMTT5upYRCcG6XaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIJ8RPruUUaJnm5lw8ccp4lOznHfB/oAhh8N04nda
# qOZyMA0GCSqGSIb3DQEBAQUABIIBgBKTAEJfiwGQcxYQ/BVRHff2VplJnEal7bRr
# MCzNEuKx5LL5iIZ+w5OEqg92t5G2eqPBB2uDVQge/9WSraA4tgQhwP8bQ51JE+8b
# 6eS5UsbRDJLBdxLlmaa3mwv8Mn5+X2u7lBgCS+LrjB2t414P7RqBHgSVYxEPreDn
# wlp40ZMvVh2Fhzca0uFnydj2u7gBYtgPnOmI1o4la+nK149q4K05GOhifGhpYkNm
# CfIFJDcT/gip5jPCYIcGWpY8bBvJssQXf87dGcGTnH0GcarTxljk5GB8z1yWlXKq
# 7JOWlOdHMLnV3HvZ/A2D27Ermu3vGvxpSa4RIAVJb+gnfTOcQRSpZ5JyP/uyNHOA
# b581sIFAC0dcTx74PXDCCw4WkqQhHnuu435m1BVhaugzL5zCeXxGwEslPe6t4ZKo
# Xg80xadyeVGjU2tf6tCHQBR/rKIiK75C6W+ujBH2u4fjcx4UlLUOOHAF5tU5nRl6
# MXte1ws5he+J7DrgbF9U6TYZNBBAvaGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCBNi2nud/YwaGhn9rnbV5tia5WFJ5KNR7j4H3UIDsifTAIGaeiBPOEJ
# GBMyMDI2MDUyMjE1MzI1Ny40NDhaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MzI1N1owLwYJKoZI
# hvcNAQkEMSIEID+MsxCBscF4LCimNkSaoBpzAQeSzOw6Hyw0EXcHZlkZMIG5Bgsq
...
# 9w0BAQEFAASCAgBHGeT+ABfHqyWYjqgGAXYYLGQx6DbS9NmDqBl7fh/BkvMnr7el
# QAs3VbXkRkSc/4f4BYd/POFc90AQBfGHpnShAbqwQpBX7zWfFmXwI9iqvPI7cRSi
# X9nJpWQMe1J9wqXlI7jjGPwj+OJF4/ajJ0ESAqOsMlTEp1SC5192LguKhKT/oX0v
# x4A4QbDX8SZZmXWqy+WiHQd9Gqj9r1dnxFYWpHpGxUawYFeMAmu98dS7FASmRa+i
# 2X6aZIc1Oea86QYP9m5MYNwgB/5VN2tNOSW5nsXQIu7EDmCcsV9driys7ft1Ax1h
# XkdB1s1atkywLjOqjnHSGjF5tBVwMVS6B5xfStegO7XJAXvZH+YEVNdraRfMPcs1
# V5b/96fcIFes+yd4VFlTydrt/eH0oSve0MH+HwrYUSRAGlGgCRKkz2lxwB9XHUTJ
# OiMMNbGXp4dAuSkM4SEriLO8+MOIElDedno9E6EOoKFxPdehR0DLzS8dqBwZqqRC
# 0z2cLSjQzsKdV07ZjkKe6hBT+M4Q76eUrS/EPawrUKWGbAblbTTYZbSKndm5p8Bp
# dcPTgT0wxPWTuqaYNADw0l3N2aset1MgE83veMTxtTTwBGxkTOatTHHY/r7gWRF3
# 1AYl54hJS4nLdCDlDjRdlJXFSiUMo0o+Q2p3IL1Eqlzmb2l50bcvVAWeYw==
