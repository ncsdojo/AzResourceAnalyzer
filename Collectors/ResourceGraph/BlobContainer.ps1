# BlobContainer collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "BlobContainer"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "BlobContainers"
        Label       = "blob container(s)"
        UniqueField = "containerName"
        Query       = @"
resources
...
| extend storageAccount       = tostring(split(id,'/')[8]),
         ...
         hasImmutabilityPolicy = isnotempty(properties.immutabilityPolicy.properties.immutabilityPeriodSinceCreationInDays),
         hasLegalHold         = tobool(properties.hasLegalHold),
         immutableStorageEnabled = tobool(properties.immutableStorageWithVersioning.enabled),
         defaultEncryptionScope = tostring(properties.defaultEncryptionScope),
         denyEncryptionScopeOverride = tobool(properties.denyEncryptionScopeOverride)
| project subscriptionId, resourceGroup, containerName=name, containerId=id,
          storageAccount, publicAccess, hasImmutabilityPolicy, hasLegalHold,
          immutableStorageEnabled, defaultEncryptionScope, denyEncryptionScopeOverride
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCQBbQ+6FmOTOHD
# rkEf6bYNGY1eDQF4l03DIzvXNWZaEKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIMVSmMZ9I74+k4On8ONj8vUejC+KdKM50PsQQJUl
# KJCKMA0GCSqGSIb3DQEBAQUABIIBgBF0qJ65PUN0I8VH/oGnW0MTFiQ4PNZBpkey
# nCJZ7A36byR0IapnHIHzM6U2INLCGW4U2a0cbSN9tdxOzcE4m1JNnFbUH2c81qpC
# KcMyfQx7/GPENyYE1n4aLCvfBU+yDRt2A9sHKTLjgAhV0BaguzVBsHx4Wt3MU3dy
# fHr39Ecu6ej/9jl0SIQaWljXcclAbuVHJvzy+8SX5JEkehuZHWTWnzvn98+HwkrL
# Y5d4qTdbxXNsxny7Xj2FgWp2s9YZ8yOZzWV/kTqW12G6e1Dr/1Yo5FD3Y1EtIY/x
# TQdCFQJwPSYZyZx2RYMi5GHr29LBMUjCK7uXkQMzhK0I5V+KmORUgwL+wEOGozO0
# +eQYqC1QSU23KgI9IclSmdP//+J0v/b2ixfDZOULUOQKnBkPhjawwue+i6LSOxN0
# kMKtqDvS5e/erXh+TIAHUoK+jsq+U4cUF4RenjVNWyDGnnVjVnky5lVeT4YCv+TJ
# mQWLf9+bQtSHfIj3LtPzFKp2HYIT16GCGBMwghgPBgorBgEEAYI3AwMBMYIX/zCC
...
# AwQCAQUABCBCq3JkFg3Iozh89BMDc9+TTA4JXO5JK37x0EIdo4YwcgIGagxE2a7w
# GBIyMDI2MDUyMzAyNTEzNC44M1owBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDI1MTM0WjAvBgkqhkiG
# 9w0BCQQxIgQgYoiUO+ZB305QJ2LdSL6AOCxKaimRm/dE9zQt17rOv54wgbkGCyqG
...
# SIb3DQEBAQUABIICAG9AEpMuQSAIDdcxVciMZj50KHChX5fI25sYaRJ6ERSVHmDI
# ntgPN6WcGaFiZ6L806KDOt/LgTWvyNVDUwm4d5fCIDGyNwhpCoNJqF7dAEbiDuK4
# jMvP4Cdziq/GrYGnjmV62z9mddPda1qlXJfqHoFeVZIgJ+lCVfiIsG1/jITIjPWl
# WLxICC+Fo4Rpko7WYd0JRgEqmYoT/YQxGR52lEIjWk1amtmZ7HBRiQfWbIymWuqZ
# /7uA/0Z2/1vPDxGZ1us+kAx3SdddMKcBwcT928njaHqjN7uRVI21B9G2C9v689ms
# X5Y5Z6Kt6A3Ia5g+QVw244sREOGtjfn6/tMl+Yobyi9jqTDcT4YBXkg8l/rkP+TK
# EiTCsAPVXi32mHNAEqqwSU2R9oILQZmV7hPtKivLaAEk3QSZQ/RkFvtqyLOVRnTI
# eYvyaca/Ef6pTxlLIKan73Y6PonENv7C4lqzz4NL0bybXX2qo1wdxHUuGykRWPuq
# qxTLRQcyoyQORFGahMbYRM9IV/8dX6IXoyGFRRci8ZxIyO0uKgvzKOdYQN5fx/5l
# XJ0jr1T304dd0ccPazYt4GNtQAmmrCqs+0vGlyrlx4wug/wjKAL9V6xB8B6EB0p+
# 9qTcdz1DjUSwgsrpLzqEo2k//FpqXhqH8jG4ajtCwAJN6SmoXr9aHi3UrMOf
