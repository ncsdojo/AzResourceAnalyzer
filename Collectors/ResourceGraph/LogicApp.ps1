# LogicApp collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "LogicApp"
...
| extend state               = tostring(properties.state),
         accessControlConfig  = isnotempty(properties.accessControl),
         managedIdentityType  = tostring(identity.type),
         definitionContentLink = isnotempty(properties.definition),
         integrationAccount   = tostring(properties.integrationAccount.id),
         integrationServiceEnv = tostring(properties.integrationServiceEnvironment.id),
         endpointsConfigAccess = tostring(properties.endpointsConfiguration.connector.accessEndpoint.type)
| project subscriptionId, resourceGroup, appName=name, appId=id, location,
          state, accessControlConfig, managedIdentityType,
          integrationAccount, integrationServiceEnv, endpointsConfigAccess, tags
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDsUYvUY55LRsWb
# 0+bqMCSYgAYxeaaAXYlI9n3ldqTmc6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIIh1Ys4Jq+Rs8bz2vtuQvd+GeX3Rb6EpKjIz3Ee3
# PmmZMA0GCSqGSIb3DQEBAQUABIIBgIgEIBl0X1mVzvpGrgcg4z3ii1IQdsSTL+j3
# v6ejB9dTxBbYXjh+prZWCbdc+NccoJ/SN8P5gjGYNYbzrtXkfUfBGdLWplgnH9R1
# nNj6JCAMBr+e6VgYEN3DSIbf0QRdVhajQxmTi2pYZKg1Lbzoep0KxHS/9mspW1OW
# WWPi+h4xadns5YXKYt1JI4Sm2CCdGmUXZxClMpqg9Mr+Qi1Ec6gogjW0uLetOk/b
# gwaVCRkiJ2B+zm3ZI94zW7bnKGFvEoDRWE7UrAAaVXZgCCvqzr15yFkUQ7+taBz5
# EjpTcqKTZRtm77hX3d6+I/s/iPOH1+RcTGjj5fAJRAT4p19HC+nfMY2jO5fx+h4t
# VbFQiAsTFoM2yGs7HKXUao1JOQN0OrhbbGnmlZiwvJCdXEcQec4Mg8z7PiAppg7j
# LlJSmaVLTANzB3BRYn49AmnOb1Hj1tSxGH6kkAENxwhBpBZ/sv1oLsONPiMsqivz
# 04VPsxhJniSNv7hDly3/XHb/1F8wmKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBoYc+M/AmEGoPw+131s+q4B7boZY3NlEp+tSr0+8EH9QIGagxE2bBA
# GBMyMDI2MDUyMzAyNTcwNi41NTdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNTcwNlowLwYJKoZI
# hvcNAQkEMSIEIEVMyEZM6ZOX3pC830MwJx+oeP3N6KQkQlh7nFyOTxdXMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgB3ptWH2SqJjZx3XN+C+Vc3X4oAGRT3TR3fBQWZEhNP7SgZ
# 2T9uIXp06tlDX3uo1/DE+6/G6rj2gwHX+LWxcGSEoobxa4/V3x8sm42vOfD43bqv
# m4t6fd/m9CVtct1TcSb2V3vND58S6pcGt4mEPb1Ef6IKZ9sRXywPuFTcGrgGWyXn
# q/+HrEmXI9c+PQhy2sgbE2p9nSfULBAgg4aoiICAGzSBjXfs92SMs/3oXH1DdanZ
# PORYfJrbB4vfXzI5gzFx1yHuIN/87445GDlize449fJjdambcB0beHmhyOCR0RBA
# OVnrATQCR8ml4xR5U88BMJKEfC2pCQd/dCrHOG3Dfan4wmpX2W2JHOP6PG95x/H1
# qXh5DB4EJcrv8viALlNE9r2h74MVteYeWPOtljIt51qofcSyu1zG7iJIeonh5WH4
# M3HCZ4sQeChr1qegdqfdWBL766AAom0D5eEKUbeV6Jf2so5GCnh7dFuEJKCO4UxT
# gA3+z+HAnYFtOcTER25/qQyBvw68P/58xkCqTrd3f2l4BdwIYkkj5Zvd9mFaRoVF
# xfQQWhUWJyMiLsyZgCEpaY971o/rVWxxRaZ332jiS0WelTkfNt1TBaLUNHlNLPmQ
# Y2PzWIdj8CZBz+aErHnc2GCfwAMm3/UmbjGc6ZktUkp8cFcBD2RxPgxlhsF3Kw==
