# SQLFirewall collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "SQLFirewall"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "SQLFirewallRules"
        Label       = "SQL firewall rule(s)"
        UniqueField = "serverName"
        Query       = @"
resources
| where type =~ 'microsoft.sql/servers/firewallrules'
| extend serverName    = tostring(split(id,'/')[8]),
         startIpAddr   = tostring(properties.startIpAddress),
         endIpAddr     = tostring(properties.endIpAddress)
| project subscriptionId, resourceGroup, ruleName=name, ruleId=id,
          serverName, startIpAddr, endIpAddr
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBvBX4x/lgDY1if
# V3GvtvMn2jbDBpad2C0xRkJePxBQvKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIMePPXpC7Valnu91naGEWRvTzeumF3hXsNqbDyNM
# z5R9MA0GCSqGSIb3DQEBAQUABIIBgDvMEWHfH4Q3mvyaW7yEMPypTp8C+3fx8Z1g
# UoU5bN3/RL+04CwzszA2PDwz8yICwBvzFHOe3YMWNX1mZgeofyBXrJEcgbTmhU+I
# yDVaA5vtJ1nRAOMntf8Zq6BWCi93F9Ae0aPjGZooAKTN6h2vVMtV5XDVvpyILrnd
# TWgNOQ/DnC45GTWKVf2JYZU2BYOFA/Cddv8ttldplCzrKFMPpDYBm05+hOx5tmsQ
# g0DjfHtinKdkcug8p54+b4g2FhklIVMN8ZCrkrhQ/pV7ilbiteypMHkNZb4ojY/d
# fyaCL1gRgue5xc7pMyIJt2DNb7mOD7nuABp4HK+pF7OEKR+AjWrDlYagH8Q3E4Uj
# YtCZLQY/LVkutVuQPaav12qmnCYBV+TETRSuvOUl2h/C6TeoI0yeriIyWuW/0ty1
# 5LWPtMlU68nCfr9UApRi6Vua2iBO3sFC1xGSy/WICp8AcMt4U/rl92IL99Mp8RQd
# w3N2cX48kz5ufQG4J7nk3ietM1mZPaGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCDWSYT1GFx2r6R1xErasMbvSJ/27H4/opLgPVwIEg8X6wIGaeiBPwmk
# GBIyMDI2MDUyMzAzMDIzOC4xM1owBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDMwMjM4WjAvBgkqhkiG
# 9w0BCQQxIgQgHBFAs0WIBBMOQ8QZuHiwy60Wh9Hnke1ZXj8QWpzPjrcwgbkGCyqG
...
# DQEBAQUABIICAAKZvlk/gQHcG9xpiDzn5wL117AghNBoXe0OAVlHc0yGQZRqVMnj
# Y6z+DWywyp0rQCG9vFLJ6IrjZlWyGqBN5aP2hdoEwsqpD4LDV8m71EfNlLFzkWeC
# P38vrzVLm5RHKy4qFTKWvHZAwvSOrSBj1OQEnCrSSzpNcz1/TNBO/yeWFzGHL2Tf
# P+npl4+hVcXKs96CGwkEMrSaYOVCF5gCCDyqBiOuBESY/Tc8BQbHcX+dbHTBQJ0V
# zwnyMw9V0LCyYuZ/xVV28yi/Mtjc+4lZujSHPgd2fnDs1rxhAp1sy6G7e7EbencW
# HcHmdQE94hxNMaRtnBYkdWdjV7HkXpiUf5FdWTbl/arSixcS2KIYLcipnj/qd4Wa
# Xx8nyZDty/EnYMwzx58b/kOu/1N3gVEkaQ4o10MckymeRo6q6zST1KD814FZma6+
# +GCn8+4KiyOCV7y378Ukx1al+E0VMRLyZO5/3noeU3g3qxnQAhXYa9OY2vgVuwAE
# nUy5ycCGjWL+dXNIVNd6SnCalNBndoIqq17sBuQ37sfdwe2Nt1+1PqqAdbyUBtEQ
# LIKaylwo41xSMkOD4SGl+RTQKvOTzMHxkic7Tex1WgULXoh/TUi2syFKFFy+7o8B
# TnQ/ZP3f9F03Uc+Sj/w9zAJsi7d6e45ookhs5xtw6gUykjbKfg6sBbtk
