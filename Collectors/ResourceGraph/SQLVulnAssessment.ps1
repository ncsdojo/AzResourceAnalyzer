# SQLVulnAssessment collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "SQLVulnAssessment"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "SQLVulnAssessments"
        Label       = "SQL vulnerability assessment(s)"
        UniqueField = "serverName"
        Query       = @"
resources
| where type =~ 'microsoft.sql/servers/vulnerabilityassessments'
| extend serverName             = tostring(split(id,'/')[8]),
         recurringScansEnabled  = tobool(properties.recurringScans.isEnabled),
         storageContainerPath   = tostring(properties.storageContainerPath),
         emailSubscriptionAdmins = tobool(properties.recurringScans.emailSubscriptionAdmins)
| project subscriptionId, resourceGroup, settingId=id,
          serverName, recurringScansEnabled, storageContainerPath,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDmQtHXc39A8tm4
# cg2i21ACe+mIndtsk9bt5DAy4FBw8aCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIGLOtRid1xJHzPW2Z7uX4NIIl9327yE85OUo5sO2
# UP/yMA0GCSqGSIb3DQEBAQUABIIBgKFDsCgQZePvprES+nYrS6OwkaP7mgDr9q0D
# BZPXcZWOXzxKU6DNh1G2gZ2dxWFPzxoNNDYnr6mum1YQOucneioTReMppC9KyvMF
# IevqsndQ2ULJ7DxsadpPesPSat4JNFVhHE6Kvtb9V/P3zKjvf1m8ppGhXo/Ig/Ih
# aN46SR8M+9p8ESxghAdJip7RVTXw+OvnenEp/shMkQeJo0o+H39cT0ZIr7U3XBTa
# 46CW3q3nzunFUdsaWMeSmNW98smGlC4WkmwY6k5wt/GPtmlqYnUxpwpaxPLzTACB
# agANEKr7YM5uihFrTZG2ecxLfcr4uywpQj+AqejPONeE6dXQB8n9HwTHvYz2TATJ
# UuGwyjLgvipSx4ZyT1p9/Ut5Fx2e+e0oLiwY5YB2LWACv4ddlvW1GtBlJ/bqbAGi
# XkEsKxQnubRcJmZF5Vor+rcVvuiTGelq+RnZppmkIsMfjpcc5AMbha3hYp3x5xhx
# oOiKRDA6mX5pXhtBvuBq36QqnZ1r1qGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCljj2TsSIelFQK6J6iyTJN03M6cg6sOS3ZvpD5KQt1IgIGagxE2bHI
# GBMyMDI2MDUyMzAzMDM0NS4xOTFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAzMDM0NVowLwYJKoZI
# hvcNAQkEMSIEIGftsBxZPXmXsYUifLWgFR/iasXtUyiOf1gKEXqTPxgkMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCiRLvBmgeHgGTQADK5XyvP9CwnY6avUuSyb/BCakGiTdHS
# icoJA7oo1qCobuLEBUf23qJ62sqaaMN0RuyphRoNzCFKMvHsTH1+aqEEhJMhgFNW
# Is7FBJg5/fj6zmBebOr//6wshEMLsvWdKb8Zw60ETzjnFZYway/NkzD+xC9aKxOx
# eaDgFQeX9kf4WU6aICvmNp/4JKBbyE4f/LnBBooqT4Tdo9C/vk+z4ekIIdNPTbOc
# znZRirbEIzQfPw4aL0iVGksQpzuV4mOROFwxXdXtgz41aGgIZQaSiz4Vs3Q+9cam
# 2zYwbvX6jplpNfRL3Rplpoh2PRnG3T/K0i5tu3rcDvNvz3IL0A36x7w4dQFLxkSD
# yFh7RrkYFTfD1tILkousJSS2wyG6qX7+UPYoYRZCUC4luguo0hrdoHyzf43UyeAJ
# Uh7m9eaf+7U8lJ4Fbepp6v3y73ZiSb7OwZFXcjFhNEUoL8Q9wqiCm13UdtKa0IGO
# uVzkSY8sxZK4Fz1qDuA/vx6tVEKpc85H+ZY/fqDCzvsEC70PUZ5G6MFL3+CLrCHI
# W+xfGSWs74S4V0E8iyY6hlDtshfcNtXFnaJJaUlBejnkAGINJbkyWGNTSyc/lxlZ
# MravZf/XixLgfBsm+fDwf9KiRGKYxDhh9k8IsZ1HDhkCdhbs869G7EtHlte5HA==
