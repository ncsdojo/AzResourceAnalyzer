# Bastion collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "Bastion"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "BastionHosts"
        Label       = "bastion host(s)"
        UniqueField = "bastionName"
        Query       = @"
resources
| where type =~ 'microsoft.network/bastionhosts'
| extend bastionName   = name,
         bastionSku     = tostring(sku.name),
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDDG+BbAW8tIThm
# gJ08ekiHdlHSZ80EzF+8bTzBUk0WsKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIFVJ3hWjUBh6UUqx/MjNU6bfr3dQd/EAiH4qvz1T
# spesMA0GCSqGSIb3DQEBAQUABIIBgH1wuraGM/rJoyjo8nVh4AODYpZyc7OWTDi8
# pQ/iAj8U7223V7iWVDRiijumaOV7mZCI3X5LJIId+TGlnyR+II3GSdRLeH9UrnNR
# AM3jJs/mM/4qU2f7VfCIYusMUjcZqZUfrMlNBBcpFxEfIySX0cpGfsRxfQ8d3Zgl
# iTrCMyPkI3aMmY3tNpSRJ3H30pgjxzN0ChC9hZltbdMltQ/KLmtK0XS+BgpHFew1
# o0u3/6+/p1zia2rn7a+/YxgrqOGSn6vzQZHMcKPS3mzTr99v1dDY7Ylx7XWcFUqh
# s9j5VyhZX3Fcu81jFlfZK+7tqTucFK+lfnuJUdb9itFmXZhtc68xHbqnLL+nAE85
# D9MSOGQHiOSoRSyrrBYXaoKdB9f8r0Uj130UJ+u32V/pQXvy9zfd8yDU3+1TW2BQ
# QlVXU7HtBcZ7mm3voqHZQen+KARyTcWmHyGNKLQVZW1jly6kCLOanMmzVGBoO2Ov
# UMTrG7ikPlwGKs5dkugR3r55e72MKaGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCABzAb5pq+j0MHudRSj035GUoEHLMnvKEBbRGhXI6oS1wIGaeiBPOFK
# GBMyMDI2MDUyMjE1MzMxMi41OTlaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MzMxMlowLwYJKoZI
# hvcNAQkEMSIEIKeU4Z4d2vHHM8mLnlqEnCgkPfb66aBZe+JHK9V8y/RQMIG5Bgsq
...
# 9w0BAQEFAASCAgAz3WVdcTAleKyvjlAcyZ9st6GaJ02Aw1WX2+bS7aK/fNrdiyFO
# Po4TLwN7Qm+dVPMz8ZsqtAokfkxsHrDJ1LhjADeo8CeMi7AA3Jqab7FlYV2MevCS
# +FRh5lrqQcugVkf+X4eYdCwnSZT93tWHoewlfyoZjLWMHxhbfc/rcbSISrhSY71g
# omLGytAM6CPVLFH6Gj3/YRce2C2koHFcB/fbc1+3ytyOIe3n+NvuHWwvwzy5vQ9I
# lkEDGT6sA0OGZZXYO0gjHreEykz1wEneWphYdVeHLoOm/5zfcBT8s4mQYPfCwDNn
# FoSB7F+TUtMsrhmHZtvQeU1nJnp0RnuOvZIdeUCf7NuQ5Dnnp7Tvrzc+N7xd7UHb
# xPv1I/j1SUBLfn/ivaDAlxqMScVDEc3Zp5mLNUoS3mcFBWvXaeLr5E0TOxE7DFUd
# r2ycf5sNyP0r0egUzqi/ZjkDYqY05gITOXcfy6JRpQG3lYVh1TtuOA5/v/QoTOz+
# inDPZ4iSGuYWRwpw5iVnz2a7In/JYGuxfylks/lOKcv8D18FLXhNo/hVv++f39Rh
# oRMFv88ZwbAFwI5o6sw6lqS8BaT40HxyyJGhC5TZa4LFaTrmC/xoWpZh611328hb
# eWohkaXnwPvE87lluX1iHXe5Kl362ga7Nkstvta13fqg14/cDwSwiUDmig==
