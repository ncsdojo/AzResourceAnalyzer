# Databricks collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "Databricks"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "Databricks"
        Label       = "Databricks workspace(s)"
        UniqueField = "workspaceName"
        Query       = @"
resources
| where type =~ 'microsoft.databricks/workspaces'
| extend workspaceName     = name,
         managedRgId        = tostring(properties.managedResourceGroupId),
         skuName            = tostring(sku.name),
         customVNetId       = tostring(properties.parameters.customVirtualNetworkId.value),
         publicNetworkAccess = tostring(properties.publicNetworkAccess),
         enableNoPublicIp    = tostring(properties.parameters.enableNoPublicIp.value),
         requiredNsgRules    = tostring(properties.parameters.requireNsgRules.value),
         privateEndpoints    = tostring(properties.privateEndpointConnections),
         encryption          = tostring(properties.parameters.encryption.value),
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBtJvAdMCZk8aWl
# Kbi/WmXwnaNqUTZBg/JTZN8ORcXru6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIBvQ5MsdOf/IPriKiK8DMip/wzA3phA6iyCU5YwC
# oEE+MA0GCSqGSIb3DQEBAQUABIIBgANOMBrAB+9prIlsrbPWx/VTNJyHMEhGUVPY
# fzNR2puZRSEdIRAU+T9dDylcrbz92fpR5M2w3ffv19f6qeprJfcADDnE4upsRdLF
# a77XUo8JI4UHN5qkt7kV1gPlxsCpSIjyskhQOQX2va6djM6TKEr+yWgHc48xQYBQ
# yqtjPD67zF5EQUUuee5OpK6MJw/jNW09pJuJE0gT05cw3sji4rqHinUNCelulc1S
# wKKRrKpjypzmNh86eQGTg7y6Yuc4EFhYkcvxVnC2zgF+lkQEEQ6spp/JGV0QEpkj
# ByWnGaxICEkiHHQrrKSdgfh88tspooTjkWrVlSlOgVZzjyIa0gDq+WKWfiWPgqPb
# iwUQ6/caVL7sepYLXB26XAVhzTsbWbd0p+Qt8fPgB+qoNYPteUHgoWERZiME8gMi
# N5oMpCoXAJ/nv0DwtlzxA5+ZFITSiiW9UwwXBKyRB3QZhbRLGhUJJkdbbP4p2+9U
# w3bJaTBIqbCfpp7vl3XZwkxsSR6UjaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCASMtVcdJEy7OeHWG19UdrNwGrVhjoOsDOcwjELDBPUMgIGagxE2a9T
# GBMyMDI2MDUyMzAyNTI1Ny45NjhaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNTI1N1owLwYJKoZI
# hvcNAQkEMSIEIPbyQI6erinvLTeGGBT6ZpitH+I1yGI9F9HmTKh+CfpBMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCLToDJoZ4haWljrOYzPHjM/fqnHOWkpx6jMfHkht9TOI7l
# dgKKv311BNvJ4+ZkZ/2a94OtktgLp1imCzg0Ce/drfCfz2BbxoP4P7uPImk6aHGe
# NVZrIneWScFmEBiOFPL0vaMg+EmXhigXh4V3/h0SZHFd9ejxYHPdZgrMavHkdKuK
# WPUtrpsjbrMbNiiJoq7LqP0oD9R1uHxrLhs8vAVpc453GbJhyXK5ZS3F2EHTRGSf
# KT+QAQ5QJLOjhvuBeQu4BxfmZq3khVa4jYPh5vffcilF1RYxEoCsuS9qX5HkgeGN
# Hal3bGpIywQbTxVlV+rBBHINnngxYwtNnPX+OipPbGRG1KsErHTCPC25EA/CPqtQ
# x4e4oxeKR7AyRlz4AVBnKBXeQNL7wpNZ/s7EEqTlDk3+AC7JJyDzp9PYX/C8SMKT
# yCGgrt1iPs0IwnJPtcJKIfBV6I0ObSCGvu8mZbtxlOAAHKtN6U7uGSvhXAx6O7fa
# bnjsCNVKjLxdHrB1/rc0TqaoWCI95V80szGkR426YwtpViw7A3KDSLsyfx4Mooy8
# L4ZPXyP2ikGOZJ+Ci1tegJaY7iSWTph7rQV1k9IrQPKjtn8H2coR5Cz81DeCD0P/
# 10Wh3mLQ2YJ8ClIv/He79TQF7/Mw8jIe3xKBsgnW+1FPzJ457PpfrZtobgTCxQ==
