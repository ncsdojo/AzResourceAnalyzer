# RBAC collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "RBAC"
        ApiType     = "ResourceGraph"
        Table       = "authorizationresources"
        FileName    = "RBACAssignments"
        Label       = "RBAC assignment(s)"
        UniqueField = "principalId"
        Query       = @"
...
| extend principalId             = tostring(properties.principalId),
         ...
         updatedOn                = tostring(properties.updatedOn),
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD/G/bxjoCDRFNz
# j4Ab9RNxKaRzS4qSEVSSNBPAIQcI1KCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIMffTkwevbBXIT1iCHZ6kUPzLjIdpGL8Y8dYS9qd
# gPMCMA0GCSqGSIb3DQEBAQUABIIBgH/ciJMGTeSlyGgkgH+Dq/H1fe/yNWCsGlri
# uRA5qRWNiUEaPpL0JUR1xJ7h1wzpj8cM9XIecF/S9f/OQopxlYTsbFlJFBg2UEUY
# DcLF8EcDKglA+/HMu9q2BQE+3+kTF0uP5n3ap+JFjy3eUoUlxa0btgmMvHqpO24R
# 38J6bqRfybEIFuAvVpCyUlrw1RO34ji31ME8cIZ7//XfYF9iRkSfJbobr+dy4Yo8
# CVVqTlQZ3z4q/yCD/oBjdKH8R7vgk0yshAGtxNvF/OiZ7ppDpK4rHZNeo0UWaEcM
# Auz5d+udZWdbB70wkEuXHp2GYthAXmKqt9imuyeoWuS6eTKnfMFKiRfGwBcQLxAl
# LMf+xlse+Io3SC9TebUFbrffULnCzTfVWvyw0vaYbmz9YEXC/z0BzHxCAK1DWJXq
# 67Od4TRh3KhBUbrBLqNm3m1fNqCkrIbd1jgUvuHuTVXWIsLUSCdIc2NG2zhMmi3J
# HjMaj3svYJSLR+9koWIApu9pC4k7JaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDByq/oEEkeP6NN3bnbdbvCIWqB4IQYSagD1cSbx7IPVQIGagxE2bEC
# GBMyMDI2MDUyMzAyNTk0OS40NTRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNTk0OVowLwYJKoZI
# hvcNAQkEMSIEIGJ+dpT+ppZhejnOp7+HAcgY8KFubREeChHMaUrkB3IlMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCOx7TlPjODUX0anqDlydus5mkwFqoDvp1phZC0JPvSkI1R
# rCrdO7m/eKAG1bnrPRj1JO1acjIiXy+H16S0x/WtKlS7DOojgDt2NvFhO0BnwrPr
# EKELJyYP+DQViSnwsDsmjzrOc8/wNFzNNvKViQBA/QM1Z1FQK5bY+OM+Sxo78FhO
# QLLejLFIJ71fpUSas0WiPCftgeMdGx/uHscUmdFfmRm2gvxWT4pNnfSDcCWJhSw1
# A0/Wvlwy+byzYOfk5Xcqf/k81R+98LNOuh4VUvVwzbaEr4Q7gxk7r9DAPwM+ft9z
# mioPlzb6FHTEX82rTLOm4/cdrQ43YEtEhKfOOLnrIGcadJhxYIWzIRWuLQys8OxA
# //D67XBHqScClBAUvY24dkj3mVApaCE08Lk0H16WR0ErQafeukrfehHTq4kO1gI6
# ebCyZK5VUHf+dyt+Qe5x/vm74lBk6KMRSZdv2cxbGigXa6zUG9Pk586IB4VzkdgT
# MbEd/ZW5P9XSSEaS3TZvVymAjNg5bXdlsBgddHW2/pC0nL6CgeyN/ytVI+1qzpV6
# VbYAVgmWmYypUivWReSWeuynKHFuKzFz5JHPxjwHCJTqAvEhMTOLIHi95gSCdG3d
# 2Xk3caPcx5ftvo4I1nfcraCDmvG6OyayTa66P5PeWLOU0Sz2nISx/qzJIEpHtw==
