# SQLServer collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "SQLServer"
...
| extend adminLogin          = tostring(properties.administratorLogin),
         ...
         restrictOutbound   = tostring(properties.restrictOutboundNetworkAccess),
         privateEndpoints   = properties.privateEndpointConnections,
         azureAdOnlyAuth    = tobool(properties.administrators.azureADOnlyAuthentication),
         adminType          = tostring(properties.administrators.administratorType)
| project subscriptionId, resourceGroup, serverName=name, serverId=id, location,
          adminLogin, fqdn, state, version, minTlsVersion,
          publicNetworkAccess, restrictOutbound, privateEndpoints,
          azureAdOnlyAuth, adminType, tags
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAe2MtljVIIdUDQ
# 7a2HQuqvSQZOopdoXHFIAU0GwZXhzaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIEGqVo+SlNOL1fJAJv9yc2FabBqUjvIQFII0/szI
# vI/rMA0GCSqGSIb3DQEBAQUABIIBgJISeeEq4v8N1W2avzwAKB/uQ6GM0+oG387a
# q6Mq1ABptba8RfyJvlS8hHIwkb/EYvJ9W2YpSN98ub1LrHm/yOFWGbZrFYd8jXiy
# nwCDV1Jz5CzqH2Ne4aQPcjUzqAaZaCQ3nsc9OAaTclcKoNK7DnvMVuLXQ7gRaXt1
# +Fr86pR/9AQmb/WzuOu67Y9kPQjRICcYbuEJKZnxyVAidPR4rRubTuS/Y9cmcVWI
# dT8Aby6yMDimGqpi6mRq7w+PcAvpytFnGZHJf5+LT+RktG3e7QadZcuXpr77SB/b
# aFJIP5hR56xTSYUNs1e1kD61golFWsrEE1OHeZ1xCXVQYYnomhsW1OM0oNhWDNK/
# 8slGLL4Jn7I9weVU3FwxMaNewkKKDJGpcyirR4lureFuAB3aP4dXJ6XeURErJX0j
# Q24tCq2FCn2dGjwI0Rq6fewUpy/+lmqirfLF876uPi4Vyu9Sus0MB9HlbqZtRM1Q
# BaSdBbDlgUByVJ/qAHmrmrdCYbOpYqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCA10kAaqGjdRPSGcMqgmAYm3RX1wtSUm6SJA31LGuRg/AIGagxE15oT
# GBMyMDI2MDUyMjE1NDQwMS41NDZaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1NDQwMVowLwYJKoZI
# hvcNAQkEMSIEIDPvHiC0WU1bhqQSP41LE+Gyv6poQmoatugDgB/MkFbTMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAlesEi9CPSKFER7T5HeXO55jTbTth8+4SPV8tCE/D8Z3W/
# FkmGtFExdEADvlq1AE6hcxA63ueauVLGxJmc2Ghtft2OgbNWvuTAnYF98VgL2cgO
# wQvIdbv9VZFYsMco9f3v9kkgDBuf0BucLz6fGruzPtZit+kD2VlarhoKsOmEPTy9
# U/6459iF3dZyvoBdgiRsuo0Qm3ImLYO8kbd1MaHM4aYxvfBF4H+irqxaeUEW2VtQ
# KkT4PJnH8+ssw+ihGmR90DkTuf0g583xQjBUH0+0bqShqfiJfPKRQpFPEwfn65rH
# GLMQ7C9gV8w3fZ+ojdTP+68+twmr/6s31CURu9sncgrqtwgPpH9FXJf60IYQjzGL
# vi5m0Q+3LqdfaBKhWGb88maVyj7etGVf6oUPeanCB5Hk7durkPLDQhYeH8Dibgyd
# vqo2YW6GEqCkZYVfSGY8P/d2WvTMFwu2Swl13VJ6E/iB66f9vNi2Sq2SCmtMQcSI
# cnZAa/HTEBsUBk0hOos5J2Bd/Fy9+nXCcq/bVKAKTj5YL8K8h8eBnfsZ3t+dR8Td
# 3TXd8+ZU0uJ+O6gQS8xUaigMIoO/O8m3RkVej82khAQtdIhilEC8D4JWCAin1ecA
# 7sX5Pvn9iMZ3Nv/DBf4lhrslpbRnL8w+IZ3LAC0Q9Ad4+20rhZMvvVVsvdejDw==
