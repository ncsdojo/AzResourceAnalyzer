# AppServiceSlot collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "AppServiceSlot"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "AppServiceSlots"
        Label       = "App Service slot(s)"
        UniqueField = "slotName"
        Query       = @"
resources
| where type =~ 'microsoft.web/sites/slots'
| extend parentApp           = tostring(split(id,'/')[8]),
         ...
         http20Enabled       = tobool(properties.siteConfig.http20Enabled),
         remoteDebugging     = tobool(properties.siteConfig.remoteDebuggingEnabled),
         ...
         vnetRouteAll        = tobool(properties.vnetRouteAllEnabled),
         cors                = tostring(properties.siteConfig.cors.allowedOrigins),
         state               = tostring(properties.state)
| project subscriptionId, resourceGroup, slotName=name, slotId=id, location,
          parentApp, httpsOnly, ftpsState, minTlsVersion, http20Enabled,
          remoteDebugging, clientCertEnabled, managedIdentityType,
          publicNetworkAccess, vnetIntegration, vnetRouteAll, cors, state, tags
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDRQ0WgsaDh/RVa
# UIxUEGN+QPrFYWrOwtrsdjKCf6VhOqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIMk14r1PeJJpftfLpbPwD/aREJ8AqIVT6CJ4uUq6
# xL6uMA0GCSqGSIb3DQEBAQUABIIBgAu9wEFIc4vCLQ9wbNNemKEV8C5Pj1Ebxvlf
# 19VRBiMOOAmFPRL1ODYY4jKzto0W9H5Ui7U4tuPKvJSndj5feiJvJo2KtJw+Sbop
# tOWfNrRfVg68JxfWpxApnSiHOHF3sa9W5Ovw5+Oa/tbvHe4ThUDiGR4DYRmjmDjf
# 4aDPFodGq9UawY8eiHRVUE8elEZwmcOkMVF+sgTgPvapTeanL3A0G/O0Z5sU09/l
# 25TDNbqWsSNB3W4CYWmxP5cBgE/apWLoKP3GDSeZWUUc60Zmg1LofWIkPEgtUvQW
# PL4eXOB58+XbGfDpi6C5O6j9w4XHVCfjXtOotKpKiFJsHzkfBjgDun1O6Zshb6LP
# 1oVLVIllPMVT6uoiDeTW6zjKdRV3+HjNnXGdbQ4m3FAhdVMI3+0o6wf47iGEP4ua
# hTeb4gwCYzKd74tiu1PS8yZeN98s1k33yD9j07T0mXOnnNZkbDcG0KOyAsoav/P0
# CrA71Su6u0p6zi5oXKsIq1+RN0QVbqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAwBS05NEff+JI0Me93waR05Sd4j5wHSNWDCfhdmq/1hAIGagxE2a6D
# GBMyMDI2MDUyMzAyNDkzOC41ODdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNDkzOFowLwYJKoZI
# hvcNAQkEMSIEIKhqMi1KuGkBCKwfF0KOWDaYzqi/oid2AIE07NTQWGHXMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBRGhO/+AoXqMSzZuuA3uRMwInIxDWudGNSmFxAIhz1bcwH
# WFB2DrMQU/8XM1Lxb85oHtxn0qejZOa+fgfUmSwodgB2dCp8EWwpve2cji1QvIuz
# 9kfbuiAocB9CdK1rn73SEyFWCW86GCz5X8dTtcLs0XItEcGWIv28T1ilh4q8bxch
# UoF1q/lVfN4x7ZiQbNfr8ErwZfdCjRwIVnTqPOFHe15ad0yT5QMY6VWmvPimRkcN
# ne+7hW4b/DEF/FuR4RnujusjEpVgCB89b4HznAyKUIN2GUfJLxCEcIVwJaFgcGyg
# 4u9EiBRP/jjuydDrcLMAuSiCVvxnW9zeo8jRQlMA8mXSAznelYasem+sV1YK1B41
# 7cY8SVmVdFeyby9cCvGpa3DBPeW0idoN0FjSBD1uZGtY3X8z9hTFn0HxumClyC6g
# QUUG7q+jF6oPGle1gtCCmOPldZCJ1lqiUMYhYOnkqMWwr9KtXgNJxJXDp50eztEP
# 0z/yqQK1bmg9Bh2TF3XCeMNkAyRslcqWlipgJ2wg3ueY/IN0XLeooYzP/ZYLYckn
# /bGXf31P2lEFJ0qecV7DUl/ARbaEWL7amTuXGwcGWFkyvGqubR2uj1vMlNs9ji3g
# SDdLwRmnwmMvxrICxHnOGW1LBC0aCAg8WBG6XdYhYvSknDL97pREoKq8YS1rlg==
