# DataFactory collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "DataFactory"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "DataFactories"
        Label       = "Data Factor(ies)"
        UniqueField = "factoryName"
        Query       = @"
resources
| where type =~ 'microsoft.datafactory/factories'
| extend publicNetworkAccess    = tostring(properties.publicNetworkAccess),
         repoConfigType         = tostring(properties.repoConfiguration.type),
         managedVirtualNetwork  = tostring(properties.managedVirtualNetwork.type),
         encryptionKeyName      = tostring(properties.encryption.keyName),
         encryptionVaultBaseUrl = tostring(properties.encryption.vaultBaseUrl),
         managedIdentityType    = tostring(identity.type),
         provisioningState      = tostring(properties.provisioningState),
         purviewId              = tostring(properties.purviewConfiguration.purviewResourceId)
| project subscriptionId, resourceGroup, factoryName=name, factoryId=id, location,
          publicNetworkAccess, repoConfigType, managedVirtualNetwork,
          encryptionKeyName, encryptionVaultBaseUrl, managedIdentityType,
          provisioningState, purviewId, tags
"@
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDVHm82yNg0AH+B
# F+b5xJ9Xh8aREZdGjHtZ+eem+EyDIqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIJ+RUYs9os8csGoZrNtzwXD+sJSpCzkvBut5w2gy
# YhAIMA0GCSqGSIb3DQEBAQUABIIBgEpD75IHGPdQ9RVzoIvCk4GALHKMmwy0VY1n
# 8rTjI243Qp0JextkI6Rc13r4HOASH/8Xs/EEnil8LD8dORKDAsB6Elnn3ddM6kzH
# 7zeMLU4I8aQrEf+nayzbcn4x5HRwKUm8lMA6hlnZ8ZMDD1y5WnHW3bTQ4+7nIlpo
# Dx7ViAdzTDELHNIofOKpdatdDSYzoTEYI1EwCZSz397RC8cuZnqR3J4/tqJW/z7s
# 7UMwcwULHg5pfsTLlwzjZvchbozlxBgy7pJSxU0BMPic5H28fnRY9wwFBXPGHIHl
# BHvvNPA2NWjW1d56lxkOz7SsL+JAhcV5RTleTig0+S+QSniUGKUMhqWHE3Ui1kzf
# DYAr73vJq4ZaQrXzsGx3Is0hb3c416pujal2px450irQ41TtfBHWJRx6j0nLwkql
# 0JeUlW9z9dFZZXmGV0uo6bxRazDzq5d7dJVYFWWCYDOOgaeJ6l/NXF5RmFKdTZMD
# 2twCPZrxNntV5ht6D5Fky4yHjbCMMqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAICH6WN/W6r4fbpGbMWFCrA+7LSg7WapF4HDX4och5bgIGagxE2a9u
# GBMyMDI2MDUyMzAyNTMxNS4wNzVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNTMxNVowLwYJKoZI
# hvcNAQkEMSIEIMmrMxbvfBD8cRNnd6HXCjbCnbC62P/j4JrgM6rzLUsBMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgACAPUdJgOekhWBFDeaAwRvdi36hVeHQ815+sFbzZ+N/+Ep
# /2Ck9Msr3gDkCyv3pwFNw53D0+4WeHNMrSZbLvhEkHXaDmkqxs4k7sMa4mH5oIEc
# VwmT5aDoyHvJYeVRtzNXM1t5WVnuZDybQsFfAqCBdItkhCNyrG+AV7JHLmY/2adI
# gMhuHSJMGjmvF9rWLfMelJcDslmlw2SrMeivhej7l3EUdkZ2R3PMI/FjqyAFPi+m
# 1UIUTCvBUQrpiR+aM1zE07dcwIslxJIyB8gEsBT7+I5+epfLGfnDeCegTPRNDEPv
# UbwJORU2gRIkbYTFnNhE1I3WG+jDJmL8ItLs002CTKWgwltBwE0K3Sp6rlANpsTu
# FSa9s78DeNrQXUVUtRrp0g0XP9yKAf/elYpS/Wkd35mNIQXmCEK6yTY+Og4x0xV4
# Ekt0ikP26FWf4YZsHXUggdIG8hfAGU22ZkREPJmI6g5ljMQFG6n1S44NzcJ2GiPB
# 6sJE89F10724WoHwj8W7LYiL52XAPXMaBnnx+g41EwCvznkYvkzVR7VL2KE5MZhb
# QV/nuJLtT5SvTzALOm9LwWDpnz/vZs5rEsAerGXj81ptLKkxVGVeFAwoVq41k3Eg
# lPOmllAj8lMnGW8VU+pjh+pyb4hQhkFyl4adwO9FyM6JlvmQSeBcyJFOgiFfFQ==
