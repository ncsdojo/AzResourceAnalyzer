# PostgreSQLConfig collector — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        Name        = "PostgreSQLConfig"
        ApiType     = "ResourceGraph"
        Table       = "resources"
        FileName    = "PostgreSQLConfigs"
        Label       = "PostgreSQL server(s) with config"
        UniqueField = "serverName"
        Query       = @"
resources
| where type =~ 'microsoft.dbforpostgresql/flexibleservers/configurations'
| where name in ('require_secure_transport','log_checkpoints','log_connections',
                  'log_disconnections','connection_throttle.enable','log_retention_days',
                  'pgaudit.log','ssl_min_protocol_version')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA6x7YJ52AQqGCh
# XZ5RBfHcN+tVN+EfWSqUb9kT3E26IaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIPnB0MTjH21RN/bu2AAZZGEd+BLOaZa7SuVUcXTY
# RrYIMA0GCSqGSIb3DQEBAQUABIIBgA84ZVfD6Kq49pnuncyEMKIBybbkBYZnBzGr
# afN4pna54+A9NEDdr0EaOV5AkLHugA5+OL9AoGjQdcs+cPkErOrUWycbg9soVrVI
# 8T180TI2FYzjEnUzJZe46POSUXWSUEmAvQaJLflWpDm20wdHb9wYHdlfs1V2tHbB
# SeH30kJYfpidEq38zHkBM5NQFqf7guKsBUe/qHIZE9Occ9Yj5I8UkvtNapFq1qOz
# PK68wStmcUnQdJVvMzex2z82t7eaGw9+ai6twi0V1cC7582En8jdiZE9XNqey77n
# KLurx4krAZdNNPYNDSPLjxP18k0sxfqUzgZ0ehmAf8gL1O6dk1dsg9/n7SjvDrzB
# rcDTi/bMY7bhNqqWEKlPhLUkgFDTbjWMiSd8MfGpScslXfha3v3v21rlzmS1IUsV
# rvfQWyDQfXMqOZU0gyOUz/EoZ/bjb2pp4DbdieHKawXkFL0EaqAB2Jb0dJuaAeCi
# xg4FGxM8valpsZj6IBPveFswO1ZAsqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBcixkuaT3x2DHxIb5gZNp4ke0DXGn7t9cZg589ljMOxwIGagxE15Zf
# GBMyMDI2MDUyMjE1NDA1Mi40MDNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1NDA1MlowLwYJKoZI
# hvcNAQkEMSIEIFALJo42n6cQ7i1eRZT3rKOMp3aCN+Q/+NGwf21eebmZMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBM+sXOA+yaA2hzLTd1WuF00nvnh9bU3J9X7OkMH29Nk2mf
# zvySSEYtMMjFyKpzDvpTBghSD8J+8pJpX2SZf74T9pACguZaTtJDKmfRIZFIvykn
# 0XkezmXonnvKXSiwh8AgAXcP0Y3015jD0ltntWcM20Be2u0XgGLT0ugzZXWAQUT0
# D+BX3DWWrhy41lCyPNik2WfTzz7kYZowtcV6e92z3QQ/FpDwkm6yjhciiXHEdD9N
# wCdwrpkbpp1lhWBNUyrNUYH2lbS0tdGERQBUJBytCUTG1w0KiGYL/6mZRufw4VVJ
# 2oUCv2Kr+RZh9oyGSJ06l3UFGYi8in4c/KjssvkmfFtr1Kdx/By2hXM3IUoUtm7B
# JKnDycsjKuhSsvaVYtUPnkj0Ni3a4Shf9Vb2ypgyZ8flYPC/lWivaNo2f2sK7v3i
# pP6Q0g8vw+TQmM/CfV5WtbUgyRyeWXNoc48161NQcyW2vwe5vAuugG181eZs4n10
# xRkJm5E8DpTYlYL8R75cAPSxRp42wuCaPwAUdRBrT6MKIxT7n0EVPc2CE3mSPZ4b
# WBWsqLFDKufie2ERC9BaQO5cyLMFyN9m+/5buzNstwsl+AdessxOqF5GBzV6Fj2/
# fZzlGTJRvr6102Ix7wEoF2oHjxgqFYvYnTt/ucWea3bD8C0ydYg961vzhqRrxQ==
