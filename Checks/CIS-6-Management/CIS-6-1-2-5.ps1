# CIS 6.1.2.5 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "6.1.2.5"
        Title       = "Activity log alert: Create or Update Security Solution"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $alerts = $D.ActivityLogAlerts
        ...
        foreach ($a in @($alerts | Where-Object { $_.enabled })) {
            if ($a.conditions -match [regex]::Escape('Microsoft.Security/securitySolutions/write')) { $found = $true; break }
        }
        if (-not $found) {
            return @(@{ AffectedResources=@("Microsoft.Security/securitySolutions/write"); Description="No enabled activity log alert for Create or Update Security Solution." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA/ejACAXBSXojp
# Re0yMrOcSErTT2MfVxIo8QY+c/M+nKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEII+AiF4FF4H/He1cGW323O7O4eRPD4VryN3jMskv
# D+3jMA0GCSqGSIb3DQEBAQUABIIBgCWLdPApZBC2U2aiqKizTE5hQTnHz0tYyBm2
# 4UK8lsKpCRfA/yL+yIYwzz8FuzeoxhJgSr/dSv8aVVem8WJ7Julsv/CDbUhO/Jk9
# g/fDViQzJo+DoBHd3WxJopNr+zKiVn3dh7gyjC4QpGaOyWtScUHRofiuqBjDfz28
# l4w8z50InBlDVckEfy+dz1LWIuFmbUmLZ4waWIlCV/o0YJutimrPcdrGC3rA62A0
# b7oE9DqW7PMlj0oJHMyFoZwdsOxhz/5RXoe3Gz58v3EkmxPpwBm9ud399Ypzbo3o
# bVd+hDXXNWjlsp9WO8WxGfUfNS8l76VY9Zdw/lrmvqu9l+6zs81TznQ5l7AgBqwC
# OA262NeKC6lLbm9wtRVsiCumhueyhrWR7o1A0l2FTy1311aPpi2J2hWNUP8tORY0
# 8YHHIrPKC4q1kWq0h3p1ICMj8YANSeaERqDMWSdhZgtOgVcvmu0plDc5e8L8F7FX
# k2P7QC+miQLzStNYVWUrQvLrApnzLaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCQ/5PGgg42T8MgmoMEu+V7hDf5qPHgyAZLw6bAiz5KCgIGagxE11NO
# GBMyMDI2MDUyMjE0NDQ1OC41NzFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NDQ1OFowLwYJKoZI
# hvcNAQkEMSIEINlpV6ABbZsMY1HwEzHEyVXQcrFje3t79lvLkpVDmFJpMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgA7dvc/DBgAzp5HQI2pRpgIFD9DrJbNyhwcjb4GlVQ08/ZM
# v0etM3UWHGJvD1tAK1WYbq3DgOn/YzhUiggoOW13J7LWLyoaxAQpo8AB7Y7S+uoQ
# 0tpJpRnqBbxPxOOLP4K7C1ipGWx9/yKj58tVD6osy1a9Ll5kI0XljjSFdf5H54Qi
# UcnqQuMmaXBEjRO/Sib3dsGK4h1ziO2fIaG96zqBgLSBxRnzlEOm/tqQ+1fWTCA8
# I7PyewjlhQKe6589mTuoZ9IlbSUM/QpwCMTAKKDXesis5VLqx5XNsvdNHqz+KjWQ
# +3KPo4K8EyZci91zWUIS2tYbelPb07oiQLsFFbFEymB1a6qIyLOp5uPYigiD4Wsi
# LVdJvN/0SKhft5Z23/8zevkPgWpYnHl0jZfPX/dxDh1nhiL4hOp7y7miYpxmarTv
# F2x6rHcZOMGJKfnTsIXUJrztuvBhTupq560n5LOc5ueuoONlSb2yCBcZLm2WbXWS
# k5+29pFE/UbMliRwtbWEqmBiHyPG1M8bcoKI6vNGJUK/wgKHOOoir9pJGcYCxySX
# mCIL0+yyE/+8x4W+5Rl54z6UgPqZN2uqo04yJUHOUWsS+Ayle8u0QfFc5KgeYOm6
# ID1F3SsBPPG8Kh+Tegku0lXLfXO+4W43JOoQw6LhlSi6yQPyevW/Q9TijZyEXQ==
