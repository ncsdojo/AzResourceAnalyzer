# CIS 6.1.2.10 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "6.1.2.10"
        Title       = "Activity log alert: Delete Public IP"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $alerts = $D.ActivityLogAlerts
        ...
        foreach ($a in @($alerts | Where-Object { $_.enabled })) {
            if ($a.conditions -match [regex]::Escape('Microsoft.Network/publicIPAddresses/delete')) { $found = $true; break }
        }
        if (-not $found) {
            return @(@{ AffectedResources=@("Microsoft.Network/publicIPAddresses/delete"); Description="No enabled activity log alert for Delete Public IP." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAwWNAY+vrIC6V6
# BmTCjs7vTDF+8SWkjuVJcmddEmF0MqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIALpaQeOkxbNCb8tOzbHjUGksqS6xJwVZjwmuCTz
# NqOQMA0GCSqGSIb3DQEBAQUABIIBgD1K7mOFgeBph/DbXvD2OFuvrDzEL8GH2ZLQ
# mWKmoDK9T/xw8R9r/44MfrIv1g7nwV1Pe4RDnj5tQK8FJ93BCN2vYRZaQrZsaQH0
# aXSo7PXm0L8IqQZvlaYt1ASqmdR/2mRFpjBOpbm0BkpcfaM2thXS6dEIXky2ihXT
# uWbnW3PKeI+ncVaWitVSCGLf5RAFgvvqSjqDvqfk9iZI2qqPVbVx2jE0klwL6ova
# tutzuNCCrjXwDlNff5dCjy1qp1N83g8nHWgYDu268fz3/x6vA6HsNj45FVBYWabB
# 21eP+OOldOHHH3hU5r5cj08j54T5eosY6xJD1lNyFUDoYFZcHQSamzGI+IpQ2ETh
# R4VpLaK3qXY6fFeWeehmr+dLZyJ7TXKMPl2MY5Jv00idM+DZnI2FTyMIC5zT413d
# xCwLDpCIMxtVTlf0RMQd4vXHd4CYtGGSI2gTqx+9mwhRrZtKtKIMST/LDdchKT3d
# Jjckt0KFv81IrNkg9LUv8owuCodI1KGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBROFw/IBGfuf1sB+KBdEwU1wRzoOWKVEHgkmlYDcIZagIGagxE2ZUU
# GBMyMDI2MDUyMzAyMDA1My42NDFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMDA1M1owLwYJKoZI
# hvcNAQkEMSIEIMCnfxiQlgeHyXgj+44Ldurx0s7sN6MTOera8FUCKigDMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAKLAbJzmEYCTyAug/8JW7A55z5+RDgEPjxP2GQ1keWUcyp
# rdxtpO/hliCovNnB7d6oTcr+qecsiS5+FQvnjnicLIWzrDHV67Isx8ERqdh7zM04
# Zhnh9Qzx8dMRRGnfU2+LXzF/a+POrCMi+P25ekj3ihNpmBefk4lCzakHO0Xuq1eW
# 12u5fzlSao/Clnvnd6CU8G+YXIf/DGKLDhNApKg+r7mjO751n4/Y4mq8utlwofeq
# e9LYhfEVxv4MOfhqR6SgMlSWiDHhML6h8kAesGXYRDg1ylS0pn8mDiNSL8j/RGfa
# EcLowfXx5N+1ZTEUeU6MCW5P/vcprt0Dub5XC80ilE5dNmAGbfSsq8GAUZtG+y2T
# YL70JX685vdI8BgxNRCMJYobgK9kTN14Kzw/IFeJTrIuoi3UP8dhhCkFmnnT3UbA
# 6EzLi0CA2xUOscQ9uxqMhTFRhOsX/p2prFEkFf+TargU9cg7dx3v9DBpq/cEfQOT
# F1HyI3Rq4VEj6YZ2uWLS9rtqYL9AKAVJHtywKX/TWV32rBW53IrzjejGpsLxZuxW
# QSW0kFYyY8OLUywJ325CmqD5WGtjwOpTNJjHtacgmnzqwe74PI2+Q7F0xH//MDKB
# a6jhtJfpbF1eVAfg9ssu3aHbmVGtOHEULhG2yaxTB+xPjYrMvyqrSXN4V8tmqw==
