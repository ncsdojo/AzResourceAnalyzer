# CIS 6.1.2.9 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "6.1.2.9"
        Title       = "Activity log alert: Create or Update Public IP"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $alerts = $D.ActivityLogAlerts
        ...
        foreach ($a in @($alerts | Where-Object { $_.enabled })) {
            if ($a.conditions -match [regex]::Escape('Microsoft.Network/publicIPAddresses/write')) { $found = $true; break }
        }
        if (-not $found) {
            return @(@{ AffectedResources=@("Microsoft.Network/publicIPAddresses/write"); Description="No enabled activity log alert for Create or Update Public IP." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA7RMB5B0qy6Nn3
# U9ltEiD8TEow1iSK3edVjKd3uBlWlqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIO95aHvdO5ZDWJRIw5NUdnrbXnm0jnrnudc/C+w9
# FUkrMA0GCSqGSIb3DQEBAQUABIIBgBQWLzKENLUdXWo6D2kBwS1PK0OQLEMVV1Ok
# c4bIH9KlsWCOhoIwOAKGw//nBJvJxoxTy9rRVqC0DJtV7gG86YTp6qjXGwoZyAik
# PzFdZoLSqN7Kon/88ZvgpTnLor/FNTzWcfd+qGoIKZkccYEkF/U9pUIeNiNA9vXx
# IQMwcEnr7N48zXm1KC4ryU1nMXeZLNQaPB8okexP1EiTIdA7k5n7nRgKE+oi+6fB
# pK+YQfcUSTsNX9cShBbfyd+qh2ujKOwbC9UJ/HH/Ef8vjnO/4Ouhcav9YiSfBHAz
# 4W2JhIZj5MA9XDggSlbDqbiEj3CARcqvBCTs0fLq4QdMXWNWbKWdQAtOW4V7pDrk
# D7WMy110UHg26p8kQKdT8S8f2BU/noQ3YvzyxAyWSMrFiAFPkyo4Uz91GnvKwYuX
# z9BUt2+HSAH/DiwXUAIWQGDXJQvGRfyo2ALxOyyIws0oqAFapRaK72ylz6x4y0nG
# 5flprfGuJFzJdYdBwrqrDBhouCzLE6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAhsaq5O0L0LOlPAKW7uL/We/6BSGBRrIsg/S2wod+J9AIGagxE2ZY7
# GBMyMDI2MDUyMzAyMDMwMS4yNThaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMDMwMVowLwYJKoZI
# hvcNAQkEMSIEIO+bX5cYOdRq4sJWGCLkJXPVc3v+YvVMLVD37dMDWaPKMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBwmywHlpdO/Cbh8DA/mNMMFB9piX0Elw1CoSJeHDdgGV52
# VG4giHxS4N3Yl9Z9V+k8XFsi3LzRapYDkHiDp3Ss++KCicXZZD3mEDdw/HmP7xTk
# xpXQH8XQBKyUy/k2B0jbc06J5+dPqEF2vq9z/GLlek29yvR7lAIUy6yygLmH0F2e
# xxZFiFCjt2IuUN1vg1Sxa7lgoH7nKdAhTT+c/T6aMBA4brkKbUvNKC2pwLa1TwWD
# 1XArvE70+5Rb3AUXcckRf07yT9jUn4Hda49kE+WZpnEdGbX61u/c1P/6zT07njw+
# aQYAvrYXKCIJMzCko+LIDsYkL2qdRCPwchK3VjgLkUXgAh9MCXhJMPO9rMqnPd1H
# syOYuYO1iTKrU/wfXou7a+R4n7SgApxZMobK0FT5yE9jjjpm/+rB59mqDEPzzfBM
# xTcH9uRymqV4F6uzn6EG+Az/IA92krhdrWN+r2NufefKm1c91EZ4RtStenKlsISB
# w3o035ocJh7t5sObFjJQAp068VjZKSorMXRBVF1Cg5DN3sLxQghoZ5mXwQj88f5I
# RMPAm/fvv7bnGFL03VSiH128CLXmZcXcu20mC/IPQD84zw490mbLWeQIJrcD/WJ6
# 0FtBQv41eRsCsw9qwtbMbh6Cyf/JwMkO4WcqfHPsy0KAFjyjHrZKBOGmhyY5Hg==
