# CIS 6.1.2.7 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "6.1.2.7"
        Title       = "Activity log alert: Create or Update SQL Firewall Rule"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $alerts = $D.ActivityLogAlerts
        ...
        foreach ($a in @($alerts | Where-Object { $_.enabled })) {
            if ($a.conditions -match [regex]::Escape('Microsoft.Sql/servers/firewallRules/write')) { $found = $true; break }
        }
        if (-not $found) {
            return @(@{ AffectedResources=@("Microsoft.Sql/servers/firewallRules/write"); Description="No enabled activity log alert for Create or Update SQL Firewall Rule." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAL+DOAKZWEFHc9
# rbuID8rTwh2XwAYMGjw3OuwTg7MhnKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIFkbfzrLfmfBc8tqnnCN0HPV7Qwxuo8lQ00z4ef3
# He1ZMA0GCSqGSIb3DQEBAQUABIIBgAoI7+KgAGrVBdXN7VhDTvegoZKC9ZbqS6TU
# aDah2zN2RM47qxwJlCtLMgXLTFrrlKJioBvfmlRlunweNS7HKSQ1VDIfh8fFF9Q2
# x6Ci5peAP9blfoeIG6hF2k8aa6gC5CFuWRDGTQ6Nl1XkTOXJyPmUPHCUrn6S6xur
# 9twZdq8t+dFXii0cYSVjSIJUCrXK4pV3Z137GQRPyo/94vNAVPcjGV6xkDcogzCY
# wCjT0EonFvNTFRzgYeF5kZAEQmPv2IusaQXYizQDSuexNY1ziEGd3or+SnXQtWlx
# wLd836c3OFG7ilNYvingKmR03NLRAcA8wNmJgZCM7TdFXLn8IrsXy3dU75YbI10K
# qE3suX+gHBDZmNhcDZSr6Q6/uD1nQg1M2Wyif+140YY8gOk6+Dxry5g6zFhC2/ai
# I3a1I2my6vWIGFn5DyURr60ba3EP+8nrGYdelC/eJD7IoTUSGnLfY1U32DTcSj4F
# NhUvx2KSJ5HClkgFsX3dBGO0p29Xg6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAChaXrwrxdW29OONekDjaROBlEtknLjROj2Sn+dXKW2AIGagxE11OW
# GBMyMDI2MDUyMjE0NDUzMC44MTFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NDUzMFowLwYJKoZI
# hvcNAQkEMSIEIM6baDNqOSUHcb+3gHuI/+EW3B3vMbulrm1CBT3NxHpHMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBLzPiXF8b/vAN4UJwb4FUHzW5e6RbQV0BoCEpOXbm4wWkS
# Kvy5GAdy5GUif9gPOXWwkSHh4r61peYEEScs9HesdV4TGbs43hfHLHgdsU4W/nCv
# srFdD/AAFSChJ/ikLYYS1eYVtp6DJY00YvR+QN/MphokzBfteeu03GdDkdRN8+4Y
# KtdkYJn2LRNEjRTVryV6upmPn5cu1myqGhX351gZvJVYlY30KlcKlH/7VbPO8hcu
# 5j7ie2ZkFuf69VHcHwTO1kMY+9YhOo9WYj/BolE7aUnbg5ubcFqiAL/9jgRE9BcL
# akKpHjd0+okLIPLSJlLjxKunKWubhUI0wRRm8tmjr/e/wxzzhPPgcs++QOCzKPan
# NtTFz1Mek1+nkZUpTpbL1iHVBPN3aUlg/m7FFnogPrHd+CwsuAOt/TDkn/SQhAMr
# CvPvhKdm7E+8SSO4lawFwhob97CDiMkuAxiWJ99TY4t8zUwoWV8cSIo5sJf4lpKh
# aJqRNeExpO2vJ4R8duCgFO2UVmEfJ3Saa7fX9J5MJA76NAf4Lg/xIMRfG2LLqs54
# La+aOL38XPIQ860PckiZ0uy42qhhkYKCDlaJHnmyBUQuRkE874fm7moGB+cnsk/L
# RePaMHo4BmtiVyi7F3QEUYI1gkV5lZwNxqw2jsnHTpBbkbCfU1lLHSW/GVn4bQ==
