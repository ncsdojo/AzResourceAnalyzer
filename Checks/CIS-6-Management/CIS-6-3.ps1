# CIS 6.3 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "6.3"
        Title       = "Tag governance enforced on resources"
        Severity    = "Medium"
        Automated   = $true
        Check       = {
            param($D)
    $tags = $D.Tags
        ...
        $untagged = @($tags | Where-Object { $_.PSObject.Properties['tagCount'] -and $_.tagCount -eq 0 })
        if ($untagged.Count -gt 0) {
            return @(@{ AffectedResources=@($untagged | ForEach-Object { if ($_.PSObject.Properties['resourceName']) { $_.resourceName } else { $_.resourceId } } | Select-Object -First 100); Description="$($untagged.Count) resource(s) with no tags applied." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBpYP/0RltjSnI3
# mG4YqR2XT9OpbaOouddq10LubAz2z6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEILihYjTOgv6onpBOLBGD4DEYjSst6ON/7cVLsrzW
# qKa2MA0GCSqGSIb3DQEBAQUABIIBgIFGe3mZY+tmPmOBlajOixC2IALCNP/BQwdc
# T/D5ZKZ+zl0wD7AxSq5YNB8QOfiBu/9T7Vxr3sqX0wZ2Vm/U369P+/RwzEHyliYo
# eA3ZQDLLZRRySFKsOUw6rLHIrnjuEoaMZSgbDo9IAHY4Q/W5h8A5wI4Jo4Fw759f
# fowiUnIvQR5i3bYA3/YrKGub+CvbMuVj/VaUsuzHmULEQ5M7AfSinI0dRLjbvXEh
# VuNxlW6gMC9S4Fl99OZawwHz9nCBgumDJh1gpuafc/Ko2aUx0EuIhddpatpcnWY7
# IEpq7x7ClMGhDbEMk/G5a8XOpASLx0iCfg6nmBgeRcZ7Sl8UjE0d91IS9xdvzuAb
# ucpPuVKYNEIcN7EfdhRvfldDlvedNrSDKeNLqE+VlZSXM8dcHy79g4eMPOdAB8TF
# YhsnKhmSwuURvgwNsAtM3j5f+q54bP1ET8CEEGoFAumZW5o+ZBK3CpHQlUP3OpkZ
# 3fxyJH4C6CvJ1C423jQQ92KePPZoGKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBn9GspUs1Zc3+tbVlD9QppzE/GdgPiVE5RZmBEnXN4hAIGagxE2Zei
# GBMyMDI2MDUyMzAyMDQyMS42NDJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMDQyMVowLwYJKoZI
# hvcNAQkEMSIEIJs3qBZELjagjeqsVg0UIlbPmy+SCQz65tQGm2vsxH2vMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCdtEZFzqwUiyvdW5Ku75Wvc44xiFITr0yTd48k6TEQX7/G
# wEoV68PrZmpEOyfiKwHLPhhbekcjIWv1HKwJu/0o5gJcurbbH8f0g+atG6MSLD08
# WhJl3/9UUVcxwGJWoguAoQ9OOn7iwKaGigiXQ24a5pA4kAwB3GZYxgw/vzToQ3If
# ytk2Vq6+UR1BmM7clrCxaG54oZ2PGuPxpDjL6DC9tzaue4h7YM8V81QY6ISq6SEM
# PPKE2cUvWHrxNqSTeMvC7NFQp399qH6vklAHMxfuHeWWU90WFqbxAXfUbRIbyV89
# UIz5ldBD52+LeaoDb0xNopQn7aiGBI+wUAWUdDDaAeJKMRTjjq0lOpX79LjmS51G
# 4cftY6Ht4Hdvg9REWTj7SYRBMaZvQr2U0ir57Ia0nJzYnmkOfMeWhviJ5IGZLWoB
# UyYbq2KdFDk0oGSgbzw4bz7oMa675+nQpdPpAgebeh7e4Dfh8vFg2Bwwtki9bpEx
# wJqqnvBvCxEd18zuJXj07TOjLWqkMyi0SO1Z1sAvxcbTxSgFj+nUfiaZTM7Gt80q
# mAKKZkFwV8wflwaBhEAPt64dwsjpqsDb4D8uGO3nvNCUyY5kTlAdOnrwSsof+lO5
# wxCm2Fiz7WUQbpFuyOqhKTYSX7AGT0Nn+DOVmOqJr/ZxXor6WnHbKdsb5EBd1A==
