# CIS 6.1.2.11 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "6.1.2.11"
        Title       = "Activity log alert: Service Health alert"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $alerts = $D.ActivityLogAlerts
        ...
        foreach ($a in @($alerts | Where-Object { $_.enabled })) {
            if ($a.conditions -match [regex]::Escape('Microsoft.ResourceHealth/healthevent/Activated/action')) { $found = $true; break }
        }
        if (-not $found) {
            return @(@{ AffectedResources=@("Microsoft.ResourceHealth/healthevent/Activated/action"); Description="No enabled activity log alert for Service Health alert." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCa4F6FIr60eQH8
# 1QbY3oAnTSijHSkWZyajZrXgXxac9aCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIP0Eu4NXEy8iLz1LKoYdBue+h1tHZ5dV5lb3ZsCl
# DmQwMA0GCSqGSIb3DQEBAQUABIIBgIVmUErxjQwsrNhrsw1Zi6OMxSA6YHjjIhFe
# keDUhmZ2GFKJ13Kut/RRP7e6loFFGpCRGonPaTYc3KmxoojgPyCO7y1XMAX03rqt
# TaWh2GERgblZqLvoilR8rayQDoCEx4FgVyvJrA5vmBCnojXEPQ8pJ8Rfm4K6CAcG
# jqyvekCP+WPuCqzFdiHNFLRc/ehjQLILB9cySDinvJ5QV0BiXq6HmtmWngooT/t8
# GrzNBz4Da56M6XKHac4kRer5+Hwq47zM430fwEkCklkK3RRruj0ynUHP0HAmQaqT
# q+4mATHktV6eQ2Vb8JCF4qkGL+STIkBpFIRGdswxh1wZjI9g9zzXfUzAnyNYRvmA
# nC9PNADYNyHvB3ceSOXxE1Vk2QrGmcim3dYbtnAfIeYlWO9defWZ9bv1gi2wo0yB
# TSQl2+4qp0HvW8PwlWnXk/BJDrQzCaDu8wMulM6PtflSaP2cQ7wM/ut/2ebF/tx6
# OOAE5inOcvENaid2HSvAX8eC3MtYjqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCG5RBW86epr4fC3dR4rY0UzU7c2+4AdsuQIMBokNTKtgIGagxE11Ka
# GBMyMDI2MDUyMjE0NDM1NS4wMDVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NDM1NVowLwYJKoZI
# hvcNAQkEMSIEIKHQYbadtNwtR3GPc1bVh2geLG7VqEvexROPgK9bap2vMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAG73mbkAkNSzlNdm6tSS/fT9iQJ17wGBT2yrRAdR/qlRao
# hvmvNfDUPECq8grn2T4Az4MBRIy59O40IVYKxvIpwBO4iLgBaE513sd7fpkXAbYC
# wT3EVuAhip4A1apx+nN3MOPRFYWM7Va+XHCFYmrmMPG5+9QFXmsKaIEDp7Aol9YZ
# k6SOGXomes8OAaYQFtxVIeCWd3jweg4RZtqjwHYnoHLjkEGLWFZDpJ7RggZ3Oyff
# AzeT/561+Cq7aJtlmSNWLLx3sra5vn7AvPTvDsBqbNLxvUQZ/qgQ9FzjxFE4ZhxC
# GHbZq34EiWenjjbtaQdml6NH1TsplFKt6Hlt7d3IXc1WExGixKW14LbTLTMUK4AH
# Z4DN6ZLpY29W2vcQkY3ZQgXAjiMKsUDvUbY/ahOvNBoQu+KFUGGz5si50miH6BBD
# /WtZW+wBMELHJtnvpdr/ynJIRmHsgNLEfNA0C1/qFILjE4L6ucHyQrt4ZSvyWtvw
# qDa8e/O+8Kj4gxpCS3r4hfR1RRlCAETQG2VQiNSfLOWJvkmFDgfn888yc9hh6Lfs
# 7HROzw0XKbItzY6XJLUgr5z1gpE9hznPbNfC7M7+USOVyaRSj7jrwX6T5SOpAuT2
# AdV5W6Siyu1sT7xzBvB5xeVCyuxQ5aUQqEQ9xKaKEjMdtc28EXbhTpF8vQDuxw==
