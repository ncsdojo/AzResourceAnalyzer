# CIS 6.1.2.2 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "6.1.2.2"
        Title       = "Activity log alert: Delete Policy Assignment"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
            param($D)
    $alerts = $D.ActivityLogAlerts
        if ($null -eq $alerts) { return @() }
        $found = $false
        foreach ($a in @($alerts | Where-Object { $_.enabled })) {
            if ($a.conditions -match [regex]::Escape('Microsoft.Authorization/policyAssignments/delete')) { $found = $true; break }
        }
        if (-not $found) {
            return @(@{ AffectedResources=@("Microsoft.Authorization/policyAssignments/delete"); Description="No enabled activity log alert for Delete Policy Assignment." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAVo3HlFlju40lm
# XbAzH3gO10H+lTPd45bHtBXoPIK8RqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIJ5lq0ij9mJlMi0BesHsKb1yuXVhipURl4PuhKrC
# c2KbMA0GCSqGSIb3DQEBAQUABIIBgI5nGmHTNlBV2dGZUowXr7/fcumJj0beTScn
# 9fF/Sne+/5Lgcgkk46glVpzXuaK/nNdMScvl9tnL4OVlJYEw6hecufnKUGtMVhMu
# CH9rUV2NCsePd4axwV6ofk6kX1lz3XRZ5FwSDwIgGuv8M8PIZx799FKavtWoLMou
# MbUm3koet7vfPPOAm4C0jSHARUzxImsbcoCiKBmm949oT08jiuTzlJMDYHBkrgPh
# 1ObqzXxFXXbJZRSzURXiFDkZOURjXHdYbkmzXvj06cnhF8gyZDxkRhIf4075Nsga
# 2tT+dM0zm9Abtw2WSgM+rB+qjuctmBCyIWWehQzMw+AF9gFbmA7Y5FgbipL95Ltl
# iuwZP11kvViNCcjqUK7cRIlBJGKzcAVCzhn2NInOYJDPZ71tAh/I0+X5qy9ZMIaA
# nD9EBQTrZgEaw4QWZMrgrMovFNA/d/65UKMUFzjrjZcvZ/F1faIzkudg2njgPPtP
# 8lAoRYQKo8tDohuXr8/pMVb5rR7I3aGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCD3ULf9NTZJ21/icoV/iNaQ4w4IdVmuHbvzHthZ67FBIgIGagxE2ZVg
# GBMyMDI2MDUyMzAyMDEyMC45MjhaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMDEyMFowLwYJKoZI
# hvcNAQkEMSIEIPEyZ99RXm0JIGwgf51gQDXbX5QwWhKVhXL8a3CCwZUxMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAvgc91VakDx1SsdkBZInTBmVFvzrjONJYyQmprPicqP5j0
# JXnnVUvMf1pdmJYMBczqaXK6TkjULw4K8JqmWCmGyZ6jQEuRABoGQHIVcnN68a35
# ntV6vjvpCeqeHtgO4EgNBOwstPXbm2mwjaY+2GAv5ZN+bYa1hYCDvBmE+WGPmV6Z
# Nhh3kz0Eaa1Aq3raPvl4gTmRTWGj81W54jKyVI25YZQxPTX2KMN70JP9KK9ceKxR
# suKcfm/UfJ/CcdptUkeA+g1UJFsZc2KrAL6LBs2rY18oIK3CZyvD7thWOXnlCjNd
# vPuYAyOOLKh+RdSCewTfDZ8STznyKXh43pGYkLTa1DsUi7j9wruTI80fyOfnKbJY
# dFwUwvy4bP391/2iA1yjeqg47bypEC5VsnApr1OuvmHXRsYt9jmzZ7BATF8AH0jA
# /8riLxUs/71K0niPLMJogYAD0vbWIycY2FkBqJD86Sfna6RKRvL1smCdyDwJT2fo
# rXH0BBvhm906vb+6FiJbiwrj7NJeqrfciQx61JHI1lNd0kKAfOvKOjFvDmYadJQm
# M6OGdXS7Z9CoC8ZMRc4hEUmD0+w1GLVS/PA5hsbXpEwNxFPzDrkdVRh4gY7oVDaL
# SYCtEdH6CnqsVn8QqQ/11BjcE+eRFeZ3MBlM2syXaoP81GdCjRVIMvcpplWo1Q==
