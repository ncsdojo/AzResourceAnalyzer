# CIS 5.1.3 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "5.1.3"
        ...
        Check       = {
            param($D)
    $mfa = $D.MFARegistration
        if (-not $mfa) { return @(@{ Manual=$true; Recommendation="Collect MFARegistration via Graph API to check per-user MFA status." }) }
        $noMfa = @($mfa | Where-Object { $_.PSObject.Properties['isMfaRegistered'] -and -not $_.isMfaRegistered })
        if ($noMfa.Count -gt 0) {
            return @(@{ AffectedResources=@($noMfa | ForEach-Object { $_.userPrincipalName } | Select-Object -First 500); Description="$($noMfa.Count) user(s) without MFA registration." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCm6w6DmP0l8xCD
# otfVET2FZ34ae5iBzFNWGFeQOlMFFqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIGUf6zdNK7rCmJWMcw7MQr9/ur8pN1QIykVc9CHf
# 6inTMA0GCSqGSIb3DQEBAQUABIIBgACNyqoLDMD8Q8TBomu57Emhrzd5VjFyVZjE
# pP436nldMA5TuZn9Fxv2ZcGg5zuB0nS7CTMB+T01vzyffsDF49e/VEWLieuIZXm0
# zQ9OPj370QdmQxKn3TM1QVjH0P1rh1/Q1AXYEipYizA3uvk954lC9aczrAQWNRX4
# 6PeoU4SvrU7Vt+NL157ykY667DPpGY04rN7wsDWjfhB2ACuKxm3eRuENZYgzpFYX
# v41PSldnGAa9geybzGmk/jpYxM/7zX1CQeST884XyBeeNXG6TNm+fwnK68WvyVpt
# Z4rJXwennn0ZUW9GzRRknYkyekYIEA2qPPR9LcljqWpEJxtwDQ7ENddpJyifvevb
# BxzC2/YWnSFW3smILkvMlfHlzw6a37s0Ac+Y76PDMYkhJDwFzo8+NLs2xsd7rRxC
# 50CU3+pCbNLyW84Sk9Svmk9/MwA659HKLeP8G+6IL/FbPFuDZ3EMmHIKLfVf+vfM
# ThnzGHf4W+plSpRSGyZY4sGhO2dJUKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCB6Cb8vXsAPryXEo/so8vRV08eMFu3mGlEvgRmsjwe5HwIGagxE101h
# GBMyMDI2MDUyMjE0MzY0Ny44OTdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0MzY0N1owLwYJKoZI
# hvcNAQkEMSIEINL0I800CQ9t/XPgmbVxK36dj0HE99tqUNdQ8l5U4LW2MIG5Bgsq
...
# hkiG9w0BAQEFAASCAgB7gxMYYmWIzaabuzT5XcyN/SeCrDY8LISwbw8m90eYRGEO
# BEk0FGrhOXdnK2xWh8BwP73FTvLE8M/6ZCjOA60dZufoiG5LHMB+dE5/xYdiyFow
# Mbrny8TzWoHl7P2Wq67q338+FinVxwAnOEhEokxxhhXhrTtZCD71+H3l/oVQIiDF
# M79bdxo3PcmcetYdaqmpGYkzl1mfxxGPGIbnALtcuDipAc9lXb5tf7e9PXiQr+Kc
# IJvmaulHZrROVYS8uuzVBKKtMjv2hxlzNoytqjD1KrtPJiSK6eS1pLXtzKavQZQB
# I2CcjSl+KQ2Sx4ZasdPfJBrMhDcL4qkhripf1+2StB41/fR6fgp9YoES95OwyE13
# 8I1eCA9sBNDyEqZfD4wRWN73tvLPHxTU/nusynvL3eFCqLIpWypJ6ItD8hgIHfIV
# PNyxOePj7NhFLxuJVF01ZWglJoCYsvmDDxh5IGZo0uQjiJtbS3JvWAusJGj5Fc1z
# t153cDgH4tFFsBqnh315uNHD0p8XNIjhv5Skck+XzYj9y/PtB16t01iT5E/OqCVO
# qwOIHw/b3uTFYtv8lY4UVXOCpRbrFNkG/DngUmKh8iF0gYppnHJ2c9oliqOJ35IX
# 3xtTqqv6tLtOgZq1tWHnpWlp3FSNRXyqkt12ID3NBGxaoOzt6KXp9SRAUVv5Ow==
