# CIS 5.8 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "5.8"
        Title       = "Contributor role at subscription scope restricted"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $rbac = $D.RBACAssignments
        if (-not $rbac) { return @() }
        $contributorRoleDef = '/providers/Microsoft.Authorization/roleDefinitions/b24988ac-6180-42a0-ab88-20f7382dd24c'
        $subContributors = @($rbac | Where-Object {
            $_.PSObject.Properties['roleDefinitionId'] -and
            $_.roleDefinitionId -match 'b24988ac-6180-42a0-ab88-20f7382dd24c' -and
            $_.PSObject.Properties['roleScope'] -and $_.roleScope -match '^/subscriptions/[^/]+$'
        })
        if ($subContributors.Count -gt 5) {
            return @(@{ AffectedResources=@($subContributors | ForEach-Object { "$($_.principalType): $($_.principalId)" } | Select-Object -First 50); Description="$($subContributors.Count) Contributor assignments at subscription scope (max 5 recommended for least privilege)." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCtTnRbAxWVlpWH
# QKFLDeWkiShglXP037/RJ+1cZZ+FxaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIGB8NKi8cwMqJZRsYEHLN05MOmcG8FC3jAhgfIPI
# J05HMA0GCSqGSIb3DQEBAQUABIIBgDJl7HjSwPEWtEQPk1mAtvVX0EeekHes4nMq
# G99ubvC/khBqGCbNRI+rDiXpvjZSw7b0wQ7Kl/fQLmPLK88X8L3eGewgKARDA5KW
# mI/QHCtYhFGJq3asyJt7IxyQYcMeGKo+xJfjdP/9BO0uLUpTJoZz8zxGcjTJKne9
# 0vy18NY45Mc9fv4o53c0aUEBi0n51BFalfQvJibIxrTpi4QlnhsXVB8MaAax1Luh
# sewE5grFSmDm22Xi1s1i5ndRR5f6eLNwQSYwk2KYvYeMrmcpm9yhdaFHBwdzS2es
# kcgupNtPUd4vLq/0OF+cOVKMLe+hE6+wKO4wRQO01og6o2B0QYjGZBjov2/8NmmI
# t9nkKbTap0zRnG5LUKO+M852Fe5Ea1ZFZazTiWS7CcTu0+2ge5zv1qZPg5lfyQqa
# KGxYjLfzR4CXqIP3n3qWsqXx6q2BuiQ2+dTQPMKU5W21oMZIdJ6k56kwzGrfVWXn
# c9d59X8BO554SGEIPSlaQvIgZEdnI6GCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCBNhxSGPSK4stG57uTOnFUyzyNVl3yqS3xQSp9JmFlMuAIGaeiBPKRv
# GBMyMDI2MDUyMjE0NDAyMy4zNDRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NDAyM1owLwYJKoZI
# hvcNAQkEMSIEIDkOHMFrIgoPCpDWuueo6m4nDKBgrwBX+P1xQXn+vz45MIG5Bgsq
...
# 9w0BAQEFAASCAgBNEq4Y01kfWps+EObjv3giwh6lxwJRYmNKhMxpOtxrjr676rJC
# 35WYTISiQqgiSnfaKDN8pwKNWDBJ07r6SmE/vKiR1h+LRbGQMKCKHGxwT277ONCx
# ojbTnNgtZ5Pof7hmCQcLxfIHqjzwBgLfdqn2HfMYvBbyIM5XgGpcoYm0MucqrtdA
# OTwU2urXJT0Pt4nqGQwT74FOwAtu4DRIiBVJ+pev14P657CKeX9emud5wl+bbFpl
# FlOERYDJ8uaTzvPdbGIzwpODH8jwU9//LCDemUBWbFhgLd0678AnnzfN0BFaIkBX
# Rt2W4V/xqXjkweScV1xojEY1qE943ELvp5vJlwNB2xu/gVPMkoMr1dheQGprgbOA
# 6w3sWTizG7OHh2RDHSWVDS3ryh+KjtVugO3WMkSnSpxxn36vpyTcVVE8IzztvOQC
# vCiySxI8EOBQHy7PYH6GC+rO0EZDpPg1WKINgIf1uY1PhYbpl3StkFvDrwefDFxD
# +DweVaLcqjrR96bzAJM+9H8NO0smp1xNssjmGnZ+6ly8oZFxYt0/rLMqFVb5Eoiz
# KlCCV/UiZiDpr/5f0fi6s5a33vspBtKCTSbFqnohLYiGEJIpgRLHPXMA6n8jDKz4
# DkLWGva5f0FUhwKqIdYGSMVdWJriZVt8xRoQKKFZF1EsVphF4WoYNsEPTA==
