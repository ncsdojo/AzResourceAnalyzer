...
@{
        CIS         = "5.8"
        Title       = "Contributor role at broad scope restricted"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = "Assign Contributor at resource group level instead of subscription or management group."
        Check       = {
            param($D)
    $rbac = $D.RBACAssignments
        if (-not $rbac) { return @() }
        $contribGuid = 'b24988ac-6180-42a0-ab88-20f7382dd24c'
        $broad = @($rbac | Where-Object {
            $_.roleDefinitionId -match $contribGuid -and (
                $_.roleScope -match '^/subscriptions/[^/]+$' -or
                $_.roleScope -match '/providers/Microsoft.Management/managementGroups/'
            )
        })
        if ($broad.Count -gt 5) {
            return @(@{ AffectedResources = @($broad | ForEach-Object {
                "$($_.principalType): $($_.principalId) at $($_.roleScope)"
            } | Select-Object -First 50); Description = "$($broad.Count) Contributor assignments at subscription or management group scope (max 5 recommended)." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCGSAmRSoKTH5s6
# +UL6GTqILF03qwealoZgjTmXM3o7CKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIOPulhbdFNPXtYN0et2XQfG5lUEYH6RNXwGE1os6
# spVzMA0GCSqGSIb3DQEBAQUABIIBgFpfmp9Eg07eeKBkK/D3jgJ0c14XMISILqGa
# OGieskGhAPtbNPjf4VpQ26/fvIraWv6e2BD+n+1hP7SGk8itdEbNmOygAyE8beoG
# EYPEjcecHt/oPJDURTMvRh5xLzBacBDGJNxOw3W0aW5b/K9/8ngx0IsXzatFrBF4
# 23+6ZH6voRzgM3tmAlJm5YnOMi6rlxo5eoCfrVZjQ0JPsdgRpHheVQnLrJeONflI
# NKErXV0YM+Mx18H/eSJKQcdWjeYUP5y1SD8cCsNBLeL81rYvekvZ3I+PESEiKRk3
# QBdd9y9uBePr3mDF4OlAHF93im1Q5gQh1fe8q/s1CDYMNpnPTrjqDm7dFxaD8bVi
# 088XPWruxswOz0qgooUZ9Ecqc8kTpLsg9uy7Ha4uXh0/R4eXwRJB5atO6lR71/Oa
# Gg6f15RzXMKRqYECXiv6lUWmxWTespLNxJWy6aGtTZYuwqLJInpYv7DDw0vMxybQ
# QqfFB3VFfl7rKW23qX0EImXzcVb/RKGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCBaETrXWc1ci7LX+wN62312NIc+b43M5WeBEjt/DuA/WwIGaeiBPapJ
# GBMyMDI2MDUyMjE4NDUyNi4xMDJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE4NDUyNlowLwYJKoZI
# hvcNAQkEMSIEIAUPeb2u1rBbI6OPZHwKcgfFxvGj8RjCb7b0ibgBF0xmMIG5Bgsq
...
# 9w0BAQEFAASCAgCBRXJdRl4tdQ/noJW0kpidz6l6V/yyPh2ipEGfopR3iCCZi3VQ
# h9LknRx+IGcg8F4rdtFZlP+fBb8dBMF+xB/XIwOTRMKPBABJiBbaOsIMMykyREAA
# CabXZpXg0D4vgvOm3PoFxvrlWlgxO0u9QSwGyAip3vMTlbhhlY9thUffAAwc7j1y
# PM73jK+0IWPGvoap8JhTwl6NM4Z+H95ZQFgb5i4/NHPl3nuZd7jg1wrZpEJyAar1
# RqV6ICiyoOOyLW2j3Bo4UPYAJQSZAItxyEjBzyvbuRazcWhwidFT94zMqECoALm5
# f/jWAz0G95phQtZ94mAO2JJrmg8+AzDz481Jg/PCxSK0LwdwS4dT5PuUcdcjND8b
# pQczg4LVwN/vxOwjXeD3W15eatAuYnawDp11q3wwiUeiesmGri4ufWfBFIlBxvag
# XrSSd4sauSHa5NSXH4uqAq62+Nt9/s6pXK9YJbqUbRMOHG7q3o7FxcyCG2XNjMbP
# gXUGigeWk7N2tvAkmlBlYSTHzu9J0QXjjcoD0x/sQDNqHUH69iOpmy4eR+7bWCgY
# JsgUC3WXrp/HUUNk4Y+AAeRFVbA+8JHEH3Y69ptkSP2cPLlKJe26TUHg9SZeoWPo
# nNqQhhgZMhhNGaogb/b+7bwsT3zMzmfMMEO483BcnPTMcb04wMxZ3UkXYw==
