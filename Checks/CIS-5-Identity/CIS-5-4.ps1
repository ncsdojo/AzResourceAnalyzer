# CIS 5.4 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "5.4"
        Title       = "No custom subscription admin roles"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $rbac = $D.RBACAssignments
        if (-not $rbac) { return @() }
        return @(@{ Manual=$true; Recommendation="Audit custom role definitions with subscription-scope permissions matching Owner/Contributor. Remove unnecessary custom admin roles." })
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCeJ6yWyyK2DOWG
# G2znhNPa5m+ATOark0ZsdwQT11pIkqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIIEmEKHtNNvZUUF540CDpNQ8VU8pf8xgjjXujf0x
# cMomMA0GCSqGSIb3DQEBAQUABIIBgFhqeVLZdHcL+jJclPTV17tDtnFct9S6TfFp
# uH8/WABuHYVBl+DHrGBTsb7tHBVS/h7vAaV5zl/SEeNTjpAG/TN5GDf3ZbwG/bMR
# LUQ2hIHbZ0el8xlxah0EUEI6/fNxSvGJu59NOjkNxAXWFBB7HcGuBWEauYwk3wUR
# eo5+8YgxBCvUjUM/egXBFBwA5P1bjn92u3V9ja+H4T4CsEQ2TiWqpy0Hpp6VPRAH
# 8EUX3hTUeZfqZZr9pJHALEPcdGC+s942cPPxWYXSmdeSMcDa7TQcQBtk90y0qq/O
# tYNnWFYyNS8NS5l1Od5r3Ya5T/q4QhYjOOxZcUkjaf2HYgtrXL2Zvl6DK7ZE2N4t
# Lc1lXbRfIUqb5D+ASDvG9AJGX2QTXPlYpeHbCyyRPzUb+eMqLWxoCaHStmQ///Qm
# XB3QlHPknrsv3cBuLmtHhISQ7pm3Vw/QULiIQ453oHTkZvqNDOk1/XbAg0DKQFnQ
# qPLLaN+6FU/yrLGEkR6+Jy5upXvETKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBJaDUabgtdybl3VQejBKMH6//EweA5KE4wh+l/QH77XwIGagxE2ZJ+
# GBMyMDI2MDUyMzAxNTcxMi40OTRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNTcxMlowLwYJKoZI
# hvcNAQkEMSIEIJYtKkt+PiY0e3Xg/n/QpdqxOmQkpaGFYniFuM3YEZGFMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCCQ2MLlyJ/lGcOpMtr1rcR70vJAynJhMzTPH9zMf3VLakf
# ggLsNZ4IlPkHakUI4PSB2im7tbjMWDGblnLyluFOzKlgSVmscp+eBQDN0QKl0koh
# kCclM3LirD0Lt+rijEu+6wiA1swBe9fOZHH2Fx6UKlHT+O+JNKMFbhyx6aqmD3ST
# IKf8KJ5EaPHOTPr2WRnsQZmHOyzSoc23O3nqQTsjSuZkeqsGJP/nd2rT+HriNut2
# Aqku4w5pomdmunGY49WIIK4Z8i2v5jWzsw8Tqv4VYraB3rNV9R023eew2KFcCLrV
# bPz3KjUGkiqkRIwGrM1G0XLv3K4j9vgtWqnG1f1VX7MQkxCn1QTaC+05THUxgU8w
# Mwn1tXt2cJ7w/vVMzu7phWWmCUWMdSiXNSGhEvPufQifu2Ls+KQuiRfkQMdtIWSk
# khW/gDw9SOGW7ScUl873e/k31UPvqdSVCKWQv+yKnJmlFHMzEAvec0rs08BOzlIV
# Lm0a25YTcFykumJIgQ7w2QFw+F8t8VqvoZg5ETAAR/ir7BKhB9Jy6STsIWUMTcbv
# RaS8KGDKZE//YlMV57vIiI36fxLaJWTIIkej9wfpggLMjaBuNG6RM9XdBKU4WCuo
# 8Q3jOaWoZxWvPkKkpJjKJfWYPQBukArwyfi6HWJ4kj99tuYMFSDfT64Y18+Dbw==
