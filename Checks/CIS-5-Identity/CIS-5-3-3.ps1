...
@{
        ...
        Severity    = "High"
        Automated   = $true
        Recommendation = "Limit User Access Administrator assignments. Pay particular attention to management group and subscription scope."
        Check       = {
            param($D)
    $rbac = $D.RBACAssignments
        if (-not $rbac) { return @() }
        $uaaGuid = '18d7d88d-d35e-4fb5-a5c3-7773c20a72d9'
        $uaa = @($rbac | Where-Object { $_.roleDefinitionId -match $uaaGuid })
        if ($uaa.Count -gt 3) {
            return @(@{ AffectedResources = @($uaa | ForEach-Object {
                "$($_.principalType): $($_.principalId) at $($_.roleScope)"
            } | Select-Object -First 50); Description = "$($uaa.Count) User Access Administrator assignments across all scopes (max 3 recommended)." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA6TP0JR8EwaArP
# JVOyF9jfqTqz/vruUXdgEpBzHpTc4KCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEICyN3H0eFZSqwPeMOSv/XOCRbXlMu93cNprMFe0H
# GlsEMA0GCSqGSIb3DQEBAQUABIIBgDKT/ox+LOFYTBCJXLQ/noPaC8DDO7Sf9yw8
# 6dkPRnRQMHFuIofTt9gkJJUf/8Qd0FDbMh+R2o/nF9RLI6CwU8bte220OrC9M63o
# no4R5fqsxH6/372PbAPyyJ68jDY9FNyzV9z7+IfuCwQlTBwP9I+e+Tgq/mgyojSD
# AHX6EVts7XU6bdEdj+/cswpcXab+wk3F/KAiB0kx01QySGn+xkT34UnOlEM6BeqB
# 0IUXtJEjNAWU0yfP8Y0ALYDTRf/mkKvB1Uud6xx2sXmkJ6tKH6xWoHcxUTzU2vcN
# vsoSd6jMzh+Qye36QI2TgqSZl/rj91fIePcIZTwjfPlijbU2BAJmTPxd7C8/Rnbv
# mfJqd45Pva0gxDFmwBK64f2RdctNhowk4kphk863bTldI7oE68X5U4GRHb1ZdTJT
# Gi9pVMyssLkYywDX9lm1TJkIvb+16L40LCUeTdj11K8fEwx3bh2OBbuufihTEZO5
# p4dZzxVlXHEoAdslyT5NHcAd7cslAKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCB4vsFAFIjFzMPZe/S+4KYXf7mwxqExXXUChih6t29H5QIGagxE2FVP
# GBMyMDI2MDUyMjE4NDQ1Ni42NTVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE4NDQ1NlowLwYJKoZI
# hvcNAQkEMSIEIFr2lroXzpfLhCLzY2OGn6TYW/eED9tJzfjxl5WJh8uLMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBSa4qiJlLQF+O93X4tIEIx10DT1Wgax+tSho51bwCndOBM
# Zj8NmdalG+GlbYiS9keqaFe6GWh+TFk9M33PGS803IWsryltyQKzJhvrV/FVK9bz
# M9ikoqq1BgKe5oDQtELXhhi3v6G/ODMNZLc47Mc2ZStJVeuiGcxMed7qqDQ5XW/y
# Wh5sB5i4WeP9lKLuIEHv2voYc1SBlFndGnDq/XCfL//selw8caN8+TKdnv0z8zXS
# 4DiegrqDpv9kK0FxqkBrcqTF0caHRusIwmiqa55xKXHhURcz4+T1zPhhdYlDAw00
# qqAr0igatObi4fxILiz82tiXdbyKDjaln8iqv3AZ/m33PeuCa7DiFSjN7p0ZBKQj
# sT7kW4NmQPiQY1VYf8eZoF6a4hMMnLG3RaHTur7A+vVNia25v7kFb8f3YdxDu1Xp
# xEjAa+9Vzy2AGunUy6D53dwOx5r7trxYvbJZBayWtWPA5FVe+Sapta4FrFiZAWkK
# APtVlpOw7PXRCUzMNF0GDEwHu9EpWjgJVmwjRVVdj6d4ROxBe4fYIHWpX9FYWNpv
# D8LEkG4lYe44u8Tq6Bhh10BouU+UvS0mDYtgZop7yLJgmiR1pNI+V9sZjWUsGOO0
# HSRE0bjBvtHBJovrJHPfyUgH7MdkTdeOwhQyW39Ijxx5dmOjuzJC5e6lAHQ0Tw==
