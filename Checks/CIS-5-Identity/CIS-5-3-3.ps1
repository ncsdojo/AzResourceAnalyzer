# CIS 5.3.3 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "5.3.3"
        Title       = "User Access Administrator restricted"
        Severity    = "High"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $rbac = $D.RBACAssignments
        if (-not $rbac) { return @() }
        $uaaRoleDef = '/providers/Microsoft.Authorization/roleDefinitions/18d7d88d-d35e-4fb5-a5c3-7773c20a72d9'
        $uaa = @($rbac | Where-Object { $_.roleDefinitionId -eq $uaaRoleDef })
        if ($uaa.Count -gt 3) {
            return @(@{ AffectedResources=@($uaa | ForEach-Object { "$($_.principalType): $($_.principalId)" } | Select-Object -First 50); Description="$($uaa.Count) User Access Administrator assignments (max 3 recommended)." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD7ndh10k/TkF7n
# b3xsMn+b6YcHGIlP3qcmYern11PBm6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIHz3cRU1s7GTH9ZVuhrrRcSDqQftC59OguJ0JU2w
# yMVqMA0GCSqGSIb3DQEBAQUABIIBgBlBoYw+LsPiZbe0TGtQwCYofvmB0ghH7Vpy
# clL+ZnT6iuIwfGZYnEYz7J2cN/8hPBMkiRaKonVGl1xJGy6J8bg0E8J5AOi2senB
# 5K8clKgxtq8ZwwVf1eHq49sGYZ0upmkXS75e0sUKq1g+quoxMuRURIn/otpvhSul
# 1qCh+p2IMtlS0Fj+5Dcja5cs7bQK0s8X0Q4shgDhi7IWHKkklbawHe4ada+PEX5u
# j5+tYu0AI3fFYyEQJa9w7lBxm4EHVqQw52fdNrVVQJ32NOwUmzVcsVOKqK8SwRwI
# QrXInJOzhWlUcv/skEBKBEhy84GjHbk9dz3cewXtq+TGua7Xp7rMTg86YsUCoeeF
# sm7PpucRgOlZ5cr9Z3GjR1HlsluhoLweH5jupReyLSnqM0FUJUwT19F95LXWF8r/
# 5qcNfws+6Wunb6629akZgo54kxAr2ljVWH5nnYBEZUw56r1Ec0uyKW7Zf7cetQW7
# smRf4ONg0Yj+uk1skfOGKQOgrrP1cKGCGBMwghgPBgorBgEEAYI3AwMBMYIX/zCC
...
# AwQCAQUABCCaajjLXsRUYvqNIzmq1x3oK/t4m53kMC9h374BIp/99AIGagxE1059
# GBIyMDI2MDUyMjE0Mzc1MS43M1owBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIyMTQzNzUxWjAvBgkqhkiG
# 9w0BCQQxIgQgG1PBbaKrD/5M+xFBAQad1WwFIuBpyk++TEX1HulwGMowgbkGCyqG
...
# SIb3DQEBAQUABIICAF3/rJJFP9WsjJglkg/6Z+wRw8m8eUrQJVt/TAnKrTPDJaCx
# V4N8zmMqp05JY1UPJZ2jwLYU7w/SJ2P8irWZsaW0PSEcfSvTyhFRfuZEambe30ET
# T5BRncJis5yWAMHW9f/gEnwkiIaosjpn7ja0iBPMvKfwDI/RRdSaOC+OnWdtM6+9
# +K5OC6AMYhD55M8wfDl2aij+QC6/eYDRUeECrZy4byFPzFSSdeX+OEN1vnPPuo4Y
# BleT0eEceuwEvnSGuEiqjxOWBebY5CPxfaddBPVWHwsRI4chcLz3GP/3XaB6CXLW
# 68OfSQ0DeRM7ekq0h3IVCzm2iF7EIDLwiHULc0g7yQ9hSN1VUkxZapMieyY6W1AR
# W9pE7XNF27HEfs8O/UMuNaPNqepi2RWKt6R55umY72v8eolTinkPFHouZEa1c1hY
# ik39d+Avxf6Xfu7CVBHBIC4RJcsWZCpyt6jInWUTq8nGO16Pf9ELrPdbtvf8vCYn
# bJzsdtnF22RIo3QWjV1Wj8u0BlCiE8+EnsBjf4BpW8kKx2pU8k+kpe82lP723JDW
# wZPjdjCsQbBg4n2qF6CPEP/p+UmsGs+sjFoimczO1lsdIUng+fen9yMUI39P4bjK
# 6D3659dStNRUSQUWokJBckx/Nw+/7JrMjaKc4PJ89050ZYCxCAkRiv/7Q5/R
