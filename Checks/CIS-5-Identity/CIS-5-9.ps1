...
@{
    ...
    $rbac = $D.RBACAssignments
        if (-not $rbac) { return @() }
        $ownerDef  = 'roleDefinitions/8e3af657-a8ff-443c-a75c-2fe8c4bcb635'
        $contribDef = 'roleDefinitions/b24988ac-6180-42a0-ab88-20f7382dd24c'
        $broadSPs = @($rbac | Where-Object {
            $_.PSObject.Properties['principalType'] -and $_.principalType -eq 'ServicePrincipal' -and
            $_.PSObject.Properties['roleDefinitionId'] -and
            ($_.roleDefinitionId -match $ownerDef -or $_.roleDefinitionId -match $contribDef) -and
            $_.PSObject.Properties['roleScope'] -and $_.roleScope -match '^/subscriptions/[^/]+$'
        })
        if ($broadSPs.Count -gt 0) {
            return @(@{ AffectedResources=@($broadSPs | ForEach-Object { "SP $($_.principalId): $(if ($_.roleDefinitionId -match $ownerDef) {'Owner'} else {'Contributor'}) at $($_.roleScope)" } | Select-Object -First 50); Description="$($broadSPs.Count) service principal(s) with Owner or Contributor at subscription scope." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCjnKhSo5W6v7og
# QBTf0sBLLI1ggY34R1p4xa/o7Sy2jKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIOeQG5Ro8Ovuebaqj8e1/CEX6D+nxQ/dL9IR7Jao
# ZgvoMA0GCSqGSIb3DQEBAQUABIIBgFzOeL3z6vWApiZpQ/HdWL1KX5xKLbzb3QB5
# +zqnzbEKxO1IsYjxl16YMMOiRgN7QYE2gPouXfuUSNSssufuIKh0JN53o6W+ZRPR
# d9FQhs0DnA68A8ikWlmATH2ctlkAVS21j9WfH2osGpSNcXIo25ikZgRVddGgmCVl
# SucbSE2Gr1y+rmRdqcy9ovYAl3TKbr7aVbyXkxjgB6W2KJyUNWuNwkFrAuMtly1V
# qQfxNaMgMa5bgiZ9aDzr39B44fl3ZDfIg6lCZ1J/YMn614kBehTt9Zahg3gys6Io
# pqgKQLPhYCkxyOIcjMr2JAnNRm4eM+90nt4tKKNcBcq7u8vKjmxyZ8MwHqppogFP
# SM+iZqM2Y7G9ObZP6oJR2WBBO3/cTayg06/GhrB9v7QcQ4rGoP2EgPKMxNEWdZrM
# Gh8YeCFf2SBop6KWsX/PnEJuznxug8CeIQrecIfwBGTYaKqXy+0ZvGNDcGZMBdgR
# IAYLUZlE4jZxFGIBcM9ovnNxAKC926GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCACRSv5Xm21y1HEHo4uijjq5xUr6VUNrpDcxkESyjIPcAIGagxE11Cf
# GBMyMDI2MDUyMjE0NDAzOS42OThaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NDAzOVowLwYJKoZI
# hvcNAQkEMSIEINS6xwLZZ5Bz5jKir85ukzt+hF1dNFUCb/MjjDOPrsT3MIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCMeUUlbzEwsU2B0pKKc6wOQzusFxgm1EwKbgzTrk1BpSD7
# X9L3D0oFJhfz3qLq5mT+qFQUKwPwFiflalruqJV8nUqQt3I1lzeJwuFMNLi7Ez5T
# Ye/nfVZEnMl12j74GQ0uzxxMp89DUnPv2jwzBb3n/H4a3X0kc4yoZ7wayRDb3VHs
# MyUDsV4cvtTJ3CUUdncrJ+NNcKBkLG0HUfuOYd2uxIxd0/Tirz9XONMoi/tfBl5D
# ndcgjYoWgzrtfO87cayfMTqmp/ydrLgmyNNB1Y0zOuXsu2nxCP//RDwNhtVzMGI4
# SqAyYnks10f4jlz6FEUWdinoKIwdk1SUF0chgc+LE7yAR2vYTJ3DLGgBMBrE0J+O
# hgcHhkw55PXMkLD5I1MXrBIz17RNjfaGnOoyxhpMTQOHGpttcUgDKQLEM++BL9di
# 04tM7H5DkRPgWi2OERz6LoZyC9nON3d/JTFvsF8/nkr/pXZBnA9Yuv2LYjsuSEZW
# qvNQmLb/jX9rwdlrj95f6lXkKyp5BVrbrtdT0OqVVrtfRlclF2zkt7J+vGS+gan5
# tqF0DeZWxiKwEiKLsQnTiRvz/L4SnX1dCtIlBMa6pu59nBEIPSPYBU6RhPjM5Pes
# gEpXj3YuSsif475nKaRV6/XsKuUipAr+wVSxwEtvWaf81UuF86hR9AmEtHeETQ==
