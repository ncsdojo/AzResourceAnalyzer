# CIS 8.60 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.60";Title="MySQL slow_query_log enabled";Severity="Low";Automated=$true;Check={param($D)
    $cfg=$D.MySQLConfigs;if($null -eq $cfg -or @($cfg).Count -eq 0){return @()}
    $bad=@($cfg|Where-Object{$_.configName -eq 'slow_query_log' -and $_.configValue -ne 'ON'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName): $($_.configValue)"});Description="$($bad.Count) MySQL server(s) without slow query log."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDjAcmE7QF8vpfe
# mpt1JQxzG/3nrlsayXTsDxBSHt/y4KCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIGGC9ZDcoUOmCL/lu3LLw5lBkyJvVvvCKpmYPzJS
# vmElMA0GCSqGSIb3DQEBAQUABIIBgJKCUeK8PRvJ79tU3fnfDBhgkIaMT2MT/MzQ
# D4xztMnZY3Zp7qQqeK0CQb+jZk6riX88JQDbEu3Ghs50mf8NM/pKEAzMyOoN6wn6
# /S5bhpTJJp2ZRHbqEQv7buNRV6lzvnUOXZM1T09qbRxp1p+cyEhpaPK5HsDyR6Ta
# 1s/laV0Hfp2TlSvYBdJrbPjegWYoORCa+tRPzphMGPKnihFXmvwmBV9aTNTDdjyn
# LzYO5HaAU3dW35yepqW0T7E9+5RpQDMBPgAiTpFZemk1e7SBIodzBI5wzCwbSS32
# jJH0VlY6viI12r1MaXYVZo2FrFkamx1zDcMU9wl7Swlwwis2GjqeZMhsQiRZq7fG
# /biIYr+OJyVOYUNm2MOC0I39FtLKAUvAGjbL++ZPCpAZ+MOQ4Z7xw3cbLcG+kYKO
# LuOH8l9/Idj3N8IcX+84XcqOYSPKGndJERPXNI3bqBPX6/Y6YgPuNQM6zFRTVsfT
# CRkGOIAXxhN3zrGFHsjre2Oj3t1rxaGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCA4EVeigOm0UH5SttMJ3n9V321Ctyh9j5KFDie/dFn2+gIGaeiBPNF/
# GBMyMDI2MDUyMjE1MTk0OC42NjJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTk0OFowLwYJKoZI
# hvcNAQkEMSIEIERstMgUnju/0LoySbXDJjMC9c7f77ArAXw9ny/KnXK/MIG5Bgsq
...
# 9w0BAQEFAASCAgCGPJa5eisihhuizVIF8lBReOdFm+JvrMWXq2yWRnc2VwauCfPe
# EkW2nKQXCcIDtHkRAggyXayN7ag0ug9afSUCDdEfCjIh7W2kWHdsY7EhfTJUb2OY
# niX5DOu0BwObvfM61U1RafvTjDcp2e5khF7UYyNgtvCm9WI3XeXyeIJXmDqU7dwa
# 3rdxa+J1ZtH+JdG+6Giq8tvfduR1gk+z/AcEb3yPe/TjegxKfkKRh1BmZLPaj171
# PmT31Q8eA6d8yqKb0UxEVtK3Da1q4+dry4njWoIQG6jC+kcJuaNsW4YfpEnmEgHC
# SbkuFnAv1ZNKiwCQMzATESaseanV7+juBBSctzmmUy64FI1p8ouOrLR21/VB9T7k
# i8cwUUDh8AvcF+F9/GGDygMsEO6Kjw/oJMLKYMse6D9xXIF6ilz9B7EfzGdOxaz6
# sfhcR2d+JHJgkQk0Y6LRKsPPY3kY33bnfYqE7AfvGFKv4GW41Vj+H+yKAUzqQNNp
# wD8PzQ1rsEgWy41nDC8m4xXMSbZKzgDfFx800w+RQcL93d9p2lnTDuWlfQlBSu6P
# fLOEjvAp/8IhjYTZKHnk2cm7slZ/CMFITJDORNg/t+eQAYAWD+ZGEcwffGnEfsew
# mlElnepj61UirFjC0lTMKZUJI5Asat2U4oBFBzJemQ+CjwBtajBmPcBs2Q==
