# CIS 8.43 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.43";Title="SQL Database geo-redundant backup";Severity="Medium";Automated=$true;Check={param($D)
    $dbs=$D.SQLDatabaseDetails;if($null -eq $dbs -or @($dbs).Count -eq 0){return @()}
    $bad=@($dbs|Where-Object{$_.PSObject.Properties['backupStorageRedundancy'] -and $_.backupStorageRedundancy -eq 'Local'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName)/$($_.databaseName): $($_.backupStorageRedundancy)"});Description="$($bad.Count) SQL database(s) with local-only backup storage."})}
    return @()}}

# SIG # Begin signature block
# MII9FgYJKoZIhvcNAQcCoII9BzCCPQMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC9t/uHmRPhYZL+
# XFLRXePmFId4FoOgBtMv0pXHOR3aBKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIPpwWHgq50ky6ideWwH096k6J0gFZQh/cDpH/UOh
# ThVvMA0GCSqGSIb3DQEBAQUABIIBgC80xJiysQbkbWDuqED42v3X8n54eWVLYGjM
# K8oU3ExFTzNBYoZZGQIXWd5UhrwACL8mCdFSqOvLVcKoPGu6/gr+mUakcue3v0Py
# PoyheG6epWdgBh7y1FrWbfKWjOuSKfBOZBf7BR/T3K+FotA39Cae/fC2wB5EDZMa
# ne6R85PQ4FV6VV4L5hU/aBrloZJGV8zd5V9/Ro1an/xHVQoLNVtczWF/lsFZRpCm
# AThuKcjDy7SWLsSK7QC/ZpwdoWk/+pQSXzj5yVS4+m8JTJLWs4BtutaTJD4/LZ71
# dITmh2onoBB8YJZ5HGeId+FRsZ6gNRn7cu2tLYIJNdlJvWh+VIzDRY4TnyDiVUAL
# 6W/30PM8MYqraWYzRtvoEBUOoxpH+DbZMXI+xxOX9xvYF47553SgI6DXIuAVX/+q
# 3qxdQlh1b6xo++MH+OMnX4HRg/unUXwtsjUQxRQmoYIJyJiGCnw0CWdEKirzzpjZ
# hQGwI42yd1nRDy8fu1OTcb7jC1PG0qGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCAU7VYX4QjMddtT5LXLxglZKe+dHnnjJG8ol8qb3vedCQIGaeiBPM2Y
# GBIyMDI2MDUyMjE1MTQyMC42MlowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIyMTUxNDIwWjAvBgkqhkiG
# 9w0BCQQxIgQg9+t7sEuNCXMV2qAkyEC3Aci29NE1nIagN1bbtzpbhygwgbkGCyqG
...
# DQEBAQUABIICAKv6pEGWRb268COUR5UHvt8NeF0uTqz7Ui5toqAa4vDQ/inQJBnv
# Ij88pgwfYVLzDc2Wa0VM7m79tGu1thfgj9+7JckZM5CE9nLVaWKcpBm54TWX/uaV
# W67r/8O5rGEu09qgiFmz4jMroX2WRV2uEC5cHrlVWsHaZzhLbqF/hGufgkw6WRe6
# 5E5KHuNsmmrOLzvq7B/qRJWT7Qx7kwvk4f8F6iotqI4trq0q7rgF/DZqqaudRiC2
# qdLzhKIr1wkGYDXAf20MWeYBgPIQquVXwVSUtY9MobIVJK2Kf0ORvfg0jrJVjsqN
# +8k5gHczTn8NAWcNA7xQ/hEgR+tnEs/TH01PPtixqPZqpW5nswNzKhctNe8/oh9d
# OQjX8KxNYXGeArA4sQ2HM6pTKL88slnrSwH9xYM9Pj4dzSZ46FXlcjhjwgOuW1ql
# HeYLpCSaWPX6seIwaGwoc+9yjm3BrqjG9vWZERnvP99lDSLPmF2vjxkwIDWF02rw
# H0ioKKjss8WiZkT62JvNbKslOvHX4K8ylcqduhznpks21/4cr1pkpVKvh4eOjBzy
# ZNusGZPL2qZyf221QpS1upoRZ/oXj1HBtl89Oe/9RdgVl/JAlubscSqCW1iZJIWK
# Z8HHG6BusaGbwUQPNy2LmnUeMjaZNrUIwQMkj8xHTHv1X6KlYSgWe+Lf
