# CIS 8.42 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.42";Title="SQL Database zone redundancy enabled";Severity="Medium";Automated=$true;Check={param($D)
    $dbs=$D.SQLDatabaseDetails;if($null -eq $dbs -or @($dbs).Count -eq 0){return @()}
    $bad=@($dbs|Where-Object{$_.PSObject.Properties['zoneRedundant'] -and -not $_.zoneRedundant})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName)/$($_.databaseName)"});Description="$($bad.Count) SQL database(s) without zone redundancy."})}
    return @()}}

# SIG # Begin signature block
# MII9GQYJKoZIhvcNAQcCoII9CjCCPQYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBtsme3XE762pCD
# U3F4KgIGhBRWC7Z2lkQHbNMJhBLPuKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIHow0hoqQ3QyHo873UoK0SbWlBqsOmjrWDkitecE
# /AWuMA0GCSqGSIb3DQEBAQUABIIBgFf7wSNXRjChFFJBiFI8Xv2zF4Taa/kpO4Hk
# KqVFmmJ8gtE1FTGw/XOUbiGnXkZ0jVkZ9i4hYZxFCLFXI6inClF0v8v9HKhM5D41
# lGFf4LErsGNX1f8HWHlApvu8C7yApNhGmp+Zbi/1qyF5bSdSmURDPUFXo1HKR4rN
# j86Pv347HLexFD+LoDZZ/OV9H4ZFrPPBcHxZtU04S7gVgoHxDjW77v11YAHY2Mok
# wEpWdXGtyNt2RluIczeubMSVpiwN3jx24vZyxWJgBtaUcxLJf86+NuhsgcxKKWI7
# Sb5F3bVYtgnvrgEBav8Azp/Nj+tjQD4wfxa4c3zKv+naAaS3FYYKGwXgGrTUEITH
# X+1OnumEKqAQL5Y3wPMWnBOCHaAZVziqGFa6zPF6KA5/DiodF6sT+CzI0aWwHaCP
# 38OyhXOqllopFm6PRVdn/OetB9W2lC/lmdfDybxjLvYzsEP8Y/Ow8Uu6V9IvrcYJ
# necEFnoqNThsGLv8esjcOCRVxfhL+aGCGBMwghgPBgorBgEEAYI3AwMBMYIX/zCC
...
# AwQCAQUABCCZaWuOmWTtCzlEvUYCWJcaBgOVHWWv4t8U9VMP2Cw7cwIGagxE13vy
# GBIyMDI2MDUyMjE1MTQwNC42NVowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIyMTUxNDA0WjAvBgkqhkiG
# 9w0BCQQxIgQgftw/o4pcUH0qdHbrkOVugJNc0JdoHvsd0yCR1WpZhMwwgbkGCyqG
...
# SIb3DQEBAQUABIICAGfnWxJ7mHj01h6YTbHzcJulRnEev4b0z6dzE/yS0ndEqI2E
# lJu3usOoKPJ+5B+3lfDmeeWIcmDoIlx/sbjaOwBpvGIeUlEv2KgSVCIa3EkNInVb
# W4NT+W5jAZgaPZu4X3apHVptju2RfvLxvwSHODXIv5z1joiEJ1YeIf7miKRklQdI
# vZCAtinxe4rDlE3y8kP4vSin12RDFDUVDfHWjkJStr+yFdg+t7B6GtgjdMmcvn1Q
# ZMEFbVyVMLzJA4FueQ2ur0ICDnpPjsBsctjKhJUV/3lTDrvs/miNcaO0A0G0whxQ
# Pnxy+UcTuxFrXqdSJFsopNNXotNWJpM6bV7panEnmDvbdBsaP2ZdDLnqE78VnDnW
# 3OvwonQ8bUVPnk5VUx56haEEzr0w8yyh6T8ABnE/F2bhv27xUpSNqsioaGFVmISx
# kyfK511wl7WFQBT+WniFHHVTPhbdIhadFKpo+YX+F3UrbMuKe6Ld/Aezyq1svLJ/
# 1lEg/mxAc6qLwdTUP2/Xg1eIjXAiU4uaDb7lNpcwRUpcnklguqjP/ELvmQVGVmtw
# wd0Wls2d9z3/cJCm7Ut/Che0szePmSU5JqAULzwfRH6FTe/nUdGf2u+/q5OBMxje
# vFEWkRHWlSERhkktH/N3IXGBFcbRnyADlORe2knDVJjlfzlM45BgSwbEM9Rz
