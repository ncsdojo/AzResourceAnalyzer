# CIS 8.57 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.57";Title="MySQL require_secure_transport enabled";Severity="High";Automated=$true;Check={param($D)
    $cfg=$D.MySQLConfigs;if($null -eq $cfg -or @($cfg).Count -eq 0){return @()}
    $bad=@($cfg|Where-Object{$_.configName -eq 'require_secure_transport' -and $_.configValue -ne 'ON'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName): $($_.configValue)"});Description="$($bad.Count) MySQL server(s) without require_secure_transport=ON."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC1vwpmhLQ08O99
# y0LJfGKCKSIqtSCJ1jFtm5B8xtgPrKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIPGeUekDoC4JwporKU32qsEM2bsHMl0jDxrm0+7T
# CKNVMA0GCSqGSIb3DQEBAQUABIIBgJSkPbKaazsj5/3Pn5O9erIhriKfesgGz248
# FpewqxY7/MqRuimIGDpREvSCXUcUUm3OkME3b/oRibsJZ0MUyEDk6f05/XPP02mM
# GIlQmJ+9GeDbzo7gTzjg0cQ1vDpQsD9WjrKt+4ppYQg1Ov07LqbFdjdbVCPUBBnX
# Ne09tHcSasD9ZSGmZHBCZKx4+s0HyYyJ7DnJrUgrbi99YxwF/BaaL+FeJ9+O5L2k
# xLIwEWymA3bmS7OsGkUt6I5WmQ2xelcL43/PPqRqdf8xhFA+nDsNbbyIcdWZTcqH
# tt2Oj7xXcOtDiNzh0tRnrfkEIL4GsrB1rumsW7zodRLighyV2WST0LiNWhqbtM66
# deprO/7GBpyNe+XhpYoud+sZbH3EkMVkLLuFkBPXGdgbDlbGcyW7a7Lg+4L7ovPd
# P82BxVZWaWDwNz5tGKBy0lpXzRTi6Kt9rM635Zpq3b9Epnd7qjWAmwMnCsRR+YMj
# zK/47stZXpr8mbShDRMdibPzQ0VniaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDoheGPr8TOtqtxILvHG9k+D2/faQ0LGZHmy++fLDA/iQIGagxE138z
# GBMyMDI2MDUyMjE1MTgzMC41MzJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTgzMFowLwYJKoZI
# hvcNAQkEMSIEIH7hGNTnfJ6HKieIG7acVNmGozZaUFSuJmrXEP76RuiOMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCfiM/LAtFRlhe8YSZzYa8/fA9lv9zcO8Bzr9uLxQW/1H8f
# dlkqr/M9Y9nRd2kst7hoWax+zxk7hzD53KgaVU5aQU/IsQZV0vuQ8g5Fobx6Qr8s
# SBhVCbe2f8HdR6uM2XqPO/hjGFy3gHyojh9Ja3YacnYWacaRuUep4VIvbM9B5GNt
# E82ZqyB86NgBDjD/F/0+/A/yJAICqqVGd/lKNu31ZhN6hghoSIZnev17m7tcDUBy
# bfcqNPUxTRta5vNVChnjpwZV2SlceN4d9p6blWVXe4EfSLBG49MtbCN3e+eNpBXu
# BMNRO9vMiHPT6zLt4jhygOQCZLHbq7f/LhgS7eLi9yl3Vz+eiF621iIBfUkkVNaU
# 4dmp1AtXsXLehm2Ly4U4VbA+WMNB6SOh0p3DsXXcj/Oq5tbdqxRiaesKmWCcZGDK
# pl5Oy8Xq2iInvXYJ8V4HXFWhMfGUgBwbTqujsmObAvBbSlq8kEOFEi6zVnkSxaaV
# EjBFkjOYQolZVlbUtMGaXgpRqtcB1qBtaZBmJ8f1YHypmWPFtT0J+2yB9/IiHbCA
# 4ZvgJmmarn/thPtSGpvJ4kFh7NeHIvesprYoMbhb/008e4P3PSpcuF7Oy6OXE4XZ
# O+QcPUtFn3PQxFBZ2LIOHDgtTN3qa340MtUt9etsG8h9nSlec+AaqUhWttkUhA==
