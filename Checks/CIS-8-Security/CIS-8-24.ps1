# CIS 8.24 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.24";Title="PostgreSQL CMK encryption configured";Severity="Medium";Automated=$true;Check={param($D)
    $pg=$D.PostgreSQLServers;if($null -eq $pg -or @($pg).Count -eq 0){return @()}
    $bad=@($pg|Where-Object{-not $_.PSObject.Properties['dataEncryptionType'] -or $_.dataEncryptionType -ne 'AzureKeyVault'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.serverName});Description="$($bad.Count) PostgreSQL server(s) without CMK encryption."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBjxql4RlcrNXrA
# AOosoCC7nh4WIuhghXctnatKtuPbxqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIFVdEEejn3CZIf4E6HY2C3pVVGa0QF3Yy6SlYnl/
# loDsMA0GCSqGSIb3DQEBAQUABIIBgCaywcF80KHar9yUfKqNXIWVjU/Va1iqrNGe
# Qa3hNsSBoj0JuKo8JITfT3C9rJdnPmZAeoVuAx71f3qzAwk+Fw8CKa+Aw6mu5+SF
# H33rZlQUqiZfb5trkIcoYwi2uvD8k/T/gh/TbDnykLy8CrDOMIR6GXl73GCxIDqR
# q9oyUDleAKBI+K2AcAxbV2/a3MI/jtDgFaYnTWzVhmBJsJpXiV6JS9T5GxLquZe3
# QgOJc18Ly8ieEcXFDTfKFL7LOtobetvrw/tS3NsZfm93My4J4J0y4dytN/MQXtSw
# sxR0VyTQU9s9Bfc27GIyhj5YbwZ0q7p5xxo7orRlC0ynlH9l0hTmmcoyWRWf5AnM
# X8nu55LaC3NNuGhDmLvsz88YXxXN6gG+FipJgmYlHm8BMSyaSah7+dqTFQHnbnbt
# Lqpa5/hc+f6QNdoDPLGAYREF0b7G9D/FmQdQTnzkUUXJKlA/T7t5k1acGXAc6wER
# q5akKkNBkKTUcOTXlD7KSD1lB2PCi6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCB4RHcHjXEEvkkhSlcPXGL4WUklLh3Xn6cWGl+NfRWinwIGagxE2aE7
# GBMyMDI2MDUyMzAyMjIwNC4wMzVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMjIwNFowLwYJKoZI
# hvcNAQkEMSIEIDX3gvQf8m+KmsHr3FVOsJo13eqyEaroWcnwWIcgFLWXMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCFaqtaPVYy+U/ct2oJrWfNY8H1zMhes6IvxuS4gN+OWX4V
# DA9DPKajE9+rSDtHYt92oDiQw70O9RvivyWJIZchY27N1AC2Dd/yXvb5a+9Wn67m
# 9c2VhkeVqkDximPnq2WttZau/8mV1FsQXoYDBz8u+JjtOH6ePKnuX0WjkOtMV5K8
# IhXNf4UTozAoAQsvxMYtuII+tUTyqJ9fofK09QlDmruLZzUzGNwaRStDybt4cV8i
# ECCAKo1KFyOZPEJXiTYcBCYTZuM3QmcJ/2LDgcUKZc1xeaya6+Fz6MSlfzJ+NYcs
# f6QcVFZ7GaBupxRBnJbjG7l2eBMHBILynkwmzihF5npDJSDL+nDoaO/6pLSkkVt9
# zvLnPzAxSxjqxBD747/LUU2/LHBhoE7fvjDitWv1DvKbxrjViBpz/5pYF6XwXtDU
# c2JRRvu+0HloWpkq55PHqA40orXziZfTsNf7rFJLmISAf6V5OLvaJwKpcHZ0YRKd
# ViLG2OeGdFb8rAQABtKMzerYjmEyP4hTZWBx253yShriMyJt1RYYmxyfUn4zViy8
# iW68EZ5aN09QVmPLMHNw+siWhWKUL4YvcBIsdS0/HhM0YD7jz4n6rFCW4nBBLPeD
# iwpqxQABuyOsC55kMVnpxaLewss+mUqXMNLVdm93okJkCJOkMZNNOpkiwv4IkQ==
