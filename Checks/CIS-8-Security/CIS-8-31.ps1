# CIS 8.31 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.31";Title="Redis private endpoints configured";Severity="Medium";Automated=$true;Check={param($D)
    $redis=$D.RedisCaches;if($null -eq $redis -or @($redis).Count -eq 0){return @()}
    $bad=@($redis|Where-Object{-not $_.PSObject.Properties['privateEndpoints'] -or -not $_.privateEndpoints -or $_.privateEndpoints -eq '[]'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.cacheName});Description="$($bad.Count) Redis cache(s) without private endpoints."})}
    return @()}}

# SIG # Begin signature block
# MII9FgYJKoZIhvcNAQcCoII9BzCCPQMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCACz2oadxMOuxjg
# Av1LOkBQE8AZYxyFy0UiiylkVEsoCaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIC0oFqB/pMwio8WWjdj0cs3FRjntxgCiV/Wg0HT4
# lEZNMA0GCSqGSIb3DQEBAQUABIIBgD2xwSURccmHTwAGpwCygWKq0TQyKbt3CGlF
# fvxOz7BGeVEHOIPWzruapipmALVkj/W91DJik0/F3+Vf+sp6uft2JgwAe0TuTgpF
# iu2bi3ENwjsyzsh1X+p6ynINDNiUAPYnLdMEyyvvMs5qP1LKoG91LHnhSumkYv4+
# wkmQvOT8crq+1o96yeXomfbe86rbd/NSp/Y6hl9OqvlB1vX8SvrXTbLsZpXDPppW
# a7q1wLCVphaEpF1AxcWMBOc9/i9r6ehhTeq4MYWZ9TFwGfbw7TyEweu9sm5/fSMb
# 5zCRsaN36/MjhtG/bSntkppTqC//RdZBVjLtRvSOYpZohuLltLNinb1lc7Ez6SpM
# zFJ+UepaZp3O+jEiLM+iy6UEo0v5wiqkzfc32KaJr+q1N3hekJDlkm2PjmULCl2Q
# bu7wik92SH6XC3s/RblMwqsD7N4bSGZUko2+U8MjH2rKv9a7OpT/5rqSrElGX/Ge
# 49XtY82ByH7N2NuGomr0pzr3++5+NaGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCDRUJDdjuX31M336E1CIExXqDNxHqCAxjdUQus2GlX1bAIGaeiBPvuD
# GBIyMDI2MDUyMzAyMjcxNS44M1owBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDIyNzE1WjAvBgkqhkiG
# 9w0BCQQxIgQg8dEI0lS6OWtL1GF8qmKgFoRoCMJRwd0DWnlRKZ0NwHMwgbkGCyqG
...
# DQEBAQUABIICAA43LB9AIILknbHqCblZkgZ/Wd4FwQAPLTvppoORM00NQi3lkaXd
# YgX74Qv2VVhC+4r4S5mstNcIRRc5/7dlNfxDI6cd0wPgi5v+lykDpmUi/wFOVkN3
# Cy8//c+GE3oRhSJTHdxJHfmRmUWkVrq9iVxv8PYm/aMGGY1ciynhmTHvLzhFj96c
# B0u2vxALTgCfymopY4hM2vc0AEJOLanjUtnFNqejUEfFT86K6NCM35sHuf80a0fk
# E2Uncx/1t0b1IxbpKxrq508nQfG0BzIybEkoeWPg7kBVBrcRSpfnUMaCt7h66Mxo
# AH4HhRFg71dQ1Od5S/CownJE0uHucuIT8bwmi89WxRh9RkNqYL8GcMw1DElKCyYq
# bfBRZHp5NYjClfURQcFdgOzB07lTDvSjPlPniGGkegwNw+ZBQlzbAfM26XsCQCRh
# obDedrbKuXxsHG91sCbb/DafuGvNBFucsFA8UEP+dotj4ss45oAnGsrCPDe4U58A
# lIkkFWpMGnkV558+TbG7RgqaJ8NRxr+ytTFeTR5APnTEYjpQXfgtTQ4yHevqD4no
# 19V9wwemB+CKuahj1BRO7K46o6IDX/bf/aHDCGIDZo0KXDKTwIXsITsEIOh0SsuL
# B7b52zBbRtmha+SnSo5ckaFKNur9dHnon4n/DTNhgRswcUuwpZ3Tknmj
