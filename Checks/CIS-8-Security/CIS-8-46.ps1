# CIS 8.46 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.46";Title="Backup policy yearly retention configured";Severity="Low";Automated=$true;Check={param($D)
    $bp=$D.BackupPolicies;if($null -eq $bp -or @($bp).Count -eq 0){return @()}
    $bad=@($bp|Where-Object{-not $_.PSObject.Properties['retentionYearlyCount'] -or -not $_.retentionYearlyCount -or $_.retentionYearlyCount -eq 0})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.vaultName)/$($_.policyName)"});Description="$($bad.Count) backup polic(ies) without yearly retention."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDMqRtN+xG0+ORz
# 5lKbUxe30bxHEc3sefCNC5Lx9Y2Af6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIAQAZ0WPb9zVTFQSl4yL2FNuMKh7ImFhRnYhxKXD
# zPQAMA0GCSqGSIb3DQEBAQUABIIBgF/hP2AcDQtkQES2b5y929y2AP/b6vsJA6WE
# vbLWGzVp5IYd+t2wtWfC27lyRXO1kdxex4akaEMjtzrDniZtc+T5b4KjivCImerI
# BKKXoFUg/VwhLumJtbf5yqDN2TqdOBQJGIZ7F1l4I4yDFBSy89ddkV3ZlmkxcPP4
# lvBH7xnEsFecvz+PL/HRllQ61pKGxxyBiupDhfiUXNIJYMC2adSzNqie2QfTgWRB
# 396fDl4G4sn2uRow9tDQSjo1XZzFawAQa/xIRJjKCcz7AulJLX19XGSuEtVs4/Lj
# fR0qYJRFfqVeTA62NiGilPRiaLN+6+tk0+2k5kLLIDRfXDGO3Ghk7okIFj5fLWZV
# Q1P02FtZ03E6d2SkFKi9/jLRp0TTTWcaPtqSUfyCe/5V4lYtxsIEoKcW3gY8ryVz
# T8yzNNAHh3k96Q8YQ+icTBgC3TatRdPLzab++wOV+fpAVmzo/AlsAr1pHxieoOPw
# o5NWeaHpeaCc4f/rjRXEUms5dXYxRaGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCB9o0AqWOB8t6uZWwfo6i7h4rqFBFbIgM35cOEpXQHu2AIGaeiBPM3c
# GBMyMDI2MDUyMjE1MTUwNS43OThaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTUwNVowLwYJKoZI
# hvcNAQkEMSIEIO+bs0mDuMUFiQgNOFbFDE0KPmRJ76ofbQ4nTV4/GESfMIG5Bgsq
...
# 9w0BAQEFAASCAgAwjSwIgTrtXmvgURWKwIOrqF7mJVXSuJvUSdswMZS4xcMiuyuT
# HAN3yTOS0RzGdfue35fBec7IcEkKJiFj/FqJfj2zNjFET1xO650ORcNbikq0mVzV
# 5EEXSmFurvfYKC477pTmK9x7hgueql/joRe7zW9gXHNWbbft7DE8gdZ4rpUV99W6
# ztjFFVfzjbZXzqPLHStECHks/SlreQJPQ2bIckGoduug5a9436GhMR9hoeg9/lTJ
# HFe3Rchbuo5/NaGluMJfC7Kqb7elqfsyJ5SWmDMao7xlp1G1QESaqFyC3tpHVXpf
# i0VqMReK2t8x1ZhmAbXCairQ7lprZIc3oJAV4N6NcyAmsKUXFkSXD5azTxq1z2+l
# vCDEwU4jJVxOcOiEIqglEw2iNIVbtu4PAB3SDkty5om6S9DP87IY5yFmzwYPMbmj
# FtlRV77BqAZPN6+ypwqlxMB+gTAYUNJtId0+QLe5N1hf/1tMe/qnC34F3FH5RTCA
# OgaW5hN0xGEJ68/1ihN888bmi3YqU/xb6zmvUDiGAG3MXHKN3nrI+J6ED/8zom/X
# RHFDQzdbA2qLoIqx6ctapSVGwCBo9P+lIXXq91iYN9CizFgaI5NvMEZMSHmfnhw+
# o58eOxV4S/2BEWX5vsOM9lzo9MRcCK/KCKFm7d9gHu57PFuuDTkSaJNbcQ==
