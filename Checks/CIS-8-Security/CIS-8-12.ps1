# CIS 8.12 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "8.12"
        Title       = "Cosmos DB local auth disabled"
        Severity    = "High"
        Automated   = $true
        Check       = {
            param($D)
    $cdb = $D.CosmosDBAccounts
        ...
        $bad = @($cdb | Where-Object { $_.PSObject.Properties['disableLocalAuth'] -and -not $_.disableLocalAuth })
        if ($bad.Count -gt 0) { return @(@{ AffectedResources=@($bad | ForEach-Object { $_.accountName } | Select-Object -First 500); Description="$($bad.Count) Cosmos DB account(s) with key-based local auth enabled." }) }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDZ7H87KnHhJB7I
# 7/jLgzfZ8YaXoaarf6NxDRNh03yGKKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIBm6N9QqYFG2MQQ/9yhY9QyBUEc1TPJZ1DEMUxf5
# VwI7MA0GCSqGSIb3DQEBAQUABIIBgFv9AOnp2KIzbFsmyYT/UxnIzddaY/NEMMmV
# juNt7ZbwykhhNA5gnbOFl5xsrni0VyCdjeRyR/8bIFZYxzc/3sgYuqFdm+LUvQcs
# GenL/kdWOS9QA8XrH2WzVZLnwJB2VsHxxEBomPoAswb4ehtC21sIeJR7FsdSDrto
# 8CN5k7CmSO6uBNVqSGoQMjDSX6udCKNxkdZiHdW5klpUy6OXrN1dkC8ol2OjbI3k
# MXunxVYwNJBes5SFBu/4HbjYZ8JE3pH152IC9Jdc/vInZ89677xZbxq5ImsaxSdy
# SbmkmiVQMVKkbx/GnRXMcH76pnUeoiSrbVZktV9fvr9+PgLayQoHObxBFvg/CEz5
# i1e9TZj8p9LKplE+KhKE90710XKNY/fIjpa7SZwJq7GYgk1q3ZAt8iBu1lMnxEBY
# R3FfTAi6vx6SyCZz0xhq42D/+uyRIX1F4ZG2qjwfq5i7IacHwBZs1ljqP7rv9aKf
# 5V25in9hx5Pu9LgLouTSeJA5B93XZqGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCD0GzkY3/++v6DpwuvSEQfEOHPKzdbaZQH4rX32Wd0BQQIGaeiBPL3E
# GBMyMDI2MDUyMjE1MDMzOS42ODZaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MDMzOVowLwYJKoZI
# hvcNAQkEMSIEIELsMQ/UMLvhJVB+hzyHKAfkRBPD2YPqffMGVjUCrsFIMIG5Bgsq
...
# 9w0BAQEFAASCAgCY/9lj8agYHXvRv1nMZ4Vdhpc7dcINiLGBhmcgVqtBXhi9/Y3L
# EmFZKSid4MXMDEjS2raawikQQkao8PxxZ5SxKCjoxnYm+XHmTm+BlrbXI6qdgnxj
# qri8BXzhdLP3B04+wWUKofrPxL60MpYEArmxYuJ/s+xbpM/Ix/fJSg0ZRdMoaMxd
# 3vf4MPLL8beaiGBkDy5oyxOobrT/53P1TbJHJePOUidACD7EbOJo+55YXx6TTIUZ
# I3E4jEKlT406R9uw+vuZ6dHwjZn5eHHCEJ2/YYPS1IObN0yyWmgEn71GEYrIcoc0
# 47QgMdNdAXiVHcz5jFcz5PUjkYJVT7OhwBtq+ZrTm+SSubAa+xD3w9m6mlllTCtQ
# e8juAMfha7ocyYn5YpRSCak0BdeG3WgmUhqLPcMNtTdXwTh+LGg/Fgzf1y4F7m66
# Q2LEEnL45vOyVfPpZ36D6ooco9Y8GES65bFD3qbYFxMCzy6Fb8zQzyC7/5c7VBHG
# QaHnj84xbsUI1PnV5C3XwQd7m3c3ONK90iqKAp0zmz3wMUogdDqSCSUVZq/y0pcL
# 6tGrCtwNOdJWnbf1YXk2t/PW77ciyE3oWkYaUji4V337j8kjMD7cVLrFSsOVdJmc
# tbTYK/l3HlcTsyZF7jadZLrsE4zx2HUYoAsSXDqi6B5bkh7KaUT0Go26pA==
