# CIS 8.56 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.56";Title="PostgreSQL log_retention_days >= 3";Severity="Medium";Automated=$true;Check={param($D)
    $cfg=$D.PostgreSQLConfigs;if($null -eq $cfg -or @($cfg).Count -eq 0){return @()}
    $bad=@($cfg|Where-Object{$_.configName -eq 'log_retention_days' -and [int]$_.configValue -lt 3})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName): $($_.configValue)d"});Description="$($bad.Count) PostgreSQL server(s) with log retention below 3 days."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA3uU3kgvUD4SE+
# ZclL5u9junL9T6gp7IH5CttrzO+2bqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIH0oSztXXQQo78JxEKI/hFuAeaOJQQlXL9EasnoF
# 8LLxMA0GCSqGSIb3DQEBAQUABIIBgJxDi7Agdx9Ll1RottQ/jGXyE/CYdi5NjJF7
# 6EMwMIIwWkLCQryAE7+UtFXh9Kf3W939VKv1wlD4CfGDozym8NxVcH8zoNLy7ezQ
# UD89bHYcDIxkzYyhgjDLeDS8ky/+sx70TKOmVQNikveKTMBtFDrQ2q9v+D5+NQ3A
# EgAI24jMdC/wRMY0E7qpmIM3qeDCplY0zUq+7Xe8D6TGIdVyMtQ6F/eIcuM9tTqY
# i446yZov7KhcbgeeuLQXkqZ/8g7pr3yI/AOcOdUJ6LGZ1goyzbawG3qgN60BioTw
# 5/R3Mc3UrdwkkrpFdxGu8aVxXY1uwbrdsU4Vzj0xpaJaSN2r0CHF2Pp9/3S65v4N
# pmF8gV/pF8L+nGps+Re2pM+kuWSUq0vf/BfPBldJ4zozMS1r95CD5HggrpkazwRK
# vPxGva+jEJjdmKCVnIMZ9K65GZHtWopRpGUwhmsY/sgdb1zkmU8JXbn9aI1Ft967
# rl/igIjhcZffeinFbGLeL9BXzd2l96GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBjb0sWRNQdHZM3zNi3F4+u65ZhM6U6UEMQ/aNSJEvWfQIGagxE138K
# GBMyMDI2MDUyMjE1MTgxNi42MDJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTgxNlowLwYJKoZI
# hvcNAQkEMSIEINjosyfXVQttDY4FaTPWAhIpT2nD4MJDlUUMQvYaUxpsMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBLPJ3QpATJbxgqnSdtrDteJCep8aw9Klkt9EMPtKBXpKVH
# BQJzyBQTAmtA7Lj4dVAvHr0jjATdOt5Q40jVwcB3E1eRAaULa2fXdnORK09nWLCt
# KXO6wyyZo63bHHWhiPI1gtLtsLlBBlPAvq+HNzTxz7kwaAKzpOfdM0OUiA9m9MDs
# B6N48lbPXdqEE5hQZYop+/BZ37rX6IPGyaITUbFLNGUCarRQ88kHJTWrVdaSW+1g
# Ch1axiUgDz6HSrZGCaxBA963sd7FcSg2i3bQTuii5Fnw/3Cc2VCDFXZxp+csfn4m
# U99Mxf4cauxsquyWU6t64RN9MMHZJlLApJhqqZvpisIJqFPiDGgWZ34g8zM0brgj
# 078ado0eq8T0QZs/Ld9ivh9FfGfsoQvm3X9kGaGAAE9SQzRPCoz5YndTBdDs5zS8
# AKq3n6RQ+KgcQXjWp4rURKpzj1gMk3anQoFKbBwZRXlcjJ4MhdCcPDYT3XsOQtJm
# ZhxPFN9xvjClhVhtvYPjvsPdz7MXNlk68GbkdkXv+frk120p9QGAejoQtM4QI6zd
# DVwTQEDFOnnX3tcTY5B5FD4BG4nIgMRO5iJMwCIhxS55plgnp8392en20tVQiK/4
# AmjmlBB4QZ3bhL80LS+jvEtjhfr0leGNzkH5U7l9CCBrSdkDKQ/0bi1Wp5aBzg==
