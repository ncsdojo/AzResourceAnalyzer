# CIS 8.37 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.37";Title="Backup items in healthy state";Severity="High";Automated=$true;Check={param($D)
    $items=$D.BackupItems;if($null -eq $items -or @($items).Count -eq 0){return @()}
    $bad=@($items|Where-Object{$_.PSObject.Properties['lastBackupStatus'] -and $_.lastBackupStatus -ne 'Completed' -and $_.lastBackupStatus -ne 'Healthy'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.itemName): $($_.lastBackupStatus)"});Description="$($bad.Count) backup item(s) with unhealthy last backup status."})}
    return @()}}

# SIG # Begin signature block
# MII9FgYJKoZIhvcNAQcCoII9BzCCPQMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBhw7SWzX9L1dKZ
# QJ9HMb2i9XhjY0kibWHJIccDOAbQCKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIOfQN2aqCTG//a/ovbJAym+JIZSpFu5cVV+rF1JL
# ZxnZMA0GCSqGSIb3DQEBAQUABIIBgA1q/XprW4zMFQprYHTTq2P1Trlxnp2NtfbA
# LTDx6uDLumtlk8U5Fb5HF6Bu0yFEKCROO8eWCRWaYaQJZg6ixlFdNPnuze1n01ts
# tE6RCTgMefwMAg+i/RN4xirXBCVYjf/T115aRuX/e3ruHnSbVxEQDFXURqZbOVZu
# EabZiUsxo1d/h0harIpxlzZowjIDoONKBoYCUcaF2iVTxg4SMLMYZKpmLLFSTH9D
# FPkIZEgJ9NQ2mR0ko3w/71/e88Ck0vnJTOdqcZHlc54zjY704Z8XiLksKAKlQD5N
# dX/JX5YknTKZDGQcT3C1ZrKZUnnP2iacxyvMyGGR7TkDD0sgqj49BidqJt3fQp1a
# kbRwawsPFc9/tkIyrJeFLuYHa9Q6J5E0hTGrrhw2AQSyWw7Ee/ZbrZ/zELfPQ5I9
# zghs+dVrGVOf8VPvmUV6gCu2Brf3mlBKE80LQkua4TSVjdBzzvGjpm42/jg6TXYh
# mS/kOHZ3mWetBhJ9D9Cy6g+WCEr+bqGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCDtBQ2rTvi0f5V9Q4BEDJaplHShWc91C5cVMxdWuuam8gIGaeiBPvxB
# GBIyMDI2MDUyMzAyMjkwMi40NVowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDIyOTAyWjAvBgkqhkiG
# 9w0BCQQxIgQgz90VmHX14nbfTMtV3KxCqZwB7j9tKyoTagrn6SlGYQgwgbkGCyqG
...
# DQEBAQUABIICAH9xy8nzf+DUnybFh7u03lMyiM6/y0aSCpHgUkBbuI5n19stujmy
# /6tFUaDbY4z1IXfTmZd3F99yPq7A01oufJcFFVM9vnMxDEYmEsgbjM0nR4tJFtFn
# v6JzgSo/aL5YAUDKKY5cYvjmB24rcr5b5FU29NYNYdxDVo6SpOIwB4jWKf2Etj1+
# 06TvL3PgYbGkmyds4EATfgqC7x0pT4Z1WxKn+fJxV5L8/aOhGPdot89Qf603vQyV
# m94O1proBW2woExDlwphm0KpIeI20DPc2x0RD/jjotpvK6gicFD0EvJEcbOxkqFs
# m60EtTy087vFtCmNC8Oe6/zwwfCK8g2DkDa+XfL24A9et7F9IubAqVt3aCM0XtUT
# L2D0A280Vdf4d8Q4puNbOZvuMvmZwz3Yd4U1wkMsb+7P86Mj4KSWOs7od91RsQBj
# Wpu7XVVn7WSCoJda6spGmBli/DdzxL/2bGeRRErRwr80juSBixZYkr8TGYYInuX7
# Nf4H3N/ubnyqVLQ3g6AX99sb5ZKnyVngFtKW6C4oCbpLttNck/2gFiFaopvsm5/X
# X7nPbJQS7zmbozUuUwRQlCP0hfJm2skRyQdWtukCbOHvNkQvFi1GGiJ9lJdKkTES
# BQVeuYiBdUxVrxDQwnX0N/oqoM7WqG4Nok8hfyCfp+0ETSvlXWSL4VQf
