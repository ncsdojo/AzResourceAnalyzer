# CIS 8.33 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.33";Title="Data Factory managed VNet enabled";Severity="Medium";Automated=$true;Check={param($D)
    $df=$D.DataFactories;if($null -eq $df -or @($df).Count -eq 0){return @()}
    $bad=@($df|Where-Object{-not $_.PSObject.Properties['managedVirtualNetwork'] -or -not $_.managedVirtualNetwork})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.factoryName});Description="$($bad.Count) Data Factor(ies) without managed VNet."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDLQnaNSmKhzrlY
# k6Mg4WRwesP6w4VGrXEPJ3ePDdCFy6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIE8ezdUd6wgW9YNgtnVPcDxCLGxqU8DLHPbdKmEP
# KbBDMA0GCSqGSIb3DQEBAQUABIIBgF2kP/GBl49X7gZ9aKpHLep8mJ2wOoXnWYyQ
# zcA3b5y8MJdiZbQlQycfrvT+FdzYi2dHTf8VqHZf/RrwhtSSoSljwr42urxToIWa
# IZyawWqQKxqWgTyyw6A12f4uhoVTY4kpzHPvzfQs6CCtmaa7j9aRcLyoovcHMgKS
# 4qjgPmQH8BNAClgFtrEsRZ13/Ia4PAJrfAcYgyvoyPAPjVJ9RVDpYqKS8Vs0K0E8
# IWHL9kn2u3hatVHcg3wsp05gAyxjilbHkihA8+AE7J/F/FcCA4OBiTN7iCMWsH5E
# 3oLRItuYtT11e1UpA+PyBKMKYfqCyr82TWlSoZSVOj+oU28G8Rm9VhYvVcIPKUlE
# hSiaQZ+T7RT06nTOUDzIJbhsWrf6uAJRW57BEvUnr0kSEpmxz3LJaZaHpVWrIBsF
# PVqc10Fwa4uQUky2YyfpLBGaQleJLDXGlLhzLMR7LJKzxK6HvK5xtrWO+HtuKT4w
# MMCQ2FmFn2Y126CgxVLfnD7n+Kv0bKGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCAuTe9aJzHi+PnHF4tFs3ANPiy1rBfBAJC/dCqvXkQc9wIGaeiBPMoa
# GBMyMDI2MDUyMjE1MTEzNC44NDRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTEzNFowLwYJKoZI
# hvcNAQkEMSIEIFvmzzxV78eVSvD8Hdpui0AnRNTC7fPT2OCCYLM2gZAoMIG5Bgsq
...
# 9w0BAQEFAASCAgCkoTfGTgkk+XNaLzgrtdXmYmBIyyCk82SNTyGCeEBkFPebWl07
# pgU7hUBC/C1R72U4ihrEAF+CFrYUGthrp0hzy+877VFSiSP4qjoykL+9sfDatXR3
# gZJrDgDVcC8dIbdi8xyrZCel9egeNBNtFj8oS5pp4nm1j7aAcZcLydppmfVXksjG
# ENdqZAOh3fG01n6P11hx9glQVQ7hP5MXRQ+Axpbm+ySqgjkZRMrcBekcCKkiZJ93
# CLsPSwHDdLgVFsB9ak6zWxxWOhnk7jIIsuTzaPZiA4IiiK+6OTBfEJmWJJj1eQgq
# l+M78COg/Wx+jcTR/GjrTFiVgpHp83zOGG1oOuVlI7gzNoSQlrBQRbEwzVYWndOl
# l6O+VWli5EMHkkYL7YhRyKwC6+OLD8N1LZV7Ip/S3eMXrufIsmJU5GwGvkQdDTr0
# nL51J8abq7KbAAiptNtHkN2MjqhUIt5Jv5UPTurvV3Ejy5KR/dtghl7bUs2CLLyS
# f8NOR1rzgwWJPDk9bYTGr7uEL4ZouE/FDLgPw6ha7sCJYgYgueWzeJb3kIIJQkcy
# QDxHuq1vB3rbsJzLLD5v3fNIfaR+NmmdAQ61Ym5sv2oHjYg/fYtpuDlZ8Wt4kCbI
# WnrKVn41kLToCnzYq9VU/sbPxwp+s2fE1sGNBKO6EZr8H/XTMVJsoBCrTg==
