# CIS 8.1.14 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "8.1.14"
        Title       = "Alert severity notifications enabled"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
            param($D)
    $contacts = $D.SecurityContacts
        if ($null -eq $contacts) { return @() }
        if (@($contacts).Count -eq 0) {
            return @(@{ AffectedResources=@("No security contacts configured"); Description="No security contacts found. Alert severity notifications cannot be verified." })
        }
        $bad = @($contacts | Where-Object { $_.PSObject.Properties['alertNotifications'] -and $_.alertNotifications -ne 'On' })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { $_.subscriptionId } | Select-Object -First 50); Description="Alert severity notifications not enabled." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDRZ0eMmiqU8wpd
# 8rWjOvdh7mua8vhMXVnROVzjBTSG46CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIHZ9JjKWlcHBRhJtlmBctWpRaY+P/qdE7Y4kSfLC
# 2MdBMA0GCSqGSIb3DQEBAQUABIIBgEczYgd40BzQ1t03BaGtEupogksiwDbxNZa5
# g5zxN8mNVQL3ydgnWbH+tYdHyy7s2I8MmSh8gaTpQ8zKJv4j/+8tp7z71f0pWYNX
# PmAPl7cNDb9yncHAe9KiGB2S4W7AEWj40UqPgH/eD7o+gMKt8gvH6lRZVxv3bT1Y
# vnPHDzviVeb4fcXV4Vvf97fJQxuj8vurD2/wVqhtM8n5p6Z9ZGMs+5OGYUEEPfoh
# y2JTyLumgm6NSj+IKaKhEACYtOBiycTUrjLmd5SIIBQnGjPZc2fwXWGBlRsJRqs7
# Nkn14ngpYR6tKmI7qUSipyPpE+B/DOLmdFkBl41LSjC8cCHorMF+5Henj3VEmWCg
# B6tQrNZzpw9BUeE3A74ixC1JpEo+vRYqFzo34rlkRGyVwJy+qHrd7lmT4P0ENDt4
# 1Pe2KGljs0+QauFejnOwpzbLK2mXibll952zaaJfEyjEAPO/Hpw4s5k1QR5NAjYk
# ydhfDLzMEB50K+x8dL8mPx4BbsxWmaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCA/jy5jQxDZJ1q0iZbtSxWuV69AlN9M7NxilalAZxPN8QIGagxE2Z3h
# GBMyMDI2MDUyMzAyMTQwMS42ODNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMTQwMVowLwYJKoZI
# hvcNAQkEMSIEIIUxVcDjcGdN5ETAjpMnehAuWRNCHSiRG2YPRsMWg043MIG5Bgsq
...
# hkiG9w0BAQEFAASCAgA+nrWj4wFzzth5uRr9XZrKRwQ8nNCaS8yF64gsrh5jRRd3
# FPjALu2xQ/sWbVea6SEWYgm1TsRyJjPyc9JdNT53Du+iR14NCHj7VyVT4lue1Olv
# lcrdDPrNcmmDgP4JZBD4nnd+cBflvY0u7sjMNOPNmj0kJ892B8nfiuKS89pRfG6v
# hVua+r9FdFF134NbAOGAkpBSFvjrQK2PIQTrylhfx9IkRD2WPIg9hwX/8Lzhza6u
# QM44+HEC49SOIY0RSwcoY/f2wzs8HoME0B2c/xrnO/7DWHL/hWbHJGVEZCJBGnXl
# 7YLDOhpHRmMvdB643CMhOYJTq8Gy6ZXSV1YFsN2wcYAe0CvijjjkLl+u0cC9LMGh
# 6P2nIiR/b3bFBb1f157jdj8YAvnYLrlYy81B9GxLZ1Yvk4GsUDW1I6CC/64dMy2d
# ZG3wGkJUtqjjqmDcS0VAckdsmmh5VJMbS9rIKZmbcoomn2ZqaRMOU9Qk8PkRwAX6
# WhpN2tumKfLKTfSbwJl9snYz3QL2Maux95ey7aWrqvtWG/q/5EpQRukEWZoS0z9K
# An9zHHOgQ50ahDS9ml2Ih9jjN1ShZie4+Z2lNFPn29JdsDtJ+602vfMBmGpXTkzp
# J/Ey4yRZTtfabmf6x8uyho3NgvKbAoVspPwj7bbPzvSYIYzooc0J4ySmJLECbw==
