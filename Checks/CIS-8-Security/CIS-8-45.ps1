# CIS 8.45 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.45";Title="Backup policy monthly retention configured";Severity="Medium";Automated=$true;Check={param($D)
    $bp=$D.BackupPolicies;if($null -eq $bp -or @($bp).Count -eq 0){return @()}
    $bad=@($bp|Where-Object{-not $_.PSObject.Properties['retentionMonthlyCount'] -or -not $_.retentionMonthlyCount -or $_.retentionMonthlyCount -eq 0})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.vaultName)/$($_.policyName)"});Description="$($bad.Count) backup polic(ies) without monthly retention."})}
    return @()}}

# SIG # Begin signature block
# MII9FgYJKoZIhvcNAQcCoII9BzCCPQMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDsjnC6QOY9faHx
# rHYQ2u+M36ttzg6M5gtCgF27lAwN6KCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEICTvzUn+X0JE4gLrjYSStgOD9hqfhSFeDP0Pp80M
# qsa7MA0GCSqGSIb3DQEBAQUABIIBgDBVuHk3lDH5F9Uc1QajdLaeI88bAjfjMlYt
# gytg+BAvmTKd+/LBVYNx8R4UGTUgETkn7uxKXgXEz5yORLrP/d12qJh63KvZ/RFA
# p2RF/fFPX6dSPpcPsOaKUFcr6IEp6fnrD0uUyaNEFuPv+AuOJU3kvi4a2GWTNYON
# P+89K3n4ARLIc5pqKW3QPKpzXcJToZ18xAI9TGC6MJD687iNaQwUU33An0lbb2km
# tcwkXDw/aICVa5+3stuTgrG6umrlY5B8ZRqLDqGzISW0e5Ju4SH/cTqITLK7FVja
# Hbwxfr9p1S3DM6Ybg8fefrxZJvqVHUOENqUhPZgTM7NZzZWuB1Cj+KmZkIzLM5Yh
# YOTlZeLJCYHMAYtYvI3UPZYQxypLQLEF3PdejvnDJI+3abR7DI2I2uwNEUVxJ3hF
# lSqnQ0p/KEvkwUyHJtcBDYbgLYdczXSedFIvafmjfn6cbDHYH+Bfjf1i1AyWGz9M
# yBdybEpyu89u8m42NZCrEm3E24+ht6GCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCDdKhou3kGignmJruUIkgwwKj/14v0n32z8MY+DzGaj9AIGaeiBPv8W
# GBIyMDI2MDUyMzAyMzE0NC4zOVowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDIzMTQ0WjAvBgkqhkiG
# 9w0BCQQxIgQgZv2gPghsNvekm/ACirpqSChjnaFbck10PSBDK0wFN8wwgbkGCyqG
...
# DQEBAQUABIICAHDqb1R27G1uW/5DBs4X0N/ja+4SnW7wt9WLi+FIhi5O/w866/tw
# rmqWKr62D4FOG7UvMgsrfkOhFKonRn9UirNJfQ4LHEo8H+Jb9JBfSw6IDd11kIPy
# z5Ge2TRJ+YELYYBU6hVOoG3GE9nnvlirT1Hf+c5fQXbFEtyfDJxiog6zoAiBObM+
# DxVM/DRZ/nZAMi5A2P1Y79IIj4fOHHAI3F7anEPenfkRQL3T9hwR8vFiSniQ3d9V
# TNjJxjljabMoW6E5SM/Mv/TfYIRtHY0XKLk5zY0oXaPVNJ3HGvnArmj5uq19PMyb
# yj72QQEkS0R6wKhNQL8YFtY9lolG1TQ5lsZeEZl3zqrwhjrZYm7iyRWvW/zHFfyQ
# C6Eaik/voB1SetJEZorpYt61PMf49o8noJsyl0UD2mDEKodn6bZ/QaF9Ei0pWD4j
# GZFltPuROb7SM7ckduM+df6ONqk3mPjz3FQVq0Tol+2+884VHFQWLj7yZtjRruG6
# 8Gz7MbNq8i/YsKYiEXQTL5IuHps4pfjAda2QE+GXvW3Ae3yAxhKfjXRbiJlldgZ6
# N0EOFvQU6Pbk6voG5LidWiQz+Pkpw7r4G//gHP36Ii2dvZPYy3k8Azb3mMtuiNLg
# aUV25L6E9wHWx/LZHhaBISocavgFWk6paP03la2NMysGsyQKsxtNX6WJ
