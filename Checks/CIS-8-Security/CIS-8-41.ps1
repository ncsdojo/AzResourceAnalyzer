# CIS 8.41 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.41";Title="SQL Firewall no 0.0.0.0 allow-all rule";Severity="Critical";Automated=$true;Check={param($D)
    $fw=$D.SQLFirewallRules;if($null -eq $fw -or @($fw).Count -eq 0){return @()}
    $bad=@($fw|Where-Object{$_.PSObject.Properties['startIpAddr'] -and $_.startIpAddr -eq '0.0.0.0' -and $_.PSObject.Properties['endIpAddr'] -and ($_.endIpAddr -eq '0.0.0.0' -or $_.endIpAddr -eq '255.255.255.255')})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName): $($_.ruleName) ($($_.startIpAddr)-$($_.endIpAddr))"});Description="$($bad.Count) SQL firewall rule(s) allow all Azure services or all IPs."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCKiH3yKuhkRMgS
# GLVe1Sly4DcGtILYyF8xgvVNYAT8eaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIIZbaE393NEaGp1Ybi6StAv+3uVhmNITgfbkJw9x
# mMjoMA0GCSqGSIb3DQEBAQUABIIBgIn6i+F+6wtb5/ErLC6H7gOkRaUDOUViNjMn
# hnXMLikiujBTUMRAbL5SvTp5FMiZO++mIoOHZ0uTR1YsBUG+FGrIcw/4QsKt3RQu
# uYUVqyoUMyLgNRrAL3601okQM/FxjV5POKVLA2qjc15UkXBHMhotDN08IT+OCGvL
# 0NhFxRAEDhGmNqs4/3z1gWjVJZrYqBxSum0am/Nq0XtEOKZBH9dPZlqo8r4wiVN4
# SGP4IV/AU8OxoQVnxDvxvmc/XOdNTEvE40YUTJ1yyX5tuo9Xi8iWfDJa1XtMLghr
# osbBHfhFlndNsMrpRcmYgvs4nM5BI3rGT7+7IIelowwfVPscGsgTxjkmeZs2lk3h
# 6Ycak84EjhE5suyXsw7uxs2L6bo0Ezy5IPD7kLw7i4/RbGXvSYOtFkS9poWs3OQi
# fCUzYybgOS6NA/PRiEGATjvAI1UoyQhcNORqFfJe4+1RiyMScyCZ3h6K6qVLR7cJ
# MQgJ9jxVjVXntHlzozoUcs6aThRpxqGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCDvuuE+mc8Wgl6jiTvtlizzCCJBUHxicG613gWnhoFGJwIGaeiBPM0W
# GBMyMDI2MDUyMjE1MTM0OS45MzRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTM0OVowLwYJKoZI
# hvcNAQkEMSIEINsE5DphKfOAed5fUs8rvdxdIQIVWjDyb1RDpdzaaHd4MIG5Bgsq
...
# 9w0BAQEFAASCAgAoPVDUYRWfhp+UHYAamyPacVh2h3Q2ZCy7uvPjGIGFySpYLufG
# Q4UEwOYZuEb3pkSI1KsahrxP9dd1JRLvX52y2yFpmJxM6cYa/+1H3VB5tX1fDUIg
# 6XheHK5JXm8l1KdCT2aKFYDQ0DxJVN1OsxGYnMgNc5SBmHgsNi6IkNVMHN9aBjzq
# 4K3PMbtGa4DtmjYEDuw3S+J7apRBrElmgm6TqDFMmoRODdLo6V4oLAK+kiJztOTg
# sdx8HV3F2rYExExc2ETAP7qCnaQc5PTW3SC3V4mcUceXCZWI6dLIdwgoLxvpm0Yc
# RoIp1l+InY23jRtlPTJw9FakFBtJU3HhBFUauZBQeq7jhIs6rgPQ4tAHftp/ziHh
# lTjN9iniN2tIj0/Goecnv6BEckC8yjH/wri5Fvk5bN5XoJPjir5mWc7Yg57wtI/1
# bOs6swWsYWEGMH7inzYqhho9cPn/VrRECbJ/75JqAEEz3OfMjmooUvu5U3BgPu89
# tbLjHjya9RQ/CM566wvdrDhAdNte8ACSVH8Uj8piaSW0kqAamRfpZ1eytPm/BEKv
# xI7j8q7p8pdNLXCaCXqP4KfBSU6cfEUK/TTDqqvzGltS+w872mspOsuh/G6aV8S9
# t6bzwzkAEDI+JX0kEcUD4KpkeNMXVJDIYBwugVPYpspH6knbFy74a6fNJQ==
