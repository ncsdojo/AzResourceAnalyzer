# CIS 8.18 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.18";Title="SQL Server private endpoints configured";Severity="Medium";Automated=$true;Check={param($D)
    $sql=$D.SQLServers;if($null -eq $sql -or @($sql).Count -eq 0){return @()}
    $bad=@($sql|Where-Object{-not $_.PSObject.Properties['privateEndpoints'] -or -not $_.privateEndpoints -or $_.privateEndpoints -eq '[]'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.serverName});Description="$($bad.Count) SQL Server(s) without private endpoints."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDcwITOVfrQ2FKP
# jBf+0W0t1avnKPnhyeWfIW31Zbk+BaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIK3xIkkOjp4A2cPsQvaxEWqhkqOv8wfb6leoDjsS
# HKMqMA0GCSqGSIb3DQEBAQUABIIBgDVtu9Nrd8muXZJnbTBH3wFPALB86hiD+Mgz
# MJ7acdYEFvBJC5c3BJlMPsL7naU9c2zHO+Py4yX9uWUtyCSf7Lc46yj3Z0GLV74o
# YoqpKf6No82MkGFVtmQma32U8IVqbMBu0WNb4a6Q6gmk1f5iG9T9avdWkOnDHzX8
# cQmtG2FqG2Up+y4W6kndFGDaulAI+hEs7IbttG3HOyufO5l37F4leVGlnN4mbxfg
# vlATVLHeZimaxecDh7S5CwfhtlGH+5giuS0yxcNkhXrMEIc9iJYmubCv1ZzHd+OV
# Dyl5267leh7YTvkWHE6zXrr3/9UTHv4i48+bKFWISmVvXUal4VTGBTSCx7ixCTcH
# KyLczAgFzGyx/Uf74pfNSLMPIj7nq/XRz6zEqByz9x2X5ng6a+cCrTAN/7pP8QJg
# y2BzDRQm5olIzHNCl/QF8VPn+GHgs3zVAlNaoKaLVeK78ItIRcKpb+24kQQApgtC
# IxcMp8CSVDN6yOKpSvL8za2Z7AURRaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBlrheWapu3xL+HORJ989NhPcldbvi+/YG0kH0f4jXeIQIGagxE12xs
# GBMyMDI2MDUyMjE1MDUwNy4xNDdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MDUwN1owLwYJKoZI
# hvcNAQkEMSIEIGTnA8wLXz/s73GMeqJlJN6/EglHOaudmRST2eld5HFKMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCpcOO0LJcWOZmesz/PHLRX6IplIiATzRau64hKqHw+7zdr
# aKJ5WrjfKQO8CvL9DYQm9XQu1nUa7U98OW4qtGfAZ+83xVpMvK83NmkCEObd0FCy
# ++NnSHlmJZjxTQEDT12sH2SCz3PAgKBBUXkNyNhpEb/S39s2S1cyyVDNAswk7fec
# tIMXhvUIcCzs+7wVUqhgzgjdNjqRfDgJH2BUtQtKyAjcGFPwkU7FK/Xe8j1Zuu79
# AjcxFBt9hJJqJw/snGTzKflu8aE1gewsK0ghiHv3Qs7WRTDzI/3AHI4EVqx2WcKu
# Rnk2HIaOvIzUsRiu9wm+UCJfx+PL90wamfRlyvevZuNfWM0IMxYNHovtqBKUaKOw
# l1Z6Sj8M9lMd/PCE329k42RcjuwQwa78V+eUsJ4RHn6TU1aeuLYvpQSnmVjC1Tat
# s7lOWlTHUHKKEpYn1qsdmBEWvSTI1PIVTT5lLhGA2k/8rlzs9qqh+j+bXFSWVOsk
# ooaWBNqRiLdp7WM/dURDPRHKCDKJ8KB1Xdnk6tvSPi+PboiQNoZRyrjyl+be8Wvg
# /psjUp5VHi8ZxPw7DzJM9kD07sAj4Pth2/pQA99Bd35PVdGCD0g787kgXVBDWUGs
# VHLIF831a3dpZg4MzJcCWtgSDyiJP8e2anzG36a/bI8bcWAUxQFbm0aOBrfk/A==
