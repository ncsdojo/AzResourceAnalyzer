# CIS 8.55 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.55";Title="PostgreSQL connection_throttle enabled";Severity="Medium";Automated=$true;Check={param($D)
    $cfg=$D.PostgreSQLConfigs;if($null -eq $cfg -or @($cfg).Count -eq 0){return @()}
    $bad=@($cfg|Where-Object{$_.configName -eq 'connection_throttle.enable' -and $_.configValue -ne 'on'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName): $($_.configValue)"});Description="$($bad.Count) PostgreSQL server(s) without connection throttling."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAcBJhEJro57MA3
# c36dafL0L9JuWIb7FTreSaqOOa+b4qCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIDROwr7YgPUKv8EGhgQxzykwjuqi7nznCAyS8OK3
# Nq2fMA0GCSqGSIb3DQEBAQUABIIBgGqAaK/Oxmid28IEbQ7DvY0ufpz6yMR774ez
# oCBpno9yd+KPIP83xtVe3M2tPHu1ffX7JS+BjYrpidRVgQv1L2vBqQ0KQrLqAxIb
# o1kcBOOjR8Ybte1S/RiB/C83HBOTgnWsTQaY6VBP4iCtJA2hKpfILgsK5zSEdBsy
# Dr/Al9AoV8SAoDFbr0I+fbMrtZj4kCBuRoBX8eic1WBqAT9lhdoSbOmSlXxv1Tlp
# kftqoSjJaGaiGVh5bzkZVI/WgbjInnZ/3pzY9HJrIu+jGJeM3hNUfatqpw2tRmmm
# a90YGKbUCSsYUMi/h4SfahjkduziUaYvlZnKFleoqDLMyuKVpYHLqzsC+wi8HNJx
# TNfNl+0MGOn6J9suNHexUuYpR2QXZd7epWXzq4czAei27F05XHNMRbrxJgOAS7C5
# a/cEssmUWpYw92BlnG3ZjP1xX+YS0QuKbloTTuhXfaenWjVrPSbQ5xuXGCDGT6RL
# TAmX57XSMEpnDvgh4CL71CHq0F+2iaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAmiUU+vGf8nxquD0E5fVYf/e85NxG8Rz2EnSlljOxtpAIGagxE2aij
# GBMyMDI2MDUyMzAyMzQ1OC42MDRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMzQ1OFowLwYJKoZI
# hvcNAQkEMSIEIIvs8ksSTypRC1Ay5QoSuOOBtdaCzoc4DsruGDrSjt+oMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBv4JlP5/xV79WGrDKnSFnbkjwO2pM5uXKd1jXBHM6551hq
# fJAKoWlNq4T122A5uFh4pAVh752O3i+Fwbh5gueotqE/qyLxxpuSlrFhoqKihEv3
# oPmvNTTjLYzXhLJPIY7OwQ9Bv6YzCrbc3/7Kh34dAJVwnLLVwVpQcsIkWn/IaWXm
# 9Gmz/OH27zhXGPb3Yz6HVytwOgS6hG/92FZZEuHOn4nyjkFlcZcKizBZhAvDxAff
# ZTuOvrIXgzRDfiXGG2c0I44iAjDe+HweARy5F8WaNu31YZiC2p6kD8EnFXDEn7Vw
# IFPBSOAWc78RVulQOba9vLgJeC5xnqFro+hgPzgXmNyZznh8Vc7s5Izo9uIQAvZO
# QZF4GtW8VF+I/LqmZpZ1TuGTvI17KbRMzw2p3eniAcW4+3oKU4SYtbEGDVLNmcSA
# emFL6xnMClYd+Hr5tBMPJK+HcPuHlu43O1HadTt7kh2LbHKgx5S0GTGjgCPzk4eR
# 2oogGDd7XENaFpME1L0masPQx7FBqMqhPyOUwQ4JRKTk7aCdvE51HhPT8gj6hWIk
# BIZVjGne5zc3AwpBPe0ed8AYniZYuPfz0RsSoZNkD5FiSmchaPULBTfvkst97aWd
# nq1AQZcWBPc1mff/XsBBkEjwMDIXXOcLCuY2R6vqngCp3bT+HxcFZSIhkw1EKg==
