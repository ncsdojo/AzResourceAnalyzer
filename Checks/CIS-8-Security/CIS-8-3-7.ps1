# CIS 8.3.7 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "8.3.7"
        Title       = "Key Vault public network disabled"
        Severity    = "High"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $kvs = $D.KeyVaults
        if (-not $kvs) { return @() }
        $bad = @($kvs | Where-Object { $_.PSObject.Properties['publicNetworkAccess'] -and $_.publicNetworkAccess -ne 'Disabled' })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { $_.vaultName }); Description="$($bad.Count) Key Vault(s) with public network access." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDFb/84vT1kFJIF
# FMNhAIS/IazPiOrA1orTEYNp8GEWMaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIMzqfq9BgkT7ya0o2YuB6Zy2t8ACdZw1xwsMyex2
# H+hUMA0GCSqGSIb3DQEBAQUABIIBgJOr5LQmSVRk0oO8pEibzbSBoVZYypcrU7LJ
# yyClo6o6PwdJn0kvLbfWbq7fNzhokBlTFDKzTVzxabaqcvhTjdnKHJu7Jc815ZRh
# gRM5i9k/JIebYAxaz5TFRNC1F8981qZwfretDoELan7BpSyQ+teBd+Ix9Iccv+/o
# FiCfalAqT6R9N5YZD5YZuYM3bBu/I+g0h2VpPl3L/8bFGAaqb5hf5qApwtJtctWb
# W006dyorq7e+7QccAsL3CgSztzLiHQpfZxDEBrCwxOv5KMdjUIsUkAA31U3phHFl
# 0xGyrMxCTTUvjhMN8cykPUKcrvzU+t1zjDtV1jTgTi4m9HJ2LkaGZ3OZDftJs5Nf
# LOquEVE83YcXnH665DWQcxyYeI/SROqKm8CRbHmCcI6EkPpTN1rell3wHgkFrBnk
# 7GRruX+m5UX8QbayUaAyrz1hwLQ/RHANmQswoucFduoaswZvikqjJgSgQ9KbotQ/
# dbUzunFL0OGIrXTNpgTSOeekSA1igqGCGBIwghgOBgorBgEEAYI3AwMBMYIX/jCC
...
# AwQCAQUABCCgrnwKT80dyCNxYPRGkWlYVLK2c6AflRMxsi/4j1B/uAIGagxE13XM
# GBEyMDI2MDUyMjE1MTAxMS42WjAEgAIB9KCB4aSB3jCB2zELMAkGA1UEBhMCVVMx
...
# SIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNjA1MjIxNTEwMTFaMC8GCSqGSIb3
# DQEJBDEiBCAQjIH1PQpnkUkPdvb6ONhCvySBg1UQNgbmrHokNt5DwDCBuQYLKoZI
...
# hvcNAQEBBQAEggIAor8aM7upVaE/VCWvLaZtBedDJ7EC65b0aHqhs5pJh6wqt819
# 93tyjZlwdzk9Wm0njLzMA4IFSz5vKowxcdt9UiBRmBs/Dom5pEyRToQXxZZWlPbt
# 8+1zOCFmN0/fi2ho4pA4fXyNWSyGPVMq6I5SwoszEGy9lb78/EywxbfO19ypNkz+
# 6RC8ed+xeorsttVEQkWSJyy1BI8O8oLXEHXxOPDx0CvSac5NDi9VwjQm4WfViPYc
# e/dyBpIHggsWh3E+niaXGvWf2D5Rr+H2WtqzxrRpyk79HsKnokFwQJXUkcqY4GO4
# 8QIjDqMYAaDgFggqSKM4nFhGBc+1ExI4YqOYcgouq44kjyiJ9YkvQFHVQvBsQKXO
# D9Qc9Nk6wPI/wq9EvXqufDP/uGyCnkP8sJNLn3ge3gr3NPx2k8FKf9poYhlwrQx8
# KEVtmd39Yw3vmaevSfo/5+Sk/439EfK5vI4ihUahIKQ8PiZl8iHkCmgvNJyA0CL7
# 6NHd+c+KG6eYceKuuRou2fIdRN0ypcfRdGsG1ycPTvq7C2WvGG33IP4gPH9y0YRZ
# tp4akvveJqqbMF260Hw+iSO9607M0PA7OIVsGDdPeALhSLUASioiQ0NDl8Q6TWgM
# oaPe2u9V993Vxkmexp9f9x0EBeNmbr2uGsaaAhIeQpaNW+qG8hI3POq6l2U=
