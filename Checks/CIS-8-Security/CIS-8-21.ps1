# CIS 8.21 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.21";Title="Cosmos DB automatic failover enabled";Severity="Medium";Automated=$true;Check={param($D)
    $cdb=$D.CosmosDBAccounts;if($null -eq $cdb -or @($cdb).Count -eq 0){return @()}
    $bad=@($cdb|Where-Object{$_.PSObject.Properties['autoFailover'] -and -not $_.autoFailover})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.accountName});Description="$($bad.Count) Cosmos DB account(s) without automatic failover."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD9KpFkE1ZLebP8
# elvwqtxTsFcdweb3H9owFdJBvnybHKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEILnYuqRGXV5anofOInrGZ7AfAUcEcS3V9l5syfPd
# orVQMA0GCSqGSIb3DQEBAQUABIIBgFHZUDPztSOW8MVAaSZObNFKzGCjMgV75AGU
# bWZyjrqxTVUCig+0yqv82B4RXkKxHCfY8qKMH+lQB6hwdhCZETm4OQFoamFpLu83
# BNMExVr4goDerEHMJ69eYmHqP3GFTbdwrn5m4jYUdcLg5zTfKq1pFRI/1k/ET6vc
# qyL2HHyWdL+EdEXUytF4yKQwff3OJbSCqKPUHVFH0nLt4hr9y61baCS9wmnV5/SO
# BgFquFbmEp7Th+YAJP19MdZLM2T9DXMPCD6yKnj7W2Bt4gyZ0yX3APRH7eD8QaP1
# hu05NbEevQQRaQSEUuJPGc651NB1zFCG72RDKXbE5H3RLMnSoDFzNYMysBL2oQGW
# 6DY13bpVvcy5jH8eIYSZ9zMUZXt3Ycvxx3eGYv9w5rPx0IuWGQBNdXRPmswJ7I69
# eYembsneD/9nAnr8ZRCD2ApKFG8nIybvWwgOUSN/KZaUgGtR4Ut3gz6u/2ndbSj2
# N6gHeynSjTvyOI5V+cMRyy5CF36OWaGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCB1or5h4cWfC+9q96rgZ53Yr5CdGVC7/AfQRs5zjgXjIQIGaeiBPMIj
# GBMyMDI2MDUyMjE1MDYxMS4zMTVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MDYxMVowLwYJKoZI
# hvcNAQkEMSIEIHhO6Gjbs7RCTQvETL7dSq02xh/83zdRR+GIljHKXlVzMIG5Bgsq
...
# 9w0BAQEFAASCAgADs/MsIjCpx6qI23Kbzn8R8ongKSHWKHJdqSaHHQ7yxXyUSxwW
# RS31E8qM/wZDoC/PG7L4319iP7a4c8b7wHR1DzyIu3nyu/KY2r4azR9qRpNNb1mM
# M9JShPWB+cFMVP4d+BZw2V6AIjlrSxY21YNhfVLnYkFmn8FPsMxcGMdZpp7Wheqi
# LZjZ3ufGh+TzaG2ZrEhiRZKtVkUrkJegMXOREjVRB6nde/VsrcKcV8IgIfcVeCN6
# x7dbGqwiwyTDdOt6qiaDVp5bi6yehNYka6clsYzRHtM5nabcYgGOsZJC4CwZN3Mc
# E93P92WryG6l7sl1bJKht1Ao+TPfoKkj1mIt+TQ9mo89+V6uqKwqaqC8GiV1BSie
# NVQ7jNrEwRLYEGzTWkYssjbjLEW0ya0/TALhIYX18UcoBoPuEHoIHVXWo9JTUTAQ
# 1SLX4Hn3+I2gRM2rQsi9+tQh0LqRa4cLVDoa+QHp+I09h6mmXJ6GwaaiyGYP6t0v
# 8SRcWiFx2kI/DiK9zmQlx1nn6Prt/h3O7JZ5xZhN4HYFreVLlwlZI068HzQ2LvpZ
# pFmFqUCnNBYbBkSUMEsfc6Y6A1vuVvQAZiwnKmvHCncRCzpc7jGvQJz5FS1sZtem
# NUa8pv9s2VrsbsnsaecY1cVWAt0wAtvgDZaRJEolleDBWA0D1QxOlA6tVw==
