# CIS 8.23 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.23";Title="PostgreSQL geo-redundant backup enabled";Severity="Medium";Automated=$true;Check={param($D)
    $pg=$D.PostgreSQLServers;if($null -eq $pg -or @($pg).Count -eq 0){return @()}
    $bad=@($pg|Where-Object{$_.PSObject.Properties['geoRedundantBackup'] -and $_.geoRedundantBackup -ne 'Enabled'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.serverName});Description="$($bad.Count) PostgreSQL server(s) without geo-redundant backup."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCvDEd+5KggS9Qq
# fjPU8dAXz7uT7svXdImEHH/6ro6+XaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIMAAZ4KvW66BntBmCSpTZgzLfftj26UW+xKOKY5m
# mt/hMA0GCSqGSIb3DQEBAQUABIIBgEZK5rHjSWToiLI0YFtmAvU/pErMDLxNfjhX
# Rf4++44V69hHkHdF6/xn2Ktg/Z+MpikWi3uX+Oi6ZZpXNpd9qPG1hvmY1n8AN/qe
# VWkWBHF5e+p/vdp72eiUBez1Cb0LUjJ4TEc5yfFxSfdoEDoEs4URXxbxzIv7tjAO
# M3qqyMBPr3fDJ1wcUTaOet+27/A7TZArGysVPPCvS0LFRNbYVIjiS0Yq8JaNXq55
# 0Z3CPhEHhNfmU9SuWR8/2/5Y+ThfjYd+tm1P8Ig5TUx+dpLZolUhszB90H5Yx9J/
# dT8ns5pr9kJYaaEj9LYV4oF/mFGDT6DCO4ajTaLNV4GXCL9vNzTdKyLfP6DKez62
# /AyT5PEUKSvgHnPn+JDWf7s6g1p99gD7ViW+azOCWn4H1V9XWQgrv6QKI0WPj4TG
# aa1nI8NdAfoOD4peAYAYjG+79O2atAtd6n1dExc3w4Ji5D6NOp35DokgyGGV0AOp
# g0IcKILYycFuor3NqRJD0TdCAkDYdqGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCACi3KB9m3Y1CEfSIIzReNzjsgCbS7MX0aiqd/AIjy3awIGaeiBPMKx
# GBMyMDI2MDUyMjE1MDY0MC45NDVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MDY0MFowLwYJKoZI
# hvcNAQkEMSIEIAoJBzxdbDzIwjhpK2tDtW2JdmpvlasOtf0cK+LWB4vyMIG5Bgsq
...
# 9w0BAQEFAASCAgBt4DOZ5BM5/ORSfZjAd2iXEaO70kSza3LYd78MO8N4z7Mszz9B
# P3J1WfDHjLN6GgQnsCHOZsPtsWG0a5Mnoef6V1ymn7sK91+h8yt3x0Wg/bd1EDRa
# hr/cNGRc6jYs+M/oQvgUGk0cyK6v1MfJwNWaXL8DdnEMS8LxNrl1LQx/kngQKyqf
# Q5UZVGm6ht/OtWCB8LTUm7rrSzhOC/3ijueaODEaS2CcGEDq+zk4fTG2tLHUXYgl
# X2+EHugFXHp1m6CzPSvjJidjCXAuoPBoXpAIkIBVxOCnY+N1tOh876uSibHjbXhu
# kdq0AYxhYVlURhSzbpxMEE3NQkjE29NJyAe4l7BA7UIrLcLpWJRkI98hrCW7nziy
# Xh44ycXIJutRSwL+dgcprMqlYbbpB2DXXRKc0JoNUdc/59ligS7b3eG5Z/5m7yBO
# VRxFXo+6nmRe2d2wb6Z8KuEoN6uggRNT+hhabR4OmNUFLbHXi1e60Zqujm82XfV6
# i3hcL+exBIqdJIuLQJdd3EvDq0CCQaZ3RJjKBqLsBXqbCgyZlaayRulVSY8RFYtA
# IT8/1POwLhsHNNr3Q+hjUOo14DgYTNhvjld7Y/AspUra34g984shH6fePJ/YdIE4
# GkXOcoj5cFnB9TeTj6zBevRSytXEM+4JiS1N/5aKiYlmAWaueXB7bC+JYg==
