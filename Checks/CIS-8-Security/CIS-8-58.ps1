# CIS 8.58 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.58";Title="MySQL audit_log_enabled";Severity="Medium";Automated=$true;Check={param($D)
    $cfg=$D.MySQLConfigs;if($null -eq $cfg -or @($cfg).Count -eq 0){return @()}
    $bad=@($cfg|Where-Object{$_.configName -eq 'audit_log_enabled' -and $_.configValue -ne 'ON'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName): $($_.configValue)"});Description="$($bad.Count) MySQL server(s) without audit logging enabled."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCbZ9q034ioFdDa
# GLWgBkXYQIE2UEl5WOVUHJTPV4fTaaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIFcYqzw7iT2o4kRue1536/5cUVU8oFRNBy29HSnX
# P1oLMA0GCSqGSIb3DQEBAQUABIIBgGcoxOaYUvygf3anU0fD6ktwd7NYeA9O0xxn
# Keff+yqVgXZ5RfbhDBaS/cfugB2z5/IxJb9xvQ6AKBgsV0v3w3b4ncgujJYYgTyh
# l3uwIyinMDGDcOwNridgNfE1+kjbuDw9FLLz13fMp9mmi4W1lXQpLvso6h1yj5u4
# 162aoxg4tZURkjcmZbtIsV52C3ZOYqbIfuon9FanP714mrhynbJH33dkHWCgiFDC
# zsDSFEqdx7c8k4K+b9KIBR7UMENUmZQcSavf96A+fIsAsr4ciMQuwu+7fQHzZwYB
# FagNjmmmeY0tjsHXEeDDV4j4u/5zhHNuJRKxawz7hJpTtjDpsPI7LVX47vBrUDLE
# r/JBMGW5OwybDwIVUPULQ/ikZKlC625MYlL5c6gBM1+mx2w0SwgeD4crpV+B+DWE
# 0hcs2r3kC+6YMvKjNfn2oIy8ShW6ewZnGEuyu09eEUPknYgYyjAoI/OoEYRxLFXH
# GivmWHlcp4DNMxdl0Z/DXPGpedocUaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAYPOoEn6tsdGpYcao6YWqI92mb2V7GsvF09q6Dy4Pu2AIGagxE2alq
# GBMyMDI2MDUyMzAyMzU1Mi43OTRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMzU1MlowLwYJKoZI
# hvcNAQkEMSIEIFIqVk/xzSf3MmRo1EhXeHPZLIs3aGQnPLarjYNVZh+bMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAVtGCoOMqUZJ2AfotcLDjqxQyQAJRhDldxDaIv725YjD4A
# tS4oUtePnbVoJSfh+p9TbS3BKdlGSkqOoGb8YcZwc8ilFuv3A8ojfkv9G71LbE+u
# UwAqPckC8psz2OIPG1pMM5phBNZKN5gKJoBBoY7XnMXUtG5MP+0P9NX+XLdcMzT8
# qQqdbAEZXDsHsvGpGvKdtl1mXjEz95T+0j5oKWswjPIdIj4L2MNVqruKxIz86wIf
# 8NWGeMHUzojJuMWMicIhU6I9Rwq5URzZEYae5KjHplYtIU74TDgG2IOAxd50jqt9
# 1Tt2e21UZ+ncsX+22uQscnH4qNiO66kmYnRsbsYYpARidty1pmG03HB2yQFty0BH
# JsEt+MvTozipf4JGDbH1JUWUHJUdtkNRES7vb0rbUR0uXRxQ0GLGz3RpqGOhXD1V
# DE8SC0jLQuE+2Sm/gb+lcDZtzjKh0cNQWVWlTQ3OoZL4i32NUdrikaEfiMJZcekh
# DFrHwc9Xi0kUoCRvjk+wtC71W6QKIA9aWgbdCcVPgmVO98nkNSea+DsW5yKWSS2J
# +TOCSxXYDjxfeCBwb4LoUaEjBY1gseVFz3JXZPjqbBYK4KsXrrLRf81DRll6NLdB
# WBtObFCBn2CkkPXN2YOAfu+Xskl08r8JGMW5GIwZzU7yRv/X1u+Q6Y6435UIcQ==
