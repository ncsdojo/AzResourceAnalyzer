# CIS 8.40 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.40";Title="SQL Server audit retention >= 90 days";Severity="Medium";Automated=$true;Check={param($D)
    $audit=$D.SQLAuditSettings;if($null -eq $audit -or @($audit).Count -eq 0){return @()}
    $enabled=@($audit|Where-Object{$_.PSObject.Properties['state'] -and $_.state -eq 'Enabled'})
    $bad=@($enabled|Where-Object{$_.PSObject.Properties['retentionDays'] -and $_.retentionDays -lt 90})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName): $($_.retentionDays)d"});Description="$($bad.Count) SQL Server(s) with audit retention below 90 days."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDHS1beesSFmrtE
# whkowIX6uv3KwOi/aa7aNZElcWwEVKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIK4J1Qk+jEEVPnl4LeSQHmeKpIJgP/VOwJ7VC17G
# X4uVMA0GCSqGSIb3DQEBAQUABIIBgDibKnsSr0z2TCbas7omvksp5l8EkoXjaL9t
# K7Jd2oABY0MGva7EGOJ775uwYQafHTUTpCKD7R/X7TqBAs6HNJlP/eUeBlzXABF0
# EKZa+N5WADcmNDk6lIoHv4MO6gnfuUb+xA/tYVY1hyUHLbU6aEmmMzxGXO6vX4hz
# 89GmjA7c+ylvcJxHkxbA+zLnUSWmtot7EoRIXCyaNE/Ltp0f+nQLgO5+asyoFj9u
# DqCg0Tge7hm3W25C6+UcZqJKzFsnoGEDqWG9dOmCms38YWeaiIiCLOgl0Sl6G42i
# opFiB+dOE9Lz7zkRRiRbHfAzHCtv1jDzTiizJNsC37sGVcutgeE6L4fUkJ4QXWN6
# IAWak+STBzwHrk4aNQw7Yp+Mm7Pt1q/Mg6tlCQJuZgMbDcfvsi7n5ayDcQnzsWl7
# tKAu/1PWGRcPCT6MxlRFP54lWoPJNrC3RADvaw78bonLEeZSWFqjerNHT5c0/juQ
# TDUhkQ7ngYJamq3/8vnvqPDvcGIezaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAbiOhiE4ubaRMEeqzXhdBUpOd5ctohbIFO0bk5meiM+AIGagxE2aUR
# GBMyMDI2MDUyMzAyMzAxNC4yNjFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMzAxNFowLwYJKoZI
# hvcNAQkEMSIEINZU6QcidDORKwZCtHMaPJdk6mA0uHHbfEwzUXC3//gnMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCO0M/k+WIWNXMB77joc8LJ5dvWumo9wfBh4uxipEv73uPe
# OTk4Hwnqmu0F/jv39ybd0VDtQLizhqeUM7OcCEm4lULCllWB5iGocmsO67j09baA
# qiVXmNQ7ziFPpKRYOgOnOYRfnRYRKWih7TQEzJ3aOvYK81QA0CjyI98RVCbkzKX5
# atM/HObblrTRcb/CQ95QOqOF2V1L+o92AxsZEXjobiZ51Bdgg79BUOsmm8SgM8w5
# AmAGEGs7YeSLtxaP0GcX/jd3Tn9XA2hEXQyopynnD6pIgYg/yvOHQGMwDd+biTu6
# jfzKePuEIRN7bsgvQzKGTELGRVmobk6aSvWW5t5Hn3YzFYO/njVcDVsf7GoUGl8G
# crAd64yuewk2vf7OG5heKghHWGS4eT0IwIn/4gUFnW5JCJWcD+tGk6aMPvmJens/
# 6advKZcoLb7JaQ7FZfxSY72JLhU2Sxjm6n4VmInnPJDYlYNNEOBmP7gVQ6n9MIbT
# AKvrOiWbYlhDnKCqxMoryfc6VcQ2rli+Bq3z/153+FrGZPzYp8X1bqA7KrCCu7m7
# GrBy0cuyfT+1xBLHc1dKGIx0B2Qw80/iiZY+ycsdm7DQJhrW3ou8bwId++BQUMmn
# CGPbjTEogxmW2SofmCYs60RA9joFew0g521Ps8Hz5IKb2mE5/emvp25VZzXVSQ==
