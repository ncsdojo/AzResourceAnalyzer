# CIS 8.34 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.34";Title="Data Factory managed identity configured";Severity="Medium";Automated=$true;Check={param($D)
    $df=$D.DataFactories;if($null -eq $df -or @($df).Count -eq 0){return @()}
    $bad=@($df|Where-Object{-not $_.PSObject.Properties['managedIdentityType'] -or -not $_.managedIdentityType})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.factoryName});Description="$($bad.Count) Data Factor(ies) without managed identity."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBGh96bwC21Q3J+
# 6d5cR0Q9QG7joEV8x9hLV42hqlKYW6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIE5DXF3oMpg9j7lHdL5mQiIHWR76GLfm90n9MKJD
# O907MA0GCSqGSIb3DQEBAQUABIIBgBUED0qGrjkxEslHUwUnfQ5ZCatVwK1mKBEF
# zN3KpbHBFvSGNKzx+/4WExilr3BbvgH+TugzEWqPgjW7ZudR9z+22CPFheppX5fp
# clG+vW9IRliXq8QU7wGgS3RdBERKRUMjCF+NPuiD0CRKm/aJ6V3tZe+Wqm/820K5
# YQa9UO4EKoMwI0QKgGschlEOgzUMx0sG8DbWfdqxYv4xPPlD4Wsumw67w8kepLro
# eEXtGQak2HB5P0aRgitb+xdVgO9C2p7qzp6mHMoNixdjfKqD95wUbqB7VgFatRTO
# MIdyVdsJJJue8jEP01cFbHu1w85Re32+KvQM6qXSpWgYlDzrgaifEt3/cJVdFKXl
# JGYh6fU8JXaQPwiQ4QjCca6uVdcfZD3mHGQ7sDWLHBD1hEZJrybVzVy9m+JggjUP
# rtAZWvbRPmkqmV6NeTkC51aPesnXBqFOoB/vvCJPdEVTocQ+hM9pMsbHsx6NEaxC
# lkzBPecF4liDn37m1VqE5bjQ25m/1qGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBdXfo17wwiAo4yL10Y0aGG/uUt1t4egEfo+FpN4dYzqQIGagxE13gp
# GBMyMDI2MDUyMjE1MTE0OC41NjdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTE0OFowLwYJKoZI
# hvcNAQkEMSIEIJhPMGG+waalMjr+qCC5Ixqn2TkKKqiFdwQSdZfjYG08MIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAlpMEcFm/WbgnhqOAN7jICqNLK3+USP/lPnblR08RsQRgK
# 5tQuq/TKGlhg9C9+Os5gESsGQexjfvrTvKjyOo8rrXk85Zspe0dUvMDOCThPT+5X
# avCmYqshhaU3xySDVfrMHo/obQ415Xzzy2KCeX8u3ukbjcZPByS8Z+m2yjg42uix
# YC1Agg8pL183ZqNKaiSELjoouRZn/G/ldr5lz04EojvfItQi/krQ5cqHR1c+Yi64
# UXHhiz3NTL5cykkc9afaQARXbTxGvpSBnNF9I2aImKKWKsFjDiKFfcf9zVmOAv8C
# LIdvWFnsrMdUIXMsjavtM9u/W9Bkhs3WNXB25YJk3pLXtVjFE1nEH3FOBlKv94v5
# xWcisz7vZDcT0lI1frb33sxF4TXWH1Z6xQP0lcEn5T77ANbZbTPtkZ6K75BT2p65
# tvR+SGcXSmYqftJ4YM3rU36Ea0R4Po5H0ww7Y5jD6igGORXVVybG2vpETaMZEHSx
# 7hx7TAMM1uzLsV9HoLyisHlzkuD44AVVcxL3YW/+Snq1sxpklHFXkasr7m/yX3qY
# Flw4CdhJrNVUy0p/3tdk92Uui5JlGONkHhh6feIbxOgrskCrjLUpVtTARjGxu/h3
# uLvtTgMC44W5wzTl7F/RS5Ejox0Ei5KLoD8x5ER10fO7buavbV8kGR2mN8F7Hw==
