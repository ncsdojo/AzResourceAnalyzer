# CIS 8.25 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.25";Title="PostgreSQL high availability configured";Severity="Medium";Automated=$true;Check={param($D)
    $pg=$D.PostgreSQLServers;if($null -eq $pg -or @($pg).Count -eq 0){return @()}
    $bad=@($pg|Where-Object{-not $_.PSObject.Properties['haMode'] -or $_.haMode -eq 'Disabled'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.serverName});Description="$($bad.Count) PostgreSQL server(s) without high availability."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBmf1aBB7boKn0e
# OKAtb7sNqAfuVTF2IzonHEnklGbmi6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIGvuBh/iTc4x7vL3fYupSLBLiq1bCA5tQRdlrC4o
# eitkMA0GCSqGSIb3DQEBAQUABIIBgHv0EyYazu5fSjABF2jXw4Jv7gzbXFr7a8Tw
# 6Uklu4HNSZH7ufoj7Dhm75unsFIIPFkhHeZqkpmD3JoI6Nv1eb1RzXsfEa827sId
# pmFtW6q+Z5ttIEZlgj2WesC+SYmbTXnKQv5MuIjZUgzwAeixIbEBYztBk3pmwsDk
# WEd4ZP1YgSWan78Z7evjH2kShcuJhiu9bv3OOs1pQ8trHiyRjluu3NJAjgelSfrd
# /NWAKGXWa1EAebaT7ZS2p8MV3rjRpsro/VtWcz592rnvJ988LDD/okA/d2HB9Njj
# /EtHxRAW7IUIOW/R4bFUfJMIFyEf4FN6sEgeJrG14x9Nej1/sO4CVpQ3Hc0ILRaR
# rSlgqptoBE/EQWYyfm6TiPUxqIQybDKXdNGdejMHRJkevQkVUXy8O26rw25iRjUU
# DANynaiqsta0cpqFXwYpye4LdBGwt6Od3ibxOhFk6l8C9oQqzWy9Ip3HnMWxG90p
# M3pj+8X5X6RoJCPLqErRlK0xyx0brqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCGI2srfHy8f9mBVbjBUi5tbzTFGnYtkPGFGfjr6byyWQIGagxE13AP
# GBMyMDI2MDUyMjE1MDcwOC45NDhaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MDcwOFowLwYJKoZI
# hvcNAQkEMSIEIFf/YvDtwyX6hUDfe3Dw5YjQkyGSPdwPGcwlQfdPyoj8MIG5Bgsq
...
# hkiG9w0BAQEFAASCAgA6Scmj0/7bwU9ii34Sn0R44vuPFqAweMgFUizzcOy5i5Bu
# 1Cd0LK+RBh1lsBB1KpgjA9ETb49Xy7xBATTT8GzbLGng83dh5zPruWsItf/xX53t
# tSdIZGRQlUUJoiWojPmIyb01NzRTKAqCOut+BntZERrPYcT44oykmW+0R6pylSqN
# ziJmM47HfTofZjD+j13tbeqjsF7/B2Xqz0CM5yNGyaBcyF3p+IUX5aeR75r23xIZ
# wZ6ZGXydOzCwpJxRNc8Q+d+r0SOZa2GYt8y2Eh/2qHU39Sc69clFzRAEMKnNyDdN
# 8USwnxFhUCw06rpNOpdQLjFlVoKLdDLqskTU6sJdaRGskY5OVRrTSQ9J312vdzXD
# XGFK0Ns6n1fvE0JLqoCnh1g/aWURltru9G5wX+/ymS/8qp02O7bzgGOD9hFIiK/0
# CHJgSPWPO8GYim93C4Ej+feEiR62dHnKTUS2Krr6XYzlfuHd+EvKZvJ9WNjLN8Dy
# XN1PnSgxlXjNQtvm4rKfwRmesir/vdOee4lvI/sEhuhsF8ZRQ2Je/RBaeyJys3QA
# UEO/0677+QMz8iLcLLbH3tqQ8Frjw5cIUq5Ax4e8hsQr/5NHQarpkyqWqX7CnvLM
# r29zszAT/smb9NbxaMKOOoicl7RC86mw0PFUPCJ+hrn+9BWO1j+mP2LT2MiLSg==
