# CIS 8.54 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.54";Title="PostgreSQL log_disconnections enabled";Severity="Medium";Automated=$true;Check={param($D)
    $cfg=$D.PostgreSQLConfigs;if($null -eq $cfg -or @($cfg).Count -eq 0){return @()}
    $bad=@($cfg|Where-Object{$_.configName -eq 'log_disconnections' -and $_.configValue -ne 'on'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName): $($_.configValue)"});Description="$($bad.Count) PostgreSQL server(s) without log_disconnections=on."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCADasdqD1rbWDAN
# KDxygs3QJb5Z+WQi1L2FgVZT1d4RDKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIBkfImysqpINRzf26AeR+uwkxtMKdIMqmr6KgjKf
# tZSSMA0GCSqGSIb3DQEBAQUABIIBgBLFMhJ2CoBfkUJ2utm/oRTedZPp2jG7XtvW
# ZVzUHV2PBahFt3nX6JK/Cf6bCa2QJyaHfOJlYxK+43dv2PEw2OH0x/spgvLfFN+5
# KmV2iEPu9xTI+EGJtZ54JwAvPG82OlxL90c0HdJy8Zc1ECPadGRJyR4ECwTqdliX
# fjgxwcnISnlL3ofQoBVUaBQYgSv6XthRBXt8pwkkHdPc/6LQJBlzhVY5dzJ1knxe
# XAhNTHB3Zz5p4mk1kwhJgYrTGw2+UnFfGgXf5/Y0sxZhd+wcpp3siIpFjXCsSZSr
# 92GZq55nOMv6Uoc82Gutl+zPXGsyk+ayvEf8S1+mpoRPGtBzvVwC6YqnTwXaToaO
# kbn21bxRQCeHXJtGVL/Mtp/gzbKLsHYpuztgUJTlsXV65X1tO5ig7NzlN3eSxJAJ
# /Rpys6ueR7pgt2bNVO26/ZDlizYD8MsnUUXOIcUi5ppwGLDzD+8M6mC1EXlAh5r6
# gJ8iP0Co3SqQoaGBqaxgYrIV/yt/TaGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCA35Arw78e0TzqSUai7iFgNT/PU6BXhxgvBkH2G93+S5QIGaeiBPM/r
# GBMyMDI2MDUyMjE1MTc0Ni42NzlaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTc0NlowLwYJKoZI
# hvcNAQkEMSIEIAyLTbJsq8aVvBoEthNxE2kUJoAF8Z3DcXEw55UKxfjdMIG5Bgsq
...
# 9w0BAQEFAASCAgBPoSdZvu9aJJL/5WB+qyLaBE0tCJONZFk/xZN2/bmEYyy/5dNX
# d/CgMD6RdpcO+06FzHeZY5iDETFMaE41SCCbgrT0+5gif6mD2J3uRalLzqyDwJik
# LVaUkQx16XXc/Y1/7NiTw+Yk+8nwAW3lD9Qrex5AhlG3lb6Uwxep6QNjdLPcWjuq
# ze9TB+gSgzAYzGQD7667L97/fTCTDmbSRycAknf4rtIP4ESlbrkJujNp4RvU/CQQ
# S9pl7P7J8jBpl0edec2pXhGF4NUZXLP1TgX7NTrtd5Zwvb1fjUD/ps4cNkqNJXxs
# 4BMMyjoQW3y8aB01BMRl3iiZKjj2mo+4DDi0MkmBn8HvXkZUgNcYJtUPjVbH8fOV
# c2WJ09WQPvIdcwmSgwg13iBopzmhveeMOSsjp2uauXorKXwbqtHZD3xn+gam+z6P
# /6h4361NEEQkw+QBalXctfG0MMBDUQV8FMJk9Vc9msAp9YtXqEi6wHzniZEjaGu3
# FGLP5d1HficitPrfdgJ8twGSazeQtca2oVpS1yECunsIOuB0AuecqbkFXAwChoQd
# Fm3ObV1TPPlmlVaw7RqkcJCFOfD+M2B4LBUvJd50nFg7ULSZt63bT0lvisJHGR2k
# j3XlX5ZYw9CnP8wPaQ12yfPy8N2HCgpbOmfb44EL3+d6XRXFJ795yp1Esw==
