# CIS 8.52 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.52";Title="PostgreSQL log_checkpoints enabled";Severity="Medium";Automated=$true;Check={param($D)
    $cfg=$D.PostgreSQLConfigs;if($null -eq $cfg -or @($cfg).Count -eq 0){return @()}
    $bad=@($cfg|Where-Object{$_.configName -eq 'log_checkpoints' -and $_.configValue -ne 'on'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName): $($_.configValue)"});Description="$($bad.Count) PostgreSQL server(s) without log_checkpoints=on."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCApEacaq7lZLNao
# ygG+cspgp36vNo7WYVg8UhTvKbFP2qCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIPNjkPmvaj17b/+tUSfuPVpuBqtPZLyMJOMuqnjo
# tNTnMA0GCSqGSIb3DQEBAQUABIIBgECdoeVuT1r4c7qu2wajiLwy8y8PZf0DAexm
# uTaOtLjBD2pS6sPr56Tngrehdt43k3uEuc3hKXNZumTmiAAVbx5rDXTeO6Ez/Ltw
# xca456R0xJc2btPAOUn+3Cwjog196Lz1U/O6o6WHNF9tO/jliot3qbBZjzBfwyj1
# E6P/oW/PjjTCKi5xmuwiGqYIP5BLyy1atVi1RlTsFf4IgWE5QukLzCECNpii/QMJ
# XQgSJ2IGYAINOUrS3ISOILtFbAWHCvYGA8gIZv/aTBfRCehmTH6waR9f4Nd5+9s2
# 9Nqii2HyVM++q88BvInBqF2AfpafYLSe81KA3ojxN5RTWVhLe+CMdKPp1ljnsYGf
# S6BnqnvnXPLEx3/rXOz6AOV+sZ79ori4HFuw1T/2yMqR5erosMSFfSnOetKMlqIB
# NMBdwmKgIlR3vxphiRyIPKHholCEjslTjF/Dj/vVTmiLXXgCLrN/V2a9/4XqExaY
# oSIvkZvaOX+jnjtVQZxhwabz1Z1duqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBV2JTE7MUbMKv/cKv+HycjWeD1R5aJenAEwIavFabwjwIGagxE2aho
# GBMyMDI2MDUyMzAyMzQwNS41NTZaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMzQwNVowLwYJKoZI
# hvcNAQkEMSIEIEK+gsIWTVq7UFJGmENPMYxcIFacJ+kINxdAvjPh3zLgMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCr0svzvqmWFJJZzPEpVK4gZShzXReWpWhHBREtEhe6mafw
# zy1BtjPiX+fGiocxGHM3fIJCnrhKpw4ITPJkKpBSOr/GfyAR0rhjTZWwu2YOyDcD
# eJrlZvDB0LtNPC9tWgdwO+sc4ZT25I9JIyc/Ad4mm+YYf94s4AGcp0BJgSDtt2LW
# 1i9Uw6tjzgswcdXJ0WotKhfMGQL/5gqPLKuEmhO9KwqVdl2JvH7f3szWP8tl+igJ
# Xh5yYnddiw8ZWYXrnoSxCPXTe3auyysDfB+8u0ozFAjUGhUdDcZ51ur2V7R91ugQ
# 0ZVJuJgej2Yu2zd/up2cQJzPRIPfDcG7pLhVZ+i0NjRA5QmTqR+iGos9QbMPF8DX
# isoeJF/9j0weUvJkSGypUbMvDcU3ak25PljLIGQfPhSMrRc0wkKxOgYRlLqx+Cg3
# n2PzeUGg3a1pcgSSRtbSqvIgYDJHZLkQ2vKuYbNRRnJbow0umK7OeeYy25fmgKq/
# mBBkVzhOHWR/60sSE8Uc+yMcGvLlxo29n/734jnXbKe+jNIYihQmdp3vNRFMTqJE
# nifNDhCs00skW7/Omqj8WQfyX6+IKC1Mkzez2YosnowVW2D08Ykd2epLDWwkJqzo
# FgbT9kDpwl77q5FczAfuzLxdiONLz9Nwq2/aLRQCna2PC7cuds4Oq5GSmXNDWQ==
