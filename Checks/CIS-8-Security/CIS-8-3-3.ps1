# CIS 8.3.3 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "8.3.3"
        Title       = "Secret expiration set (RBAC vaults)"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $secrets = $D.KeyVaultSecrets
        ...
        $rbacVaults = @($kvs | Where-Object { $_.enableRbacAuthorization } | ForEach-Object { $_.vaultName })
        $bad = @($secrets | Where-Object { $_.vaultName -in $rbacVaults -and (-not $_.PSObject.Properties['attributes'] -or -not $_.attributes.exp) })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { "$($_.vaultName)/$($_.id -replace '.*/secrets/','')" } | Select-Object -First 500); Description="$($bad.Count) secret(s) in RBAC vaults without expiration date." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCdSViD3PUFWqKa
# cdj/ufymiZKAlCD8L4Iaoyi1PQEzLaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIDtDLQRetQOF11kDwdj/xGi5ZpI9/0SqXi1DZxE3
# tTURMA0GCSqGSIb3DQEBAQUABIIBgFo0sRzkCxk4k/HATWCJoQPkxQ9q9Au2BrGU
# DJ27vwVleMDN11sAwH7Z537WZe6mfjhsc4ESfRo7JSRtBrid8jfzll5jSg6xjq4J
# Ko3SeXcFVZmtToZ8WKDaRWX/7u52CSDR65Fb3XlYopQ3/FJj8u696jsPob+J/wYK
# QayQciDCps5R4EWXJx/59fE5hCu8DWdNYfA/gFZ3E1MEEsZ7adGPYYckB6vUBd+6
# kYVAoGLXXZ7HhylvH+5b7TK2MV3/7YQZt3O6yE4HLpCiqvjJlBIJwik0g6941ETn
# 8wfTAz3/gQ1HCWvsCJt7PWEKkCqk+vBwgOLgV0iEc9dRvsX5onC7j/oiY+sVAuKu
# IRHXW4HYBS7IS8Fy69OK5NZQbdxtLDYSkDs6+9xq2EcUpa62wmIz58jS2KTHmLcj
# dSw7VKbJNXPq98DknG8Yf/97HWbm0PGG4qcTOG6x5/V1xSK64eFnRoFXhfsExIMm
# i3CleIXoEK5YW0hGryGpJymiLNyYWKGCGBMwghgPBgorBgEEAYI3AwMBMYIX/zCC
...
# AwQCAQUABCCx+E73FttFg31W7JjSvZKaVnBHC923PPH5cPSFHE25SAIGagxE2aLI
# GBIyMDI2MDUyMzAyMjQ1NC4xNlowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDIyNDU0WjAvBgkqhkiG
# 9w0BCQQxIgQguDE93lcB+dEQCx/1ITRCJ6VMgBgzoODDHu5/U2Sgi1EwgbkGCyqG
...
# SIb3DQEBAQUABIICAEizTRHb1VBDP4E2pG6syDS6++kiwz43x/PvetFFYeVorjyD
# tuya7X4SwIe9FHmM6BCw0xC5W3ztYwVN/vuvv8X2T0/yZoexVhDkFl239Hj+ukGn
# xvLHkjneh7NysSm8zbixb2meSNXk9ozjDgJd5ql6LFV38OB2CjpkZ+7yYAJjouCF
# KwpBNnmjXnymr3tjM9Ky2P+b08aKab2Q6nMBmF6rGlt+qp4MmaVK8eCNaxApYsZ2
# dqM0u1EM2QBhr/BniGa5Ceznrn+jzRhB2S/NZM9LKskGrkWzl9H7tsymW9xJ0x7F
# Rl9pY8l91e1P5boabC/8mT0DSikB5lEhhtX31+sMk6piHDplq0Lww+oJZGktBGy5
# X/KUbrvDkuCPWInCWLsj8H5qkQrrT2IbJimE9w13rcBW5jtIN7b7+PmXUA9veZTr
# EPuNDNWOx/3ADOfgwpnHwOiMOMSBS1vTZEBxJTovl0UJn9SHT0rBvHmZG9kg2cx6
# wd3NdUL3/ik+wrNos+7nUkVDjo1G/IPvdZYV0A/JTMaaPyspJHdC+gq7kNi68lWu
# NZiV3y9wx/VckDHu9UnV78bq3wCUvqUGfbaquCX2vxH8LYsjCWTRh+o6QrgnMvrt
# uDEdu/nOhjUebT5gYVJWXocwrPABJzfTGXEFuYWvBFK0tYUr9T9zIWxFItzn
