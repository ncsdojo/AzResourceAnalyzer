# CIS 8.26 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.26";Title="MySQL geo-redundant backup enabled";Severity="Medium";Automated=$true;Check={param($D)
    $my=$D.MySQLServers;if($null -eq $my -or @($my).Count -eq 0){return @()}
    $bad=@($my|Where-Object{$_.PSObject.Properties['geoRedundantBackup'] -and $_.geoRedundantBackup -ne 'Enabled'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.serverName});Description="$($bad.Count) MySQL server(s) without geo-redundant backup."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBJK89ALq/ANuXe
# wlOIJnuS1J3UX2X2IVPc6Ed/TLzE7KCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIO67Ypk/4xhlBUyeJ/4m0J3c/m82kH6CkVRH/Jv6
# nNRIMA0GCSqGSIb3DQEBAQUABIIBgAJJQQlslPR5f+fqKVWGYPQfmxA0csasuXen
# Q4mwIXwMstyd1JDwDh2wTKtOLIFpy/y0xEgdWZ9bYoY8bUgRf9zsauMpjIS6p/0K
# 1x737eiXJALuqVSAfPbu2qj4ZsqYe391RkCDF5LNx66Qejp1oVsegpDSe//cFdFH
# 8DsSuzaofPUfXHjc/g3/5qnKyklMF2aF8rEKi5ZeG2GxnqKmdmqxsn3t/D9PDNs/
# XRT86z6VMfQQ0KbbWVrVJJqUJxlOP8iniFHUGOKFBXkJ/fqTcRIpPumY3vscNBry
# lorrbsUQC8gRtrBr0QDThujxgWr3KSBGq3kFsSDU9BzXZUOU1XD6V6OpHDQxyXmn
# gbAmJuhMoc9UQpcdPcC6+9ZJVBRPvTlcUODDCnwQG9myPwFZCrIag/w+LlHJczC9
# 9vADWk0drCbSiL9mmC279Q/oZ+CCkgD9VKqGrkpKEclXxVq/GmvijRKnB5oR1aXG
# CFzxKVn4mSxIL3J9BLSf0Prd0LOhq6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDMimZbRVmAtnKBm3HwtveIkjoN5jo9hHQ4pzSoeHa5/AIGagxE2aGG
# GBMyMDI2MDUyMzAyMjIzMy4xMDdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMjIzM1owLwYJKoZI
# hvcNAQkEMSIEIPvvxOswcuHTCmXIh1Y1a3ITW++d6ejNfYylGZVmGpejMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAdxoPX/iBM2AnFOu932+68Z5SuhGUyqn4NzMLfu0t14IIn
# i6F1h/vp3AEOay8K+Vf9fDOVt+L4E9BBPKkpOHFMm1CKuruEwxHf0M3rZn2iEgDk
# dKPDtNmhRpW4KYQGMsIB7dDq3YM/st/Uas184MHar9rggsBygbGvVjmf6nYgMkl2
# vVZDoqOuIa6Ry5PdfY5SujuOuExSIfUGMvr2gJbNpWxo7Yl0rhp8twAsEAl1h9LV
# MKEML8RnEI9kYA9UG+RYN+IicFz8mANS4+E5ntjINcy/B/OCykPKsxNnASOMKHsB
# iQHK+sSf6I5UNUzVQ3h4EEEhmOKvrPs+KvwkFIe+Sy+Rdia6GeLNERuc/hD3CZhg
# b0DcFPSKUeLMvBVF0BHJoJ7yaejlo7e8Cca23WlNyIOXTtn2uc8SmQG7zbj9C8po
# c2HwchgwzzMQpmhB/FIeE/v6MZxoVU/3YdLzhfQxYYPn4IZMID6yorM8FxfMVmON
# uutqxpO7NlSTGCY+VksrKvCSpXAZ0vCJOvyIu6sIS/jSHngt+UTCiG/WCg10hX+b
# ve1W9L6UPrs7hZS56m5OjwlH1uu7BRuDQeGi2YLA9+1aF5TCCWz5LmrMp5y2sy9U
# QHa5aIDeYJAwJm3aeT9AgkEIkE6eqrWDvNvoyjWW3+Ra29fHY3oRy6NxvEk6CQ==
