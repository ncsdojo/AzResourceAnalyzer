# CIS 8.4.1 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "8.4.1"
        ...
        Check       = {
            param($D)
    $bastions = $D.BastionHosts
        if ($null -eq $bastions) { return @() }
        if (@($bastions).Count -eq 0) {
            return @(@{ AffectedResources=@("No Bastion host in scope"); Description="No Azure Bastion host deployed. VMs may require public IPs for management access." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDzo/g690vrfWpk
# V88sgVrDB+3mdxo6b9TQFVzJXPPOUqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEII/NNAFIfCgnTnWZYCaFFdrXVUD3rnMIy2uu+kpq
# 6dxkMA0GCSqGSIb3DQEBAQUABIIBgCU/JHJnaD1Nkj9BAUfvz5Xw2vkIVy+lSqwX
# K1NBmgfOk3Wpz7GElAzxP4vIJhWNpmtkvNlrSJzsZhi9AzbA3X6lg8Cy7+t9zlit
# kHWamfqemipLUVtVsxaCZRi2ZNR61ZyFxkXC7gnbvJ/J/PLXtIRXCLJU7JD3LMhp
# fAs48sWZNsLvl0wGIbmBl0rqauXUIOut/F4x28RFYsmdv4OC5InXsIdbSqZgjICM
# REKe6fiksl8UH3139R7/2+KlCCYkDessBzz/lpWvk2P8i9oMRRJMgvNSErvwxczS
# Z3hVsBZ0UjgsFMLT8WD9UIY3dysvZ66xeNfJ1KiteDVuJ5ZxM/yn5Yv7pn2MD/kK
# s9oXsX0RDYAq00wxoPeQ3g5OXmLnKcq+MO+D545jD9n2LQqlmCNUnbA+g0uwKQGL
# i8LyuWbThMWtTpPlTVrOOGPl6ruDkshlG/mX8Ni/EZ7v9rzThgKkhcrIC4ThL77b
# +nP5YSPoWVbbLAzh1CzTvA0VTv3V9KGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCQGIrO9xV31XZy3Qu+xJOGVkJLVFNyskshCRhbEii+1QIGagxE13qk
# GBMyMDI2MDUyMjE1MTMxOC4zMjVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTMxOFowLwYJKoZI
# hvcNAQkEMSIEIJ6WpcS6co+J5m2AipGiEsYcc7E9w4QbOwP7cNcWprVbMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAmO56nFNvZt9RhSn9vVeHyLsVQkm6OoCxW2m5IIYZGEJwa
# 1BdaZ46KiAi8pR/U9TkjXKPyuwLhv3orSE5nxo6x4WC+iW1Juim9GaWuoZHLj9mL
# Crmwk0PDNXt8o0NKFlzesvS3u1z+c3uUKqTfXB9O7elVo9i8gDV6RKShlxxiZ6fY
# 5tSEMZiNphrdt7fduX5PT8JetT0zk/0Gd5/o8/S8t7sCUyn30+CfdSagdDBPQ6ka
# kDssB4ATpfW6WlnMrj5dVLQFwGdVlYmHPmz8hbLTjjRjwWcnxOjosqTE1MXKGXnE
# WLPPgmx2l11aYNBbJa6Ta6M3osM/RD/BdJ5Q70JGcheBxCea//JzDQnljP01rmwA
# XNieAdj+OyaMRaiPLVZ6WKeaSBOIu5rYTvDcnMm0PG5iZ5Cxc6YCIXpAClMIN3w+
# Oup2dwHjbddA6qXa0mwj24/KKh49EtGwYoRrAeDy/ZoFXTBTv86Fq+LCTwoIaklp
# ZqX/QE8eFx4GzOQ4McY6dRQ+7qZx3jLydUqlR7dlOEJycr4CzxJ6M1jhv/bghOLv
# WCL+95HMEcYK0xLsTXRLJ0OKpb4weoV+bJo5zlxkvtNpiJs6qbKmd2LZtBDDlFj5
# CCLa1jnhH6jSQM7xZY2pxj3IMR6+7/g0z0QlLwj903DyP6wkJvVm5NYn53r+WQ==
