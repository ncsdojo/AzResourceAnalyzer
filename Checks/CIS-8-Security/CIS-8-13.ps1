# CIS 8.13 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "8.13"
        Title       = "Cosmos DB public network access restricted"
        Severity    = "High"
        Automated   = $true
        Check       = {
            param($D)
    $cdb = $D.CosmosDBAccounts
        if ($null -eq $cdb -or @($cdb).Count -eq 0) { return @() }
        $bad = @($cdb | Where-Object { $_.PSObject.Properties['publicNetworkAccess'] -and $_.publicNetworkAccess -ne 'Disabled' })
        if ($bad.Count -gt 0) { return @(@{ AffectedResources=@($bad | ForEach-Object { $_.accountName } | Select-Object -First 500); Description="$($bad.Count) Cosmos DB account(s) with public network access." }) }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD/540vGSB+FVLd
# cs5UMcqOGZLOGOldLH/TO3FwiXI3baCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIAfjR915ZCOGV+AAq24BTeucasj9hmudiZSmjn0q
# drXDMA0GCSqGSIb3DQEBAQUABIIBgIxdYxmqvzf7Zsbix9QjL2l+6J+MgCLyuKYG
# oaQxDlLnFozFyeQ5LwABNOh5g6XAJdopr5WSmLZzSFscMzMNhIsL4bM/K2RqM01M
# 27nBg42omW6Iw4A1z1XAZN+uMYjEz+GZbEuDhpWI3T2YdCwTUbyZho+prRnGGx8z
# ICjtWwUexybJefzhYisHLzXjEMEyyeCwRALaXdH/MJiUhCwQeqk6vN2EIKHnnShj
# tXi3z3ch5edJuSOnVeUVpcNsyzB+VnsBMiou/b8y2zRezqNMVRDaTk0GOXQph4k8
# lih27OS34PfcYHybR2Vqqjzfn5NQwKNBAVw1fRRVxPW7Yg/yEJUBg8Ng4oInuUCg
# 9yiSFyu67Kh/poHhpG66QMGfb7LrwSAs3z9I/oM6uGX8vdZE+1/t04cX0dIVmPHD
# 0dDiFF/r2YDLl8YWQo+A89ULzcQJqdibHxXK9gRumwGaOd0+oyvLBRP+GFfbD5bF
# vq5m0fG0Mj2RDmrt6O7Hl3I/mU8BL6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCB9jukXX3B3TIX6lh2UVg3JqIFZP9Au8g7gyxt2PDBaGwIGagxE2aAJ
# GBMyMDI2MDUyMzAyMTkxOS43MzVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMTkxOVowLwYJKoZI
# hvcNAQkEMSIEILVzVoZaodmgMzp9HVp3CazhzE9trH56rb1XAPsidtDBMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgA7DFxKbJrwA2GD7cL8YIiPETXdeFo8MG7TNuC02AFVvauU
# EJ0qyl13sPjSVhGWENcN+JTbVn28+JGRqiD849+tNOrLQ1yeSH/actQpTmWfMdaD
# DOR4WH2A9I1Atdmcxwff8gFibs+6ClYkXoi3nRAfIxsJLRPNa7yV+Iqm7MK8Ba9I
# U3cXzfqRY80Bk/ReZJlA6tpBUWYEn3kLNH2lP7ovAucSmnFo9Bfxa1V1j/qKYSSj
# TUha/KHSxJLHw/AHZNiLzywZ01aGpVfmFdR939rhta16WFWpyjbJK0hPOrwUkovh
# jhKa3M2HO4rPwpNa0qyqVjHjzBIKGdsF5OJKO8QtT0qaQumo5KWT+qBv+4PwwI1N
# JlxGQ20PCy5augQChJ6hvNfmIPsHZ7NeugNYnfNS7hcxJikNtuqpso3Q7SHBU4Br
# zfDwOlgPX2bN7lLEOUe5KIZ6jhc2fL2kkFp+UOHOYuniQSk0j/pZfbJ/SMIZUTR+
# /RRA54Kp0Nlcg76v6x7qp+XBFu6XEXV3djEoDxpFwOGrXHJ0N7cBjVCE25J5nyec
# QKgcsqdB7vPA/zjRFQvZNc4oaZTinmSoN7ZJrjqCvLaov/R/m8B+BBkhlRKFopWa
# d4CYl1eRfLfliNUiwW2zeL7vyZ59CQTctQVWN/ocMAmaYJPgDMPVDlfcdPyXsw==
