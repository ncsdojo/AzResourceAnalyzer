# CIS 8.49 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.49";Title="SQL Server threat alerts sent to admins";Severity="Medium";Automated=$true;Check={param($D)
    $td=$D.SQLThreatDetection;if($null -eq $td -or @($td).Count -eq 0){return @()}
    $enabled=@($td|Where-Object{$_.PSObject.Properties['state'] -and $_.state -eq 'Enabled'})
    $bad=@($enabled|Where-Object{$_.PSObject.Properties['emailAccountAdmins'] -and -not $_.emailAccountAdmins})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.serverName});Description="$($bad.Count) SQL Server(s) not emailing threat alerts to admins."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAIv2PyKgIXboTP
# lleryc6yLvpn+IDHLtDwX8o07QwzCaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEINY1XQuJzv0GY5eqg2s+ARdmOqTd4N08m1wK5h2w
# XVjFMA0GCSqGSIb3DQEBAQUABIIBgJ1GHrg7pAxq3C7D0r+UC9g56q/IfYaeUjOc
# A7WUZX1kvOLM4d37yowyigXrw4JJAyU1zKb1bDiExIhi3Y+U0QmBnSPeNNBg+fhg
# mDTf4pDzYI6UeSp8WGpciZkEtWBjJZRBmpFua1+BQ+Ct0G+gQHlsEPvJGjIv9dum
# KuAa0kwGznhKq0rUkn5s47ulelZhkz+h4ZOj1ujzZBnvY4CcWr8LBkdcdjbJ48yj
# F/zAIZQ+zLddf1NNv1WQfcDd7VzMREtvW50mjLtY1e3hNA5o1Rp/cPxcUrGfsYPb
# 5+AFbf49BYGp0jf5bVQeQfp3GTFYHWR4zJYH1bi3VHEZSMyqL2UaHLWpNikB/ZKK
# 9mvVEYbVuSHDBimBWUjEUX65Q4lLHjX2fk8N2qN2esnEI637ZOJCags0G7wBTGvl
# elfcChaJiEOw2E8TwZL2xg8K5u2ya5uPjguknyNvG2VMTqWjvcuYgLfkVzNLl+f4
# 7wZKTkIjZ/85Lug8sk6rT299mhTDuKGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCBrDfBeM91Fps2srZqjLWzySrH5KCOV5Ke3ZJMzROyWJgIGaeiBPM6K
# GBMyMDI2MDUyMjE1MTYxMy4zMDNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTYxM1owLwYJKoZI
# hvcNAQkEMSIEILUy3vNLJdKytrEsV5KoxjXR1QblKKK7tzeBBISIjKrdMIG5Bgsq
...
# 9w0BAQEFAASCAgBuvE4j6J/dMNnUoyaZGU5QHWqpg701hpSYGxAoMhAKePmCav4N
# niXAlM8uJWrn5FaOXjA9eevhE3al2oSFjNv4o8RM97aY4koW+apqK1MM1glK3d3v
# kpfnCh+IwEgHt/TakhW8+Y1iJIGG1GSwvRHGdLfRySkaPRzdDnEGDOH0LirjEhP5
# TtINoLPbJqRXqbQhsZBRCgIKzJSVh21cDUPzHYTr6NnudfqwWl2k7Ndch2Ns/JH1
# jpsYn2BqgSicMGG291qt0GemSF+pTu0jvTC+HUPoA+kGazdhC4WTtDS2F5gdron4
# 3q6MnfGfwVeuxXtSWT7joQf+ADzfYofEaZauw6j4fsD3GoOiE5aWaLPmtxvLqVFg
# Yeyib3zg/lnVcRk5g2WKDJDUr5TfhsEmnGkHj0eTzCBQG8ps6VXB5rS91LYdp6TK
# AaCuNRcRY3hAwc6SGYjJaYPhiIj/iFRnZKz4b72jyd5GzjaEZNrzQAwOnZvbCnNZ
# CRF3j1WpQPX2aATu5ajWnAPwxIi13PE0nVFCxd1MHD2I82r08fiEY0OkhZrh/Jw1
# TRdRhaBXI6sbD5WZe9F0H3h71fOlcox4f+t+2VFW01CUafbUgsFWayjZ1yrRWtQR
# 9hT5BEl2nowXIl5EtpraBeMhP40izX85466B49m4ExoyL58REEx2OQuMUQ==
