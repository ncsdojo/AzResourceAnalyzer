# CIS 8.20 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.20";Title="Cosmos DB VNet filter enabled";Severity="Medium";Automated=$true;Check={param($D)
    $cdb=$D.CosmosDBAccounts;if($null -eq $cdb -or @($cdb).Count -eq 0){return @()}
    $bad=@($cdb|Where-Object{$_.PSObject.Properties['isVNetFilterEnabled'] -and -not $_.isVNetFilterEnabled})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.accountName});Description="$($bad.Count) Cosmos DB account(s) without VNet filter."})}
    return @()}}

# SIG # Begin signature block
# MII9FgYJKoZIhvcNAQcCoII9BzCCPQMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAKjRBUUqD/tnkb
# ijwUA1gHE4ovkBR4j7MAg53MUBX5e6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEICl+sXqeg0SvPY/dC3kCFHiYbHGxf/eSqywAsDbg
# 0R3mMA0GCSqGSIb3DQEBAQUABIIBgGc8WTWkiAb3l7epcE7pwpM0s//bsX7+YMDd
# al90Gkhg6M5NGXGqEpqSBCvYcGIEBbYABiNxopLlxe45bO0BfyNfLOqZsFPw+v3m
# zLzQNJihUUY9l6JSrUXhbMTSwF6JLAAyuW7IeyOHXH0SatcU1ctSZLf5hyMQkkPz
# TxYjvNUBmKz9tMyDmpSOxhV2vDyv6xnbyMAVAwb5yAbNe8UE0GwzwPq3vXRDJO10
# WjxpVaQI8R1eJIrg31Usya4EsLVkVwOtmA+MBEA73GD3pNDQ+QHSPjNhhJhbfH+h
# B8IHyjv4OkqRB719B+ay7Xk21ZFk0Uwa2vUAG6ZIi8j0nQVSorYkbYoFmxNVAA8W
# +Jzhu7yGckQd97Qf353uovmubojfiOEmQ1Qb6R0nOBrolsE+Ijri6lfp0Eb5S4WG
# LmZWLde6sh2PFhEupvkyHxj4AWnoP+XMOM+r6itS54K1S/wxGmAakX7OfPUdV+3s
# GAJPQzvGbD8CnmeaPYyWXZio/MA9yqGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCCFHE3HJ3qMUH40M+jG/JtGQd8LEm2t2FdIWXjoayffLgIGaeiBPMGQ
# GBIyMDI2MDUyMjE1MDU1NS4wMVowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIyMTUwNTU1WjAvBgkqhkiG
# 9w0BCQQxIgQgcsVx7MI/nv7JGjqXOxW8v33JbTQH9oR1EHxKfmnK+ncwgbkGCyqG
...
# DQEBAQUABIICAAFPXdYKyQ8HZB92ZZ24vxg2dXhOqj1AFk+OG0LBNRyb1QycexcA
# cV4FbtK5boeT+B0ZDCCzSeFZcxplhfXxasBHYjrOc2yMYcG31sqQj4YmuggPUtmP
# KFXHybOhNwFXDydYWwGsE3eSCB49g4+e5DaRYJMLj839PKHQvMIP+eveEMouqeMm
# BjodupxrKnKEfFULXkbfyRll7xRRl8snl1BsMf+FBG6HIkLPF+PT89m1uIBmqCwa
# gxWjfn0G5JmRs2c++WcANl7dVrjczqkhfSnAzmyh0xxwg0V7I1WnVIkfg1rfmwey
# SRf9xTBSeGIZVkxA9HWjWD4RD03SRXJURGv/kNSG6iZ6ZY17xd6j7JYga7+hN4cD
# YiEcUmMhErswUKDD3e4JUol+TwIKai/KVK73bLW1mK6n+M6OMajqIt62cwucX1JP
# DeThSiyAh0MqlTNAiBjf04d+ioTCG6L3LxET+lBBSOUeAI0ePeKO3cnr8JbRRjFi
# 2kvB3zT7uMZJ8nxb6CtLiqtWDCpJ6D1+Rf4VYZVXtRVlmVVrINlCSPKozh9JANEi
# S6BtpOEYhDsW9+Id/79vvSrXax6evVaSgD44wXj9dM8bsKAxtc6ARmBez5/A2y6a
# 32ylKw6t80Tdx5Og0jASAaU0Z8eNDT7O2ZeqQOzfqY1B8OuP/0JPHKpJ
