# CIS 8.51 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.51";Title="PostgreSQL require_secure_transport enabled";Severity="High";Automated=$true;Check={param($D)
    $cfg=$D.PostgreSQLConfigs;if($null -eq $cfg -or @($cfg).Count -eq 0){return @()}
    $ssl=@($cfg|Where-Object{$_.configName -eq 'require_secure_transport' -and $_.configValue -ne 'on'})
    if($ssl.Count -gt 0){return @(@{AffectedResources=@($ssl|ForEach-Object{"$($_.serverName): $($_.configValue)"});Description="$($ssl.Count) PostgreSQL server(s) without require_secure_transport=on."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAcfI6PV4+kc5hK
# fsFk0DEZ8dVOJa86DHoBRs5+KNJi4qCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIETuGKRi+SDhSrpJIham2UUGCHRv2Xtdh0hJ/P7b
# RXopMA0GCSqGSIb3DQEBAQUABIIBgE2baWWE2/5tWCvAzK/0gANZWZWtIcaliyjA
# joS+6qtQbSIKPji/A4wuUEw/UFhMOfHZm0llEvPBy8NFU2vAQ8GrS8+ajvQtNYB+
# VS9acIF+p4O6oFYYxq1g4METcWrrpnRzTTvt+SlK8msMY3iLkn2UcCg4kv6o8pWf
# RIr7f8xPMnpHh4eUOLn/X/DO5CHlL9AMYqdoEmjCgCgjs2jIDSEw3nsMHJGwwIiN
# H7EQ+21izx8NF/v0tuccmRyfsnmXKdxZ0zTgqJxxk6jGYlsHpx73txP2FO58/Wu+
# is3efvD9/rKINgT9U1bmqFrVNCQ/y+EstUfLb7yKbQb5i6SsgkbSSbvOlC6mxGyl
# hLrFIYPSxcYWBVzT5grXeYrUGbd+yyqxHNJQbJ96SPKjoxroEfHFi6Y77XUuVBrA
# GOma9tVD+OeDBcjD8mla747/r3WRqJE0IvWNT3FIbiqNRq/CTgCbHe/wAFKNWtil
# w7F6NqMmwnkMeNEZ1LTr9PaCGAnW5aGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBbMmhKeYer2I6uRZhmxMhutoDRC5R1dwTkUsPpkksV9QIGagxE2ahW
# GBMyMDI2MDUyMzAyMzM0OC4yODZaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMzM0OFowLwYJKoZI
# hvcNAQkEMSIEIKYgqhsm7H6b/JAJSv3aReup/4+0JBRRZBe1CVev6KgQMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgClEcBemRV5kWBZqmuD1hCOmAT+22F23nQ5m8zrhZ2b78Ie
# k2fAvym8HS7A0O7AvpPZtfOg1FfF1EtyoeuR/XUMBLx4Er/RjP1EvDMcGzfrdnhc
# pJetJyyP25J7FsVdPKab8tKrKq+gOlnqXmBCSnWAAwCqahsN7Bja5kmAB55l/jJc
# gDPFzyCD7AfRaEHbosrWHr2gp5W2u2VgzVAkB5Z9ZtnijlA55Y8SqXOElsow4ABx
# 45H5bgFiIWutAa44GH/15F0HPd6MlQnQAmqU6HVovJnyLr/ODkFJiGmFwJloso9W
# a5mbRnPjf/uEo25L2l9q7gL7JlO2uCClLZVfjIi8HiAhJHXawD8eF5+NgOrccpLP
# G6+/RXRoxjpI+I2MCJedI2x4YtNJwmuohdqf4EHps6OBQgz8VUnJW+EdYDWdNtmR
# U1IP6R0u3ppbbmc8UOrEGBvLTNx6y4NIumobOvXNy0YHKRcCwi0CNnHh7MxXkQGo
# 0I0jo07yoYuq1HmuhRGOrNHdyf6FIB4gGy/6GfIga6nLJp6od4kKedCrjY5+Rtax
# eviuotM3LyFMfO+nqpHk529be3jZz2G20hebOH8sPQl8J356cQRwAEKUNK1TKMdU
# YHNIldhUoIH0ZtBMX7L3Hpz+aDfcDlJZA/sZmsYnwNt0td0XQz2BMUBMO5GCsQ==
