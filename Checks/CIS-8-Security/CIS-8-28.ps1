# CIS 8.28 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.28";Title="Redis non-SSL port disabled";Severity="High";Automated=$true;Check={param($D)
    $redis=$D.RedisCaches;if($null -eq $redis -or @($redis).Count -eq 0){return @()}
    $bad=@($redis|Where-Object{$_.PSObject.Properties['enableNonSslPort'] -and $_.enableNonSslPort})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.cacheName});Description="$($bad.Count) Redis cache(s) with non-SSL port enabled."})}
    return @()}}

# SIG # Begin signature block
# MII9GQYJKoZIhvcNAQcCoII9CjCCPQYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC4fKaB3V+KVi0Q
# kdUze0I2l/6Uk0g30cfWhtC5GCAFOKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIB+BEVNlXZ5KCCdEgXYne8sMVLY7jU5e3cgpYIn6
# XnulMA0GCSqGSIb3DQEBAQUABIIBgJMNC1N8yodg7cuTRp60L7ydCHf4cxGQPmrX
# ghsdN3aOC5QN7jgNYS4Cd+IwbJOPBvhSHnuQgoATrBlmMfNSPrQTtVV6Iik5juzg
# 9zeDzVB+Zi7n99wktKBf26L6+oPxmu6ObnQc6kYFgQ9/X8MvdEeUVOUlnE+eBKJa
# qDdjgJJMCDuDVZxYohMx/8Rju5tYYCK46w8Eqm9v+oUHffcR9sYASpd1pnRBvQRy
# zWX3IjlCQwxhOtgFs0hgT7O/2QTm0aYORx/GRTWS/l8v24F35jchVlUSScnhnMoR
# T6Q6z4/y0tg11bi9mjQoDncoEzihangtSleNtE/iuF47VgxuiDRJZNqeKOmVPwyI
# M62u1fI4S0zZ+9Z+w7iW6iOcVPZQbBOqfKg+Sg750sQVnZNfNPxfilBa70XR+wR2
# RfLIwprsuW3cg+dQrq8YXWqQ8eMi4xoCanQYm8oxEkZe04jViCqgfgsPFm0BjQMB
# tkHNp/l/jJvEyuwSlCPQT+gEktVfAKGCGBMwghgPBgorBgEEAYI3AwMBMYIX/zCC
...
# AwQCAQUABCCqR4srsTKZJi0pAXI+WA6iTQwbKpXvgyophGf77IpF3QIGagxE13G4
# GBIyMDI2MDUyMjE1MDc1MC4xM1owBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIyMTUwNzUwWjAvBgkqhkiG
# 9w0BCQQxIgQgIAZbtyEtdeKlYU/tcKssYtxoj5gcSOP76O+8l3bzTMwwgbkGCyqG
...
# SIb3DQEBAQUABIICAAcyrGYIKo+FzvrW8iAVH1yZ0tjZJin+0CEChgkb+v7ZkYqW
# cCBe5Ne6Hd47IR8FgqT7IbCdu5OBnTptQBPdHdkpO8glgyLkr+xBj3HfYHmb648o
# gFaNwva9K2pGjSaezcCrEEI5nVpeM84T1exf057jbhS74wfcQMrY8PbLzEqefNSc
# KD0PaS4z3NTKAhypl0JOTfTRzaJO0iKZs2qu+Ky57bz5GRakWoft3NfP52qW+Hof
# FtDig9FvM8gykZ6vxPLYiOC7T+PHZTj+dP90ZLYnmW5Erng1SGRT6c+csKbuv/fI
# 46/iDR/OPAV+uJMUf8MiCxz8FgRZsD/8CbNl2rXfAti4AS2BKqqoaFb3i73TFu7g
# PkNCWwAMATw2GEoSs036aDU2ajMote4KYT/tNLN3xCLmgmrdUBrzfZHhvWk9lxsj
# HTd812hnyuLSHNSUo9s8gcrpwEp1ARQt5TZGXTxQkPSoJoC9J9hpl+XZ3cm3FTI7
# a/ZWy4ivRbsrQQrpNZ58v2S53xVeWiYpeS4WgfFz1jIXxiCpBxDIuWjvz3+ZCcJe
# YO02pirCkmBzZN5xIXVPTpupeU8OQZf/zuyk5AA27mfp0IFkn+wu5Qsl038K1dkT
# y7Ze/lfYefqJ2rDfcVRBnfwzYz8itzlSwFNel4tcoktdiU0ohvOAzpeEasm/
