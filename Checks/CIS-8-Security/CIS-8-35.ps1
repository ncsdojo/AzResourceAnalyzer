# CIS 8.35 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.35";Title="Data Factory CMK encryption configured";Severity="Medium";Automated=$true;Check={param($D)
    $df=$D.DataFactories;if($null -eq $df -or @($df).Count -eq 0){return @()}
    $bad=@($df|Where-Object{-not $_.PSObject.Properties['encryptionKeyName'] -or -not $_.encryptionKeyName})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.factoryName});Description="$($bad.Count) Data Factor(ies) without CMK encryption."})}
    return @()}}

# SIG # Begin signature block
# MII9FgYJKoZIhvcNAQcCoII9BzCCPQMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAEdRmfo25g/9uO
# TulONeWkG9ntmDywhyezfzGiTBdnA6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIJp3/Ve/TpqbjR5+WFyG+FsVJ8Os9BcjHiu7wEzm
# bCGJMA0GCSqGSIb3DQEBAQUABIIBgAWmDiHpWauctwv+wkd0//lEYXS4nRS3sjCf
# a8FH+QTFsYmGIS8JWA3+dCSP50BuX76cmh4MHcScx8ZOt5nMUGOPMKlp5Rx4UiXc
# rgV5ABD48ftgQdNkkOuOwopPSb/DpP7JbQDof2myhs6iZFqX21trtBrCt438f3k9
# t7PZTkl4qRm6vI1ESQbkz6xQw/LdH7ZPnTRhKrxs5xOuKasuZ1grDIxgaO4blPPD
# w1bscYbNEk8suaZcV3w0s6aIlkhY4iVO3gBzZ9o4nHtswn7PEuLUMd0ZwSp19BXG
# E4ko39Az/UPe8aq6/DK3023lcsrQ1BhrTOg+/e1QZuXgNDnva9gVO23cHiJucDie
# JHJmRaIP3ExTXL4fFdS8PqkeatJHwOv9uqaLjp8QfhnvsCWIwkG7UM8uB41amGbu
# MghwblVfcjqrMHXcyJkYpr2iVa82vt8xYLKmIXveTyHWmhbOTLD1d3i5Qs877wND
# qEYYh8ve1+PqYQLkoM2POc8YyBWTzqGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCCHry42cklT6KyUepN5zFH6WrFa3RwhVGEZtwQ2yz8mPAIGaeiBPvvz
# GBIyMDI2MDUyMzAyMjgyNi41OFowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDIyODI2WjAvBgkqhkiG
# 9w0BCQQxIgQgfMyO1UFYWPrOb7U5Sgz9WhXXCeRpZdUoRI3vrF31ae8wgbkGCyqG
...
# DQEBAQUABIICAFKNY3ueHPUWNXeGd1FjRf1Il8tnUj0my0qrZJRAhDolegoGfoI1
# fYZTQwzoh+RUG2AMeGm4pODvqFJCawVPOjVsCzPl+uCzTFWZO++jyxlzYeQBdAph
# RmdEwj68IdJnVQV/K24tVPvUZskRBho5tjH/ez+URC7gpreVhOKLXbH8ZoIPmK1c
# PTpsiLMSAurZwZsGPzv+UJ8HmCcOF4uReWAlYtof/YyKkvM4e6n0mmN4LurxAbXv
# e+c1mX1cP8vjib+7E9dnVbBQFF9KaIaARVnAcP6p/Npf7NY7cxSROB7isn+UaHiL
# dXl2i4ujPnqNuk0cB0aNqR+RDutyeOXGxuIriC9o+3cuhXgr7gRPf/qVOWEwNGM5
# f2SdclglNcTPPsNjPo/9yFYH9APYrFfGIbrXL7yXYq+MFvTr/K3Z5gD/HiSsGGm7
# oQFGFPf0Sfu0c9GkAMJriXEpRmxb94rTAsF6Xb7iHolyZSZq/DxLten3x2zZn9s3
# qD0g7iK9bubBToLU5UssK7GKEgcpVg0WHOf1W3Dnnh/945H0GNV0D7BxKqZZDpvA
# IQKUyIK9XULxiWBDmHOCH1Vv26XfyWxlD+isAZGF14zv1fm//8OS1METvg8ePu9U
# QsHFv1MxkhIoxO2Qv75Zc02STl9NsfusytuatGa73UM9bCoWVdcF1X7u
