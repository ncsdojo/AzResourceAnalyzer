# CIS 8.1.4.1 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "8.1.4.1"
        ...
        Check       = {
            param($D)
    $pricing = $D.DefenderPricing
        if (-not $pricing) { return @() }
        $plan = $pricing | Where-Object { $_.planName -eq 'Containers' } | Select-Object -First 1
        if (-not $plan -or $plan.pricingTier -ne 'Standard') {
            return @(@{ AffectedResources=@("Plan: Containers — Free or not configured"); Description="Microsoft Defender for Containers is not set to Standard tier." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDEW41quVzUcriK
# /g7Iho8ydEbUAu5Um2tl0p4lP4I2/KCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIE6qwnlZCfqRkbMqt/huxpzujjFG2W2PmocBamFU
# rBASMA0GCSqGSIb3DQEBAQUABIIBgA5U3lZaxN8QGNeFNvHWayhZGEUfMKDUaGQB
# 7j6IcwpB4CQ6/bDtdkFsNx8FHk50KCAJ83Iebi/QEpRuVh9lyVuEog29pOamqySr
# bvSaMOzFVTiuJoKgqiE+GMX9vpzoGUVjzmCvuQcOT3EpnEIM5xpq1VFUVBQpA/rG
# iTBtvTlbI9SpprTstQAckV7P9mVjdJymMN06wXbML36W9nQpYmhwBWEBSgE5+RR+
# UOukHEwRg/yNS4ZlLFUieZI9WmxJ4auaDBkbjQeATQpq9QpELZiLn/gSUIAzzlXz
# k27LVP7ALE2x675Qpl4B/dOP3SRFyQG0+cSgnIoM4wA3EPiC7erLy7dioDbM5kxE
# XO80Zv455ZP76DnWDqeKWVnnQwOCyYDNWppqRL6tsuT+doBtZkQ3qyIQND/jXSNK
# jov76kILfS8hsZVOf/WBErAqnK0aC0y5xmDHqkG6e8z1yyUye/FmRpdTJzv3EDD7
# wTF+rAhlxymAtggpKkK3JaRi3BsICKGCGBIwghgOBgorBgEEAYI3AwMBMYIX/jCC
...
# AwQCAQUABCBOa1jlXix86VVvV7ivhNlIkTl4jbg4xX8F8QmSiOUZ9AIGagxE2Z6q
# GBEyMDI2MDUyMzAyMTYxMi43WjAEgAIB9KCB4aSB3jCB2zELMAkGA1UEBhMCVVMx
...
# SIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNjA1MjMwMjE2MTJaMC8GCSqGSIb3
# DQEJBDEiBCAFSjfamYVW5v5kclPvb2+up8rMqFQRWqtqfonBXBwBqDCBuQYLKoZI
...
# hvcNAQEBBQAEggIAFF6GAOROuHYCv/d7VGdyW4Dv8MyuSjGWqeHSlb/WD13qHEeP
# mP5owYVdFwhwdRC+OikBruTo4yA7L+rrJZzEaMw7roJBrya5MM5dE8GKNcTTenrr
# 5VImcdYDDt2GJYPMq32zTFI2oQ6IlF/ZYuNT9p1EjyPaYlAXuuYIyYWpe81y3Hyn
# I5oXevf4ay6kUA2tvtQN5GydBODORsR0yX8fb6dnh9htCCAruMZJmVZ5t5DyfNwu
# ymdl/aPytafa3zwybDmF0H2rFjVGJsaFL/JqKiLceXtnxzBiJYCKBdYYchBGtYJR
# ZLYaW7Zyz0TRr/qUJXntcNN+Fh98Kd7q5A6qWo3MGFutKvdWMYVSYjjHO4wSJRgo
# yDJiBR8zPu8gn2igMj1aqggw9qzgX1b/xklR4wzjdqejXYWKnq2wej5E4s9o+0x5
# S2Fc8Vgkg8N6FXUIcczz/ig5pt5jMfCvm8Gzo5w3FAxbr3rlOJdnNgSUAgfLJgQQ
# nKkmj/sj22v2Eya8dQI3Ojh9aiIZI3aPiUAhpNAQa2tra1QccUMekSJ2XlrsqxIM
# myKqbqAxy96OyQO/IwDXvZ7iAoi4fjLn1twTWh42YOp/g7ghJpI8ohGIa5wZ6Od9
# JreUydtX0mExMR7W565LB1CTvf5J2tFgRrJspalj4RezSFNQGL0WkTBLexI=
