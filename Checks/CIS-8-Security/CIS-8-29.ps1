# CIS 8.29 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.29";Title="Redis TLS 1.2+ enforced";Severity="High";Automated=$true;Check={param($D)
    $redis=$D.RedisCaches;if($null -eq $redis -or @($redis).Count -eq 0){return @()}
    $bad=@($redis|Where-Object{$_.PSObject.Properties['minimumTlsVersion'] -and $_.minimumTlsVersion -notin @('1.2','1.3')})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.cacheName});Description="$($bad.Count) Redis cache(s) not enforcing TLS 1.2+."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBwttgAWk+18iTY
# JArSV53bSAQh1sUDEVCL3ST2ZEg726CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIOXXyJ04N9xqESnSVfckUmm8fj4CXO2e7o6BcdhK
# k1pKMA0GCSqGSIb3DQEBAQUABIIBgIIe2jUfzl4zt/ttpaxwN0/b13llWVq/h7D2
# 9b1XCN1UDR6pz6d8zS5yFrpWhOjNUo1uMGmP047A3aIcuJ1N+kkD71ROLWOeqdSf
# PzXdCv/gTiuzG2fJGlM9q7CGfV5aYN0SzN1NQLGyM80pictZ9i/dlk/CoJ7ZrKlT
# JnhrRhK+IuXLO314Wt6qOk62B47SVJ2ImitaLf1XXQXsE2mXlLKf3iJqjjVSk7MK
# 6HiVQvdExawmBO8JlO4uQtjHHGsoF1bg2ykn23z2hpV1znY3obgMhfAeC7Oi/ABI
# IFM3v1gs7AHfh4DyrjfBJuRD9B5ofmsF1fBLzOMY45xgkvOMMW64LDDr39K3QQwQ
# VQaVbhK0tquAq5KScLdGTkR7hUhS+NxZZbYqC9OnYFDXSYMzigTIVaACJrS0Gy09
# eIKOyyMuXrAZMlzitEi3ZrAHx2rLR36JwVBuh+lxfFc4Ejyo41XeV5iGtexkreyf
# RUKaDZ08vDrHQfAR4f4bZGQ3/zzV2qGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCBc/Ko/GQfKBrqSA1ANPMfo50GFzAAgJ4+f5RYcKBOTOAIGaeiBPMS9
# GBMyMDI2MDUyMjE1MDgwNC44MTZaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MDgwNFowLwYJKoZI
# hvcNAQkEMSIEIAWoz9R4urdnw2MpnEPdouV9obVny7lHn2vxFF+6NpgvMIG5Bgsq
...
# 9w0BAQEFAASCAgCWqC7ckd2j/iWD2JKF/ZsEfvBLT3a9WQHR+9ywRMTJdEaXOLZI
# DDfjqtY8lwLeDG650VqXEXjqyeMtFo59mkThcGBeKSZMdEVKg2hh4CJ1a+f33PbS
# XhXhpaatfms5OyOKub60uYpKZWDXujPSjCCU+Ecd2mOWqiivYJFmy03f5MQ0UB+4
# 5Biw3WO+eUIPvGleFvEUtVtGD+yMRZSUFMQYen8YkheQD7sW738diBEg8as/ddOX
# ATVoeNmRBdBXRfuR4NngLEkCeDeU69pU4KBPfGjrgzCPZx2mLU7iGE+VNbfPUSIS
# Zpz+Yaf+6IbOlmR17JSIOqqhsxHjCwivrrGl3LN3rZpPjZEQRfAGJAh1Mko3GHaS
# FxNQjlUCe4vbDXRpog2RGpJUnKi6zlv9U0/Hf5DDjkkg3oORR31qyxrPoaXQ4WhG
# 1CIRbo11uYWpEWd3gkbi3gjRBkrlM6us8ECiFqasUIIKb30+B4Ls8knLRnhEdkfd
# 1cs15TAzWKkqbtI/rLMR06Ur1cpXuPHC4iMA9/pnmEzh4YiZgU6cky7S54Gcw0nO
# wZ7MX8J/pwT6RmFzn+4HS+mHWPgYQXG3TIm7Yca+MXSh0b/1nSyo50jochytVr+x
# tjZVwqkWlk8a3XECOI5MAAJJ58f30saHhNTUPfHEM2aUD0Mg77kCV0icTQ==
