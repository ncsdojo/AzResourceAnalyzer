# CIS 8.47 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.47";Title="Backup instant restore >= 2 days";Severity="Low";Automated=$true;Check={param($D)
    $bp=$D.BackupPolicies;if($null -eq $bp -or @($bp).Count -eq 0){return @()}
    $bad=@($bp|Where-Object{$_.PSObject.Properties['instantRpRetention'] -and $_.instantRpRetention -lt 2})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.vaultName)/$($_.policyName): $($_.instantRpRetention)d"});Description="$($bad.Count) backup polic(ies) with instant restore below 2 days."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDRrn5m+4xyOeYK
# 3/8QT4oGoVn7zGqkDdPo3QyEfRI3s6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIB1yT65zinCl8l8TihKxTFW5+R+Z15XUHYsvXiFI
# Rwc/MA0GCSqGSIb3DQEBAQUABIIBgJO6oJHxNYg1sEdmFUFbUen5RMTWXxfQ7N5f
# /zqyp5+eZsAfjonWjy3C5H9wTJELTCw4S8Upz2GtDN9JhWWfFbhi9E+BpAavHNGR
# 6so0/Uqwe6I57elGLDaVn5gzWIAzoK0ybN97q9luYcoL8xErGoSOEXK0ZgRjvGjB
# bC8ChJ2WpCq8cUQjfWwWDbIZzPze11MusSGcT0SMQaGPxSuEZ4LQjRnx/EFWN1Ku
# NvkHXp9SOIIOyx65ZPtnp/vo4Yf7bZ62DAdoLhz6Qo+9s3rq69tVKY/VB9aTuzKe
# ngVQK85HGJqHegnHSE1LEi80Rav/7AHzineYZILesugOD/uOB/hpjK0okeJ7o1DO
# Q1xNJaLx5i8KGeztq0kEc3bU+AQ77vzihuLUBsQk86gZQHTkzK9IVw0csEZPzYhZ
# e5VMfe84TX3fey0M+mZA58js3Ls9XzOBxQpHcmv78LlS1En+p4kjhu+nFUPPeqmX
# omTy90UNZJphCbCudp700T56g54HrKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCB1KBuf8hyBbwOHq1PihADpqdty0sr/7jTYw43xvgiivAIGagxE2abv
# GBMyMDI2MDUyMzAyMzIyMC4yMjFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMzIyMFowLwYJKoZI
# hvcNAQkEMSIEIJPJUsEIPIKXb/+KQrow+COgNFc6AVE0zE5PGgL6MOmkMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBgdAMLtcPEjR1U0/VtnJqcFJgRjCUizsA4m/bXGHdhDN4n
# VhKdIdi+MkPIZ84seWiybzFtepC41BCQsjhh74poDEfNhUmM+UDeh4VJzdcgHleR
# alg6pOkVzYKqaIG8DycZP7CRcDwaNq5EqPd4hZEn4LuNJqlFlNfErZjBdVBXivjT
# d91LDVfWN/oBtCBwyrC3JnZWM5y/0u4pMOlBmhrGIHriFlFR/uDNPuE24oF+IZWz
# QXx+w8P4MyCsHNpzI1U0ZmAVQZ+SazHmzhg1Fmg9BJZc8T3NgF818rQicZMpMwR4
# ARfWlkbYArT1XVoUMyoC0HE+JgguI4V4dCcmE4X4QCN8aHnDHsc26ZSA/JowhokZ
# 7uLJEvToJtRRUXymlVyVCyZD9d9FYveaqWXBH3ptcPs19g6DtzyIX/GQpZCSPlxU
# jjzzD/j9qxonknCSqs9quNWBgKLfYkfGv6Sv/jXyL88c0+V7fE99m8hxYKzjc/Tp
# fwoIB6Iv8J+coSQMqmnDeWYRZbG8IuZtZMhoE359iBLI0/e1xqH7BObYZU61nJYp
# S/BW24ujn9ecDwR68ssPorwuL9Cd/0yDF3RA3inzffQI02C4WH7UtGSvmgthNsXj
# A9ASpWrMBOqm98ht4Is7WVbakmnDgvHldMipGa6YgAiSwHQHv9PA7WjIVBnp/Q==
