# CIS 8.59 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.59";Title="MySQL TLS version 1.2+";Severity="High";Automated=$true;Check={param($D)
    $cfg=$D.MySQLConfigs;if($null -eq $cfg -or @($cfg).Count -eq 0){return @()}
    $bad=@($cfg|Where-Object{$_.configName -eq 'tls_version' -and $_.configValue -match 'TLSv1\.0|TLSv1\.1'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName): $($_.configValue)"});Description="$($bad.Count) MySQL server(s) allowing TLS below 1.2."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB+scz5H0dGN1nP
# Q5plweAvsKBVuzEU22lAfUJxUzU0+aCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIMmkRftu7sFJQHSg0jb/I50w23BT/XcF3GBXUDXY
# drcwMA0GCSqGSIb3DQEBAQUABIIBgAl5Rsh4c8cM5ODsu6t+jajQ3GviVnCpandU
# k1gGixkPJ3A/DlSpkyh0Mq/7lwxtBBK6iLk6G9o5lli8Zn0yChp+PR4DbeB1+4cv
# jYV5klc2fYNcZk0z//7QmlFaF+LNjEwBXskxtGuDlFRqNEnx1ra9DNMQipd3AmL5
# uzqspx9iO6gsnnjAEwBaU2kuY5JUl82mKUJS8sYCuPAwh7Ky9K18cqP9/HovaPsO
# 7WbanhuTMaDDYDX4GTqvaHiyXy3a3pI1OHgRRd3Qt9+W7nYcuAs5P4oSGyg3TqSv
# vwk2nKX+S98CzxO2A2rTMIzLQlFjfzTtTypIPbDXqrcc2nPgW04OIw5zTgdsV6EK
# 2BM0vQkf4FmHI0Lq2jwM17qZtsqxG4/zkiSrZIqEo+3iLgJzcije3odxLLqjTSW/
# 6SG950uDjwlV6znrahK6HNQNUynPFUjHlMagug9MOm3lZz4XPQPCeZZbQ/zYhNlY
# Nfg/MxwrS3crlWCBOR5QIPwcGEk5eqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDL5RpnTHJtG+DhpVJjaBfoUK4m1JIUbwsuarGWskDxtQIGagxE13/M
# GBMyMDI2MDUyMjE1MTkxOS44MDNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTkxOVowLwYJKoZI
# hvcNAQkEMSIEII8Z+ELq1WkIzoo9aCKZoomfGax5VT6HI+y5J5vNcYpuMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAmkjm1DqeqJ5Fe4HTVyd6ZJYOlvecYJOoz4rDsg7uRHUPQ
# af6T24HSAzqsDbQyO3fXFeXG0e7wsj8myjHVguvz2LxDPCyponHnTTTjtpu7qRo6
# CJG+VRPoMekZ85y7jKSfZUly75zo/YVJfViCcue4mAb57c6ZWNTy2qX9UufaZppx
# QR7RtRlerdqdDpvecimHwt+ql82ISaL7Yrpj9zntDLlB/6jy/3HtCTvW0nVzlvVe
# lc2FVmm9ZDrq/3L5xr8hJDyWvS30Ux1Tcszm2CviXkNAd2QyoyRq9CGE3mJsgOy6
# mJ4dWHkCRRy79IUeyyASAGMEUc+jk478rIAZ7cOUpGXBi/YD4Xn57mz+kW07qmVg
# xIxPRGszwdbKrJva0TvscegwY7qYOvhO5ZEHJDW+yuwxKNa0zDUzKJHUG6GFD7QQ
# ViNReB4Q9NV4FnFdPXcLcMerMnI9jwLj173DtRkigFLO8mk9JzlBmJuAvNnFfrcC
# bH5T6mSNpvJOMII1/EmUK0Jdk66jhIEKufuWfiV0ZbDWaiNWssw5+/0VjtNZaywK
# 1jCZ5RPCRIdHpi+nIb2yiUD3JvWRfuK9eQJiQnAK/QlU+SoCqBVQl7aHixUvcYlF
# AX5FM6oQRa2CAy3ZMIZaDyopeqLQTLKicvjovV4EdRhw84SPqkwauwGvAvdZqw==
