# CIS 8.1.12 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "8.1.12"
        Title       = "Alert notify Owner role"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $contacts = $D.SecurityContacts
        ...
        if (@($contacts).Count -eq 0) {
            return @(@{ AffectedResources=@("No security contacts configured"); Description="No security contacts found. Alert notifications for Owner role cannot be verified." })
        }
        $bad = @($contacts | Where-Object { $_.PSObject.Properties['notifyByRole'] -and ($_.notifyByRole -ne 'On' -or $_.notifyRoles -notmatch 'Owner') })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { $_.subscriptionId } | Select-Object -First 50); Description="Security alert notifications not configured for Owner role." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA+aB8vDgIfJeCL
# op5cJvwGTx2BvXX3VsFQ8Iw+NCPcc6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIG7XcSL6TIIwL6e24AFhersGOozBnZHH2fQ1nPcR
# sHDdMA0GCSqGSIb3DQEBAQUABIIBgAvVBf3Mz7G4Yw+6t6e0B2prphG0Qc/RccZa
# g3PpQNEPn7USHLnUIhGBkgdi+xjfF4odQVmupimHM46ZJk8n3T7L10hSvhz0XFkV
# lWN3gVRB3BQQiX10ymmWww8eS0qRVWrhBzKbs0bMAQ84r1HVjAqbo8eW2sByyg1c
# lv2SS6uiu4LY48Up3etR2sjSf0mOIBTn+2tgbjx9PaE7R28EkBzSEF6VewZH+k8o
# BjwYttP9f1Lzy7wzTAhZElQp9RWg43Q17P9XtNAYsdRIV1Uf0FCvHMvT0RGBKlh2
# TUL76X0U88bP3Jk5Jq6w8je4hVw/G6cEL8/IAzNc1O+h1x9Flkxr9V4I42vF2ruy
# fmg3XpB5LpHVBeJXMk0wfEU66vfccIh7ZwloQe9bY2zEtl3DchYnr1MPPDsn9mau
# uByG+dnk/QUJDyt+5RVdFCVDbCyjoSaowTrMjsP2Ms7Ki4u3JmWZKPH/3DRc5fBF
# TV4z734/kVQr4DWu69jlsmMEhpZflKGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCDUIwxZkQ0Iw5UWmYu7TZLkYiiUFq4830xP6YQVm5GnaQIGaeiBPvVI
# GBMyMDI2MDUyMzAyMTMzNC4xNzNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMTMzNFowLwYJKoZI
# hvcNAQkEMSIEILLfphWwx8NkLcZ/bliTJBHdglpQCaq0t7lj5AnkYB+0MIG5Bgsq
...
# 9w0BAQEFAASCAgAofBXwwgegHfZl2Bg19M/5Tw/IjCq7NWh5UQs3HkGJ5/UXAmoR
# i3M30fOdxkHS0PBNC7hFZ6XweYvezxAbbe5mD523v+kPiYgnZEsmKHq7EKZ+L2y/
# JkG/XHhromfyI0oEe0pQth12ggmbyzhoy1AzCyAx5P9I+kUfVi8l2A+97I5Tz591
# WR5X6Qw/gA+kI67OT6svSsukO1zlhdXC+VYZJnlGcQG1XacJ2572DROjrf6QaVPZ
# EvreDY386pT78BSzM5OceD9w3WC9WALLIBnwilbiDKtLuGsVmFM46mIAdX1i6O6y
# ivJDMmjVKFZjyATR7DTPpeSVjjc4FySCE3urGHOXLwCmVUto+umpwz59d+szOK7R
# KZ1n/LYfmIa6j0sgvwUN2O7ZitrYMpJdSryihxX7lSNUefc9l8L0A17egvZz8fy4
# AggOWGvwYnqiy1MEZDWsdE4eBs96cA8tDosALTfl63Jhadi7V4yUUplaoQoDYO0g
# xNFsQnNACWLPzqJezA97K5FB/obt3fQVmA7oDfrrp2Kf8sFo0EGJC+jythn7XiWK
# mCYZG86oVyM02I4t5Qey/XIw+VmAfDLTWcfYOYHvM3gXGNEjuP1foxrSsKFU5sOr
# YmBDfO4tmmxXtAr3lOfIXDak6n04Hm5mht92hm/kM6NwbQE26SbNmJ4Cmg==
