# CIS 8.50 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.50";Title="SQL vulnerability assessment enabled";Severity="Medium";Automated=$true;Check={param($D)
    $va=$D.SQLVulnAssessments;if($null -eq $va -or @($va).Count -eq 0){
        $sql=$D.SQLServers;if($null -eq $sql -or @($sql).Count -eq 0){return @()}
        return @(@{AffectedResources=@($sql|ForEach-Object{$_.serverName});Description="$(@($sql).Count) SQL Server(s) with no vulnerability assessment configured."})}
    $bad=@($va|Where-Object{$_.PSObject.Properties['recurringScansEnabled'] -and -not $_.recurringScansEnabled})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.serverName});Description="$($bad.Count) SQL Server(s) without recurring vulnerability scans."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDmazJLIYMYTe0n
# K3nNDYIiBK/d0OnmldGR36ok91wRAKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIG5ZqxZ0yK7twnF6F3gNfMvi5cvQs7LIiGrA6AXg
# DLNNMA0GCSqGSIb3DQEBAQUABIIBgGJAoo7UFRyQIJRmOLsDFi/FEGcfo45cwx34
# wIl9L473nv1rPprdUfPm4c8T1Qq8XMvMN1i/tuUDMJWPM75InXQCZo9echHiOO1T
# EGkNe2V+MzhwqhiDL4KNzsQDRDJJu55OSgJHf6HfaAT/TQ+lpRsb0SvtutJHf+ua
# V126TNycXzNjFZun6ydbtqpkQKgYFhOBckURXsccSXUuLJkHD7GOle/xl8iax+bm
# BCMEC8OrM67QFKoWImZnpPx5joAMKL8bM4Vlhipeu9wSYB0Q9r1pzldtb3i5M0tU
# 4GNGBvZvEAo49zwZmgKOo0MmCjPDw7Zcq41ibKgpxQ79OYI7x8hv4Wic9maHsNdx
# 5X4Ttz1yMA/xDnyjAqPTSJSdlG+GeQ1Ic57LW2iNT8n2wwMFfN5j6Mv4qk4BKWnM
# SeWyAAK+aCpbf8mIlDl54LW7EPHcIjHkNPoPAPu3avbHazcqGfLy7RqOouvMna36
# Q7dqCuKH23VIpTE2Be1xr8Dxp+Cxs6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAUUm8cpbdoq0KmYMVuXHxwS2fv8RPTapgwrNPb2wu9+gIGagxE2ahD
# GBMyMDI2MDUyMzAyMzMzMC40OTlaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMzMzMFowLwYJKoZI
# hvcNAQkEMSIEIG3adrlkPw40CS510D7dI7r336b6CjazfXeql+X3CnutMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAva6K3paM0YISTVAanew6NukLufDzhc0QTUdAG1U3xqhWP
# jZ/eCb1oh0t3BPdpoCXzcuMgtTT8CIduFsoVbrUVMZJA860Du0EfUfyGLRWjYNrl
# qxwHCV2M2WhCzyJF3svAVZHD5zNyl6xI/wJJs0zD1Xvvys4GsvNpWDMLqiyfNO7l
# vTG7o5w9mOGcFnGRNG3VqguXA3iHeDkGgdxWQ7xyckr/vGp+3p2a7IjgeHfgd/n5
# OsrXF1mjKjzph7ZH9WG3gKMGq6f07++rlg+12ggt5xbITVyGmGGdExJwAE03lSC8
# 1pCbZAi7Z85gWmRv51SxSIH2yLpXIds4mlrhugLLWQ13DTrk2aKTybOzJ3FazQ0J
# 1jPFEItJNvFqSd+9002ni0OfGr9baS4J4Y9gnAxwP+DCHC/fSKhSKhdRXqyeCr05
# MVlEzR7vNoUtiB92lQwk3ey/2YvibZ5S/6t/d5nHWDJRHIYVBCe9z86K0b42fnSi
# dhHDsCv4hqjiFcgdd9Ui/JfpyUjRGbHvG7gYgbX+lwSkYHPA6qXymk46i1AM7zMb
# nSb9MnVxcaDFWCUhNPnLL4cYrwtBxr6ctotinXTWxztifbQF6FOWl0yuzbAzhEwX
# 6yJ/od8k0hQBmJ2D19yEN+1jJmD95JPRU1MXghW6nK9TqN33/A2buBfg4YRiug==
