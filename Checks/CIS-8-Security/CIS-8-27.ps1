# CIS 8.27 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.27";Title="MySQL CMK encryption configured";Severity="Medium";Automated=$true;Check={param($D)
    $my=$D.MySQLServers;if($null -eq $my -or @($my).Count -eq 0){return @()}
    $bad=@($my|Where-Object{-not $_.PSObject.Properties['dataEncryptionType'] -or $_.dataEncryptionType -ne 'AzureKeyVault'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.serverName});Description="$($bad.Count) MySQL server(s) without CMK encryption."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDSPoLAcdsQ8MqU
# A+aJpRRms5XGY4WAyi87CHKfJjREVqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIAH8dRYyZo9RHa1zZyIFlTxSOFN/dUWw0bkXCkSe
# uN23MA0GCSqGSIb3DQEBAQUABIIBgEqWqpXI1eTAS8ElRfSfO4XjFi4YzCP60SQs
# yAGFaWfqmht2ORyVbqUhflLKOXE1+gW9aNYpKnHJJifhgyvpXJR1JSjq5OhN047F
# OqqYmylMRx1S8Xb2MNh+7u2L5SzTDNECVHI0kHefxzttW4dMYJNapRy6Vq3Vb7pY
# nnD+XptMPvK+rIWKKnB4d+naoHerkhwtEVCKVrdDXNRE1mxo8QSSjH49aGE64eBB
# yQBzhx0kQ8LWaiq88Tb1MiTvcN/M9NKPPuxqOMs3SnZ3laOw3Pu9L4VdGlAosKug
# 8WLn/Ut/TVJULi1l0gCvTAWxkfegZA8LNak2xcLR7kVmnKVyQiHo34ZaNUC4v//Z
# dJVTSQSxHia9D/UYwKK4agXGd2YwOnUJIKsFuDbvio2S1R9RcY8VxoV4A41UM9W8
# nx2XCAyhYAtOrgBliOh7qA5Zb9dbbkL8U9qFqjYjzy2yaZImZ3H84Q2DB+cfFtqg
# 8hodiP2kEzqykXl7FUEKzSvq+jhu9aGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDFKqFGW0+WeKJdf6kjRNm0W+zsVig9//XgB9eu6tizrwIGagxE2aGZ
# GBMyMDI2MDUyMzAyMjI0OS41NzNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMjI0OVowLwYJKoZI
# hvcNAQkEMSIEIPlW3PF5ITVqOj1ecsvQkuFILq5/oYL37yTlUmz9mQI6MIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCVs/7VmPlYC+4+uu/HWkgPZShG4lc67QNmr7VTib7fsOto
# rWR+LbxUPSEK4CRiaUhy4jfUjll7/MhRojBqjlbqRFyvQn6677m+UL9cxnxph37I
# vnjx7Ws93kLjQ/DgENFjw2+tBBQ3rlrcg27QAHNu1u+2hyDTq4L4yNDR6SDPVman
# l8rcRHh01udVwcCuBsWl1DCkIXcRM9z+WKrsX7FjxoCmLcl6HvJflrUCowKvCG+/
# jKpi7yYQu/9m2AHSe0eSJT0QeBOd68may0fFnwoHCg7A9CdnS58zo9tr5z+lBxfq
# z07Z3mMRps+O9uPT91In+w4/94Rf57CNiprTp3Il0048l1t8vviBeDVq21Uyqx1E
# H//WtaDLdgeLd5Fe1R8E8RGTzNb9i8d7ly8GnsV6gMjdE+XDq6HNtjsyUqwsLZDl
# epbl6S+IVyHJ8MLQn+D2Cm3++0/zNTOYp45l/ekHq7jReb/0fLYdJL3JvvNfYAJ+
# yXQQQl+7l7xMjd9TYML9aU40BfywAI8yIHE+kEqTv4Vy9JcyfQkEXXZLJPwOxXtf
# oQXxm0TTkvy5UCPHdisbWS9GXjK9pIBiXXv6f8/4G7iymWRWUrMxTZqdHjGGUd7y
# H/3VgdUjY5rNrVRT1D0qX5W4bE8lkO5U/evvdpBQeSE0zs+7sL0WX5AL2Hz91g==
