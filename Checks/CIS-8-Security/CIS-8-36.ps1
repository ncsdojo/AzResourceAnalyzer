# CIS 8.36 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.36";Title="VMs have backup protection";Severity="High";Automated=$true;Check={param($D)
    $vms=$D.VirtualMachines;if($null -eq $vms -or @($vms).Count -eq 0){return @()}
    $backups=$D.BackupItems
    if($null -eq $backups -or @($backups).Count -eq 0){return @(@{AffectedResources=@($vms|ForEach-Object{$_.vmName});Description="$(@($vms).Count) VM(s) deployed but no backup items found. VMs may not be protected."})}
    $protectedIds=@($backups|Where-Object{$_.PSObject.Properties['sourceResourceId']}|ForEach-Object{$_.sourceResourceId.ToLower()})
    $unprotected=@($vms|Where-Object{$_.vmId.ToLower() -notin $protectedIds})
    if($unprotected.Count -gt 0){return @(@{AffectedResources=@($unprotected|ForEach-Object{$_.vmName});Description="$($unprotected.Count) VM(s) without backup protection."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCBki36J/CHcauV
# +KKWkJ7VvI5i8F40fzxIRlgb0vmWoaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEINP5qKCmYwMf1qcT3xr1y5Jm2lo4CfgmKHUSlh/H
# ULDZMA0GCSqGSIb3DQEBAQUABIIBgJQqGXTXz950P7OZA4cVjx0phe6Bbi0xxwEP
# kdlTwJvTu3p9zXqQbF971R3rrnw/mdJpMt+k53lUhzAt7ve3IraVg7eUOSltyALv
# lScWSDUOPwF5EGHGshxf5HXPAA9N9zuqw5Qjfh1PJpSJ0SbFzYdqbjGGwzeSV9Sn
# MbB19hmPtetobPnZQPOm1QYJPd1e240hM418YdeyR4D2NYgYjEdQyrp6McPFA++n
# 4EbvuQCDQyvnGyqn3VU8qyLLCJuXSE1HXSF270RXJJJ2m+7SxP8V+UcLmK4zvo6z
# V/N8Yw5OalyoKxwHdRD559AIztUVkGQ2ayG0XT3IA47IxT+H5USa0rR4+1eV52ZW
# ns8anh9CNsVPBlwLi3u7GOdHOlgejGJU1ceJTlQsLAED5QxXr/bpJNcXcwCw8QHN
# nPa5Vg0BdGR0WL2Qspwbg9HznUXG1mbDGsK633cH5pn6/gUe2QzsA5xAglpigZeX
# LqBcW4V9UPUhiYQUvuvOdlWGw95guqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAceoV6v3AysEgpxRvTZJh0V3aOeAUTrnpAlQUu0BKAuwIGagxE13kQ
# GBMyMDI2MDUyMjE1MTIxNi43NDJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTIxNlowLwYJKoZI
# hvcNAQkEMSIEIEm+sc9JQxu+KIjtF+F12BoEkyTXaSRHppmwO7MnkhksMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCDQUaclhVv6TgUfb8DoZDy+dxvj1FPImpf30mWl3vPPTY3
# g/gsdNPGOUMxC5U8rkw0z3fslP+ejM1EN+Um1mq/xPlGNgTuFWSIrNW8UCHy/+ja
# Zy3Q/GX3Of1JTG3ybEjqziZmdwhry5MMdxpiQOATmDBGVDB/Osm9YVr1Ij1XXvzz
# eiO/6LvWveD0uU5+KsONgt4ZLBmJHtfgFsnLnaGhMHHUyVw09ZsNyBvsN33wMTkD
# pss51nRqyQXnGztcF86I+DAYAroIUaITTCnGvEPJsGXDZmA6U1UM7K84b7KpqI6Z
# Stp9v/0VrNa/luxoMIjxwY4Mh3+CfA4d4ekCZg6cnVMuvMBgAIe7Oq6e9mJ3D6qg
# PnhCu8nDyEkdGQbsFkhkUy8rhGXRCEVXyU58oxfGU2/L6MuJTg9D9NFd39BOVs6P
# J9Z+nWb7Wx7srfCJityHvY0IlA5sTTSFhuZGUeClDqBq4D/n8pGciZ5gCssnuIj1
# ZEi6jd4YYTFOVZUFEfWJu4YA62XXAKJICmHltZeXUdjYtorzGnN0BK8wArk7GXPP
# a/B8kBR7T5K0T5nkr4NKbwmQHpU76PJl/QhvJN6wK2d/eehWFZJ6Z1iBqVh1yese
# uBIeFkeih7lwaeuolGJfYibUGngqNqQfnP8g19ZdSqTy31q06DvbFv+9GU0ODQ==
