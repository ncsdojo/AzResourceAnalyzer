# CIS 8.14 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "8.14"
        Title       = "Cosmos DB CMK encryption configured"
        Severity    = "Medium"
        Automated   = $true
        Check       = {
            param($D)
    $cdb = $D.CosmosDBAccounts
        ...
        $bad = @($cdb | Where-Object { -not $_.PSObject.Properties['keyVaultUri'] -or -not $_.keyVaultUri })
        if ($bad.Count -gt 0) { return @(@{ AffectedResources=@($bad | ForEach-Object { $_.accountName } | Select-Object -First 500); Description="$($bad.Count) Cosmos DB account(s) without customer-managed key encryption." }) }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBZzjoI+n4T0/Qk
# AAB+mNFSJkPN/flIyLBjCyZgpi0IFaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIDWUgteTUE1GYjD1E4KB+Q8ZMI1rSnrcXevPleCo
# V1/PMA0GCSqGSIb3DQEBAQUABIIBgAS7ctxHz4CzDCF65SEAilyrl6RevXMN3f+H
# UJx/G57bUgxJl2Y4SD7X2/X+7gKP314CCSa+qGGBZ2FrRS6fvcdGmGN2dTXib0qS
# UaLgpf14eF40QrArNgSDsdJr86LfT8rpqdhxwpqEoDoEhtsIEpIXU/MCDWv+SuZj
# XkzdqngTzX7qQm5Lzm8bqSadyYy4GSSXex4PEheBzVfctJeKZVVS40u6rDjY4jja
# eUTjPFiMcCEkuHYFhRfFgelIFHfdhUgYpx/56w6IPay4uoBDaRuijlMGwKErdAPg
# PWshanvrc1njU0DZ+AcIaxos6I0Ewo8pxNqH522tCe0pzanozCN26BndsmekNOG8
# GBfuOelEZTlhKgnYxf6YoBVWU7CE1eelQ4Ct4ai2MaBpoYx1cvbzam39cXfCLr2T
# +aTmJXdEDMDOZkAQfCLNvbL+8Vf11fIT1qJVulfJSWXFL3xQCTRi1NoMr2MtfbRb
# OI+SzZD8cnxAohtt4qapJTyOanEpPaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCb7dzHpKXqS60lZJY/wTMtOHowc3a+8xjVmrS7/tIXywIGagxE12pB
# GBMyMDI2MDUyMjE1MDQwOS42NTRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MDQwOVowLwYJKoZI
# hvcNAQkEMSIEIG0/PPZNdzfcWVyDfWWV+t6InzAbzm3bSOSUh5SfJe2bMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgChPCwMHRMhKSdVX6J5rCT+2f58RROw9qApmMTSZbjXfeWA
# fYPK7faZslkA6xahIUiHx575S1KzT9Rheb7XG8SeWOsVLr4EKA0dmB8f5q0NJRCE
# NFNGe78ma0coFzstl9ixb66zdUvUd6UPU97jo8fM8a3vDwEVnWmorzWya2XOosXf
# TuJYAYiRpBhj1OrQastWY8+6caNAc4qFeYt5LyJwCrKWvjpDX2O+HI6T9RN/xAQU
# WrMY1xK9foRBdH1KTbo1jQcmrdwQbsTL9SQiR9Or/kX4XamzNZslgtFDLMdlG4a1
# 1I7TYxp9oTwCewCgqZ7nZ42upomhPLe/cvVhKJKK32msGlL4K8Cv7C3VT5s11h/K
# 2v/sZ+g0p2Iwue7N2sisoTAyXzgvLTziPHHgv+LgN/okJml3WtdXcLOggwr1as+H
# vXLZrL2L9M938SqUm6NHxB9dLacdpE/FBqSchp29ZCY3AgwLljdHkC5zaVubzUpk
# karmxn9augb6zkwFDdicYesQcVIZYAoVeldTjd+KkIjAOIA0dMuKV15NzhZqUCs6
# 4cTDAgANwoM52eWqLsUg19S0wlEQKnZn/SM+NIqr4jg6Ty+KwBlqH481wGVY0bhe
# LQdnHFD7HgMsfHP7ki2Kkh4ETFMamZqfFWAYQwYLfnUnE4XLMGx2IhkvuNljnw==
