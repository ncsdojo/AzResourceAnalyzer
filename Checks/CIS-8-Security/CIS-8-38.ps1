# CIS 8.38 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.38";Title="SQL Database TDE enabled";Severity="High";Automated=$true;Check={param($D)
    $tde=$D.SQLTDESettings;if($null -eq $tde -or @($tde).Count -eq 0){return @()}
    $bad=@($tde|Where-Object{$_.PSObject.Properties['tdeState'] -and $_.tdeState -ne 'Enabled'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName)/$($_.databaseName)"});Description="$($bad.Count) SQL database(s) without TDE enabled."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAZpLKsAvOSUfPM
# 2e61FfO6MW7uM+I9DtwyUFWJi7zjGKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIAGFa2LttluNhhlmMtyQTU0nyXtnO/G3DZi/bZ5u
# 7WdoMA0GCSqGSIb3DQEBAQUABIIBgG6x14u9E/77pRzakTH01pfY4fMKtCmda/UH
# j+goHOPTVnIVdIIruhQIRCXV2yD2scoW6E1HRFpyIrctvy3qfTruiL3oP0Mcp7PJ
# Vq4ywBPNgi3HmFe18JJSF5rCbphDmPIkbOLiBc3tQ86P641oEPPsvkYBBPUPvSIm
# i6R+o4dFFI9+3wy3vFwMUTVIkCwd0WGXZ0IFYdoSyeQiP1EBemIqkmrK3F8oGlXv
# JVPkLzfiHEa8fKcUpqSvHtJyUtP3rakJhBCwxjaN3u+88URlYob8HypcLLSF7iHq
# 5h+tYfV80xQ2kDpHv9N7v36nHATloRZdG7w7lK2LZFahGqlSKclfV2gLK46q32rH
# l8dbA/P6LlJYt8nvMqPuuYyI5Bx3DhqzV6b0JmqXDM9z/Lhknx7WVYJA1Pu5XyOS
# NtK2Mxv9ML3o/VjHogvnf1h3s3kAn3mIxU2kHJPTHgn/RHXf8JE/cH6UKzoxYNPz
# CmKWvfaCTbawQsSzMGK63eXOMgcQ86GCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCBBVQdVdNCROX9o2ircyP8ZtA3sCXpYLbFIG09ecoSy+QIGaeiBPMvV
# GBMyMDI2MDUyMjE1MTI0Ny4yOTdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTI0N1owLwYJKoZI
# hvcNAQkEMSIEIIJzrYMFtporPulj4KDLfLR29kBzsM/50x2moW0ekqYJMIG5Bgsq
...
# 9w0BAQEFAASCAgCQccdRJfRJOgycu9fRQuUhZOZOJ1g/VRvo1teurOwImcuH3TvH
# WJIWuBGvj23UYnZf6d9rOo0yUwG/u1EK/57fuU8LakoX18BqIwNYEutaUJ5jaEK8
# RmJRyt2diu8QqSBHTyZDrFNSUft0umW0wSAUVBUNcjqvssBief0VjY3BENDoSVSY
# ai/VPJw29DrvyFChNsAkteiZhCGn/4Tirvk22dH5PWL/0Ijkk4nOiwWPioDxo+kC
# 6B5vipgomxmz9ORGjDAKVBiqN8fR8ssM97xbJX35+/Pn/hHQkWmmqEmftevUpDO3
# IuZ+w8eHiSPuRZRmKi+SpWtamZdjqsA+a8tYxUkxePusyf6vNJ6QS3X3A+ISb6YW
# j0SsHoZnmT2Qw5lFZc/NHdbO3xZ7UDcvsyxgA8AUM+ormXzQM0ug3ezB9C/QIvpX
# V1qcOcNfacue8m6jHwixTQAhC1If5jw4qclDLLqtSYsnoOttkuu/+szQ4uq/5bCV
# Uy3oOA/FAVvztAAXNYMv7qKPHpmallgoA1jQjCxB7HCMjApYbIx0knM9SFLJ905O
# VR7SfZdwNm7almNtiiOrev3jJEhYeu0u+5CLW0WDVHf7ETxou1KCdUJ4Wp9MPtFf
# aViCN9XtjZMP4qN+BUGlNEWs7OX5xYYEC1EwmPmv4sipIY6DCidgV/xhgw==
