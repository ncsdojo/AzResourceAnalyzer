# CIS 8.19 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.19";Title="SQL Server outbound network restricted";Severity="Medium";Automated=$true;Check={param($D)
    $sql=$D.SQLServers;if($null -eq $sql -or @($sql).Count -eq 0){return @()}
    $bad=@($sql|Where-Object{$_.PSObject.Properties['restrictOutbound'] -and $_.restrictOutbound -ne 'Enabled'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.serverName});Description="$($bad.Count) SQL Server(s) without outbound network restriction."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCButUGsaGMLXGbB
# LxY4Q6xD5YzUN9IXkp9p7bDq7G4heqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIMVLHlFoaUY1Fc0AuqkJAqwQn4kODrf4M/TOaddS
# mdHLMA0GCSqGSIb3DQEBAQUABIIBgKM3PVG9kYhLjz5E9wXA+LC/3GizsGVgLEF3
# vnnojkBBx5+5ZFVanJ7nvq5rOJbEZe9QoVbeRDmX6C4PYTp5vsNFdhVO12LTKcvj
# JPv/SI8RiJGiKL7VvFKW3RbichWPW5Nb3SwHnnG67uoDLrF4jHDbaexcJJXWZ7hI
# vLx35jG1pkjacE06pCmnOXOaD07QUSQiY6uBHfodRNZiU6W8A/kUZcdw/A6nAug8
# 7F5KP6LbKeiEVHa+O8DX+N40h/lG61Pzmhc+VmFtA4e6G9CzmjMniBbEjbSn+waq
# QWtoeWPWZW66v1A0MyGUMx42KiEAZ01OpvPZrwjyISsx5TEJ/nXOYhUR2w0FhKej
# gMPcqRNdCJFBMyNVqLiQlMz99f8IONxGBeVqCH5Et7p0ZyaPLPuWBR4eVB1cg7ew
# EUjnJrVoh1iUIMQ7gru+QZKUYW30N4sKW+GzC4K3gjTaYKSk2qhl8r/zSs6vBjeA
# mLPlTy+f9Ii1LOVRep8nwqQynIxg9qGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCARd2uyWAjFYIUOSADjJyTPlgGEpUftbIjTsastKnh/mAIGagxE2aCj
# GBMyMDI2MDUyMzAyMjA0Mi42MTNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMjA0MlowLwYJKoZI
# hvcNAQkEMSIEIDqTdzumkMtHSXgYYFnhqYHBxxjWJynwpyKDgMhEjj6sMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAk5Inc1rfQ1ejEb4m8ftaxHoribSCETMZCTDiGKwEuZ9bk
# PiXcD4O6hKzih6iqqtHoE4SbUgkPAky3tFm+gXCYNkMZ+A4iHgpM6+44DzXX3fE8
# /A17bgQBLOULniUGRcbYsEmisjVst7xCurUPEkA0rqSzGfipDL+Li+P6JQ40yc6V
# +CCAu7Ry/jWaBuqshgE1phUkvvjkNFL3cxHaYo9YEhJr3az8nw4PEnmFEV5h6WFg
# 2oXtbfTcoAiyGSkkvE5j3I4B1LsA829lOlNVuGOnYEa9GZg6qzYqOmuu+o+oYgRH
# xX0U4AZ5pvbGeY+etl4AY7hUIPj1BG10knwCETlAlzGo1bQ/pLqREtxomIZYXmCo
# kIERfL6MGD/7xlPVPlMHjytkaGaxQ8oZ0EmTmZUe3urQE5eaOztvFM1FEDREc4zi
# Ol+eLhVcudRn6nKZe/AHCbj3mdo3SsXD4kZPPOGWMY/I3SiM3Rxm5uXP+pPPR29n
# t28C6LiyTURTWXKQZllJTxn+6PiNVENK5O14Sg98ZLlCyrXbn5P4SuXtIVp57Vh9
# 5RrlYWqllDnF/3HiNr/WqrYxDfZW2EyniqXD772kdfJ7kq0tyreyEcevqF74VGEu
# PWiQZWnjhHZizNiePRtvCTY3MQapZNpcGb1OX5a2zzaR54cQNgVVj7I3OvLgMg==
