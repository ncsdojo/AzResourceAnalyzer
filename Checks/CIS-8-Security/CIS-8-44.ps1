# CIS 8.44 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.44";Title="Backup policy daily retention >= 7 days";Severity="Medium";Automated=$true;Check={param($D)
    $bp=$D.BackupPolicies;if($null -eq $bp -or @($bp).Count -eq 0){return @()}
    $bad=@($bp|Where-Object{$_.PSObject.Properties['retentionDailyCount'] -and $_.retentionDailyCount -lt 7})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.vaultName)/$($_.policyName): $($_.retentionDailyCount)d"});Description="$($bad.Count) backup polic(ies) with daily retention below 7 days."})}
    return @()}}

# SIG # Begin signature block
# MII9FgYJKoZIhvcNAQcCoII9BzCCPQMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAySQA/g5pbMDHs
# /lKn+xbxk9dt9PashMC8gGGc+zVDvKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIJPvhIvrbNB3hpq/ahn5egpmbc2pTDoVeHrZrY3h
# F8PuMA0GCSqGSIb3DQEBAQUABIIBgKX2zpBIpHVgF8vIpG14yuyqZIy5YbGAtG7i
# +VEb+Rcng1FbMExxn8g9dUBIeaBDNbYpxdSocO4DJkq826hOb7g5Ts3LLOxr3o22
# /UQyc6S+8mYbBf4CWsyb4Kgsiwa02kE4YUW+8e8qW9sk6VE5ndQihyPHw2cocjeO
# cjWoy4P7/ziuI9pbIXOP1S1LjGxRafaNkobiChZctnqURC39/ZsmI5zWQUl2FWHH
# fABcX2RL5QY6fLsVQFdtnPANfkdZBY/w6OKyg2Lf6hKVgfmTSR4CzHS9Syu4o9V/
# bfBETxjtU+5mGGnYng8WKf+n2Hhz7A2mmf7cVuPbi0feKP6GHT8XSURBAgudLaaF
# mMob+KvskJ9aPEJJ2LrZHrHHQHXgqycRvgCbZekuItXogM0rPyrCBCl4CypXaENy
# wINpwVxp2DMxvVfNeoNXTQsh1JrP2GfaqihCSFiYRnXBoIC1cg9hkLOxCOytXma6
# NL37ouN2iF8U1HbiioLRbP0js0hL5aGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCBmNLq1eGTc8Dk2j7+uV+MLaFZQisSaRyRBUa4ENIJWJwIGaeiBPM21
# GBIyMDI2MDUyMjE1MTQzNS4yNlowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIyMTUxNDM1WjAvBgkqhkiG
# 9w0BCQQxIgQgZG3ICS3KRCc/6FuEh/LjV5ggjnhzfD0d744gRAB0xwcwgbkGCyqG
...
# DQEBAQUABIICAD/UC3eTQ4WdKyXds1Vlv0J3lx45Ct3KfR90JAVMhHs3BtYYUByd
# U1UAd7UeUEVHs+ObNfFy6fZDIGjVFNT68+YqrbRm0mBdC+OQRn06V11IJgbM4MaG
# 9xxAcjYDAotXEIy9DLy5vjGfFArrAKKxwDD04mJ5y0PdnuqyO/+p2UoV/RXi7NSA
# ZzMOh0zEpDq2codStFo1IAe2juq/gs99TfUW6tChNXUfUk/Sz8Clr6ng4j6Fk3fg
# K6bahs5dH9OEl031iAeDyM4jJup4UfrYvMMZNENLgrzPkO5IFRlp0T2qXXcyOXJl
# JQjPjtkZtsUNu+gyx8TXgJecPcLGw/aSeYZlmkWMZrDzxFCZ5AVz8J54JkIfsGEz
# XsjVu+jnOkDHgMRbeiswchUon35NFIBBWunIawjcoClVNu5MzmKEe1BdlfIWElUt
# hAgvSCSUdyaaC3QDvGTRfr3FkVOVIoouOLykkfmMVZ8Ek5IVRTtyzLdgIGqa99V6
# KojPn1bEf59MfyBfz1ynmX6lO2Wi1DErtxwqKNsPYyR5jQWLC2sy/aOXPflI7/Xs
# Lr7GncL3jtBvaPov2H3v7L5+qf6B1VOmjY/YQBDXCnZJKvKGaVbC32LqdLwoO8Ff
# NshMKHyJZ0/92mLYh3gM2EjLps28lPBPTYnkLx7OSNmeKLb0lKOitz4O
