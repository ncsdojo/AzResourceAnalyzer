# CIS 8.53 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.53";Title="PostgreSQL log_connections enabled";Severity="Medium";Automated=$true;Check={param($D)
    $cfg=$D.PostgreSQLConfigs;if($null -eq $cfg -or @($cfg).Count -eq 0){return @()}
    $bad=@($cfg|Where-Object{$_.configName -eq 'log_connections' -and $_.configValue -ne 'on'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.serverName): $($_.configValue)"});Description="$($bad.Count) PostgreSQL server(s) without log_connections=on."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDsgKAakEMyE7cr
# 8aTJCjhcMJuJVq9G5zi1pRVuDjKYDqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIJGHteDL49kfyTpRwLH3DjCdCiJpaqswerJZLnQ1
# 9/aDMA0GCSqGSIb3DQEBAQUABIIBgB444KPsBupAtWRYeTDiIHtP+nf0Gsv2OL8M
# vqDbI46cCXtKVPyNQAm8H3KsAPj+9uENW96wfeI9572F3X2Vlgy8ypbvgAcQjBLP
# vkv4rVVmKHgUrpMmZd5NJb7HVINoz4cQja5b3hH+sjGwrj78ADraVORTLQ8ATQVp
# UUd7uRXrMu8nA4VkBHsxYr2oiieDSJxd/EVeW+ZXcQfgCD6BAvfJ3lS0mc05G+Cz
# 8BqOmLHK3hIRjJMyV/KjemP07jKEY6rmOs1Kd6k+yeqAPuN7DeRWiMki847bh7Wp
# yo98+UZNSm2mohWSZKZpsbgJGGkJiMxNq3nQ/ZBMFv492M0ci3lHeBmb/pIiVMIO
# AkGY66QBa12rYmqQSWi5yS2xiLXdWPK1+7o+LAt76A5yIF3Er8LSeVE5MEg+tpwD
# 5YX3F0xUvTlYbyGE8Xo0Pgfu0SMA4G+qAfP7qb4hDQSnmxlRZYD+8s9MLFTwFvWp
# 6u6HenY6TK2npJtoQU8EYuclNRfisKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDICHc5Zq4bHSWl8aTIrJgH/edVIOk0npr2RmFc68S4yAIGagxE2ah/
# GBMyMDI2MDUyMzAyMzQyMy4xOTJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMzQyM1owLwYJKoZI
# hvcNAQkEMSIEICeMPziBkEPf/b7k6Z3i/CjVE3Ljah2MicAQaJm4v3iwMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAIFcGAjb2q7wwxyG8Z/RDOz5dNk6JdJEFNI+YwQC23pp4R
# p5zqtWNh7+UyhwtWClokvI7ybyxTfzeldxu1A2hYdcEyHCYG47b+/D7iK6d01XM9
# Lb8R5kXMCKODp/5+5T5711RJDbyMbyBcHuAb2ebcEnH8JurHP75BNdL51MYI6Okb
# YxfQkuoBQ4RdKVtlW9qGQieBwttdbBWTToopnWHuTBjEUpGa6A2MfgunMYvRUMJQ
# rzANsQtxyrqVfdXuznNIqJxTPCQWQvT4xXkr/WR+i2S3IguNCv5+GoDwt1lwOLuV
# LU7HpPdUnCPiDtRh0kBckPk3A2eCMo6lCdp5xi+h+1hXKIg1DKE9IphFLMUlZqsM
# xIboHdJ8dgDLl+wUMv6/yrA9CduNpQ62gzB6HnHUQDcWsm6N0wv2AtygeuKGWVrY
# QT28j1PbqmchqKjTk18+TjfuvKhLmyLl15FEGiXuNX1YK/1ErT53V0O+be1KL5JN
# 8i50yRLI+UxLxD3lHuoPy4NX9rZyZBxo9nN+6C+jDmlABfRiEMtwvLFU80KHc54h
# x1RV2FVA84lhhFqTB8fiUo2SNzicRrlvT4Uxq1a1QSHbAtbmKrWaG2qUv1r1iGyy
# ijBEgiIbySWFVkv2lWlzKtpQmg/7a7xz2JnOREGiCj7QA9fkzpuRuTyW+mLKFA==
