# CIS 8.39 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="8.39";Title="SQL Server auditing enabled";Severity="High";Automated=$true;Check={param($D)
    $audit=$D.SQLAuditSettings;if($null -eq $audit -or @($audit).Count -eq 0){
        $sql=$D.SQLServers;if($null -eq $sql -or @($sql).Count -eq 0){return @()}
        return @(@{AffectedResources=@($sql|ForEach-Object{$_.serverName});Description="$(@($sql).Count) SQL Server(s) with no audit settings data collected."})
    }
    $bad=@($audit|Where-Object{$_.PSObject.Properties['state'] -and $_.state -ne 'Enabled'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.serverName});Description="$($bad.Count) SQL Server(s) without auditing enabled."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCk4L+fhHmgRA/I
# iB+XA9JNiUot2w0UAmqltzJmBaKGx6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEILEVRkQgcTBNehAlgthzPjkfZbwKdsflCqc3vWFx
# Gqb+MA0GCSqGSIb3DQEBAQUABIIBgHxQISKELYTQLMN21vWGGA8a7Ey9N/v4btAr
# +n1QTgdufHsEtRc0M4i0acy8hv/kRDma8FoonXFb4FHtWXRSbnqB/cFLVOUg33IG
# Kmb1cjVxM3uc1YOfbr0W7ZiLhGyqKFFIAZMQcI9OhX6sSuakKXQ2cbtrQL0FoVke
# FCO1UZb60rXjWR08JU27auf3Yb4KmszlB/I5GzJvWF3gtLJt0la+YIDSsWte3KDG
# tv22nUsZszsVK6fJVJhkyZr1nA/laUONW3PYPBfnPCoQ6myu7a4PGE2CgF7rDI2f
# 410DIIjdE+XYZm/xuj13p7H9ATzdD0JD0Z/qq/ahMAUs3vlM6A4J9tLjXPI1jSGM
# AN9DuSVSjYGB5jFOnUlXarGqMDwXN5/9YJY18Qt2exqtWvWh4jf13edoFn8lM6/E
# KJ583ge6yEOqLj2kzF21l/1dxAS7LdJwvjZJmvv1XeKO+CRivgA9V+jbSW33T3+2
# 11bbfnshviphBzx0oOu7t1jawJpGNKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCw8xdxWg1SFtPnpo8oG5pdTjz9z4AlLVHvDRCV8/q2bAIGagxE13pa
# GBMyMDI2MDUyMjE1MTMwNC4zMDZaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTMwNFowLwYJKoZI
# hvcNAQkEMSIEILlgJg7ujzRBvnuujNWfksLV//d7XQHqlr/HXOpVVU2bMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgB7nl75BbeOFsU23SpCbb8qNnt1BeDW0tAhgFo2BwQUA3vu
# /E7Sb+Pfaw2vz5ciKDGFGXhelzRAZTWWvaLSnlwf4Ty9fHR/D+T6SdYa+tigSLuS
# b7nRafUkEKXgbuNZRpCrxw2j0fy2qoOawjRVfYV9p9IOJX+d4EyLzw6/sAHft4Z8
# BRUHSlThrtmf9LZLRmgMWm7VMT1rr9XSjTMUlWkcVh2om3SawmqLL6jnzvYN59yS
# WolrIRXoKIA8VAIWdOM4esmIYHurcn57aQH1zdoKENKrH3zSl4ITffCI/U4DPNBH
# DluRuIymZpf1ooMleqdKC8j+7DkB8YhfTZ5Nvltf+Nj/DQonJcyZahMqlyfT9ZcH
# qssabejBU4cIW++J793auJ9pd6mXiHCORzfpR+GXGy064c8nQmshKr20/poPjuSA
# hGYaqo+/UyMzht9UD5TORIof5Fn6tc1uH+1cEWDpm9H3kLawWw9ULrluH4qwhENC
# qhxdDN/jomqhs6ZdWDyTf0YXE343vNx5yNbumst8QflAFR+GCip/di2Dd7nHclLD
# P74mfAKgr6TbMtWpq9pVD2MgeFQKH2dC+/z0Iwb+ujRl3uhF5VebEdrAX2zKgQOB
# eCc+mGT8JjbADu2lKmuhXHkOWT9vto94u0Ypw1qlLlim5UdV8AJ0hlzHF78wyA==
