# CIS 8.6 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "8.6"
        Title       = "Recovery vault backup configured"
        Severity    = "High"
        Automated   = $true
        Check       = {
            param($D)
    $vms = $D.VirtualMachines
        $vaults = $D.RecoveryVaults
        if ($null -eq $vms -or @($vms).Count -eq 0) { return @() }
        if ($null -eq $vaults -or @($vaults).Count -eq 0) {
            return @(@{ AffectedResources=@($vms | ForEach-Object { $_.vmName } | Select-Object -First 100); Description="$(@($vms).Count) VM(s) deployed but no Recovery Services vaults found. VMs may not be backed up." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDFCRey3/FUq88d
# IZLav3HbRCqGgLAePyLvnsal3Jz7QaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIE/YuqHa8JVK4Qk0FSfe/rmaCoUSEhR3uHKMhC5V
# jIFhMA0GCSqGSIb3DQEBAQUABIIBgB9V19efUPi2dOP4/Ot2VQ3KCsJbknUG3DHP
# h/IZ48JtlQHvKUSaf9u8vz3VyTEg42krGiBkGlllF21qdmB7NCvgtmmOUgm2gNSM
# L2NM4+Ieyx0ekNcDCWM+3cMXCDYxKAkZ0hT24ryABhPFO/d/B73pO7HELI+iIeB8
# RVSnYUCsHOmGCnGxssnR+mvuCG06Q6wisAj630AZLFr2r8pJ30NB6WlTxk3y6JzU
# BwWVS+rOGaePZwwMvuT5DIYIOjZszDSt1K40baS4QQfOpDF0sNIC7ndHzGjgpmCu
# 0Ib1i0lAuY3auOBTOPn3AQtaUXE0M9kNW7JEhN6Q5KgvXEbE8klpANTHTOjcVwul
# j3QTweMOhCzrJf6wblO2Yv0v2umlMQxinM1+4l0i78vcl82VuXFi+ODif+F8H4qR
# BxWBMdwk69dnvHDIW4qkeZ71CpMj+2c+qJqS2A0PqN46PB0L/SpUpKfj/NlmBJkf
# ERiLK2Di0rWS98CtV66nJA479NraWaGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCAF7GJys69MG2/Y1X3oZO9XKldouvZ5hLQDoed7cFirfwIGaeiBPNFP
# GBMyMDI2MDUyMjE1MTkzNC41MjhaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MTkzNFowLwYJKoZI
# hvcNAQkEMSIEIG7Q7K67GcmWYZG1bixFUCQ7SyqBiaYJMSK/BbwM6KOlMIG5Bgsq
...
# 9w0BAQEFAASCAgA3bI2akvqsvuOJuEaFSBbpNIrm8EWSxwIknNxxwThPofC75ReO
# +p/afk+snkX1lvDPAZKpaOiBvvpVa4ox7A0Z3pmU/qbttzqC5gosSeqO9ZzIJEP7
# 0WVp7QdXM2lBh/usjzYuHhfajVO9oYi6T7JoExKh4byWCX0Tl9RBbd8gn+CMjhTO
# AVOfW4/EATDsm4d2gCAzjDrk7Yp6iu8eXFtzQsXwSHCu3EoBv8rfuvhPucKz+Wse
# MvNn6ihimPB8axqIV7e3m6r2rh7uQL7lU0k5do/PcMEe93K82lT6QFfDRQ7dCzhC
# MhBwEFkEhAg+oMedkxPi6IE4iuLXsKqbLOVBJr3HE77c/RXFYuNroStIl9wLqjwT
# wpvfTy7N1F69KzTWGPcER2A5YqfwTMP+HEzti+Uv0nY4sXi1ZMGX52xKnsoU92ra
# TBhEMXbnJPZBcsE5HBLbNZAMJNfYAmpI/ouE5qqxIipeLUfqMrnCwnRvaMxdI/wH
# 3/dCfYH7efK7azjjl/ym09tcar06fQcmYj7dG6I2/Bq7MstqdS20nL4j4awJ6qm3
# 5gEhXx9I34ZFA97l/CabwdHityY2hJ+DQmQauARlnx3WIJHGA8tVK7++7EfXkEmc
# Nz3yiVP+jXzPZCWRBVyDL1/TKQ3hbeZlech7mYn+7hkCYCZyo3eXsTyRTA==
