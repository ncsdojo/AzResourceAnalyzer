# CIS 3.55 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.55";Title="Deployment slot CORS not wildcard";Severity="Medium";Automated=$true;Check={param($D)
    $slots=$D.AppServiceSlots;if($null -eq $slots -or @($slots).Count -eq 0){return @()}
    $bad=@($slots|Where-Object{$_.PSObject.Properties['cors'] -and $_.cors -match '\*'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.parentApp)/$($_.slotName)"});Description="$($bad.Count) deployment slot(s) with wildcard CORS."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAxKwmuJSOUUElB
# 8X/C1nLuWm/vlktRQQlN8W381vWa9aCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEICOr75HH2Amba3UJHN3ZCPkaFxYQy48ncfCq8Cpi
# QQkyMA0GCSqGSIb3DQEBAQUABIIBgCpYUFAjylnmFjgfKFYHq2olXA6jLfDl8y53
# VGFSJCDGrt+hTpxJAdCZbgFzlJ0uLJQTlukj+YLpoWkxi+xS+OFv6JpxuFBwIoZq
# /RNdN0M5B1ymNp9wRqXIDYW4giAy4cc29WTHXqNrKoldQ1G1J+aWkCuccA2SQx+p
# zyLkyVIa1QUsksqLME50S4DlU/+9x1g7xgW23WvvoqXo5T80EfQkSuUudFIBqa7I
# BHEyptkeGieCD+aWG7G5usY2cYf1jElRj7emuvdSXuMP4wmYFPyVxmeN+xkmMODH
# RXIf5w4M1p8/dzgZpGeTkt4WhAVU/pYUd1zj0ScJ/OvzLcRREKrwRbkYtQrv6S4c
# ljihgcWlCvcHjubMX/0whyM1QWNaaW4yg+MZ3R10qcYUsBbPFO5Is6ScoHuVLuTW
# r23CFNW+05386kFjwpWVAoVNM1cRk8xm4FYQHVJ6ExfEVqN2uA/DNPxfMijtAXM+
# 4nd2Ps+vN06TdSNaM4mc887qrlgEu6GCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCAo1Mn73fpL7odLtW2ZbmYs1YniI4MW0ZvFEVhfNx0gHQIGaeiBPKDk
# GBMyMDI2MDUyMjE0MzQ0Ny40NTFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0MzQ0N1owLwYJKoZI
# hvcNAQkEMSIEICAt8+8PWKPSuDltMHFlToypSjXYQBu9t0mGcVkpMehFMIG5Bgsq
...
# 9w0BAQEFAASCAgCI8t9V2qGiAO/MRtxwoy7GueAf1+HriK/nGONcZbe1DeQhXXmc
# ByFZiFN93NvRziuKGqOQGixBHxzt7jW/Q1ii7F1olmWASu9O+NOYFDDc0gQe2EfV
# DW5pLguIZG/0AwNiL8K9HQPB9kCiM6WBdN6mBZcOn6W8IUQPTzMl4L9D9dCI7Obs
# tVse4/TfMlbT0OlnibZGrzblFoB8sd0ZMJI3JE7JTumL3KJigVBjvnwndww1VL9U
# pNe9PpKmhnzAy803xKzqkQ1zs/vKy/fQdBz/NMh0SHq3C3WpMPz1pkEjbrl3E9nN
# uQnBp3EnVIdi6sVBizTe06kuXiDWTd9AycgdFKrONu57aoDgKa0VBF0OcSPs90di
# w14Q5ypoqM8InpCEipxLgPmEDluQUoV08YN/47o/PU98Ob1V+NYox3QMaN23rt7I
# yCHvOoo3x/L2No4E0QqcwChvnN4l3tDYzfhd4SG/LKSXdbRg/K0S+IqqmHmFg/iu
# 5C9PgKWXk5aKD5rgXGVnEAN6V4zhaWIYzJyByr2BGh6nfWzOOL6Z2GUcZv8+O7NU
# 6pgP8DUu9SLUHdsnUpW9CgKi+JuCr8IWm+PInzbvB5I1KWN/yU9oPk6XwR4gE5sL
# 0rSzEdE03Uw+miZqRttX2d2FliZGKtCVSetM1soGs43N0KFjmGwRSALb7Q==
