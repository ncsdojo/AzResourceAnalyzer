# CIS 3.22 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.22"
        Title       = "Disk CMK encryption configured"
        Severity    = "Medium"
        Automated   = $true
        Check       = {
            param($D)
    $disks = $D.Disks
        ...
        $bad = @($disks | Where-Object { $_.PSObject.Properties['encryptionType'] -and $_.encryptionType -ne 'EncryptionAtRestWithCustomerKey' -and $_.encryptionType -ne 'EncryptionAtRestWithPlatformAndCustomerKeys' })
        if ($bad.Count -gt 0) { return @(@{ AffectedResources=@($bad | ForEach-Object { "$($_.diskName) — $($_.encryptionType)" } | Select-Object -First 500); Description="$($bad.Count) managed disk(s) not using customer-managed key encryption." }) }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDJD8EuUyyQ3CJQ
# NJ+vmoBesOZb+yO2rx0j7QTvP91NT6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIFqCELScoopkvBTA3KfFz6R/LjHIgw3+j3ncHZmX
# qZmtMA0GCSqGSIb3DQEBAQUABIIBgJxrtd2mV/aNgtbNqiEuVPTuyQqFxDCZnges
# UMfvpu5WJ2Nb4AH89ZVoDP7UKIv/XJOypqffA31cI6IO8IJZntF4OuUZWnw/VxVn
# YdaiaePaGb7ZjsNCnsxYcTNqmCKXyfs6f5FaGLcKLGY5sZkpzxzJIsG5WJ/ZGq5d
# g9+1eQeoGIVP2HSoYcM/k1d0teHbP17MwcDCnE6Tf3fN+Gc5sE/4+3X9kCsCgNgB
# TX4uN/QHP/fe/NW3bJkuPYDCd4zsQTML1P5/IkB30rgHDdEQQv3YYVpY/KiX1n3g
# kV8E8wAMSo0KXzvr4bWThtO6nI7rG3RkQAHwFElunD1oD+uxug72Fh1ycpfZ3AU0
# RkKfWOWdZRZN1eljwB20Lj9wtp75bC+nFaJEveJ6Kjpj1f1h+TJRrUgx08l1aZ9v
# RTVxbl6OTgXypilF3rF48eSLX2K/ttjBFIHNZziTKd7z7RCtT/WRqm+HP4ugn7Yo
# yBuS8KUa04R93yAUiuZOdz7LpOcOYqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDbmALVdix2+xJtorrimOWj8NWdM8/tHFnhYSPoHk9JagIGagxE2Yom
# GBMyMDI2MDUyMzAxNDUwMy43NjFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNDUwM1owLwYJKoZI
# hvcNAQkEMSIEIPDNFX74KqaI4z81m0NykQNjrsr0uyLCtVNjT24PL8xsMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBO1SHWKEhXuJWHZOdosTe2E/6m9707MRXpia6ILxVxnsdK
# RWGCsaVaRZ4NRupBAGKWnXLG+XWebsxMfzI8rF4mF634i1Q7hiR+LfuPHtUJA4Qt
# FoSaSV//tmhKazfw2jSijmnRfg8qVUR6RRVMwknoN1DDnqJvGhLTzpbqyZtTAIiC
# 1W3uZTXiK2SZ0m+rqEczBCJ4+FsTluTInHODTFnKWU+ggnF1P/ALJpUO+/rTGsdU
# dmBoydgC2YVxG3dTFCML7oJzUntIMTeyhEJ3dzFqKGIsl2NSpx2FjaxomEThsPfp
# 0zQrjkG1UEwKdS/z9QtSE8YTjg2o8BrQeyMkYJiqX3WNYXCPRwGIfxcxR2lAYZc2
# vv6NQlxD73sc9F6bvVLdnYbkLJEskwxtzD3rBes5Xr+ik1BdL7paUqY+cs3w7znQ
# UG7nSKoMwX8cQikCZCWUWMdZ4EF/bCeBiiPy6opBJZ2U/EBC9NRz7BdyZL/OE5vP
# +Ydz6bgsoWbfJ+bMJw6ReG+papeldTGTihtKo11+9JINL0P4QBgqUYTTqysjA0s4
# hy10zWoDVYt1RUidqpXV83wxpbGT5gKqByCHd6a3JaLm8gm8dI+2XiwJJ/AIzbgk
# /D9zk5Tp5o5wDvYbU0rcuFgqkel/k2a/0vlZS4953zxE3Oz46ZlctBRf5OeKWQ==
