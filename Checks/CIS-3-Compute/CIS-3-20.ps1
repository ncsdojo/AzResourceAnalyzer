# CIS 3.20 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.20"
        Title       = "App Service VNet integration configured"
        Severity    = "Medium"
        Automated   = $true
        Check       = {
            param($D)
    $apps = $D.AppServices
        ...
        $bad = @($apps | Where-Object { -not $_.PSObject.Properties['vnetIntegration'] -or -not $_.vnetIntegration })
        if ($bad.Count -gt 0) { return @(@{ AffectedResources=@($bad | ForEach-Object { $_.appName } | Select-Object -First 500); Description="$($bad.Count) App Service app(s) not integrated with a VNet." }) }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBkngpcG1r60TBl
# ciCELlkUzmwUgNsMLAIxnQkMD9HxrqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIOZorUpjrGs7Hx0sY3y8KQxbxIP88M/ecwzSyXM9
# kYnCMA0GCSqGSIb3DQEBAQUABIIBgJ8jfWcHqKYq6OE4N/4UWuIShtbCe/cchMLg
# a89OtJY/lUpFljfl8A8mFtpMvdQaBZD/0qO4cNqdKvjJt1lKW42w7HWOxIwYIpaU
# +O6BodU6bboj30pe4WucFPPkF1KvC4fpOMUovYG06Sbt1wQvuRz0V/KNkpNUnNZE
# hnfiFYFW3KFvfMSKEYwC4nMQiW69UtuT7+AR//goEr+bfSA+WijdGfK5cqeuJQbU
# BuhZxa4bN3qH4Das4QRuVni+2C+Sx3hgav8KPnWKvff6a6Vyxgbzzbj71E8xU8US
# a0Zyj0zKW1WaVeH4H/V1TBP8n+pCJ2W7cDB9xN2F8gAlsDKPVDWJiawlUkudIVCt
# FEqammg+pEFf9Q94iCM2O3KWvEqEN1cXaHTDhuBEsIVV8GkcJgFnbzXPJWaxI59I
# q8NqL23n/eVBv92tjnhWoVWGeqOdYan+2SGRAXZMe6z4hOQ6Rrr5mtqSnXTRaX5K
# XIubYggELvTLXsVt/JTfd7OYrczpdqGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCAbltBCoJOdU+PTZL2iWhJzOUjZ8FTuYhe5gTjEZ6e9PgIGaeiBPuAL
# GBIyMDI2MDUyMzAxNDQzOC44OFowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDE0NDM4WjAvBgkqhkiG
# 9w0BCQQxIgQgKu1z7BYQWkFI3asowsUMekFO3iVBnxDu2q6pDzoShF8wgbkGCyqG
...
# DQEBAQUABIICALmK4G4o7Xw+uTm55LUV/gRWvnJfSy6zLfWNxnMLO/x2qUz9kWwG
# A81Dcn4G7aI0o/rDRd/WcgQVH7CcKXHks3W2JR5XhaqX52UQ6sHXf0CUytOIeSXz
# ZPeOvAeOGRC2BqJix1uvWPgeSYGMbpiAqekdd7K9XG0GZt0uzeo+ot6lQUg2pHKf
# p8SFuCCIq+R9hVKqwksMsJcUFXGKyfs364RF3SRGh1VzDb37bQTf+1k6PmXnz+Lr
# BKv4L+/olpTWVHulD6ejiEdi8DOxHI5BZ5D31SLS+x8+pB/WBYZQ9TvQ/cMyebrw
# Q7Lf+zMfZ+E/LODD9TFarDODcbSK4B0ih7WfcPaTwoz8ELWOxWjWnMBOs6R2HbZD
# IvehN9/7cNte9/3ZrWd3tV2y5gt8QhqtYsitqfBB30v46y4vLbxObz01HHLrKT0l
# rrpjXrVzHDogrM7i06gwY8w44lajh+YujKnjs/pjZi9Rg0fUJj2LaxOOxfZFC9Kd
# bCcaLIIJovIhnAxOlDFS2rPmscEZqwa5LqgckuGWx6fypWHzB3JMRsc1mNz/kzIG
# 8lF+rl7pwCRNv9Kaa+nLMnjDUUEk8GRU5I4TwrvVKnUigwFGdoUyZ3lq2xsbOI6R
# MvQ+CoiR/Cj/PqHyqJWKCD/U4VaCbCcxa8XNG14dVRAT8VZA5hZD1F++
