# CIS 3.35 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.35";Title="Container Registry anonymous pull disabled";Severity="High";Automated=$true;Check={param($D)
    $cr=$D.ContainerRegistries;if($null -eq $cr -or @($cr).Count -eq 0){return @()}
    $bad=@($cr|Where-Object{$_.PSObject.Properties['anonymousPullEnabled'] -and $_.anonymousPullEnabled})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.registryName});Description="$($bad.Count) container registr(ies) with anonymous pull enabled."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAsT1VCMOAARljL
# uikYXgWqrkiokd+ERsKDNE1rMsrCY6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIKZxSyitfWXuYaBfOJomS4nEBCZsgXNkOjsgNL3j
# UtDoMA0GCSqGSIb3DQEBAQUABIIBgCUBx4v5CgUHVsP3WtdYyJ8WxEwOWeMRRXIN
# y2zFkcsp0CRXf3xk31FNgpcZmAnPWyHZOzApPh1rAJX1nyQFROjtpeTgoAI64Fzr
# 8xQamELKXwpoi+6wYKg7qvxXVTFIm+5GTVR5TYJChvD8+qvIIJh0j+ZA3HI0zZuO
# LliPQJJeQ9CdGxjVOVYgnhNeNCEuAE0wz5eimXHUkJHmQ96zvi/mon03YNPRLeHc
# zkwohgEpNDR76aXNlK+p+VZIGghO6kBlHU4pJa/DFmyIMmNxDkiLdS12cu8dsN+l
# OiOap5cuG788Fp3CS5U3P2sCYiqbRFUi08u9+jnupkUbpYgkyyxWq/OI0kOTe8x9
# l8dkF0+KpTauMkAcSXwam+g/cFnk22hpe98jCK90wBMM4DZqccdxMy3W+IHE7Dxa
# p+TUKKk1x7Fs+lrflg5Sz2ReoV50dfbaE2OHhpJ6dTFEhJD7o3He28juc66tYVjI
# k8cl4q7HrvQKhpPAIfhiQXrawVgVqaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBCM4VLbhRw9HAun7cjWmen+if0OZR9kaHMG0HM92vQxgIGagxE10Ta
# GBMyMDI2MDUyMjE0Mjg1Ni4yMjdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0Mjg1NlowLwYJKoZI
# hvcNAQkEMSIEIKTfmkIGtDg6hVifOcVcDCep8dbByr+O83K04D4s+w7KMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgATyUXVVSSHytlmvdRQP9HuD8ZH5MZ2oJt8f15995jZMTpV
# vvmXB9RPoX7f/6GVl6cXjkpP6CKtn6RV4xPXBfeJJDqJ1929I/HRn7+kEjTgNGgY
# /YKtK9oRUhgTN/KhJeZszhiL3y59cqKuC+hpD+SCYVdfDY7ggbtVDdPECQ9L0iRl
# kkTUvsIzDVTqbzytpbk0OaHCRYTvGoep2qdzRdR40z80WMU2s4X0Sm4VSrQD5kXS
# iMJjvnhXcriPBp6Y8vhSk5AieCpa4Sclls6YkSwGPigqLl3QBZfsjuKLzx5UL6cT
# 0o3uCHDdsEguNU8rXOtvoaUFcm3OavBk8x7mpZC+Fw5CEVa28+wpV1ZtjqnPaMzd
# L42U6tVzjICeYNYvpFRqeYP5TS60F2Q5IkeQVTB/evBRuDX2dyklgqjlMhkvQskr
# N5ohHktbl/hYLuyLHKK2ZT2ZpDYNiNV4698PK0WzjTEfmzvZx00JNjbBHQiHc2QE
# LHMTqumq0WMExoTLT7o0zj1FdyYyEYXdWo1Ox51Jf0c5NKFexAnIOKqO0jh+n8Fx
# EnYgZblHzqzS76AqfofEOE1sia8kPzoc1b4nz7kfUqG+QHd8tI6qpqLNQYI9G3NK
# 1tkYqMlVd53xbTxDu6tQ8fSoYWJPrGOIvxb8qE42uxbnRymMTqKFrDqWYNui9Q==
