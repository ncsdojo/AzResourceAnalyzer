# CIS 3.31 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.31";Title="Container groups use CMK encryption";Severity="Medium";Automated=$true;Check={param($D)
    $ci=$D.ContainerInstances;if($null -eq $ci -or @($ci).Count -eq 0){return @()}
    $bad=@($ci|Where-Object{-not $_.PSObject.Properties['encryptionKeyId'] -or -not $_.encryptionKeyId})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.groupName});Description="$($bad.Count) container group(s) without CMK encryption."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBvKDDTehcORNGv
# AqITxUyK5/QMSlijdRiRzjBuR90FQqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEICKICRob+UbzgP7WdMN4rnH3Fxr7Sh6T3i99iPRN
# oW+tMA0GCSqGSIb3DQEBAQUABIIBgBZEYePvBkYp8z8C+7PYx7nVUPtTWKRcFJD1
# rQNVP4LAv4Ypj99mPWDLTmNtQ7chRB2txHVz/pPldr3aJZ86ic2HwzR0pG5+Y+de
# a7K34aveLoAE7pe0czg8h22pDLOFT3a9cazzINeUMuDbNejLUjZXr/1H4kCMIHlK
# uPWwpARNBlxDxmv69xlsivUpJYU4cWjh7fXCe96KZwdCvkv8pRC3GB61NXN0iJRF
# zYv2IW9j+lbyt5ObOZcmMSMOJJkWftWpu5Blz/qGl4k+iiV0Rr9gqGZ64aUj/cZs
# yWa9VZGmm8KTMuNeq1bQtbupp4o2S/xoDVZM1Z13TBk+rWBFItv6GU0ZvMuxQVRD
# /Vqt/PilcjoP02NpymgOKZ/+3hta7J9uxxj72sdK+Cxptz7RGMy6GW4AuSHC8deq
# Hi4CjcTV1jF05MuHs+pBCHzCMOO39mn7Lzh0/92QQj9aWFWmF2ClZCJFUVtLKh+M
# Yv8+kGh71mqnVqolK2bv6hZQ7X+v8aGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCYNMFXV+DmNubG4Q+9fpwB0tfO0IjnSD78pJph6zg12QIGagxE2Yyj
# GBMyMDI2MDUyMzAxNDcyNC40MjdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNDcyNFowLwYJKoZI
# hvcNAQkEMSIEICvUkrdKYWn3kWo2NtuO4XBLTDY7B2ZkmUxrInOUbiPnMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCsmLqGVWNehjY9ZOHYKKYZJ5AiFMy1VgXjK+iz3zr2OAmZ
# F5YspzuDERVOPmsPauC7Df6k6IL+Jss0DvQVxtYadl4/u0POIBqKLehTNDyo/fWc
# p9SHjNrXJYVX/7kYjFpJlB9e8KtT6NDIQ/MVqY/lFZnOTvdScnNbgapC4RlWfbQ5
# 5J1bVFx4j1AmbyBOrT3+kVjqvNK/1Mcmc06fgrisQAeOseZ+dC1xnf7nfByeNZ71
# bKreBWWuwoaxjO57rNuzMwt3sAz8V2o7mUkoLJCTObE+S7bfMHnpGwnxUbyIYwoj
# TpeI6PHN8yWCPKXvZKxiW6q1cRKX5SlSyExMOrm/R1PH7EnTFjBKKIf6IeUMg2FW
# sq8VV1pXNxH1GKxqPpzILZ+BziEpvoBjzkCgPRQGeY3I3WdDDup+/nWmJIW05nlx
# D5FJbfaAyTJ3ZcwiL221H4tyCzijdemTpZ2KQz6v+grGfFKd7mIbS2lVM5pmSdtG
# FzTG3oe4B57784Pl9p3eYSRqhlWLlq6YU5chqJeOsJHlIINzDGL2ZHVoqwKXPF2p
# MUZ46mXMCExX6F8pun3kCYeRultfm2zF6L8jWa+ifzz/CwE9tnYLF5NkHcTswTlx
# 6p8MVf5M1dR+2ovLhoih6epJk9u68pSEbrJHM/x07l4EIFklWYNyAA8zdCCitA==
