# CIS 3.53 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.53";Title="Deployment slot public access restricted";Severity="High";Automated=$true;Check={param($D)
    $slots=$D.AppServiceSlots;if($null -eq $slots -or @($slots).Count -eq 0){return @()}
    $bad=@($slots|Where-Object{$_.PSObject.Properties['publicNetworkAccess'] -and $_.publicNetworkAccess -eq 'Enabled'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.parentApp)/$($_.slotName)"});Description="$($bad.Count) deployment slot(s) with public network access."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCARFMxUKe1RV4mf
# LyH1utuhxabecwtUqdSMd97XVfwRdaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIJvQ9imgOW1yhSgx2FW8jDXXHRhZxMouO/97/sW4
# t//1MA0GCSqGSIb3DQEBAQUABIIBgJvJb6CG+cU2+D4Y65/B5F7MRkzKkrbFcHEW
# O9LacR0Mo7kawShnV1LnXIdXJ8JVRL5qHYpSUnD2bdgxPfecaYbRbeIJuJ1Ln0d0
# Pw2ceYI+tUYds5dUBcwMfLoFGN+7G6euUHY7f9EQnMvg/lFK0Q7fNLcMzHR7qzmG
# lHDgJ8AMIoNq6IUA5ed34suNMUbLw638Air7jHwf+nBP1J4KvuGswSAXX4RXNBeL
# CxVStSfu8QxOKExp9CskEsIuJl+cBy4hYu8WNcC+j0NcTkskYwMYdo1vtC//a34s
# X+xuD74kmc/L9bHD7SP3QiFlNVll1HOCsqxtvqTOq8IqAZRSGwTzaxioP3HRj/05
# 9rNi4VczekibkdkhTjF4D5UI9BheSxH/PkJqpKoj21QyEKcM7zGolhA0ALz2EES9
# KJXu5rRXi8cIaeVPM5gxQLcZpFVnWSQmq2FZTLrdB2/3c6E+5gWcRAwJSMIkhCPG
# GE1mdqF7Oyqpg2JuRH8iAOS8RIPk46GCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCDq9QtmDhTnyiIwBAme4iWB+pqpwNBViInoyfDr0qC9/wIGaeiBPKBM
# GBMyMDI2MDUyMjE0MzQxNy4yNjVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0MzQxN1owLwYJKoZI
# hvcNAQkEMSIEIN75dQroANc9dvKvHdWJ1JOd+yCoilbgm6cKDQ+vjs/WMIG5Bgsq
...
# 9w0BAQEFAASCAgBn8s7g+uLDDo5d0c2gORq3snXh7hclIBkE7rAWQ5wkIqH61cPI
# 3SeqT4cZ4EjgGlxDPDKRfdftAKDGy9NSnPJPhQKjta91drreZkVoC1PUUk5p7VZA
# G1GxKj3c78BFORWcvche3XCGfPbok2XSVab2Sme3Wi7Q12NYVw76nMwvmBkKRfZT
# M+WCp6oVlTGFVde/Mpx3Vf/1l7uaGWv5nMAegxP8nXa7/7MnGE1rI1oK6D4BwODb
# dBh5PGlkLttIuIP9y++lgqiHqi6pnShoHW6XQU5ndmu7Vu/1/pkID869Lo01L53v
# PjopLRkc4xkdw2OFV871TlY9wgN1NRXYGWAJH8tIjLkQagTEMSnJe31lgvm+ehhn
# 9NMrxHjGrCw9VxWcmVl7bSphqrs3Aecbl5RqjRZNP2V02cyEvDXxZXJR8aw604fK
# Wf/ar1k10adZc52y2o59maGsp5iRW6Iyi90S/dwJ6iBqkiyC7+STMOAOluWQySsv
# 9vVSZSaMZSKeNhzQ5h20diKxNMMgxL+1uFEL90lFNnIaSTxeFA2nqJk8/YJO6sym
# IPSV2I2CXbrOP+rrarx3cNwcLvNW4HVBCRMho9qqwnOpE72b1fFRy3rbfyw6X5Ar
# 7NxvOI+qEE0kMrhUY26x6L2PpAhzc/doUKczhJlsbJl17CXUFMyg3ZgVeQ==
