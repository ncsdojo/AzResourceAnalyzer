# CIS 3.49 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.49";Title="Deployment slot TLS 1.2+ enforced";Severity="High";Automated=$true;Check={param($D)
    $slots=$D.AppServiceSlots;if($null -eq $slots -or @($slots).Count -eq 0){return @()}
    $bad=@($slots|Where-Object{$_.PSObject.Properties['minTlsVersion'] -and $_.minTlsVersion -notin @('1.2','1.3')})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.parentApp)/$($_.slotName)"});Description="$($bad.Count) deployment slot(s) not enforcing TLS 1.2+."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCAsqUHBEWfFpWc
# bcm7eCIcyb/VWDluRGpS/sgBOKccAqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIE0TuR4Ve2Car3zYxlJfVHJLDOZNl1m4DfhfgXF0
# E+hoMA0GCSqGSIb3DQEBAQUABIIBgFPvKvuZXzrpQw8ihr+X+H5AOr2RwTIuiELx
# z4Mu4McfQPurk3pJ3my+1HPw1nOsixGzScvo9jsYIt1i2njrpPFxIlwOhiRnT//3
# PgA9+C1Ra28x7fqGiiyGYed63pihBBabzD19JqEQwbzAzhg8FsLe49mnapBCe6zq
# S0BYo8j6zJRFMOnZ8PD/rnGcxmWS43FhDDJLCGMM85seFkl7mb6Jd/syZoiVE4GD
# 59iKYF/cDoFdu3/CqCerbFby3SiBChhS9qXNdKbMe0Amf0jYfhPPMqK4NJ8Ox4U3
# fqBChEMFIq0oPZXrl94Fl4WMNsldrt6/5VICebYV8iMEXJCB/B6LyokBVa1Zb/f4
# Bf7XFwhPVExIpYFHvVyltl/Zus/D0yUiAGmYv2Cm/FcKQIlX/vfvZ+QPSmPpAZ0R
# 9OCzJOnOlCAcOAosnB/STZx4vVSgBQyW57UVicTvoYNLL+7cVrZtVE2bpYnK74SZ
# GwVlR78h22C/CfzBfveVYfV3yLhklqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCADqAogM5oqwzvqXQ4BQS3/hyIh9c+h1dB6NHt9TAc/ZQIGagxE2Y76
# GBMyMDI2MDUyMzAxNTE0Ny4xNzNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNTE0N1owLwYJKoZI
# hvcNAQkEMSIEIDHRfA2rVSGKl4yRVoCQv8xJeX5Jyo8i7o8I8dSodz4uMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCOiuYpcAQfvJGc46RKzT/rCSp+rJOi++7Xg/P23Oyw/XmT
# hNgboSSw1WqG193DzIEnN+5CiVpzmXquHDl6XdjQmN9JZwQbWZjHi+rHh9pMEdRB
# s9bpPt2sCnUT3WAX2ktsi5F1Z+qA4i3O/i/GiWskf3jx8mIxBSwYqlAx8lorvKIW
# UrJSqLq015Bik8eTIgrisSSQx+h/CZVWFvJLWPx7p8tgQnCQQV9/peMva9i92o4H
# M7dv3PbNDUoXBoJlqUKDtZM0lYO/yZBZMBCdPWwxwJ8ONoOW/3J4F/yfbZ0cicR+
# +n+RJf8ozEv6VZCET/BvGMmEm6qsXTldCF5krmYeCwZqtcorCCRQ8NJEnDyUD18L
# rKqZ2d9LqLMdiMbOjgPwD7EDPu0z8twHkQBSeLarJ4wOoa3HFkD0Dcfmjs0tB+Pv
# YKrSe/kpYDCCP0lnR2/3cdAa9nuuWwaRFR5prxrjOwS3K5n9VAEwwWLcnhYSNUoo
# iCBC5U/0oFTwqHKxNmH89dH5hJ5VDXuHXyhRcMw5Hs/7LTUPcftJUK5efkxhaOhK
# GKjbOgkMIyl0c338LxCzOX+rmp6/dbRvJaZIW6EfrrUuKkVFEEpoAKX+KXKMTydv
# X4oPRaObF1bTmSHsupkp12EtHveyl6o5dZ/rEgNASsbVOLezdcFwTdqGYld4gQ==
