# CIS 3.39 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.39";Title="Logic App access control configured";Severity="High";Automated=$true;Check={param($D)
    $la=$D.LogicApps;if($null -eq $la -or @($la).Count -eq 0){return @()}
    $bad=@($la|Where-Object{$_.PSObject.Properties['accessControlConfig'] -and -not $_.accessControlConfig})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.appName});Description="$($bad.Count) Logic App(s) without access control restrictions."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAobMFSP5dZR9xI
# ES16z+CF4CElwvWbKOwkMxRiA2BXFqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIM+P+lj81YyiYgDEdmHmHTtF8/KaP0H5fYQA4fDZ
# AQ9TMA0GCSqGSIb3DQEBAQUABIIBgIp7GpK6ZyBAgVs3NHd3epgzLFBfDb52H+Mo
# Z9U5r6+pwFjub8xIdYvPrmnxZ0H1D0XjUdfeFnn56vbJqdbhH2qYiU2s4k2YgjZy
# j/XATdMcFPIonYhIwNRhzf7g6IdGEjs2gAV4+RmC8z04tfTigvbT4c++To+0RKoq
# x01BWsxkn7/wQdFXK0xR4SY1gfMORYEPpMzX2MFnTI0otNbXsX8+fSDdM3wpQSlj
# gP4UFbTyobTrh8e2dM3MxMx0BkTGmnkPAOB0ot4br14oeyWp4mdoi6BiLnkscA1Z
# eNopYg5QLC8c2UBSgmDGQxc86t5gnTE1cU8RCpvuGePdakKMe8Yj40W/XH++hYnu
# iGBm3p2zWdewuJBwfv2jy0Wja60k+KRaWE/8sOoPQ5DkXZZ8LN5/z+t0v2326vTh
# jDt5ZOfjguWkEbbDhDDonwWjx+Y7MNzJr/eHuwA+0jYBZ9ImsWYwVXQDB/G43ksR
# XDVizl14OvbqtGGEZHwbIcCwFDEGzqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBci214Ye6stOEBbn1bdxqfFNAIdaAoRvc0xZZ3T+MPwgIGagxE2Y3D
# GBMyMDI2MDUyMzAxNDkyMS4wODdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNDkyMVowLwYJKoZI
# hvcNAQkEMSIEICTv8cVwVeU80MdyPSqDr0VBrD/3kSFPdfcUatvdxncYMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCiNz01KG6/IrSeg3K7Eq+DYnN5IpgyGbKZSBkCsXMJ/HRT
# JP6uF0GVJWVdaVeDnX9qVNJZOpR8ETmV9qzyHsABJJiFuLWBtad4CUHHj26jxWmu
# PxkrWLO2fW5g0mWK8DwQps8/ZPveK6a1KQDoKR/UakNA74MlIt+mA5rGOwi4BewB
# uoH10ifKLC+67yFr3etUA875VlFLxA/3PSYZ9v1kqZHSewbOaM5eXeCXxbwwiwT8
# ++feUlC3hF+ePk0WJHDI0WTpDR/rP07qV5+yeSKx68kDLUjbIlrtYeHhhxITJ2jJ
# xw9JHqE/1tGyxlxSccs8+YShpuuQ3rAYtKnjmSKzMLtyZmjLteqaams+mvgIpHf4
# igYKtBMauD5dvW518MAdPwPGRrGmAHX9q3uBNsvmcEYn0UQpCmyTOUxjken0A1iR
# zenmi7ooRA15cxEEbEKpEK4EcqFd8qb9OQkB2Pfby6lhQJriQtEyaFTj4koIUvEW
# yh1XOy6ZcO2rkIzfUq+TzSko/GjxQ8IGJzVqE/s6D16GFm/buIl8feOxA2f/Vtln
# 0UDZjpdvhso7pM04/vEmG83PZ86kgO6UrcUpxWfP50iReZgOfnpGJ4WoiXPtuqZI
# 3Otq9RDIAqn7bBihP9kOgov7mBkzCwRoMy5wWXrhCXMgBBq18OJGkyInXCOPqw==
