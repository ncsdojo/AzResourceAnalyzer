# CIS 3.51 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.51";Title="Deployment slot remote debugging off";Severity="High";Automated=$true;Check={param($D)
    $slots=$D.AppServiceSlots;if($null -eq $slots -or @($slots).Count -eq 0){return @()}
    $bad=@($slots|Where-Object{$_.PSObject.Properties['remoteDebugging'] -and $_.remoteDebugging})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.parentApp)/$($_.slotName)"});Description="$($bad.Count) deployment slot(s) with remote debugging enabled."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBJ6RsFRJsjWcqs
# fYI3YJSHf8rTozWSySXbQLBaAghW+6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIFEARuw9L/oa14G1zZNmFcdRqjYfV+n3CcAibXUG
# r2J+MA0GCSqGSIb3DQEBAQUABIIBgB5IUtyK+skfJsZIN0XX1dc85zzPUXNaprJH
# WBVZq1tgrJFDUuS8U5y938ToSBkmNELPhnSpIANDZlPiqsvYjM9gpE8ONO5ZDqtU
# PQQQyAuorPoBJgJ+hezWZIp5vcxSBy+uQ6+jcsnqEt/lkuhOw3/HQRtJZW1XkoxS
# GnZdnpsEc3QoXE80AxHFRRqp66qgATJ8JmQhxGVjEQ75hPZTWgtNPQtbPosG2Mpr
# GS0Iv9TrNwmSdfwdSe/hZILMcXD7aLW4ejVWhjabBKyMObWCPdrJw1NaRNYnczEp
# QQxj7uFgyRZ8f/MzT/95FcqkCi7J0SgTr73lOBrB1QzYYI7trXMJhJSaMtLylr1f
# VpzOtkK5lqwsXGLH2s4kVvJsxRCGfGRabUGIM/AAMhTzCHPMK5BaQ1mC4oEDtLbn
# k6LkF12BoUMEy3D6MaL+rFk04uAKKd4Mt41c4Bnz6CFaP91UUUXQu5DplNA+NnKs
# 2wGzbP/I/2dZWhJRNn/HXwJ6tDTomqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDQcBbiQKtb2+bxLBqJwEe7xJQgdiHZ13CwovrjtoFvgQIGagxE2Y/v
# GBMyMDI2MDUyMzAxNTIyNC43NTRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNTIyNFowLwYJKoZI
# hvcNAQkEMSIEIK2tBFeA0xjxQb38Y46BdUCEbeB3we40g0arW4zBAzNoMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAbZEdSSKRST2gvedqnFteYYY5GDYapIDRTd97T5ISloWNd
# BbIQZD9mbYPF0VhioWS7M4MO/wUxJi2tLMdoR3wlnB84sctU37cldnypH3bN1/8i
# IsohJAfnCRFA8ao72mosJPIJ0a8K5z3ipjHNYr28fMNeKg2YInan8OpnS3uxZeHR
# fizGsyJQkqPIZkkFfP+GQK94RaGgjqf5SKmrIq6/lfdo48JO+Fr1lDK8mHdarIBr
# mYreeJ3kWFTLMUCxyqdEF/28Pc4+qEYTgnc9/PiQlWa3NAI9V7wm7WAXBIS624n6
# gqhe7VYaMGfiVBhRAesV6hpgzI0ohu2GEMHc+B2+oXfnQ2hYscD7rYN9+EPnaasy
# SJ65UKvWpVquTo27iC0bPaGIDjp6zi+BNI5DBaB9D7kqcammjyQODI4QqJP96aq7
# tVTTvbrClRE9ywddyE4iG46KyM4tQHPZbdw3KAS/iazHsTBGJrafsEWT1r9k0ehO
# 2OOebB6YlsdCBz7j/G+VWKdvzM+SAZj/mESvljC+u4PNcy7seEvw9I7VqByorRaI
# 9kMMkUoF9mlXsu0CqafI7TrUFdlvk6QZ4wSHueurtJcOi163pi+7hJuf7/GgsaO1
# 92eBJOLe5+V8fqtCM28Q7w72De/Wy+hpp44Ci5s8snMd2hveexE+P5h1I0Cfiw==
