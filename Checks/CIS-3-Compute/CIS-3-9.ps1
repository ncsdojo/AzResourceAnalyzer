# CIS 3.9 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.9"
        Title       = "VM vulnerability assessment configured"
        Severity    = "Medium"
        Automated   = $true
        Check       = {
            param($D)
    $vms = $D.VirtualMachines
        ...
        $bad = @($sa | Where-Object { $_.PSObject.Properties['displayName'] -and $_.displayName -match 'vulnerability assessment' -and $_.statusCode -eq 'Unhealthy' })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($vms | ForEach-Object { $_.vmName } | Select-Object -First 100); Description="Machines should have a vulnerability assessment solution installed." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD7HH1p744HDxJP
# +cEyBD9Iwuk6Nj4MidamRUgHieHqZKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIHxaSn3Gogz44/5hq5/J+TrF2EYPeZjk3lWnxrdp
# 6wRmMA0GCSqGSIb3DQEBAQUABIIBgDkEqWuR1VxhD8036l2jAh2rRQQxsxxO42HA
# kbM+GvDtlkeED20rbwiadPi/dgvJKnkjm/mfPiWCMC6pXSh9JmrEYsavwmQZfy2X
# p8Q4J4ndeLU2vFD/sVmnUYoz1uVHfRIeQqZ23HVuK+0DYM/4xWrqZB4oQN35CRkr
# U04VlrIy/spS3MUPDk4cnFbHfImYWmuqnhl4jOWX5fTRRXoXXPV8lYeKC023f4dn
# q926klRc5QROfIX/Y71hR/ckUKVJH9pNYynsuWxxrqOAQkVnXj/pAljogyAls5T9
# bL4uT8k7C5gHvAcvdjpjs8hJ/LjNs/1fyDuVXuasfrcCIZnzpOgRZR4ZONjdB1Nc
# jSJbng9D2m3MlYg7uutem8Uk2zFP+Hnlwx9fohGK+OIvmdjMQ3m1yUtdFbcVMZah
# mk/NrcJ3p1HKne+UXMCEihTeC1snpwnFFOyOPPkuKKlLwTPysiY6q7kmsXnNIjVJ
# dzos3ROr9R5jkay81MPcf6EHV6OcMaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCARVIVSnaf19wHJLhJng+xmHUb9J0gyRsH1pYxJjGMdRwIGagxE10yi
# GBMyMDI2MDUyMjE0MzYwMi44NTlaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0MzYwMlowLwYJKoZI
# hvcNAQkEMSIEIK3/sFsPF9Mv9BVhQi8VDmOr+Xu83Nhj+PhIA9nYL+RGMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAhZ7uIOIoTUkUm/RlnvG2/gcy948pZVVMvq5odRf1g6P5y
# Ryb1OtMOB6wvKMb7nndd7ViLAdYPKxrKAHOuXuMRQ2zUyZBcO2WlzJSvMGaQgpUC
# gEJr0H+RV0bF5Yup8mtRZRKrG2D+lc1tlUMGITk4kbOnUYCjrhIPpb3qVJkW2wGF
# r99URetMYBerqOy91+dyKd5rx+J67D9lIJbus92MO2EA05wSAWjFfM92QKRtc1oV
# F5FV8YxXrtwnzPKx1lysdlmP8Vb5Hd7zicrWPpoEG2NlZoOS2N54b/Cz+sznZ7En
# uKxeUCtzRWnVC96BXOef3b5ARzGpmkW/8mcXY5cHp3cj0kdNh8i2VK/T8Au3BkqX
# cVN4S4PPQ6TiTJO6PzWscRuO6kq6Z0bMFRAUnwWsU4X3GavIYdBiQC67YZPeTgpp
# Se0/MQZB2BbzraREKGeILCxk20pRtH1WYhKqgirGbL6uHp62FoJTppxvHREHJQsK
# Jd7SDpjXmqVQXWk3rsSrB92fcfEuZhBtxrHDJbgp0aqNcPMZlWaLAE3KrvwQSY7w
# 4d1qRC+NiSJ0qj/Swnng3EibZ/JjmJnIWHZdix6vkLMSkL9tshgatDgv4B6GnxsZ
# WOMKEkOUP+LFeD7f3N3b6rd7poeo4H9dhRCij7OQnAJl3EWw4Bcxb7ZweO4Kag==
