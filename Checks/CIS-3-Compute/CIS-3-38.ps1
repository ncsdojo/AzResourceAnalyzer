# CIS 3.38 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.38";Title="Logic App managed identity configured";Severity="Medium";Automated=$true;Check={param($D)
    $la=$D.LogicApps;if($null -eq $la -or @($la).Count -eq 0){return @()}
    $bad=@($la|Where-Object{-not $_.PSObject.Properties['managedIdentityType'] -or -not $_.managedIdentityType})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.appName});Description="$($bad.Count) Logic App(s) without managed identity."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDX6bqHvIxOHkdj
# xEZPEKNCHQMQKIJQBK3sCL1WIZAdDKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIN83rYoElLrE6CckS3RSwiZFN5hqioPCJALRuAlW
# YiBcMA0GCSqGSIb3DQEBAQUABIIBgEPABXxTG/W7N+YgDNb+VPxrrU8ZbcjKRAZ2
# B7f2bpEr4ZAde4D18Wo9EUvEUtnbIpD5bxm4yOBL7JPtV1UGjXA+kfb2RZn7nv/g
# OPvSm8FgHyuL3985evcfLdl+IT4zol/T49vHNgADP151oIKOFJuCfnmCgp/RcOzu
# 3euwUJS/MiXvtVG9eDnSqGu0Yx4zL9/XneOflTs/H6JWGn308nPPHUxQ89iB8JBJ
# Lc0G/mXpc94qllX6JyxsmadRVVWivqaqyfrnh4f2HzqFXsC5ZfsTCEfamqsJJbYC
# Lk9KqoexEYk63px4i84tzkqndRmHfnCQ/jP2mhX7wr0i25NYpRjc/yYPs2IIFATY
# pkAONwotLpDrVBPvqlvNzDqE/T9gve049FdhIKasIhrZm44wubzLclDD4K67Uf3k
# NMGI73IMxR9K181NtgmoQBT+V62PAiPNnpLijv/b92j8GiOdQxqHQaJdtPQUxAPT
# JbaZwYLvd5/+JRq8IOeag93GnFnAsKGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCABgbEmmg5AO+gd7Dvwz6Yc9UUQHvID/Rcl6fPN7cBJnAIGaeiBPJmZ
# GBMyMDI2MDUyMjE0Mjk0OC44MDFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0Mjk0OFowLwYJKoZI
# hvcNAQkEMSIEIEKfDjVXdrZ4KtKqv0Kw1SR25uB+EmMSYyadq0DqgOEiMIG5Bgsq
...
# 9w0BAQEFAASCAgBduHfbWYKjii24XbrIziqXbjqJgMK+iesvBor/jp2sI1VkQ3dr
# C72jOt7qzfCHKFfX5CwVNCX2M4rhRAm2fSoPC1zHVFT9w/hHSdizMhpExk+CvMG/
# 5vrLnGM79XMmVC8N6ZUQ0qLbEmLbOEzkU5SpDn20cqijPiwLRGxYSGBp7zPvmrZ8
# h+Ba8uH82EbX+NoNKwNfaUqcDf27l8JTP2xcNTBocfJ819AUjFi8P7+lIspqTCCy
# B3532cTKv0o1On1Vw52GiQI9JIATuLfYm+I6Yt1naPx1zuQ8XxSbs0JqDrzbPSp4
# vEBi0Yzm6LO1YD4NAl8Fg+TPTu8ftxVxMYzGC4ZV6FRrW2ssFc89tWk3CfdH79b4
# 7HYhNvsHhcyRbDsNWyI6y4DOjZFeE3EQwQYFOBcZl9DgoKoA0VgLBQU2IDoI1Idh
# UCasfi3Q+GWqtsqjdBcVcd0tTCZCkfxuw6IlMj5iBEwDNj9Sh16iqAikBq0mJ1nd
# njS1utJpYRx/4iW8Bm0XISuVHDycavK4nvUZS0zd+9BXzNZdZ07Plp3j1k3icO0K
# nhL8jul2TOq7kEHz4TLjZt97LdgQUWYoBi6HKerj65m9f7kaoWsYNYYpKH8sR6tM
# AGwWpGRgHWPCzgWePv1NM9FE0EX9ag9La5FZ56AWYsHgIe31OTVi1y399Q==
