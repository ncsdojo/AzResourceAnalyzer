# CIS 3.7 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.7"
        Title       = "Boot diagnostics enabled on VMs"
        Severity    = "Low"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $vms = $D.VirtualMachines
        ...
        $bad = @($vms | Where-Object { $_.PSObject.Properties['bootDiagEnabled'] -and $_.bootDiagEnabled -ne 1 })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { $_.vmName } | Select-Object -First 500); Description="$($bad.Count) VM(s) without boot diagnostics enabled." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBE22tM37O73tvy
# 853p+PNQP3HNO4zM9GWp6O0XRW8kbaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEICrFAK9psH1oA5Rb4VcyJfAMWoYHQyqV7mmJXBEK
# 1qANMA0GCSqGSIb3DQEBAQUABIIBgHA+db45JYXtrA5KdbOc7De1nT/0ZkAFjoN2
# FV476wsZS39a6J2gMt4XUNvQLDIUEa+yvu7LuFNH4ur26BiykOxdK0t9GA26VZjP
# oF5/tHOPflCQ5awVIRxpiY2fSKnXsoRJriv/sYro9FbK7yMo6vSJyBl3Jh69g4o9
# klN0ObKRsV08M5D3zEha6eV7XwvFjXEraHYIZGC6eG1MQvpdIHfbK/bDJXk7hQZb
# H1AK2t/8rBvAUnUEGjVVMvba1BlXSHIgoz5r0oQqGlVHyBE/ZH3dakyci+Nwj59u
# AfMLVHKfcs0ZkVrMTc4CKroAYT5Sv7vS948LqiId4VScZMHFTyZxg686zJQSYIEP
# OxNEvanFQZB8dg8iot9KCHElGEOshAERAUrC6kbhHZMn5erWpBEEuCtNWRTgqCy0
# FuAdB5RfmOlppQ2bcuqsIT8QnLpc1aeBLVhcJPy8VzZvxkhDa41OfIwxGPLn2RYP
# O90NI0jFA+A5fMJ6Dd2lrip9W8rJ5qGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCArvldmak3N/fQDYewmAyz+t1oDxKh4yskqoSKXb0OpDgIGagxE10xD
# GBMyMDI2MDUyMjE0MzUzMi44ODFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0MzUzMlowLwYJKoZI
# hvcNAQkEMSIEIPHTCwOmHvsFCyn22c9xRI8r445RKcGkjrh9gwYIm7/iMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgA4vFhj+IMUfhdbigAu/oSDK1P+KDSlbW6MrPw9dYyI07+U
# VcuL89UcXTWNMhTliiKHfQR6G9F4GsltqWTC3IQISBuxBT2kqUjQA0gs3xTx0+Ec
# 0x3oEecWfQ61LzkgVCTF5WhIVY0dTp2LXui3TL6+H2fI5s/JnxeFh93zuMlOOjCH
# zcUMouZx6x70ZAxbmur7rp+7wLOqtonTdzeSqrnRpN/QNeP7GsIDxgxqYTe+C9Vq
# L3XKYmCyPXAFCmqTnur5nxNZrso+CuiwK8nN4yFMYnfyFwBf4yXSLYCphvatM3/Z
# V44PXtUT5nzf4mTbDBBQaBEpn8UuV7drZ4wJ4YnTcrjCtYmPdU2z9g4HJ9PSOcVH
# F75kLXLPEQ1g8WE8A9WAwUg4yYKnbQRNiFuZQoqZ9gay5xRa/+ApoSzkJObpofMQ
# RuZv9khXKPIt+nDvYYByro8TQTrFsMw1kDEBKI1Rd7n+xEZDGPx0bAAWd/xBReSO
# pkIzQoZSIaYpbzCxUg9ce7A5KpdH7UYbwJqnbc0lWFAPLgUuTq67YAeIKJGbHcke
# JFVaPlUyUxNKh3afaIIXTEXyE8DC2iYuwyIO3VJNTqu0ouBnC19UBNJGycnFZwHO
# kGAFE7hYaptiWAnW3fJBldSZEHB9pdjdZH5VlkoCpROo4/dlgBr0senNG/CnYg==
