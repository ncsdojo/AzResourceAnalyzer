# CIS 3.17 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.17"
        Title       = "App Service remote debugging off"
        Severity    = "High"
        Automated   = $true
        Check       = {
            param($D)
    $apps = $D.AppServices
        ...
        $bad = @($apps | Where-Object { $_.PSObject.Properties['remoteDebugging'] -and $_.remoteDebugging })
        if ($bad.Count -gt 0) { return @(@{ AffectedResources=@($bad | ForEach-Object { $_.appName } | Select-Object -First 500); Description="$($bad.Count) App Service app(s) with remote debugging enabled." }) }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC7VJwQxMSs2fXQ
# +SvwBmUgo+t5VvMqnpVjXp9stwVz36CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIH9+HbgV5gE1p59szvmS6mJhtouBoDsKjW+cS+wF
# yNGbMA0GCSqGSIb3DQEBAQUABIIBgIMfmLHNcG9Oyu98OZxh1GJtqGeZjMlwFv5C
# +XbH1E8T1Vn3mjliCdwMQsO3eWXw3k3Q80up7JRczAKQo70/uctfamdKHQFPKXaL
# +HB8erqNXvvICJ9vDLPUVJub24yNJu7f6LIoPu3HV3olRGRiP/M97NNAgYlY70Gm
# fdcMumFs5vsKrN0+LaRz+Kvff838ayOW8RrQxOKzwERI3LItx46NTGUNOg6vhxy6
# y9DgnQoISsNvnHJPrGte98yYtZVZamkUY8Uv+M4YMDJse9daaTofY61ChjbtQ9fi
# K0TQtGGp0Olt0o2PpLGzt2gQtxsYR1rrw926aBEVpLHl8ApPs5pRvg+ZvRIv1pY2
# wyc96THJhzAStQ76TQ+vZLmFRYlCnnr/uiI6fOnkOegUa9vN9J6mv45R9mzFSYbh
# 98JEvpoRDqErECEuKOUaHW/iUQXrJJMDREw19xpv3AZrzmOsu6PYBoVevIwgsmHN
# J2JJ5Jjff1BLZzo+zeKwznPDKJDjKqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAs4AUWir7m/a2PTVMYAuJVP8Sv9D/otAWNCFvdpsc4GgIGagxE2YkH
# GBMyMDI2MDUyMzAxNDM0OC45ODdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNDM0OFowLwYJKoZI
# hvcNAQkEMSIEIJk1mohEoMMXBOrxHnHX/TIiRVH7lCPuTnn3VveSasFOMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgANWcV/KVrzmoe6IeCFcTCFjm4ZT9c5M8equiLXtTn6VlS2
# 5n9vNDnM6VJlEmzmg025Nz7d3EKu9miMSGmdHX95iEFv39Ya/H7Uke3omp99M56i
# NBA+dWV1Cnzr1sA3gC8Vk/jIvx3ruE2nTnjohmUHC+fZqb3G/xWOOpc2fjxJUnY9
# teXbx1jYN5Hfc52mumh1A+IJMzxYixeVflItR2iUsaRaCmAkFg5IrVmGW7rz/0Bx
# ZUsbE2lZHF3MttsI7CB9wmu7LhmcyfRXDVZGps+OpImjWEu8gYP2N5AZTwDfxcqE
# JYArhfs69JTkG0KMb2VqsS8v0a3iVNMSLP8cDTW6fHWX4dby7yZsBslkERteA2yx
# DcNEAQhkw8RnxifCfVaXYJXIYWJOKAhoMqqD7hSgGLgHbyg3TEt7izbT0LOVeYlY
# m5QUNTeLcdJVuuDi7KmDX9d0PR1HVJhtt4du5gFVBqG+OOZ1qTu5V9Y4E62uww/U
# WfpkNOmIrzUBHrwNvBk7wdS+ZK/n3uCh4kyo+ms3zfpmfLgnOVa04Nm3Mmgfl+yo
# nQ5J8zwXSN3kHVFuZCKh2X0lLSyMaRiuviRtRau/QithaBi7+g6fhvjCqDnAjPKd
# OBzxzTxkgWW9q2MlNa0YGbjFK0gCncEpSPuKYyAPrs40fpQlumvlCE8ZIPwrCg==
