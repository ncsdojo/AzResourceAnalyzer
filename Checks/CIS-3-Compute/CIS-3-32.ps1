# CIS 3.32 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.32";Title="Container Registry content trust enabled";Severity="Medium";Automated=$true;Check={param($D)
    $cr=$D.ContainerRegistries;if($null -eq $cr -or @($cr).Count -eq 0){return @()}
    $bad=@($cr|Where-Object{$_.PSObject.Properties['trustPolicy'] -and $_.trustPolicy -ne 'enabled'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.registryName});Description="$($bad.Count) container registr(ies) without content trust policy."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC2OL/p8i2iqXUs
# oCP5ASLNWBimIzNirQD9sK0MT3mwjaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIC/PcLYSPACJAd10QzW8YEYp1WteL9S2j2lDnQdl
# 51vMMA0GCSqGSIb3DQEBAQUABIIBgI3zQRJctJt32gRZJv4DaXHRHDNj5PepmQQM
# UA83NqUTOe/5Zpcg3hmivhPza4U8w2gmbEEotjsAO3466QPXI2uODYDVabu52JYU
# huVJWaH1i8iuGvn9C6voJizobGCzv9NDEYa3mEpe9vriFnUW8+65xp9i6PIMHsN1
# sMV0ixvOYZIakF+zEO0zJhWXrc/obbikus0gTio0bY4YFJ+iEajYKex59Nah3ALh
# 2PWorLQ2ACujqa4HXk70fHb6Cuo3k06M+z1BN5JnzZRBV3TgE4tOkbf/sN8DCRo5
# Xjx4CTt2x2ouGnRBRhbDOMbpFAyZ3Tp9fdDJV8qxJ3LR/I1KhoZNAEMC46rNLGuS
# Y29AONLHSgUeJqKKGauHxItvzdKIB7LNK8YYafz0qmAoW9qtRZ7SqQ22idoRbzuJ
# 3AhlkMpP/4UuKko0Ev+5TIOnEg0LFtBxV5EXzA24DwxcgRhp0kFx0QL0hW//FZKz
# DXIpVvYhEOGG8MKtbXN/vBwS4phSjKGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCAJZi0gBCwU0dusKFsl/GKzo+Yc2fqKLKffy/QbyJZfYgIGaeiBPJf0
# GBMyMDI2MDUyMjE0MjgwNS40NTdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0MjgwNVowLwYJKoZI
# hvcNAQkEMSIEIFnbDzu1FjNVLO/I+EWk4WsWWZeJAkGeUCGFJpp5rPaxMIG5Bgsq
...
# 9w0BAQEFAASCAgACXSoTgLZlleGINFOEmshg/XfpSI69VZLelixs8dRZdImRQ3+4
# vPxzNvdjGX+MBR4A2iiEfNoXuQt4V1tYgBAZXytJf+ygkxjiifjNB7ZGQT45nOSU
# 07Xh/9lAIs9qB9EmXmlXfvYNxEoLqYzVJPwE56hpOIuizx/i6B+yrZtgfRZ2kgYp
# Fi5VjVxGTiw+olQtIKESYqeUj2Z3zxFE+FdUyml6xsz0DEC5HsG/zWNLHTT4LdXA
# NzRDT5ILEVJyrzHrx4QLDYjvQEo+2o1yZ8qjZfW4V1zDkrTGtrv09lnTtUPPpjJp
# aITjCn+CYXAtJGv0z6i+SrxLHCI5yVnvMHFXqrD1cHMyu2Y6ditbIDdi0c/Ky0U4
# mK4+bVJ1FzKk2CCmf5hrvVNu7CAyGgOEUeRms/K5uaDHnVRTW4Qz/pv1PhlM7b+9
# P4u+0w5E3kE6aMSybNZ1E+OCFJq3CvWI7Oo7ntEfmaJsXLqESOH+MMykfTvdVtnf
# wWrMLNyaAy1rHZjWmnBXJj5rA57zNDJt38XW4H6szxHBsU+vu7Y01II85hXikNP8
# +JSj43GUUyTNyU7UPq27GjdLunQR87z7ak7atU7rAlg2ePKfKcxFNhG5mliOtVCc
# IEcLnA/kJahCBoYQMx9Nv1acsEllppZBJUTxIGNI2wrCvemL58bQdQFoXA==
