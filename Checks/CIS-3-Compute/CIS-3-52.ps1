# CIS 3.52 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.52";Title="Deployment slot managed identity";Severity="Medium";Automated=$true;Check={param($D)
    $slots=$D.AppServiceSlots;if($null -eq $slots -or @($slots).Count -eq 0){return @()}
    $bad=@($slots|Where-Object{-not $_.PSObject.Properties['managedIdentityType'] -or -not $_.managedIdentityType})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.parentApp)/$($_.slotName)"});Description="$($bad.Count) deployment slot(s) without managed identity."})}
    return @()}}

# SIG # Begin signature block
# MII9GAYJKoZIhvcNAQcCoII9CTCCPQUCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA14WGzce2CxP6Z
# qSX1ulKmDZMDYwtfTXakz13nSLWT1qCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIOaWquFLroArgan1t6/Ni89YDV10L5WszWotqSs3
# Z5m2MA0GCSqGSIb3DQEBAQUABIIBgB4fMO2FaYAwfzV1Q2xYoWhB5HsAh2pvB38H
# +0M6OGY+JTCDAwqSaJJv3Q5KDHFf2ndIxXh0zi3Ker1i8K0Xyn4QIOkE/tyhFDm8
# 3FS+6RhQNxkOjIqiElptXehyk85H49zaE5gyusR4N4jFE9tHgt1y/DMi/afeGh/A
# LpiZnm5w8VUzkaM4pM4F4BtM0Kxqim19+EOAmYHz5w3c5ijA5LK7CSutZMoo/U/P
# hdty2pJeipI1eImu1/I97aoHFnwAHmTG3czaMu0iO+AO1o5xFYoeh4POxHQEn7CX
# BzwNccJvFM13JAmjcoXacvMMNX6UL7yF9pfbi0lHS5k9MiTrS89DoMfYpqsOceEi
# VIi5ZGjDKtbOYp6pMAR7Q2a9qOrcw8bjhDqc78YIWX6EeW3y0i/xmktNw7o3lU1e
# 86wIOZhOW6MHt7DYiA9FbK1dDax39/ICz0b0fBRr9fM8dyp+ROz4y9weU+xUj+Wr
# iUYf/lq9Y7qOb2OnaHQwvHHdximEIKGCGBIwghgOBgorBgEEAYI3AwMBMYIX/jCC
...
# AwQCAQUABCBCHMvCCRePqt2rORbtnxxSMvLeYmxpF5xt6ZCvu86sNQIGagxE10sw
# GBEyMDI2MDUyMjE0MzQwMy42WjAEgAIB9KCB4aSB3jCB2zELMAkGA1UEBhMCVVMx
...
# SIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNjA1MjIxNDM0MDNaMC8GCSqGSIb3
# DQEJBDEiBCAlLOjU2OkkPapTDI4iAQO3i/cvYor/NX9fybhMxvCszTCBuQYLKoZI
...
# hvcNAQEBBQAEggIAEBAghDojIk+4tJTOahOp/VRnd30ioSmlbdAmYNaGKMeEwJ4C
# yQHtxIjWD7+VF7KQjfN456PE22uKNKDVScR7TXfUCegzitHKwr1efvpGhm9fKhnQ
# Qt06hlp/gaSBqyRtK/l5802YGkzUZO2/GS0cU/iJGU9Z1z/HdXofj4CCAzqTGIJt
# 7vs6abKFAyBdxGFnsnqbnxGtZGUmkw3k3P6ENm1UugPac6Gv3Y3hUWuTI4b/88bL
# bdz4RGvXUG9er0shhcPwx3ciSD9FY75mY1ZqutltS+zfSxtcUEtL02mt2GwOWERm
# 5exOQ8OC11QHZjU1CLJJiDpFOjbVgCQFGkvGs0T0UwvdWHQuEkygST9j2wGMqJ+o
# QkvplK3KuFb0/5E2zzpu6VphnN15cIY7K1bGR3BNh20GHIoOqPvwmPTwtsBYvfpJ
# caz4RwmlwTnlQSHJyBN8qZzhUkbhdnQo4w1F21+nAsyb/F1ijRBd/6ixPWYQ5n/2
# jJP3GibTP9PyhO7RLiTIccVDx9u0Yh2rUeEnIcshVpyvbngrwACuBrgjWKbQxbX3
# /Fib4sA45LzDLeWliGTyJ4/wNx41ZCeR2vEEYK5y95Eyr2YgD9hh/AKn321R35MD
# F++gmxNY+PcI2QOGr62B/tJ9vAaSHVmZd87av4/LjrV1/9BNyBCEoyM4BAw=
