# CIS 3.56 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.56";Title="Deployment slot HTTP/2 enabled";Severity="Low";Automated=$true;Check={param($D)
    $slots=$D.AppServiceSlots;if($null -eq $slots -or @($slots).Count -eq 0){return @()}
    $bad=@($slots|Where-Object{$_.PSObject.Properties['http20Enabled'] -and -not $_.http20Enabled})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.parentApp)/$($_.slotName)"});Description="$($bad.Count) deployment slot(s) without HTTP/2."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB49pmNddWZ3w7B
# /p7RrHTdCD4wWG+cv1MRD8+eoOSqGaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIOW3zskaIgJXjq6yYaBMJbe8bSlkkb+Dnc/3+oFW
# yyS5MA0GCSqGSIb3DQEBAQUABIIBgHFA7gmwtiobN9t30mzptCQrVjx/Vtf23kV5
# 8lYYThU5nZcA+MKVzoLdxrg8o01cRfCG2bfDnaMknpj1KAxVu1khNu7j64Pv9G0A
# VugJ9JDSboC5UKvGjKGc431XNWdgL7aRy3gkk2BfXQSskp0C54A9QHJb3T5CK3GC
# UHkpSGj2H70/mc1E7viAEtRDe9Iae3eK0CrNr9tL1EDkCt9CuHu1PRVVuXq6Ps0p
# aIoqpk0LpE/xHyjc/Qfde5TJaRD1yc1zRajcTviGW6Bt6W1cJgxXGXaWdyPPvqmJ
# AYJVq77iLPj7mGFLtczKq8FvD2FoDj3GGlhv3mcTEI954UEZfcJ8lFSgdGaZ99kI
# 6IrPtOUKJsfQEYmOlk1xzvqZeYGuAG6XGq0DYvurJzUjE9/4l2arrI8v0Ygdj9bU
# gFnrqM3lFwxiZaEQiIMcb84MKf+EqgAnl28ap+zLItRugQioJCYJyM9Bva8keLKF
# KUC2RLiibFWnwx8FsbF4synDJbTFmaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCLMc4LTX7Suj+gzSsIK7NhdVtiLjAxUSGTKcHxY4KM2AIGagxE2ZDD
# GBMyMDI2MDUyMzAxNTMyNi44NTFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNTMyNlowLwYJKoZI
# hvcNAQkEMSIEIGigrq2S6eySUOa71zyd4lLxZIe2LueN5U9zN2GuZobaMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBlHU9+rAHy3VtgBCYYEPGacWTloTrYKn0Y7VlvERjUXRRf
# CTez/mmfrA8dnQMze/dClKJ5e6vCvwugYR9v/dp2q1ZQoLlTNQt+N7nwUGgP3pBU
# VRUOPajFjpdkqqpeF1pfzSD/ld87cxS8nW+wf3WFLJBcFcew8aaRqMcpvx1pFcoj
# 7Vc4/IK8kkMFopwuuwnCD9dwn+s7Epb+e57RIn4q3YNTjGjSbyFK8S+dkOHF0ZsY
# 893MgzaFmxnAoWIb/ZQUjkz3MqgHKbrIicCqdqAB5xkovlsf4BALQ+EH3QsSUaqJ
# Zd70rm1DAiKc5AcP3E99jNppQArh9beupxF0DLjGokVET4slfxcl2Nf+0ssvBX7i
# W1iHG4JCZXg/yDjrIH+L1xMQqf5hnqmuGPYotBL/Yczcq+rNeimfMm5ifBrzJaxL
# w37SfGV1mR48Qm0M+TB8JENJwvxJ+9yBDkxXrwgtHlhg0/3KKwOlFfJhX+ORMt0a
# VU8IwNktWTDeAzsCmN0JXgD4J7kDkM6hu7C4kWI01LycWP9Wn4jXpjw3sueUZW9f
# yRnr1dSmK4RCAHZKQd0GlqFa3uPdSmKAsrN6qxRuHAEJ/xgTy1Hx3B2EYj4fDMFh
# Nk0Zx9jTCNsh9MisZAl6aiEL8FjP0JLEu2DKW3aGubseyfZb2YvdnBWoaaSUEQ==
