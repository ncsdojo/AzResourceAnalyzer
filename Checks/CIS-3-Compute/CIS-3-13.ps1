# CIS 3.13 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.13"
        Title       = "VM data disk count reviewed"
        Severity    = "Info"
        Automated   = $true
        Check       = {
            param($D)
    $vms = $D.VirtualMachines
        ...
        $noData = @($vms | Where-Object { $_.PSObject.Properties['dataDiskCount'] -and $_.dataDiskCount -eq 0 })
        if ($noData.Count -gt 0 -and $noData.Count -eq @($vms).Count) {
            return @(@{ AffectedResources=@($noData | ForEach-Object { $_.vmName }); Description="All VMs have 0 data disks. OS disk holds all data — ensure backups cover the OS disk." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBFb8SlNLDL1hOA
# jB+3SqzjMo7WiW9MlmIkZ0KqjsIGNqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIHpO0ZaEEyFaqhKZ+B9aCFabTUSp88JNHXENHmd+
# +/ueMA0GCSqGSIb3DQEBAQUABIIBgIjkjRtPKRB5QjxqDMHDGauHeCJxUNZuEDcj
# dZeYDdBflPdS+iqERTmi6qjoS8gOq+4BqYH7c8ELNCtRFjaB61nUUDMS/ziVo+K5
# +Ra+mulg1kg0kXN6qNYjDgbmVn/yiy43g2bJRXzV1fBZPMSntrs9+kL8mBp3ThJs
# xJ/G/X5IqdbEKs3wMBBe6qvOWnCgBCq0VfSodOyeOpl9AM6GfAnzEHQG4SbjHPEW
# tReCVSnYtB+pnluffIaYdcVFGCHiTBowntrPO9B8Mnpa5RzLNhJtk8SbVp8MLqYk
# RA6gA89m0vlaM+tWHWHhfNlM9i6NXQZ56QKzb6DcY3iy0738nq/+kg2APTK9yXuh
# Yk8LYyUo1Ewt7l0rHtsPEXBN5Z91dxVN6oYnNdtSPIBwefqAUo8itbQ0OtQa5knT
# bEY8iSvMlg0+MMoAhYjuJosqfY0+4eLpE+WrGYvZO8RvanXM7RopdcpzQ8/DpuJ/
# vuAtPaJ9xW2zBAeo+/xb2nXeYTevBaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBD/0uUYoC77sO0lkc318D14kh69YGRrct2L6XWJPo4uQIGagxE2Yhe
# GBMyMDI2MDUyMzAxNDI1OC44NDdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNDI1OFowLwYJKoZI
# hvcNAQkEMSIEIJ2fM0do7MfRAxj8Ds/Tv3F99KrlWjXeZnoCaACEex5HMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAlhYySu/FpZ2EaV8nivTAZoxAZzCN4iYyseRIR61MEbrwk
# yyaR2Hn4KZnrzSai/BjkvZ07HE4Xk1PZoc4WQu7VQvDyV3M35xN1gi0FuQGOEMIr
# MnWOXAS7Ex0/cfr/89kRYJJsjAmLZoMTbDlQMzg7tOwQG4CWQ4CchI42vShGvdD9
# Z/oxGVrObvJtRxUy4baap659V+vweMLkbxqt0vRlNzONvMSuWf3dbPzLbtGtSbjB
# Qre5F0PtTTEaNV/7qPxNsgLeZUjS00Rz0n/1kqLxByMEi0cGcFKna9P7rbY5ku3l
# B+hLCy2KA10SUcI38H1NtRRoePAzNTQRV1F4UwTNy6ItbEobZY5Qu5p0K+hAqwZ1
# RaiFbvFZQkT4uvcvCLmZ3/kVmnazrCT82d5puMXdil7KDPcB7Dc8ID7shi0UqaWc
# P8cafydn1/42KhGt5i1iDE2dxFpn5aWDaxY8ESYgzaEXeMhpFYwMyPo30iu3lmm3
# L3slNAVAeNkS1M+QcOMZ6wJmp0oj1zLEE4zcsW3PJAwDY8LIOso+Lf8GGyZDIoYS
# s7XvuFcsupEDakYIfjsTQyg3MTsETYQYPPlqTkUtKroC/OJqZC4dI877F0zQt8M8
# Kx5xRUNLm0f3e1KZdqziRhl3agrx+ZAal1kQ1fe2c+Z4ErfYcvqyHDpV72z7xQ==
