# CIS 3.54 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.54";Title="Deployment slot VNet integration";Severity="Medium";Automated=$true;Check={param($D)
    $slots=$D.AppServiceSlots;if($null -eq $slots -or @($slots).Count -eq 0){return @()}
    $bad=@($slots|Where-Object{-not $_.PSObject.Properties['vnetIntegration'] -or -not $_.vnetIntegration})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.parentApp)/$($_.slotName)"});Description="$($bad.Count) deployment slot(s) not integrated with VNet."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCZHTo/QjVXTLq6
# +7ilWomo7K8ao1D+PMUHlO/F+9e4+aCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIBR3DE3OXsVVQOhWuUy5jr9n1UXS8oCw+OrDwTGp
# m7MyMA0GCSqGSIb3DQEBAQUABIIBgAcxHDBE9VbDq51fC8cNz5PPIn9PFvVuYRjK
# vOBU7FiKoe2UL+fazQeHifu2zEseVGcZo7hVlmZLcC2JS20qlUWiQ2/W4ty3Ov6E
# rY/h2hq5owDKjzCXbrijwQdXvDCctW0tmyOvDccHQ6KE4jD6RGABM+maEzyw3TvG
# DlZb9whu21DvFmDEejhdlvC6ftEx9uC7ihwJWMO6h/BQduYoJ4Dqa5h1NFuTTzuk
# MSoVwYNt2W/fil8YqapK30Wgx9DPAu+kaFZNLu8Nju2lrIwiaSc8kDoy66bORZBD
# hx89+z4cQlqqP9YEaBIyew4JXbiGJUH93tCi4g+PCYorV51xHA6cZU0cbkacFJn9
# e5VTaREbtErepsbia0GlFL7G62nYD4+yl+QBMOddVJ9aveoKlXwrmFfzryzD67Nh
# RXyviEI2h0G6Mj5NfBNxrxG0JEZePXmu+Pwf0XmsEFhF5awT5qJVzopJ7E9YEeV7
# G6+2tdY74mSAEEe5CXcPRQBG8ZLAAqGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCCFtc2+mY9i48UNmgoRBuoti8Q0DT0RAGNwKoSTQX3TFAIGaeiBPKCb
# GBMyMDI2MDUyMjE0MzQzMi4wNzVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0MzQzMlowLwYJKoZI
# hvcNAQkEMSIEIJe/c0WFszy26aVOIxEKV6fUxGCtTM5XwjCYphEfciyzMIG5Bgsq
...
# 9w0BAQEFAASCAgCdNiJW4Ro31fzB2Zwi7tcYXfU6mZzVhRdZ8gcSpFrMESKKtvRQ
# CG5/ztD70GQw0cm2wtI2vQjgxPEzO+56DwDnS0iJVdNxxPYa2UUF+aJR7HYs+SPL
# C8FNCbwIpOBoU41o7ewsI9bqMG4HTVqoYYJLaopZQ2/O5ZJPeVyDb3uZtd5H8Jwf
# Zic87dag6wxFy0zEFI5FJvLn02s/qOtN+VyK8HJ6f+hXFIoIKKQyleslDFvZaj9I
# gRNLcS+x+oZer+xQiHWAtn4wdFXK3wM981KY4OVAPfq8jfocxHK+hsAPcuA00mNR
# A+iOIhnhzcfuDEqHBEPt73HUMH9Gwe3DKNOMz8up6pPqalG7GXy/6oU3g1Gtq0PW
# S9ZK8kX9aH40O3MtvHIX8vWbbxUaGl7ITekXV5X7fMFa0P8ymnTI2NHW3Zor/S2k
# ulMEkOCTf84o7NIjD020tgy6g3gRZlKBsAc6KohF+43owWhek5tDuJbV1FyKy3iU
# K+38ugrYlDM9jZdGJoUKXhCkQneDwJyCACnY8lrDxZcUzO7YYTIIpJ/rxb3z/pAm
# 5rE2sYLy/ee7sNuArxP1ViZxt1jS7zSXG1Wl7k4pfrkPeosp+P9x/2nZgX+SpqUg
# iNJNoaYT9eCqFOJIqzWbxigPdL7C/mVOOIz/NnyL7EaTsYXsWBr92TuT7w==
