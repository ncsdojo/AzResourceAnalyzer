# CIS 3.18 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.18"
        Title       = "App Service managed identity configured"
        Severity    = "Medium"
        Automated   = $true
        Check       = {
            param($D)
    $apps = $D.AppServices
        ...
        $bad = @($apps | Where-Object { -not $_.PSObject.Properties['managedIdentityType'] -or -not $_.managedIdentityType })
        if ($bad.Count -gt 0) { return @(@{ AffectedResources=@($bad | ForEach-Object { $_.appName } | Select-Object -First 500); Description="$($bad.Count) App Service app(s) without managed identity." }) }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC+b/SKT0sEq5iP
# LFbYgUBiqxGY7CKylzz2omy5gmGb/KCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIKQDyiOFEmzTy3UHDe5tumwjhlDVyzbFxkiED6sN
# RSUvMA0GCSqGSIb3DQEBAQUABIIBgE9TWDR6PlgwHo166Uw/2MGsix7We++4DVNs
# lIu8BHgdb9CxWG0MYz4D+Eoned4jSuTHUhzclHmmoJs3oYNiMqsr4m29oYTSZgbc
# ug8ga75cgQyE6xqKZq//H/tZE6yZwp0wGSnP48HqKbjqoUnMg33g43tkiD7PaXD2
# nyr5lCjElGVFT24VZr170m3ufeXFoXgQ3uxD/966K+Ll5JEUBuJ/ysqs9tiSsI4e
# qVQKFGahYVxO5VPsU/xgSOU8O2iuzGPIIBia8DH/WgcdBSBpsjD6dck2bxU3ES6Q
# KRaLDSmXMcjHR1Mnn8vCFDKP6i7vORVOEAOSy+WF/ww9MQEeSwQvemlMgFF2cu8r
# cqMtL1nbRLj//IPXdHshWCZ0FOgrbko1Ux0yQkfRl4HvRCXjxx7Icx8DcjU7bqVw
# 7OiJSxNE3Mktm2/A1kWZKaCaMEJy1md356MVZhKmuU0kl09uvrOVkHqV5oJnjJD2
# pULisksCkqQ7k0iEIGNk+Jn9gFm0faGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDYVFuHONnogD4L5w6Pw7TVccLDFPuFJjfD3Qy8u6QnKwIGagxE2Yk5
# GBMyMDI2MDUyMzAxNDQwMS4yNzNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNDQwMVowLwYJKoZI
# hvcNAQkEMSIEID+T4fZ6p6qrv57K2qgfhA9Z2npDXL6B/AK/G3Yc+/bJMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBtELL/2izs0glahwWfkcUEcFaoymQpINRR2eLrQeQ9w9XF
# ieBvsKi9G4rFOqqpPn/lypKaz8dz2NP5P+ccaWjSEyMBPcGHOlZoPrxxgrBGn57h
# 8gVrdT1VbOCHQEpYKqLBOjZUp64GeaOFjBkeAGdvZkeAWbHkWeNaujMQnIdtXUQR
# QoWeHjcM3w0PKww4GuAA9rfzs6Euu1DWJO59Yzt9aFGf+BrChtiX4ChvVHNQcXRY
# jemqDaHc3ldQiP3CVQluOfKCA2ORPosoBSwnFiPxrfgwgSXPQWisH7IGSnQ5Klhp
# Fds6C9rTR9dzCWh+iuW9D8OfTP2BEZeTtsgxjSkAEwR5aR7zkJvUXVaOFFGh2lZR
# 7oshgftH2nZhboZWIQ74RsrrNGMywzThduHCm4l8IIh3g5bLREQY0XoOQSdLkZrK
# iB5txFoMdmAsF+sHRFBCNAyE4AZ0td90mGVfBlBWhVM4hDCZV8ZWr4s65okeBKRr
# YqnqLgo1sZCzaMjZykeVCfoCFR47lc0QgGXJyXMCgIMQbTaVUK5UW4p0VKXphP6x
# JBb1qtSgGAV+VwxZF7nwDcSZwIcPeujjPZDdAtofetlQInUAN7fvkKhBK9p48TL4
# mly8DrgdISQxVMy+0ZvOhmyWLaurxNP/I7VWACh9ZLdpRqJwPDF9euqDlh+fFw==
