# CIS 3.28 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.28";Title="App Service route all traffic through VNet";Severity="Medium";Automated=$true;Check={param($D)
    $apps=$D.AppServices;if($null -eq $apps -or @($apps).Count -eq 0){return @()}
    $integrated=@($apps|Where-Object{$_.PSObject.Properties['vnetIntegration'] -and $_.vnetIntegration})
    $bad=@($integrated|Where-Object{-not $_.PSObject.Properties['vnetRouteAll'] -or -not $_.vnetRouteAll})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.appName});Description="$($bad.Count) VNet-integrated App Service app(s) not routing all traffic through VNet."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAekoPg7DGXXXKY
# xbDgM/jMVMEpBGEIW++IyoIdIPL3YaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIA1xSZlCAltGhzX8Ate/OvBd1sWgXTMtFIofLPAt
# uHvCMA0GCSqGSIb3DQEBAQUABIIBgHQWhBL525LFCiHvXWJHbNEyaWAIkueXIN7B
# jSD4eo+z9KRjUTBWOXlVMYOAi2C81Sr8wcNCMHXBePYgFBK6GfkOKI7Yk9za5xUX
# IOnnuc0eSLAPBIDDBW+xnxmR21w2gnM2vb0/D69sKLkBQC/2+SBHU0h7kb9KSTKg
# 8sfpaycLACfTlfro6acQTm3LjUouS0SeBQsrEaplDWEVrMjnBh8bu5tyqI2tZ0aH
# B0rAo8vJfoFAJfMmKGDw2zcPOw6akOdqm4JcgFmZpD/bmlHn2cRIlv7C3sPYK9SN
# SMkCPlcudn+J8XulddinvTnHDquKFBYbybsRwrqDQUCqpt/FEwmdhG550j2W57KH
# Lf0abGfZAGrzPJUu+3tCYM9g8DqtvHjq618pWfEH3QvpWxY5C9v5Dp3rmsDMzR8G
# Z7cfhX3z+OH20oI4TAmd8rhpMeyGA00ZzemDGQQCe4ujSkkT+eQg4Mg13jj9aiud
# 7+WDT+BaWDAPloZeWZ4Dvru+ooTdmqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDxN72w36vX4m3e9jOorjTWdEaxGiSu+xz65bO583C38AIGagxE2Yt8
# GBMyMDI2MDUyMzAxNDYyNi45MjFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNDYyNlowLwYJKoZI
# hvcNAQkEMSIEICvttlpnsoqMj+pEYJNkv5PqcPLxlOyHq8IPB6JH3y2kMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCEM8TV0JdPKTpmwt/hGilKzORyS/E3mCvfhtiJUd9s5cy4
# xI13lHVQ74czITeF7AtAORzibewAIVTvCi7OpM0dbxaEZe4+ziRR+hqoSDI2ftga
# IcbMTP1cWjksRilZ+1/ha7YaEEF7Ol41kxXL/8Rgvqw7yGQTTMlsHhjTgjioQOFJ
# 5KN7rWyWZDq6njwHrR8d5McCW0iy9WV8ONmykeHzbb4U/ovKmw+DvHS9Vq+yyulY
# 3uohs+R/mF3KdXf++d0Z2dEWm0Pf/CrUQ8Yl3V2gG2EmfnmWYiq8CSiU4P+uJGNb
# pWn+v1n89pl8QdL6LPUJpOMTN1GNwkkESNytUYR7B+GRrQb0aNDW/T9O2XF7o/Xn
# 2nlKuE6yVAvLZTaRDOaAl6TpLcgj4PU9Ur850HZk3Z5OkczjdLO4cPnbR/YRHGgY
# cQLWW8b2RmFo38+XUQHTIcScHR3tQvLwNKNGUUdnuveFVDv1PnXmeCagJhtTjxzA
# npPsNost25hKtsTX1MwMdm95xrAq4W3j1/B6+9qRQgfJFJvYy5+gicgTthzjwqyA
# cYfXmvhSG2+8PJCBzbkaVrssWPGYlbRtnNuydaQvYMA2xIZNFt3pCTudhCXGP42Z
# FesTbL1bkVoxon/zDa6LviwuefAKmX13dfhBaw24UZiafBErlpX3IZvLS8vTXA==
