# CIS 3.6 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.6"
        Title       = "Managed identity configured on VMs"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $vms = $D.VirtualMachines
        ...
        $bad = @($vms | Where-Object { -not $_.PSObject.Properties['managedIdentityType'] -or -not $_.managedIdentityType })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { $_.vmName } | Select-Object -First 500); Description="$($bad.Count) VM(s) without a managed identity. Service principals or keys may be used instead." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCQCjEF+di20xmB
# xSRLN6sOyMt9Iw5NaTD1M8dEOLEh46CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIDztV4yVpE8WOKnA5eAAQhboAGfaSm6Z7pz0JxNU
# v94NMA0GCSqGSIb3DQEBAQUABIIBgGNGeN0END04ORGU+zTtfk/sEJ4wZTvo6cdq
# xFE3BkxvmHUY41+kR/MCPvDu+dfD4oGdGWPLKKxC2MwPsS6k1kMSSAK1fK4DSH4z
# 4HTvzuogOeyWrDTHdZqPjV9HJ1pCVyR50JZpDRWE9mp0hLxPvQedgdhvDdNGXeAh
# bVAZweT6bwFTWIGAr7suT48gYM1lIBULmGM9MKbNHb4px6WZ6skXdjUeGzGCTt7j
# wkMpzCGmgaueL2qUFzUulB5dHlxmLTMGSNc4G9utzhWGWjktuG0arWzdgZFi7Evg
# WlY/kXyG7xWaVcaYWjyokTmSPUZ0aU6gGMUtDxDT0vyUcMPACavI32PHAYYW8brn
# /5VdBhFxvmubVnP6CSFrETSVKedKG79NhedPonrjazGhhfTXDtpbzxQQtFuFMpO6
# GmfvZErXNhqrMJBx+3ey2PNNsvS2fQ3dyzonoCNKpue7zyoEU06yTF45DVn2/JVE
# yZw6OJopD7Cv6HwHaNe2+FCCny9oMaGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCDVrNRBJRZvDAMKjD6M4AXPzW+hNMPY8EQkalpxYsUwCwIGaeiBPKFf
# GBMyMDI2MDUyMjE0MzUxNy45MDNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0MzUxN1owLwYJKoZI
# hvcNAQkEMSIEIH61bnFFHb9Q+dQJMcJ1eBQ0wpGx1c8cVzOZWLKr+RO8MIG5Bgsq
...
# 9w0BAQEFAASCAgBwR0LH2LbjrEtFhYbLWTrwZE/wEslgmPMmd4G05vL6XzWzf13B
# u7cwfltNIDdtHqFrNe9+QexI9KzvtXwHBMe3Kv9XxeAQyZM1H9NnfZtas1HIlXpb
# j0qmqv9ctu/FpRWe2K0OQad5ht28G/ztB7PLm9TqvpV6T+u+x8SiYJG11Yz5Vj2x
# U5bMEFe19MfvGAz6djrykH/NAHiiKe6ma0T9bR0F6VDo7ih9gmYHZagW5tfEmcxa
# YPwWd9wn1k6xldw6aZs4R81kEcFIinUtInhcAWnUY/5fpch0HIkqaYqIO6ylTNhW
# uIRnpENrTLg1XlnXIrQ4wREKTEzO6XKZZliyYODLbRkP3n7jyfn6mC4lyFYc2Zqm
# WD7rKnqzX+HdoMkjUNPrah3acnzrWhjedVSadJk4qumujhu4kvjNMA+4bae23GaG
# hP5V/dqHL4VHbpTmSJ1InaqRVJry1rr8S4u2qWmgTvET4vZrFTixVuVkl6Vi3x5g
# o9iCUwWHRCtxtJbzYYRUg4CnyX8mQPyjsluilAFlE2glldAbRhtkGVmzh517KAWe
# Wb6B20QTSvxCjBuKuEPsR2Jz3bMgDNx0bbKI/b13UxMT5FeXE0YcjuZLg8AZb4Do
# JzvZtCOrYnr/EEykVz15l+twtvVnM7bOeX2P5zjsNH7r3GiDl/lHzBT//g==
