# CIS 3.29 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.29";Title="Container groups use VNet integration";Severity="High";Automated=$true;Check={param($D)
    $ci=$D.ContainerInstances;if($null -eq $ci -or @($ci).Count -eq 0){return @()}
    $bad=@($ci|Where-Object{-not $_.PSObject.Properties['subnetIds'] -or -not $_.subnetIds})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.groupName});Description="$($bad.Count) container group(s) without VNet integration."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDSussSu3FPcZti
# lnsjBhjfAsbB9tuR8slREZGowLTRQaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIIsJ+2H3YhmeKEg+9sKxbxXkRi/ThKi7PTDtGoyu
# 69uyMA0GCSqGSIb3DQEBAQUABIIBgCVhdfdDWUTF5DfwV57Oyavr/q10SXtl1JPz
# JDTQCMErrx+dXrAQA7I528L0b98wvFFAOYi62ixLlO0F8AvqJdjQxu50WrXnVOQd
# Ia9fdr0Cbv8xvmZ6XclRBNsQgcRLIJ1KtT3W00r81oXIAdJMrqcjcqSTP+O3db8N
# ETX3YHmNBskDjLQijkaoQJ4JlgXicdUeyedzn+aSvWVpXEfg682cTTzRqwdD0Kea
# B9YbOA42bhK6R0GhT+maRRG8Ywpij/J/Ng4rglnl/dze4Yo/06XhFCLvoElAGT2w
# 27kiYjvaJB6hotH1KZRl7t6Vv5ugadafoskwKDzwHlikNNcPdCUbkKvUuRD6bvN1
# F0CSSYxO4UI7GMV6wUF9/cWeolW8Fs5XgaSfbmeHOhqU3SmyjOC5g7+7eOkf7RFs
# 5TmeF5P57m8C4i3sceH+dIfPOCb5f+ErbIVlB6m8TOpu3W9kOeZlmt3NTZWrG6EL
# VxCrYDis6JK7Lb+hO+TCGei0vxVR2KGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDV2acJIcOuERnzzM9teLsAQasL7pixGCAHWFr9JNVtrAIGagxE2Yus
# GBMyMDI2MDUyMzAxNDY0MS45NTdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNDY0MVowLwYJKoZI
# hvcNAQkEMSIEIOkHx9uwhzaBAlVTixsVRIPEaR++AHpQmljC0EAPnP3UMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCLxiEZyuPosHvJdFmwfPwC6/A06YUelBLRtdOl0Rr+MHuX
# AbPBt7tdssJ8Hq6cc5r2eJiRGGhjlFisSwvS5tKaumtZV0XgjX6q5Afs/syL5SjU
# EilQSXJEGTVtpvJ9bqdZnhjh3dQMXdwAYlXVBe+i1Wb7RR5TJgXvhXELkphaDVxv
# DuUgD3EVWg1s0BPRaRjWvxYL4INELdCd7/XP9kaZjYV5ExpjeIBGUnCrFI1YxR/F
# KOS1J+EymzUtb9WWBwUfLilNgbS+JEOQUXWTGiRTVvUtETZQQWKJtpKPiw9jGWtV
# hnbduYrXqBdBDTzmraRA2TBNJUjqzTJWW3CnOte1dcm5eomqEmXfSNii57MTTODf
# X+ex1fp/4iTE3oGmzhy8vkm0h0VIW0DUqRImXeSxODr/9JEGRtpznJ71BHiltl54
# Flb4Xx//J1mBTMlu4NHsHvo+Cvk9UxcSVi3+rKCa85aOyAcn4v/R6j8Go+9ndgo4
# XLh8gNjL8GiV6dNiPAE/g4+Wi0ovXrAOUZWLoSoW8aQoJ71UaMuULnV/LwwABGIS
# qXhNID90wMVEtm5mjjtz7fZj8t/nMI5Hb/Nu5vfrK8w9cEIARAHWbCDGepd/4RSh
# v7KJYQSFENjSf9Cn0CkHyAHCdpXIAfqxJkOv9ydJTIBZBasom384FOxmBNHbwQ==
