# CIS 3.24 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.24"
        Title       = "Container Registry public access restricted"
        Severity    = "High"
        Automated   = $true
        Check       = {
            param($D)
    $cr = $D.ContainerRegistries
        if ($null -eq $cr -or @($cr).Count -eq 0) { return @() }
        $bad = @($cr | Where-Object { $_.PSObject.Properties['publicNetworkAccess'] -and $_.publicNetworkAccess -eq 'Enabled' })
        if ($bad.Count -gt 0) { return @(@{ AffectedResources=@($bad | ForEach-Object { $_.registryName } | Select-Object -First 500); Description="$($bad.Count) container registr(ies) with public network access." }) }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAWoXLxjFTJh0VI
# ArCHxfpOuTw4pWFoDna8YBHltgigZKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIPH1pNh9wsVj7lreDz0/J7YlojCy5FuXI3vpkACX
# sl+cMA0GCSqGSIb3DQEBAQUABIIBgJUZp0nuRDfkYpcFK0Mpd1P2i0Vng3jWjHKs
# wy23hACTC/lo6P3OS5tsV7bjMstMJlGceA7Vb2643abEns1TUj750b+V6Gko+PTW
# kW/9QHjsJUCXHHeEElPHSjgxbEs8C1x9SbYRgIv7O+77APDoWMhMuVw5U4SAU5TW
# 11TTmYu5sJcdueU5ZtTg9rk01aH8bASHg3phnF5o9A6jrqvQPPsnLy01mx98Xz4Q
# qq/oY2vN6ZPs1aKJuv0jLP93W2wgqLsGue6pptCNPYAvYDdCT5kqL4/wuKTB04bz
# DmgxJcRXIpYU1NlzeTngdNWe8/8vA/oLAKxlJI3M3gkJFg7JjBTMtOQwMbe7bE+3
# zxzCCut0HWmREZs/pwp/eyd8LTAwvgsYLYFsVDdK7sLmFWyBfMqLSLa8N0L25jMc
# JGLyoOwIsNeo6jo+1fv8o1g4LklV4jKgeVaY/+ukiAQTBaEb8dP2fghqLf6MZ7UW
# deu6QnXC+nuZzrn9j4YlNDjpcZPZSaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCs369Vx4oEnkVHTKsvqRzlMAs5S0agIlFYwkHfmfWDegIGagxE2YrY
# GBMyMDI2MDUyMzAxNDUyOS4yOTNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNDUyOVowLwYJKoZI
# hvcNAQkEMSIEIJ8ZbwQGYdDyRekIjD3W/OmkkRmPTYHWP97MeElnsqVeMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAMi0UOJDai6OfNu2CjPHJdWrfrMQegr/snQ+oMZKVboUoQ
# y0jwtLBP39T0sycyEixPL+a9mU7qp/krqMgPygmGasI8srR5BYDQ0CyXpvkioda0
# jczzmFqS9w106XN3SdgEtrXJahiRxTpDImkvP8NEerbYjzMZjsb9LKUlRE62c9pN
# hM7JXll4XXnqPMvBUWAEfGNTruUYhRUIFJ+/10GFczoNgZbpFDWzxISS2e/bhUg3
# YEbjxa64Sztz7cnFytfvskYp1k7alclQRDJn/NTs4e0gyPLGyFzkR9ztCRXTELEk
# L7BkcmUC1+w0N1o/i4zJZBT4tun7SO5C9+sMNSuJizA/SrK9QNJE3UTYMSRDnfXl
# kUu0FITix9Iow40GbYYts+ONbJmxzYWDTlrtVGj7e5Zx5L7m8tciyEV8Zrm2f2uR
# x8y+98bM9IVPKgSnlLcBZQS5gVOE/UN1SYlnZdCKumNUzHHJ97SIVEEtilge7tD3
# FK62suKPBNvK3nrfSwBXDjMBcMfbvwBvCtYJwLhJUBKETzPaPl7Cdmub4JiAnlEI
# 7IhcZBsjdd34vOz6MZZ5BsKaPntD4pO1g1P8PSFDG1NmUf1PvnB+1M+JKLKNvwiJ
# 2b6QezsrjC8dT/5iis+w9AGMxAeTI9tFnLV5x7aOGXn22bhTwEKeHB/1YCS4yQ==
