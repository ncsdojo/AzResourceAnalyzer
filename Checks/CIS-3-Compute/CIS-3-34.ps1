# CIS 3.34 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.34";Title="Container Registry zone redundancy";Severity="Low";Automated=$true;Check={param($D)
    $cr=$D.ContainerRegistries;if($null -eq $cr -or @($cr).Count -eq 0){return @()}
    $bad=@($cr|Where-Object{$_.PSObject.Properties['zoneRedundancy'] -and $_.zoneRedundancy -ne 'Enabled'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.registryName});Description="$($bad.Count) container registr(ies) without zone redundancy."})}
    return @()}}

# SIG # Begin signature block
# MII9GQYJKoZIhvcNAQcCoII9CjCCPQYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCS3iDJqv3q9UZ2
# vkSOrpALPK9avyOcZtlpKfDE6BdHZqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIMBj6ePEEE4thqWLpdQuge15K6FD++hTNDR12DJe
# 1ut7MA0GCSqGSIb3DQEBAQUABIIBgInrh8EhiXPlcPoJev72fKSTlJobVcKLNK35
# YvQZuf9HNGKAE4ZTKbNhio21OmYqNmrAXDECgYS9l3kYG4jWtAQP8Wh5tQ6korlL
# 9VWoP/ryRfSBdIl7MjKYqX8xE+NcJkrDdABz4FOmY1s1K4LGVZnJWPqdRVf83fTJ
# FTc3p4VH6OxmglqSFE1krseYOMXHfGtVvmnQyjz22H1MgcaxF0kD+4Go3j7dWzXQ
# qIYJxjvFZluPSQAmFoWjyDJKjen5xpKOsKLeK0XHu3ST45c8tKSz2RCEUdGG1Er7
# YKx5JKxrkv55f3e1oHuF6FYcQPyCFCwDqLpZa2WuyuB84S/LPpwMp3ikLGAqHrC9
# RFIJNh6bmv8VSFspiId5DE89ZsYanYgcBUpj7IJmv5zAMkCykdQG5fMgBRtE0uxg
# jZyYfNUMl6X3fDeqf1cDINXA8XlITQMLQ/KLr71SP+nieqB6Dl17jmdCWguOFdOY
# xw/VR0FI7EzIGL+Q0e1rbNauFArG8KGCGBMwghgPBgorBgEEAYI3AwMBMYIX/zCC
...
# AwQCAQUABCD6HnFEaAQYqwIHsdN/VqIF5K1RjA6P/ly9xZuQgbH/RwIGagxE2Y1Q
# GBIyMDI2MDUyMzAxNDgwNy4yNlowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDE0ODA3WjAvBgkqhkiG
# 9w0BCQQxIgQgkF4KVCA2DYIGX+ugF14fOlJLjjQ/ZReBVMjBwUhd4uAwgbkGCyqG
...
# SIb3DQEBAQUABIICAFNlCg/jNj/q4Hj8O/Jf+j1jKUNno+8OAMEuZJR5pK+dza0F
# TTe24+O+U+oLCiuf2cSUqP+zSILpJcxe6LKIXVUWfuZx2ZTs6DmY9MrMOAhKbqdy
# 6VzKmkcqSl3GVu3thg6iq9+/KgzsQ84/qW6Y1Omd4y3lNOGDRRFCBmfUWsQD/izy
# NiYX/mSLHAhEEJUpUZjuRmmEtGAR8CuaJfrD69ualbe/c0WoC9EgD0ji22PMkY8A
# RnfM+XaB97Mmmoni9fZi+O/ArmblmPvUIlX3UnYthMowtBuz4xx4DyvMt6jUGkhE
# 6R9qjcB7xk7zwrsMedWEIh5b2kLVG+6dIkxaQvW7DVQHPLx82ftAJFIkBxG5h6UT
# gwthOOJ0GWNny6UjzgPt+ciWJh0jEu9k/8rzkQhhU36bzeYJxVk4LvZUXfav3eGa
# RIMoHYP/2grwfvrk7wgmF4Z3b18LADuZJSHYFMY/fO/xD7m7DxydILLvbmlgq8Yp
# 6B5OJA7z0NCqEHD9rlckLG31UbpkvKF2JZYvPTcittdgHYTnE8YNAsXQD7pZW9ja
# p1QQXdOKdH+dNabGDS6FgNepPyAbu+0c55HyDpIdrB7oUH5lbDsCve06mm72v7zI
# 7F/eeb+ZPfYw3+hVFjHyAwdWYMx2Tu804UQ+f7eaPSwXpU0C/hFMCmmAVDTP
