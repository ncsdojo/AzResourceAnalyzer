# CIS 3.11 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.11"
        Title       = "Exploit Guard enabled on Windows VMs"
        Severity    = "Medium"
        Automated   = $true
        Check       = {
            param($D)
    $sa = $D.SecurityAssessments
        ...
        $bad = @($sa | Where-Object { $_.PSObject.Properties['displayName'] -and $_.displayName -match 'Exploit Guard' -and $_.statusCode -eq 'Unhealthy' })
        if ($bad.Count -gt 0) {
            ...
            if ($winVms.Count -gt 0) { return @(@{ AffectedResources=$winVms; Description="Windows Defender Exploit Guard should be enabled on Windows machines." }) }
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBbYH7axSU4E53j
# 1I1xaCyMVqQMeLQNQ/W1J05rRQPl06CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIG3bwzVf2IFiI/piDNxhsd7LAOovctx+d43A49eR
# DgIuMA0GCSqGSIb3DQEBAQUABIIBgDmC7gtOkkn/ZVztzbPuWiTReVqOS3sYiISM
# kVVW1Wkj+TZeOrCk44HcBfH0aayk5qH9HO/QjHOXDFrMaF0zmxYJri8aFehU+oTA
# a7ZBNiCJ7JLA/SiPZCqqFdgfHLKmxjDRK/e7ZXmalHAmexh4VA75/A46ouGefkvA
# AIJkzfm8ELwn7HteH73O1YqX7pxsqPLAicUyrdNn5Jo0tEuwwrJ4JAgwNmdACiMN
# HquTz62kkfiRhxCvh6N69J5pI2gz7cRGrKYGKscf4EM50VAbx8tVO0i6rC5ni+U9
# JLeKRjFPfmFrm7ICHYEC7BXQnWMyuxO+ZgC4WXhsYPoUNfuRnsRTP4loJPVludPd
# gt4KR/8baOATSDyPGOsdOOzkTPTyPE7f5E6odzFpZ9OFeJkU5JoEWDXFSKgvpKMx
# 0e42frsitjDO2fuCIfeJLNTyvBxlwGjtYOlMCArMjERyq+HZdk0F7yGQ5SD8cl1d
# DYWI8/g9i8U0gIcgpbXXRf7ZMxiW+aGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCALouEp4SuO4UcwdxQ/E/1gGMb8ASF3/1+HsgFOFBMdBwIGagxE2YgL
# GBMyMDI2MDUyMzAxNDIzNC4wMTZaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNDIzNFowLwYJKoZI
# hvcNAQkEMSIEIOEHCS0ok9W55dIpw7Z83as9fxdWCDnAIUt99BVjPbP8MIG5Bgsq
...
# hkiG9w0BAQEFAASCAgA9NP6EaYW0llQQarUMpVbz89fKOcHFRVVKMA67mBSNmjG/
# GJJWFiJ92FZzBlCjZtkjmjpRG9VrB1JRsICYJjcsMvamSsig2K8hzwd7/571FWTg
# /yBvMYUxOKZiscR4IuTncTIY2aMHRpnq0UFOtmDR8t0NXYkGFB9kQVeeuZ1e8ZLj
# 0hFggthWxdEPu7VdTk72PpL3qGxLxYKS5WDGUJe2XbfrFpns0y+3ADGZ8Sev/jF7
# G7eRmoOFwSgogsVKwb8mg8qFPcxiDLSLudRaIHdpTGNXJhkHWtxnO5RgJdTGnk6I
# 9RzyhbZk9vx96FjDAnbZnOLT9hjo106zkSdF5rEAZV0l/aN0fsK7OohQdsGcnr9R
# 7C2w9ZnsGR8G8bDMHBNzLgh2dRSvimpGJDY1zRiHp/lnTujJUBQKfVtnkyEGr+rF
# SCDNwE+rWk5sVn0gf7mhHSD/f+inHDB4tlE//gpby/QokHqIbAl7SEJLFbOGHBPR
# gl466PIaY7jftzkR8CDNRxLZitxcWyJCwot7lrqkO1nvj7c1warOnT9PCq0vCwqS
# SDcXvoa65YyJMkGE4u9iEhE7ELInHSv0q7GcgrnDhNEnkX3WnAUMXRxxPIftwcqY
# HL+m8/Et0QFGxINPCnhCMYnp3XNcXzWic8S1QM7gfV+1HvPemsNj2qy9KAyKGQ==
