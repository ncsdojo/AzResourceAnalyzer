# CIS 3.45 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.45";Title="Function App public access restricted";Severity="High";Automated=$true;Check={param($D)
    $apps=$D.AppServices;if($null -eq $apps -or @($apps).Count -eq 0){return @()}
    $funcs=@($apps|Where-Object{$_.PSObject.Properties['appKind'] -and $_.appKind -match 'functionapp'})
    if($funcs.Count -eq 0){return @()}
    $bad=@($funcs|Where-Object{$_.PSObject.Properties['publicNetworkAccess'] -and $_.publicNetworkAccess -eq 'Enabled'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.appName});Description="$($bad.Count) Function App(s) with public network access."})}
    return @()}}

# SIG # Begin signature block
# MII9FgYJKoZIhvcNAQcCoII9BzCCPQMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDosJ4/aA4DKIG2
# kf/4uTpCl7VZsrkv4plSkeYTW5osJKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIM8mpR+R7IYr9XLQNoMG+24OAR0T6DxrosBcAELf
# 1tJrMA0GCSqGSIb3DQEBAQUABIIBgHHlGdNl7xY3hDa8TNc0sF0a7hG7/H69ekK3
# rj/jzdzgdiRoriyZXfl8b/J9jNhEf1k1AIevoEAbhfrDO+n4c7toJLHwPTcEG3Jh
# RD7gjnuQ0f5zAuQZbB28c+Gs7vh/uXS5rHxdPDkGnFFV7M43WRAQY2GWCmgThYYL
# Bt2P3k0Xk38rSNt9qb82JLY46T0JVPIukhXHfjNT5JDncUOCaRBPwibJJZSfHKk/
# pBtjbPYSFAb6KEDd5kizz0uo/wWPAbr08CV1SfVJYaqz2zw4uSP8Ol3ZlGvmlBvS
# 9Xh/AZk2kmAGe9Obb0QrQPTZLvT9csnk0kK2SvDkwF8zU8EZieYAdjTHAozi8lPk
# Rz5YzKShgBGp5Hl+mz5vQBiaz3MnWnREspegaVSW1dyKevNkCPWYQOD5aFeE7huO
# 45xp8xjdrwsbszM84zYjlHaEnop5XgzzGPoraIMYrOw19zNwWAUHH5UScdM90gy9
# 6lA8WkwAQrUq8/Q0Tyc27ygXkGMfJ6GCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCDkjNRZpMtZPV/SB6+95AN/xNtb+mHxyKRBZd1HX/ie5QIGaeiBPJyf
# GBIyMDI2MDUyMjE0MzIwMC41OFowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIyMTQzMjAwWjAvBgkqhkiG
# 9w0BCQQxIgQgB/JuQ/zNa7pZzhrsW7Ls6qR19yXfcdIVLjq43RuSZDAwgbkGCyqG
...
# DQEBAQUABIICABkAsfpTZqTiebumzOyPXXonuc2I9EDkFDXUV0tZPWFhbt4Ep2SN
# FOdgDo6i2Zv/6MvKZNu0mIIbpfVUbTFqgZfNJD+sdOk2zODHRUwYBl/hslL7T2s0
# WAUFB3qD6IF0Vg5rahfzPn9XrEqmVvUkCUFk6180U/iKYxa3Wy1rN8ja9CPREv3R
# jWRaAhljy7akh4CtEypb1uKbb9+jgVvjCH5JqiUgJ3851ybILG71T3J0HRTdrMIo
# 0JEoee8Vc0ZeqjkV5nsmdv8+DcbYDPYcsglU65z4a8MBYOEv1k5XFFPzAkfLbbdq
# smepDjlZLSA2nQeGz7usMREb6SUZQC8JSmkVCJePVIx/I2hE9LboP3DOrB50Gnql
# N4iACDUvw825w6a9D9hlpxAtZCnhhUXE2LB1yOBrUF44OJuRlCIOVrnBAAVco7+i
# 2ygmc2QlJtkS/otnwrg5/dj40TI+o9vmDon37S5ilDr7SVj8hUlXwbPawdspOttr
# NeJSslvifI7UBaCN6yh+XOzncqUGQXMykwUo87hS+UAzpqVteKtH8hR/ospXuIWn
# SPmT5BPvbgT/wykp5CAP30odrMKA70y2YC/Ka7+7QwdXcB/Ow7KfCS8XGoVZAQjB
# mxRSZU747TmoXGe6b0wJZDBYDrZD7xFJxNWLPPnaS8/xXWceRbxoHtzI
