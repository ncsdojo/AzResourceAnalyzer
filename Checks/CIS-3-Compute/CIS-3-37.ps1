# CIS 3.37 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.37";Title="Disk data access auth mode checked";Severity="Medium";Automated=$true;Check={param($D)
    $disks=$D.Disks;if($null -eq $disks -or @($disks).Count -eq 0){return @()}
    $bad=@($disks|Where-Object{$_.PSObject.Properties['dataAccessAuthMode'] -and $_.dataAccessAuthMode -ne 'AzureActiveDirectory'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.diskName});Description="$($bad.Count) disk(s) not using Entra ID data access authentication."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDDtivU+QCmxJ15
# ck/X9+eZC3vwfHdVlk1wiPoFNgh9xaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIHi6+Q3dZA4CwlRNYuIIICXnu65ZnTSD06uPpi2g
# oPcBMA0GCSqGSIb3DQEBAQUABIIBgDZ3dyV1SiW6nCDJPIbe35J7gEnQPuI84GF3
# Qo1m7xrM+7ps769XooCjSpuwar02v1EYap4y6tVhY6nVfuagNa9JI+R/q54XNgki
# wqYobl9AcBe5BvV1ZjVaB/ZgMrb+Zn9OVOAO1dGhZ8N7z/TXUL4sWzu5YxL9ZaF7
# GcJklDpFUpZo4zWfvYIGU21B7raDn1rALCrzgzZ7ZUPbNE59qSw8T6Ew5OV3lm0x
# oB/wBVIGPllorqEqE1l22g4AeborqPua2wNoDu6J1cRCkKGMSQlPvk0oBcnLmuPQ
# hnAeJbpOdKXYIkvHaqE+CuD92XzrLlKFPrY52wV38QtUDlIe7EcAzBSw39ZRmgEQ
# 02CSrNxQkcD42qxMTRNfabpDjRmSUofwoQDImr+C5uvZlOGI6RkMV7SCkrllCNbS
# QnEF42mhp/bk7v+xAZX/CbEP2dUOddjbzvgX9WbEr8s3l42t7U1zV41dw2Csdpe1
# DIXEf72FUQNjnAigdanMaBHaMKdkIaGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCDOlf17qTFPjRi78GNHMssNNUOfZUGXf5GbZ7SJV+Vw6QIGaeiBPJk0
# GBMyMDI2MDUyMjE0MjkzMC44MTVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0MjkzMFowLwYJKoZI
# hvcNAQkEMSIEIBWlaBpsnOYEFDuREcj69SbH4bMkfe4WNWL+aCRWVH3NMIG5Bgsq
...
# 9w0BAQEFAASCAgAPz2ae+h/W2yBTISeykUrry4K0rDeCWiEvuTsIB5SluTVb6nDq
# HvS96I0qrlBjYV1oJDqgN0g05ka2oivFBGXdQRO74MrmX/cYB2UonbDOtwZJFdsW
# AJnOSsOYnaXiEFEl/uxBNc8Rh64XMDwC+DflamsurEBCTnqw5CLsSLZrgQkGMaCg
# 9+JB0hRIJRLuqAkYtdoxD+ZYPct6r+x/fYODE2z4dHUncT/Noj0rbsCPxyOZEV7b
# vucFDMfi6xrjkijzddPAZqSI8I5qIDNVzj7lLPTFk+YhNFRv4/Bshpn4vkWmIzms
# he5LIT1Cduucr79882SKZvasb3//VcZH1h5XPGo1JydQCubC0sksiSqKKXq2fBo7
# dO9eKnWZ5XF9SCbMvt7reQdbsJcd7fkgzflH2qsSg+pbFM15BlE6hcs7Uia2zBsx
# /cravwvYrGILbV6+gt53BHwYm6kkSjF2LpnD/I+7H1nhpNwP7woSCj0RNik4up3f
# xeJgqFyxGH2XK8opdV070K0egqf7w2u1mWbkFiU7JROEwX+T6axQbuGoSev5WFo8
# znUMZ6u1fku3dqapWvUfmCWLmGwYvP101qBRsYhNfmAAu8Alwd1P9U9AXaG6H/0l
# n9vBNSkP+FQdOqntqzgRZdgn17P0aasAZSNqQsKjwKINO7iYKPMAda2BVw==
