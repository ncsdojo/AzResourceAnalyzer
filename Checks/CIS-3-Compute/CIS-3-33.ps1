# CIS 3.33 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.33";Title="Container Registry quarantine enabled";Severity="Medium";Automated=$true;Check={param($D)
    $cr=$D.ContainerRegistries;if($null -eq $cr -or @($cr).Count -eq 0){return @()}
    $bad=@($cr|Where-Object{$_.PSObject.Properties['quarantinePolicy'] -and $_.quarantinePolicy -ne 'enabled'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.registryName});Description="$($bad.Count) container registr(ies) without image quarantine policy."})}
    return @()}}

# SIG # Begin signature block
# MII9FwYJKoZIhvcNAQcCoII9CDCCPQQCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCQsUuQfT+UfLyC
# E0XXFQ/YeALpPYdAb0DOqe++7fcao6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIJHmvIJFDAoq88Hg4PHV0FGIOFOEABobWIu3D/uH
# 8a2EMA0GCSqGSIb3DQEBAQUABIIBgJq+rIR9CF2h3g0UsGUCjt3ugNlI5vdUnfk3
# xvtkIKSi8o10gSvT50HcLSSDPtvONqbBUxEEcMK8EXdU+y+sKiIlkh5NSruFp0Mj
# 2xVXknobmHvGNxfwCOIJBzQBu29Es1CoDgZwm4sADtw6tCWEt7NaCJSs8jSMyTRL
# EMydQ/4vPU2Sz9p3PkcEGidVKD93cdWfRLRr202XxeyOI8DGUqVX8k3Zgp4iqL6E
# DLVfP3Tbe5/9B7V1bvddvWTi84GXTThRTf6sPKaXwswbCTfWSQKPUKV/672G2Zs5
# xoMdc/ALDEwhqZmeepUjrUNhrgZLBAANsc+4OivPPFWCelLAcHhnffdQ+KIe/V/V
# Le782GEinCKtdHI3gRwvWRWuWY4fSkJIEIPN8APu2jGpJpgnR3i4gm06qSQbGzb5
# DI/ayufm5k0JeuX9S5gqdlu1UT9+QquldHTgnGLYzie52Whjseq++moK30Luow0R
# jlCIDmBUz/pfUV61FizanN5kW834XaGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCDEetEtGqVC5moTMRooseLUj0fBPhb1SIuqtadPUpiGkwIGaeiBPJg+
# GBMyMDI2MDUyMjE0MjgyMS44NDdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0MjgyMVowLwYJKoZI
# hvcNAQkEMSIEIIZhqsUbjTwglc/iw3qUCp9VwEeDxVTKX2/8278ypgqdMIG5Bgsq
...
# 9w0BAQEFAASCAgBfBConfAkvEGnqaDljKfCrTAktty+aPYlc4+RNc3EGpA7Sf85U
# my5uAlNQyi3rWIewaZEurxXVHKy8QFAXLTyIXmIKjJlYyPP1ZXPnQKDC1K0rGu0v
# 6lSfX8hCV/rZCZYLbixZLgc6xSnSDhh3GOht8jeOtwJi8R6Xj9mPvBIfRnHNwImf
# fSjjPUaK0rM8oOYzgZWaHO3d3/gKmUAzM2h0ET8VR1Bh/tjlWCnH02J0meLcuZ/s
# giT8FxGy0L+2yxD68nM4ULldDbpodCKy2wW+zfMtP1ToQ3T7LKK+uglo+U1fi9k7
# uwSlSKXueV4l8GWFoBNlX+ip0lns04sJtkIIjQ4xJBKX3tkp7G+gA/ICaLLMaLIb
# N418i59EfYbt1Gs1Muf7QCgfuoOFGIQhgOjasxUqbLweDT34lEaJgbEfd6IJADH4
# vP0EZNlJwBPOCUWMvB29emHmGLGpUDUUYN9fUyNFPLAIzq7h+TqOLFxYVhQ92TBn
# xSMXm+khpPAsNVTIu9eHgR5LUzRSW5R5bpUiJq0Xx8rZ1g9T2wsyIA0v+hifPsJG
# s4SLwuiCPX1Itsn+Azq4zW2PfBfd+TXdE3pqz6+sRzZsz4C1sqUk4zJTCR0mTgeK
# B1oy1X5ERshv12uFlO95KZaSHuhxHQOHrSUBBVesm8VqMHj7MCzW53VHxQ==
