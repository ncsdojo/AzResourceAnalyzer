# CIS 3.48 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.48";Title="Deployment slot HTTPS Only enabled";Severity="High";Automated=$true;Check={param($D)
    $slots=$D.AppServiceSlots;if($null -eq $slots -or @($slots).Count -eq 0){return @()}
    $bad=@($slots|Where-Object{$_.PSObject.Properties['httpsOnly'] -and -not $_.httpsOnly})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.parentApp)/$($_.slotName)"});Description="$($bad.Count) deployment slot(s) without HTTPS Only."})}
    return @()}}

# SIG # Begin signature block
# MII9GQYJKoZIhvcNAQcCoII9CjCCPQYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCACqFYGlNW2vYAv
# grjIWjFPv3VrPcfa6TYgPv3SAOxJyqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIPaLoYU+tQq+G0ETkB0rd/EAZFKsWJKrZ7A/ABN+
# t+tcMA0GCSqGSIb3DQEBAQUABIIBgDhoHKn9JlgF0ohZTDNIIMUG3Xgo/t8xD0v3
# COJEXwZPDuoeVmIIeU6Rs/13kUowuU+0tMGdy5dCZWsX6hOAmhlys/RCtG4rAh/g
# 9VnCEkphIRlsjCjGaq82wno/LXGsnzee67M2cEYw+Ty04gq7msJ5brg7V+gX4Bt8
# kdIeP5KCH0VzXYBhgWKJP7BxeMr49M5eqmq/dfZQH6ymeyp37HN7wepf5QPBbnM7
# 53wXize6kZwCe3o1V2/KV0TLgO2JXqkQgwpMFjTEFZGjIw1WtYLSfv7hxDOyc8iZ
# 04R3/kJ8rul8Go+/AFQA0qwvrTqwKh/nb/r5Txd2lkEP5I2OY8ax6WZ1tWA/u0Mm
# +zEQwWUy/S3Nh0LggRiIsEZrdomBsr4tg/bjpmDMIBcWeela0mYoQmvp/8r1qO08
# SITW5EjNJJ2L0vFyXt5b7a5zBmhMu1/fPddAzCEVusWqA4FJ7IKizmRtZiI29uLL
# 1UsfHpSzBdV3pWCPd0e8eaP6LZ9eQKGCGBMwghgPBgorBgEEAYI3AwMBMYIX/zCC
...
# AwQCAQUABCBdnvHxmobIp8dPpPQdQNSEecfvaPvo7z8O4G/zNVvocwIGagxE2Y7h
# GBIyMDI2MDUyMzAxNTEzNC4wNlowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDE1MTM0WjAvBgkqhkiG
# 9w0BCQQxIgQgYJMoHdg7Nqw6keFiWTgDL/tbFljrCVuyhgCAf3MySHowgbkGCyqG
...
# SIb3DQEBAQUABIICAFiGc7EPZ6U0qGu8RmPdEVQmjTw1pJuLUDqzwtqXeuqiCjUX
# mQRXaU7L80oVtEHChE41wE1T6sWIRdOnbSANal2B7rBoDXeO1OqONBoJMzuuzIvn
# TUbgXg+x3aRkSQZ21vb/l/TTniTX4gSuCja1sx1QlFl3ciAwdK8zkLCixXz7S2t4
# PkiWwMH4RQ9DpUaKqyb8s4VtDr4NZZlgltp2BymltjYiQwWrd+VxJH/IYBqabadV
# FGvL3TsKC9rxSBaKVD8FvdxwyRABtwuN3ujF6dRKTem/mjyhxsvmJncJLdQCer8Z
# 97GCNmUTlrN6UlztkxgJ59QtM4Qv91C7apP2mkDAT++JI67F2jLskQjEDZfqoAPU
# 5CvAYnq07VSV1fHksHSYRtja0qlenmpaP9fVc/yreFPPVMjGEIgZs7JldSuelZtj
# Vql75qglH/dbd/SbDA10K1wzo1tFWd3rSpSg/WgRKOk8BWzeiVYZbIaqpJsLqoMz
# OwXDWY2AJfU7/7dK5xC3ZVi+wtmMdq021HV5R+pxrakjChoLbD666AdmWteqUSGm
# Ni/6eMiaE6VfhgKxFKVtImJIaTQIO+iuxt9qiznoqOWLO1+zDFlrDXpBKSAOapSD
# veOU9Rnd0NyvbIxFaDz8oMTb5A2PFNDO2XUSkBY7Z0kYbbEYwMlAFpr5Uo/t
