# CIS 3.27 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.27";Title="App Service CORS not wildcard";Severity="Medium";Automated=$true;Check={param($D)
    $apps=$D.AppServices;if($null -eq $apps -or @($apps).Count -eq 0){return @()}
    $bad=@($apps|Where-Object{$_.PSObject.Properties['cors'] -and $_.cors -match '\*'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.appName});Description="$($bad.Count) App Service app(s) with wildcard CORS origin."})}
    return @()}}

# SIG # Begin signature block
# MII9FQYJKoZIhvcNAQcCoII9BjCCPQICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAlkr1qgFy/HKNj
# dVqkWZv1M2pBlwQQMuSr5f+xNwms+KCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIOIJ28/xOjzXsu/908fBNdsS4afSDIRdDFeQ6SB8
# 3cv+MA0GCSqGSIb3DQEBAQUABIIBgGrWQ1wSosoAiKrQ/r1OmNHU3dfZHkvaXA+4
# i03gjhjdK0U+vPKOyeOtAATg72ZnkE9jdsACiZzKbbPaUkPhGtkAnmasJQ0Gvl84
# eWRPCTwmFNbsrogcbEt6XCCQt8xQf4iE1tjI9vxyeHt3jTFJkZpRxWLGOrCz3oed
# wvtPN9WPBgXdfwZwrbop8Z3l66fUAbWkEpDEbpB2zwPpCmkyWyGCg2KLBs95LaBv
# eA4NkMfJjPsvV7/NryB69bw//7rkNmKEk7tno7sZZ0tJIw0gxb4syXKotJEEvwFj
# Bjbo8oNtoU6Hyn1Z2DubssFoHiYrEM3QSdO/nZMO2goMyZgaQGPB5fAzll+8k6I2
# 53EfKKd1MLtgpceE3vJnEjvhdfTUgF/oxpsINPII/Li8YQyhSoxnOdpqJg8nwS1w
# wzyG9tbq0wgTHhWgBzqcII0jLtLss7m6u+r2Gcwfarjpg4+QmopaDtk5Z3tEIDr7
# qhaGSlBszRkWTMlyD9tjjnwzqA6/pKGCGA8wghgLBgorBgEEAYI3AwMBMYIX+zCC
...
# AwQCAQUABCAmuHdb+/BrU8n7TOzo+k6DDtswJFdAuAYNOiFkcCBK1AIGaeiBPJa1
# GBEyMDI2MDUyMjE0MjYyNy42WjAEgAIB9KCB4aSB3jCB2zELMAkGA1UEBhMCVVMx
...
# SIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNjA1MjIxNDI2MjdaMC8GCSqGSIb3
# DQEJBDEiBCAA2cR5LbqVsi4D4uxUAtHRbWnpWiC2a1dQ47gPgSGC2DCBuQYLKoZI
...
# AQEBBQAEggIATmeYGOymglZerwgyT5jK4IJDFKChrpaHfsmHn9fT092Gx1dUWy4j
# +8iaoyRuBOTXwh73T/KE2VvnZ6fMSV5iv+xX5hfhojEvQAU19MccnYte2UVf7QS1
# MuiYWw7WZqAeFs5+ewnTQUzDol2ejGguP07YL1PR0WbAqvXl5WLv1gh5cK+j9RCT
# fwrt0thqgGWA7b9TrjYR0XCQypjfcdVjvN38pzwyJmFUERVjDBGbd1qoPgceAS+F
# eiijEl0G1KXv4c/AAGsJO4wxWNSSRK8KMCeKBnXf0dXZFfEpW4uMkGHWejLnIR1r
# G+wKv5TUh2WlGJYvgxbREIhR0jWpNrKFA3bF/zkD5k8ZbzM8WpR9vB26RQ6rsH6R
# BGcQ5TgxYCsZlERwrBCEOEw1fkI+LSO7wfclMI412uNND2ANNkJfm4QZ28KxXgzK
# ksHcC3YvBH2sDiq0TxOGyiIzueWHHZu2K7FReTyDAmnJDHmHoRnbg+CRX69x8ADE
# QaDaCx14kmVDxLnq27pSPRL7rCiwITJBxJYsQp2vcC2qrDjqfuJrUgMLCNzpv9kg
# ZBs6cEPQF7X0dv1KUzd6YOMw90vneRCmk5xHHl4kl4vBha4GRgYII2NpnNFUfzZd
# fniIcsBgxna+PbwNQ0oeoUcMvs4Ct6sdRg5GEejGQ/IH8fMP67HmFWs=
