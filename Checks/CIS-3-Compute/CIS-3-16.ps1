# CIS 3.16 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.16"
        Title       = "App Service FTP disabled or FTPS only"
        Severity    = "High"
        Automated   = $true
        Check       = {
            param($D)
    $apps = $D.AppServices
        ...
        $bad = @($apps | Where-Object { $_.PSObject.Properties['ftpsState'] -and $_.ftpsState -eq 'AllAllowed' })
        if ($bad.Count -gt 0) { return @(@{ AffectedResources=@($bad | ForEach-Object { $_.appName } | Select-Object -First 500); Description="$($bad.Count) App Service app(s) with plain FTP enabled." }) }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBQcUnwxDVcpcvC
# YfVaq3pg9zbhU3EIrRHE1wIbENWnSqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIDLAmTDErTl5ZWbWMOr16QDft4zXKCdRWQSUkF+A
# MFpKMA0GCSqGSIb3DQEBAQUABIIBgEgo1b+9HUJVWwC40ERJuFJzKF1VutJzemzg
# ZqkQXC/p/BgiyGq+zaU5Q49kRnNjyc9DMZO+a/Cr3tK/z7o3m4wNOePmttaPs/fN
# bWLhhupSYrjYwIXrcmynon1HFU1xiIUcsFFsNVPi7EMIXHN3rARzzat6zT1DCZug
# aVuCcc7DBODazM6hsk2/wZDBph7DB6Hq8qqm6B6DXdCKlHP233Pt+Fw3HI8XzE6N
# oan6wYCdMFhlvkRkEcEYctxfIJFY0604Jee7V2BlLDL6mJTOAqxDb6lWmknV5Afg
# rg+SLWl0Ha4yToEduFgZjiZ1VRX1fNixZ8Qm14rS0+KC+7pZhVeSbKSSWEVzkR+n
# Ku0UT/JpgwAzB7grG4JIdx39zzzuqOnRhLYHg4o1xP9ap47cRai+9LiKbFMOcjoB
# FuRnMUwcInPMCIdq8fnfeVcdwP0KGr+rD3jDe9+oA6lS1jbGdHe98kXm2GryYkiz
# NF47J+aby0JTMBXqIuPRSvGCbmcwEqGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCD8SLnDIniBHNHtVrc2/kZK82xRieFDhI8z05s4/vio/gIGaeiBPJEK
# GBMyMDI2MDUyMjE0MjMwNS42MDNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0MjMwNVowLwYJKoZI
# hvcNAQkEMSIEIEzhve5YkRBm61n40Tzt2UsZJ+/U6DEu30Vaea1D2C9pMIG5Bgsq
...
# 9w0BAQEFAASCAgCdg7o5q+EOG3NjwG3xs4MWi3MhrtQMbpLS+NRGse/q9IZm8T5c
# hstetoL3hKXKE0FwpLgXhmVy3vXBaO4bkZew6qOWV5RDRpCpD/MsauF70t/UFM2R
# xhmnh34WiOwLBVvnKCByQufoqgcYKSU+a+JWtKRFtKG8Vj/NRE8DRtW89t8fMCcM
# 21n8BJbWBIfms7O2L/Y44TZLJlan5VDDZzssC/9RzpGv3sxVCcYBYH1vha2Op8SX
# teYlCui7wxmjgFcpuKeTXhpBYQoM76XGPMwmwPz6XTVuebdprZvW9A2JKJ4sARuL
# 5iu8ax1HN3eigO7K6mtCu5mAFZEijDQGXgwaG8XBeT0YuDnl/Z+GH0me93yZHSnR
# iaZVwYxigvvrUVgtIdDSDJMeFA96fuwS+TLkm6MMCFzX00pS2S4ZA/oxHpp2gXMX
# 3RdUuwfnUn3yE2WmHJtYfQIaM970soI9Cc/WTToZS++JvMneY0swCMzunkHGHsKJ
# 5Q5nJ/mkLytKZFSMFfgRk70TYIRHDgPfljRaq8FNzezBmgpDNiBgjo+6ilCyRRjf
# xapeWtp90QqL9k057FGC8ZXXWSGbVD9j76+l6vlSq9Ol/hWc3YEg5K4Cmhq5qz94
# RzyctqIU/QdusUoXO0btCP2fjZRTujoGEBc538UO9iX4qCSTTY1c2TbAvQ==
