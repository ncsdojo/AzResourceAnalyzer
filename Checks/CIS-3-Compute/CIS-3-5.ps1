# CIS 3.5 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "3.5"
        Title       = "Encryption at host enabled on VMs"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $vms = $D.VirtualMachines
        ...
        $bad = @($vms | Where-Object { -not $_.PSObject.Properties['encryptionAtHost'] -or -not $_.encryptionAtHost })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { "$($_.vmName) — encryptionAtHost: $($_.encryptionAtHost)" } | Select-Object -First 500); Description="$($bad.Count) VM(s) without encryption at host." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA+cznY2I0IZp7y
# Pyr0qB4AkBZgRRKfTvPxdATWHugmuaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIL3btKjYYsC83/6fA6i49aVIfTD78k1x0m4LzMZ7
# RfvUMA0GCSqGSIb3DQEBAQUABIIBgGWJsLUGYfRV2LS4UpqAoB8vhlFThq5wHzuK
# 1cg3cabGG3ykKaUIbMc6sqAyraQOptidAK2OxIgD4CIls5jXvFC0/OXUXw9gC5x1
# guK6BIfohsSwVg+AKgRvioW0H6FjAiGxpo8FBaBcUCi2WED6CNWKmMxvhRRPrfio
# vq6Eku2Ojg1DcFkO3jwFLRLNW4P6QEsp9NLVDfizm9hBOapgf3dUa4RUexPb6nfD
# dwRTzZcZD7DOZEtmz/cbsXMwClzngLnXerk410JXOg1AjoJIIDr8gIiN6vw3iUfR
# 48HdoBAqJFVUePr8mniVV+Fx9vX7X3tUQNNpfky7pEpi0WYiukxC/4bJVeDF3m5q
# dzfGucBXVIsvGenoqDgxF9WcB1271/aYCYIKhBE0sgWKBlwauIGObfOJjcYbkvah
# m1c26F9CXHIIT/4hpZsOsIZ1zXRh5j12uFEMYQENpeeVzaaC0TzMWiisY7fOcQf4
# jTCsRfdSvN9SJ3jNqZBACpoC8kKeCaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCA1fV4O1dX0kfD1i7OtbCEhMCJHzoUSwtM7GgFuNklRYAIGagxE2Y9+
# GBMyMDI2MDUyMzAxNTE1OS41NTVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNTE1OVowLwYJKoZI
# hvcNAQkEMSIEIL0ltmkzTRYVZ4WdM1swqkdpsdlIRXh53KrtPEijus0BMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAOTIWDe2XoM4G4wg0GJYj9sQEc82JVZ6IRa/m5WxAb9HGE
# WlsWDN9gUho4fxlIRJ/HtGLOV4HoJgbYSM1lQfGXZPcgnn5Rb/E0voDdbFET/aS1
# x7RcB2RfONhk3UU8LEtsY7IZGViPgQPCDfU3fjC0V2eshsgeX5ViKEE3H9YtjA7d
# 8KlKOWvkSWQieOKgvdRXdhhTW/MNMQ9c+lKnMNWqMQSUsjQBhQPoPYHLOLAJ4iC/
# 0jvLdxWtAdYaRDqN/zYtyPEb/pprAtzGU40QoW9yy0z0SJx8kKM0yElMjoXwyKqo
# ijXqkHFgX+eAns0Pe4etE1F6vMiHUlentsYPi723rgkPiaYA+w4bqUsH124/la9a
# WK5LPhtVWEOkRSe31MU2cxd/698kHy6KXjWp+Xnnno/fXLlRuashNvwSzCDwVRoH
# pFkEE4aDEM0AwoL3RZKMM1b4ZBgrppS1mngb/T87L74e6sbswdwNr85i4RnV0E6A
# 2FpJykC19Wkcmjz3B++PQUOdNLx7ROsiyNhMKnL8rT+WKFmqrA4tzBnjnGTNbqxW
# GAf3Si508BzQznvglaud5DJ2FkdkBiMguMo8kCV0QlpoTC787g4hO036S/7RRdCC
# 3NcCug4bhg2PU4HSB8IrzDtVUXCZF855tfxG16hdXh2gUumVgFnh1V1GQQwcfQ==
