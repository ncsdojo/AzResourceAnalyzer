# CIS 3.30 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="3.30";Title="Container groups use managed identity";Severity="Medium";Automated=$true;Check={param($D)
    $ci=$D.ContainerInstances;if($null -eq $ci -or @($ci).Count -eq 0){return @()}
    $bad=@($ci|Where-Object{-not $_.PSObject.Properties['managedIdentityType'] -or -not $_.managedIdentityType})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{$_.groupName});Description="$($bad.Count) container group(s) without managed identity."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCVGLIRBlXF/aKn
# cieRwyyzONx82ks3zXtmaoPNwS1wVKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIFBxIbunQwm13Xy09cmr/qEEkhH7c1HMMNy8XBjL
# X8edMA0GCSqGSIb3DQEBAQUABIIBgBdVhCdv+7XILWZyJExVVY7WWfSSvA6vpFqr
# 5fTXh54gCkncpqr+gGiI19pTOwAwAZFCv2FpxKS9W28N0ITfC6vNtWWaR8AEb9Yu
# FISaT1i6LZf+fbEotN+UOTyoNznOegYu0lKYJ0RxWYlwzYM6QB0oGegkZyFFdtmL
# ldwkE6AduQB5jMR82kElO/DK1Ukcz4GxZJUxBHP+lCFXdAXrrnD3LTqgq222EjEE
# ufezdgq3/8oxtrsYc80OGlAYkRvbPyX3zBYmPnVxopCQ9FS2ybbYX9jRQv6fISAm
# t2HIDQkpni59S4Shv/NXAcxEizINKR637y5X6u9mSdHlzGwInorgGjUavkgwzdil
# Iprk9U0AHHgewnAExm3WxyrIVhJwt6d2GunACF6GPEKKJPst35PZUjJ+B3unIKDf
# r5A0UonqbYpkNfF+yT4YJnelFhaxG9LMajPubGVSDUwEk+wEyb4LExCQTX+C5dK3
# d/GcpFeAwdZlsP8v3UqJc4ErUpovh6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBSAGppmlyPRfYVHHuCbFWKo7TsH8wWoqL7GAJ8A2EQngIGagxE2Yxa
# GBMyMDI2MDUyMzAxNDcxMS41MDNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAxNDcxMVowLwYJKoZI
# hvcNAQkEMSIEIAr1fR6Bdz4hH9D3m7FbqnC39jVZefyA9rXOO9dv68CuMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCZTyWYOx2EDzFDTG9rxlcKx8kk8YtQsT4YaXDeFumce5zP
# c93BN3s4pfGfD5R+IE7oqa4KjhivVxHaJnNMlfCQVnJpmQPOmk4QjCVM0WRleP7Y
# M0TPMVUIZlCu4uNau79xOL3CbJX45JPf6tSrsaeLq6uJ5OMp8ELpe4NFj1liIYKl
# vs8Vmq4zlWOaznyF9Ej4PPRDyC0qbbYeQ6jCreAJIWs0RQlg1dYuZHbKM4Rdt5jI
# TIG7L/etmisH0ISUkm5WSXupPJZ9xxxnmAd4joqaTH1Jv86n+tGRHJKEtJyOB0VT
# HsW3cN3x+DBhKdY0pDYwkt9lqejck7CxrZmz8kbUuSEObeGEPulzo2KBG2TIKoa6
# bGRnLc/8OdTgwUB9F+rOUvOoDsQ9tcVj3EfGpwK54uC2XAjrgOXsCKS34/fdk+pI
# Q5+oYCHy8ADP7XkQFnQKYzJPf8dzX0eMEZ/V4m2HLy1uBB+TvfyXRacQdlgtwW17
# TRpndh/q2qIU1veWoyEZGjrncwO3CG7aNPvDEQMwsA8D9uiXVx9Xpz+i3NqCaIzr
# 9KmCKZrEPHeNShQ30cLStA/U7WXuwvv2ZZpwPvOSa/xeY/FDp4MZCHLyl1jqZdGz
# 8YpPcwXy7+XOj21l9pE8ukwTGsQbFZwUAgNG8qupupTbiAzNdQb9d4Ik6BpZhA==
