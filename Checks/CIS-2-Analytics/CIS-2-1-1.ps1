# CIS 2.1.1 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "2.1.1"
        Title       = "Databricks deployed in customer VNet"
        Severity    = "High"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $dbx = $D.Databricks
        if (-not $dbx) { return @() }
        $bad = @($dbx | Where-Object { -not $_.customVNetId })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { $_.workspaceName }); Description="$($bad.Count) Databricks workspace(s) not in a customer-managed VNet." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBd06cVlqdAIvJp
# 6w+BcUT+3/ICFUb9URDTx5bvKTOSzqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIGhAiIlSv8hRYwrqaX19NRK96dqjEQh3OpUs0VNR
# +AwzMA0GCSqGSIb3DQEBAQUABIIBgKckGYRHc+zkSGJave/rV0127j4ag+NE2Vk7
# eUX7nqMox68Q/euK04YiG49aEt6FL6EKHEFLtBj614PkULg5PgStZyuXQbbY8eDG
# Y1w3Ud07w4cN5aArrdUk2uM2hUNhacz56iLuqaXGZPvivhpcyvAUNzSC16/AB7iT
# 1Xt7tWdkRLJmO+WLdhb0mhYOEbwUHAqDwQILcia3G1g46Lmv3F/UHes2zpdacUMB
# 0Cjfxdmnht+y8M4gJd/OFd6aW42BxCO1eAN0d3iI9T8ARyz3LahdW4Ls5jD1nvT0
# j03sKOtKMQdpeaomVAa2WzKDfB1rgh6cWTCMcx1ie25nFueJcX/+gKT/eJ3iwPcO
# JX0HHAebf9EUs0rqdUowfoKxB1DlYumrBtzQsIK85sGQH0+Hz1EztDbW3TQEbrEc
# WHI0O65QjzmTKnYcDnm7G6tZ4D3vs4sUVssTURKsN5jzUaBvZ9BXMCeYVH9E+Hua
# r5J6zXDGaoZn6zR3CsD0jKAmuUsnGaGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCCCAdO3kYX7aAX0RffRMnh+FfUXf9D0Speg+zU1EepCigIGaeiBPI4N
# GBIyMDI2MDUyMjE0MTgxOS4xN1owBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIyMTQxODE5WjAvBgkqhkiG
# 9w0BCQQxIgQg/nT+AiXqzoHNCORPVK4dshg2ZLZORNlePbSmtW6fchMwgbkGCyqG
...
# DQEBAQUABIICAF3XqjM1+0jNfr8UFqloKuipX5/mh2R7W/dCNoT21QobVfUTIJxQ
# l5eq0s4JBWvqX/WzRua/5P4WP2igp+M3NC2W7diKC0KnB9KX4JUfLzRX3Yv1mf9p
# 67g6TTo033lat4rhP5h376NdbMZp0I3VSJlHs17dukj7blW4PWvsYByG67nPrkkt
# 56SF4LpUMNKCHddcG2q7R3AcBXadNOJqKIcifCBesGFx4cPoOjNk9OgThSrAuI87
# EkJ809TLANKIHnlRt2vmaoqUQcODrZnXFtAUrHHBqShFZ07cRJ1F9Da7VA+9oot5
# T1JJOlcma4HqRvEYALrf+2hGnE4iYodA/omKgrNAUFUyckfExxO4t13qiNLkrX+1
# PukispY0FVt70hK34610LFmhouvaxvHw896xwk44w4MbqWkvijvpQO5T1g/OKSTm
# E32BsJthA0B/pe1MZ9JDITep4FJ6uuFWUXwPYSckPi7L5ontl2309Ovr1m1I4kR2
# LanKQnZ53DU6oxP7PbJmLbO8b/xeI1MEgZV5NyrzvvOnP0yCweOiDwA3lLQxr+tc
# Dhs5714BzVm0AgeU/xuPdqP2lQCLCmQwdadwUDvtxiRRFmvWDthWydkYbJ4FHiaA
# uaDc48JYQ9ekkK+zlq941TjWhtPCT7WyvtfuwHMlt6b1MwpoKLdPUOY3
