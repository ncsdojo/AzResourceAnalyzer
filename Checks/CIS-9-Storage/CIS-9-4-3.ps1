# CIS 9.4.3 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="9.4.3";Title="Blob container encryption scope override denied";Severity="Medium";Automated=$true;Check={param($D)
    $bc=$D.BlobContainers;if($null -eq $bc -or @($bc).Count -eq 0){return @()}
    $bad=@($bc|Where-Object{$_.PSObject.Properties['denyEncryptionScopeOverride'] -and -not $_.denyEncryptionScopeOverride -and $_.PSObject.Properties['defaultEncryptionScope'] -and $_.defaultEncryptionScope -ne '$account-encryption-key'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.storageAccount)/$($_.containerName)"});Description="$($bad.Count) blob container(s) allow encryption scope override."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAgMw5gxtXiM12F
# auJ8N1AmVpeRsAhVGqdm1WlnK4VLZaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIGS/FwTU/P4Mc4OebeP8Tsc1qu7qZQz46elkqSgI
# 9JyKMA0GCSqGSIb3DQEBAQUABIIBgGANoh50sxmkQttJR28sptcli6CD7/QGRq2i
# NvZGMgFn55jJJMW1inJ5GUte46G4t611GYh70XbQRGe5R1xR5UIxLFCbgBn+e9Lz
# 1yxjKil+cR+fVw/1yfO2XjB7bAhZi8oIt/Gwsorm/iGYY1lFCjj4aaa/wryFf/cW
# 3OExAT8BBwDKJM9JqvCg6LQ2gZirmYJhpxiDwaoqdHcZ6KVrOoZ+wdEuFaPyEgHG
# 6PEL3vzeJP9+IMi+4pp3qoqQGewixFcXsudJQKYfhnc+z8HtNZDKQmEjjKF1inL+
# 3CIvhnkzIDyYnhZZEay/7FytBWGKoBTZOEGQs+WigpdrZfgZIv9uC0a3xeWLif0F
# RVvd3VpK10fwoAEhRlXZe5TVQbSHoLRvvmrFfXax2tRDDbC49UkiyYohi+XbBaqh
# EBMaJnwp4t+E13UNvsJm0YpWT78QggjCA+IYR0nobZIhPMpkK2Q/OFWHTlA3W9dN
# G1PQKW7jc9l2ucSJYMVmyqAemn5/b6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBsjGF6nZaIpzr6YTm4y1NFU2gWtdbVX3MEuIeYozTE3gIGagxE2axj
# GBMyMDI2MDUyMzAyNDQ1Ni4zNDJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNDQ1NlowLwYJKoZI
# hvcNAQkEMSIEIF9rdfLRlyITey4zInAPHt976phKSou9RPzeJiHN64yyMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBT4gKw7hwUawL/Rj3n+oeeBmZ5WDtJ9/aYSpkBMXVkryJu
# oYn9DdDNyT6TEHuX9ZLpuFvoPipKKQ9o26GZ2K+ZgTkGs+bnYTxC9Pv/SrTOUcGp
# vwJTryfrLu7kEnxGMD8x38mG1ky9TVfebJ5nLmkY1Zk6X/N1YMC1lReMpduNDNRd
# gA6+dI3U9h8jNNloiT0FrvH17tHolZGqzGzEOhLwM0fnP8PpXO2V4drBmXZ/Qy+c
# WQBycOkYrdHhZQtyZnxBuO7G9qzvnGGXaMGaLM0ic2B1ZvssgFsNdRXqm15zvQPH
# sJjTsJ5LpZffbek6bujTpLJj8S5KU3ZPQyL7RZOwbyIKFfiKW3phHt32kvznn24e
# p71+NwDopg/dRkyJa6KnVyRfwYQXVlbqGyTeig8Usu2poLmx6QJrl3nAW3iI1xUz
# +KJmbm0z0VBZ2YdhHWdrQRVIsSPqGqFvHLS3CuZOctEkyip1qT4aRfLUwG/LyTjx
# yYuAsD2YQm370jUTo4xdUAVAAFHhsEVeJpiQxm9oF3dD4dDzTBfbcyaWqT6vPChU
# so/7AFmq2Rs64xqPfiAv5F4r3vE8/YckpIwrKqTulwgqIm1Fx6pnwxsTu+BXg0zn
# e+rmYCiwtalEaZU8ymzW/niXXvp2Mx4ZbgHshmmuPdlg6f4SRvc1+N85xiy0LA==
