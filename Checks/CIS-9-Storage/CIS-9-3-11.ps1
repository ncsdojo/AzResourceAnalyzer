# CIS 9.3.11 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "9.3.11"
        Title       = "GRS redundancy for critical storage"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $sa = $D.StorageAccounts
        if (-not $sa) { return @() }
        $bad = @($sa | Where-Object { $_.PSObject.Properties['skuName'] -and $_.skuName -match 'LRS|ZRS' })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { "$($_.storageAccountName) — $($_.skuName)" } | Select-Object -First 500); Description="$($bad.Count) account(s) without geo-redundant replication." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA+94dbSloIWYb0
# XEJxmzkda+1sED2drG81/UrcfwRMKaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIGcOHsMQ16lXDTDj/SMJ+KbNtLWKKFCU9RkKsEmA
# VBToMA0GCSqGSIb3DQEBAQUABIIBgFEQB0v4bIuF+ECTY4TOXbOJJSRIb8fqiB5o
# lvit/9lIYNJcr7YaqSmqqfBGbHacbUNsieeG3g/ikIo00ybWaoR/2BPA6Dh0XeIb
# x1Pk0t/VUbfHkugJFG5bMLTWt3sJn6nRheYNG3805dy1Ps0sG4GmnfSEmSyKoIzS
# uiwWRssAZgVf8L4+8jf+wu3osJAPRC97UMON86/FHeCCEzhd89Ldn/t32dZ5HuZV
# a/FeAW1tdb2ifGpaX+tP055UiRPtqncgvhkUfmcpDAFsFxApfknvHHx5dijxSj62
# NlxpcT85R+eVc1ducAA5OHPPhNyGEUylY3kU09BAq9Xke+aufBxGTUhY+l0UKPqX
# BiroVw+EnNzXPs52XDKuJgLgnudmfQSaxvH8ypcXLoxM9G7gP379txp6CqxsIozO
# g5nGG//4En9BnIrmr0H0sD0W3HdXndM7pI+sFfF8UPv37/i/+Vsq1XTPkV+XoVf+
# zEsFrbgM6oWfFAterGQXuOW7xBE26aGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBa331oU1IKi+ThxzTra0UPOlLxKHtHUD/phFBn1BQ2ZQIGagxE14IE
# GBMyMDI2MDUyMjE1MjMxNC40ODJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MjMxNFowLwYJKoZI
# hvcNAQkEMSIEIFXRDv1Ww014y3pYU8wcCKpmNDaXk8y/pWZ+6HfuSpa4MIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBwXLNAnOQgnlACCgMOpfofoZClkomw2VmHRubhGs2H4gs4
# AS5DyPf40M036M60dMqbvs6EdDGmhtDV0RCnlG+TxAbdWULpYrQpXSGWMMFNmP7b
# CDumqI7P8hosdkAQ25KNX9u7nbRf+pBbHDiioy+/IUq0GLCNUrE+RXAVLrKGJtW5
# /jF6f2VwVOuFuX20XAkcOq+Iv/jEqtkQ8rW3aL9AV/rWPP3/p/nJaFy1yEr7v17B
# X69yTRGOQczxA6Qgef4NrNfiIloqasAB+59l3jIEyx+9/46i1R8yEzRvwtgr/g/o
# eRVDocEEvY9oy1RYgmdqnzVoD9+p+kQMFrr23AJcQnpQiuezQU61JAXWIqWLfcLF
# wLeryND0qc7MZ35YGHjyyamTxSwIyIyn2ou5USnE4H2UaoOUV0VZdLgNRvRBSMDR
# 7LOsR9LhidX3Ohuw9w5kO4C1/NSyx+NOkCAptOb7FzoVKQaX1yFZElUoEpy//UlT
# ieRA0N4EcHEdNsfrXi4vCM+DNOVSRQg7On79Zv0bsUyQzFAkiKih5LaxVktVorEc
# +YTKAPFZ1x73lf5SPvcOWjJhDwQbfrjdpiDEXPyIQPFvJs35gBOSOgnJYl5EhALl
# 17kzhZ31iN9CvtAcWyknm9/TY9vstne0NhP7ltWwpnW4mzEnfAF2ffrlobR/Wg==
