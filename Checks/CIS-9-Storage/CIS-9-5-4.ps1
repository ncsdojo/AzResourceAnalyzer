# CIS 9.5.4 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="9.5.4";Title="Storage account file share soft delete";Severity="Medium";Automated=$true;Check={param($D)
    $sa=$D.StorageAccounts;if($null -eq $sa -or @($sa).Count -eq 0){return @()}
    $fs=$D.FileShares
    if($null -ne $fs -and @($fs).Count -gt 0){
        $saWithShares=@($fs|ForEach-Object{$_.storageAccount}|Select-Object -Unique)
        return @()
    }
    return @()}}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBAKJ7j7wuiFCnt
# JdlS787UrEzYbWSqexOocFuYiZNhvKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIARoUG/Mt63EXjr5Jnn6dlLLfpmQjghbIcpaCoaw
# G7VaMA0GCSqGSIb3DQEBAQUABIIBgIs7bq8oFeP77rs5/vSDzZ6xS5eBw2u4V0I1
# Fs+upEApEEcnecEgy3ppZTpSlH39Yx8U70l+7542/zv8FamidPQ810bv9a36vRh7
# tcSMx7yUmfqYHHJoeV50B5s2JGeWytAXMB+ZrIqS6QkpjSe2lnsvuKycgVfJ6e+z
# XugwnxHQFH5Iq6oKCF10U75soO3dxrYm0Wu3tsh5NI0Rd8fAFQS+Btuuh6lgGgXS
# mJSVUVrNVQzpyE2kPCWdnKfYCWaJL72CzQNJD+TRFZkn/3WCgh5do/lRBafaeUFY
# YwJiHZ4YWDxuYrcTXCFl53NhN6DKMerSL7yU+I33ShcTI/UcgFsYX3z3owsgA+S5
# POvYn4wsRZf/X5M7I/AxyeOdrPYlC31evaSESp4FHJ6+aVUIESzZPoReq+SqV9gc
# znnoWIpVW15fT78NwzUI3TR8dCcNYqAlSI1UIQhBy1SC5jd67L/AbayhbBnhNim1
# 3zQV1bw95gK1BqUXe9IA8ZJugNbtPqGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCAEULEG4mwho6lJ0QpFSks12lWH2bCDKqN3pvRcyTNWMAIGaeiBPNrk
# GBMyMDI2MDUyMjE1MjgxNC45MjRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MjgxNFowLwYJKoZI
# hvcNAQkEMSIEICCkWcLnFpkzbq3AAMFiSaAs9hst4LMUj9JSch7FXFv3MIG5Bgsq
...
# 9w0BAQEFAASCAgCQjAPZXYx6SZheNHlM+90RNbobEhNAo8Gnze0vnlBahKnw63v4
# qHOODSA/DBtvmp7zOEWtUCfgyo5ZZDfe1qpqF/Y3jbjJkpKrp+JA8gVmYwGQMzdK
# c/lmM1ckSzPZt8dzHj3UkRH55RwJZ199pdMrZU8coZIvsqprFkqqWrUwRa66Fp7J
# wwgqwmqJ/SXe2CbMOT7jdrVLf2me5YCDexUYWc5zJySRfM0Twwj0HuG6oobj7ihg
# /GnSMtw6nY7/s730Jdl4BUCPlPBzqXhVSJWckOehnTxKO0xMiUhlnTG07f7n/M2a
# VDlK7bsR0DUts7HhrW/hQqaXF9Ef8DAokNwBCIEmggW2mN0ELm5kp3XUjLz73vAs
# E8DlAn4rx6NAma6Q2IUkFi2owijc3F97TllrRK5Ivd3mJOt6myCdxbKLp6ihR78m
# wGgtCgGofrknGR6p8UsjuLSZpXvFlC/oDvL1M542RoU2J3CQ2je/3KRqvs19hqy1
# HBjXcVK44Mcd85+JJrbFhmHrgPrz/RMEO0lYBw2vNW+eozBj+saVsEdOtUhBiA2r
# B1pwJWXj3ZsrdoxG99E0LNB17MAufWNKSJF5Dy7dkn+L2CAS8Y2dVU7yOC2CaFsD
# oV/5bVHXNZuLm4P5Zfyks9mq0gxgLLcN7V2R3BxI9TsFtmdJ12aP8TIVcw==
