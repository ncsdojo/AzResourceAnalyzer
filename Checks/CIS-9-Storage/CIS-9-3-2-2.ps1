# CIS 9.3.2.2 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "9.3.2.2"
    ...
    $sa = $D.StorageAccounts
        if (-not $sa) { return @() }
        $bad = @($sa | Where-Object { $_.PSObject.Properties['publicNetworkAccess'] -and $_.publicNetworkAccess -eq 'Enabled' })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { $_.storageAccountName } | Select-Object -First 500); Description="$($bad.Count) storage account(s) with public network access enabled." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCWtX3ri2O0/9NG
# a76Wv9nCunA1OsDNcNldo7QBqA6sHaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIGA017G6wsOVLmgI/YSZU+egBquKQ4ANHOsMoai6
# xHdUMA0GCSqGSIb3DQEBAQUABIIBgF95W5Wvxc79QJsnMdwiwJEf92pnlZfvUoss
# AzWuYgka+eMhNgm/EYFBeS8IGXM4FBMAsOmk2S3SV8j9Wpv3MMIarISjml3rV2H6
# Zsho3JmEEKB2a0VVAW2XC5YF+BKaM+1obT+WTIWRYeB+7nt01OssSvm5o5kY3enF
# 8/ZXCeMdsZ5gutyV4gTMNWwt6N3YKH0IUtC8efqTO8Y++7c576t7fqHLFkgf+JSC
# sXdrETtWls+SptQ8scSrxSzBrkpx8n4i4eoFKhZxyrR+WieEWgu3M5CTC8Y5NJBJ
# L86ppcL5MPx1JvVCUK1iSy2grzfANmPRg31ZYo1x2C4FKVbKAQFkeSAjdLCJKIyN
# zzBeqTDe4PxpWs+sufhjD4Zwe7H+HITPL0CKzB7hD/qgoGGAmTQ/MWD2/wNY2rSi
# 66rwL5dje4DZAstbcdz/+zfElttS3WC6I9VfJX+H+cFGrOXPMdgZLUHXyRrrzPrs
# l0ewswQnX9pkNNvoSR90MVZFin+zAaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDdq0Of+YpWr+T8CIC8W0EinbaxQ0b8jAEfEZEwP5vn1AIGagxE14Nq
# GBMyMDI2MDUyMjE1MjQxNy40NDhaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MjQxN1owLwYJKoZI
# hvcNAQkEMSIEIO+sZbpEWmUP7RxhYH3vF0tqgximjuipBGDkjAa5ddsKMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCRF/1LgUwg5/7AbYirAQp9H9VsEwRSxvYT79M1msY/JtOt
# RuukhpxpZJ/VpPoI8ap8bBk+dGKzSIV+R+z3CpV3aNPR3zn8SGBr3TaQgdobVc/t
# nQZLGkHrzbwQi1brqwP1ZgPcnIUdB2cCutwyPc52QtRRROXTgfsbnGGuKQq97CQr
# IF923nDnf19It4K2PRX8PYVG3eZkblXxvMNaz52Ko2ITrYnC4nZQkgslQFNyZ840
# tqGvs4gFlNeCV81XvK9ywPSC032UipYxC8U3pDi3hZRPwAIShq/VanQKrsJGqrMl
# YB3FI78Bk9vWjYYEKQ/WAz4lV4QmOG6N/FnhjxT7dlMZfPmdrbypjK6SkOut0Qxg
# ZRJgMt/72PSSA+QvbkHHQn8IYYCVcfDizW9b9pLnU0ZqPGYif7VdFzSc8Mi38Mab
# Luwu5Y4LCjbW1BRzEn/h6c8S3Hj9L+X+uwvdr851eRRqsDbZoVBpzT/2UCMankwN
# 3fESNyrnNrmbhNeYE5MmW6DibtOiFgCQPeNg6mVUWnU7nARHT0ipVuyKHMJQip9g
# 2el7TD22qKZvFdPWjTnAVmZoVdjvJwbR5SfY6uxS0hfMggaSO3fw3Ze9G0k8SgoO
# VJ6s1DNPbFXE3u6hENKehhW+d2uJFdj+meed8t+3Pwk/hftUIfHQ6zSmrJqkKw==
