# CIS 9.3.6 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "9.3.6"
        Title       = "TLS 1.2+ for storage"
        Severity    = "High"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $sa = $D.StorageAccounts
        if (-not $sa) { return @() }
        $bad = @($sa | Where-Object { $_.PSObject.Properties['minimumTlsVersion'] -and $_.minimumTlsVersion -ne 'TLS1_2' })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { $_.storageAccountName } | Select-Object -First 500); Description="$($bad.Count) storage account(s) not enforcing TLS 1.2." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBSBiQNpmtUiVbj
# UGE+2srO7h0u7irXa0G5N4j3JkhwQaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIMiGTZ6pejk5CZfmS0aKEGx9DbefErDLIA+B+L6w
# BxIaMA0GCSqGSIb3DQEBAQUABIIBgB1myuec916A5PDJBt3aNcGcgLI2JQIG0Mj5
# +frAR1FmhyGBl8InvtUSaCh4xkKgSmOChg6qebe/amfNYcfBaIy7ZCG4h62KNLwe
# UxlaDcsz7gu9d4MuRWewWHbNPo2t3tXOXCl7db9O5MGRgIn+RzI2MG24bVth2jYO
# awUSugdv+omgJNcMVmcdTQ8hGaSrRUKbG0aDIWMeUL44cd80z8WmYXKiqColo0Br
# 5577xYwXMNedu7RDQQ4rdk8l8R5uJvxEKXm+b78AI1fkF7Wn1a1zc6tT/lPydbtv
# 6j0rvXj5Nd6Kq5+bRk+V1N5JvWL9jAwkWHAL1FGEbSymiVc6QJnW4ah6O/BpTJKx
# FYlRvJrUOqyEnbR2/nY1Ikd+9YFXlJg3n7thX61UDp/5PCXoRUMxGQHqT4pnxOR1
# yEUVn7hb5XUHRBfjGScr7iIfusHL5idrRFOWTyZeOsbyMqWIXHR6OQVZ3AWZHtvG
# aq9oajVIYYjAU+cMdCg+F0OLiW9mVqGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCDknLVOOBlusqB6YODWECYxf6xRn7WEx2Q2IIjwhHlRcQIGaeiBPwTU
# GBIyMDI2MDUyMzAyNDMxNi41OVowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIzMDI0MzE2WjAvBgkqhkiG
# 9w0BCQQxIgQgwm41kKWAw8U7zAbYMY0NzkG+G8xcqe+I4W1FmbpxkjUwgbkGCyqG
...
# DQEBAQUABIICAGG+/5IlVeXy1zfnt9UWMbJsMf18blL1BQJlm7dLUQ1uce8Cq7To
# vm9yZHQOJfFfhreRSrW0SI1GFos93uBKHnvbAX6KBCvlcCbDHQjBDn1MlkAlkAur
# dRaN3KYaZU22Tw43qIX/nAcvrHm9EbphVLaBscUekjMtnrW0iW+u9MzzvatrtU5H
# q3Mm9NE0FV0mhunhAp3HfL4YpOmMXIgncOZ06Nv5+YSkJEGkTbCSZTZ5pFkSmBRo
# rWEYovnUWU/xmh4LliFy02+wCBK5IwHbXoxAFn0mbuCKh9VwxyYfJpPGcsIW7g8S
# uwlWQWc/e+vKpi6n8lcxUrMH9hH7gRigz5+t++bqI3da5kNuylBJTizOgjr4GEhR
# 9C/xZ2tG/MeHw8/BZmx3Li/VV1dBWo//QLhgZl2IoAZI8DoTgXwEAU8G9owsbaxr
# I2UA+oW4CllLlgyc38bsUbXW1/zxqox7Q78F+JDhXb8tkarwvXNg47BXLvdz8xxu
# QhFfMQjWx4B5eYj8L7Y0IZT4+yah/V2j7btGfY7oMleKggs3FzB+WrLNjs3EcSns
# pbXQe/F0fJIh8beuJGY228EBjAwes/tSDW1oTaI0gmzRN2FnTHQ75X0AjWVJqyqs
# nPwAms3Wl+MgLVUt2aYnCpjlnxiM0MOLBztpccQX5mFHT7YxFAwVPPUZ
