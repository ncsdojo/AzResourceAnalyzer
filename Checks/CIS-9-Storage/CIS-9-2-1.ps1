# CIS 9.2.1 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "9.2.1"
    ...
    $bs = $D.BlobServices
        if (-not $bs) { return @() }
        $bad = @($bs | Where-Object { -not $_.deleteRetentionEnabled })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { $_.storageAccountName }); Description="$($bad.Count) account(s) without blob soft delete." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBjJ9TvteqptY2D
# wtLhtoDuSvqIvF+Tf/m3rsCqL9chzqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIJeuVoYuvYTEwijfzOc0PrNb3V4eWEmnkmZGKQnp
# pQuZMA0GCSqGSIb3DQEBAQUABIIBgJC6kLVczBVksL/+ixSddL15Y4NuWtKvl142
# O4IHrZyiZaffG/5xCGFoSmn2VpJzKw/aZ0rwsjGaUst8yXImRWP6B5DEwLV0CW5Z
# 3MG2ZQyrWyc2IgKufQ9mgKMg92qFFOwSr63LspePv/9CgDfRkx8xrgm7qGJtwxFn
# 91aBXdkY8TBbxAgAP2rJbYOvnqtEKMAo0zcBSKDxAwmetIEzCmfnqAzNjBB/ovKO
# ZfpYYYqX36FrbItbHzz7RwLklbIjchyowwU5rTzOu8vI76c/Ml0VeUAhphPuTpoy
# FJ6fAg1xo6Yiu+rmO3mgTUSH8O4tHa13WxwnkS9xW5r6H0FvTr8wRcvR8LL1B3Ns
# v77LIFu0JwemNUf1j4EtUhEjGrBrjDsgWe0yp1Wavk40JXTE79iD1ExTt+RDy63Z
# O3rgJnmg1Li2CEuXHsfL8OdlumzMF2lKXhVygCFVJRN7A2VVqVWtQ2i6ce2cka2g
# EqOjCsV8JLt95mF0cjowk5BGVJmM16GCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCCFgYLK7Wnn7B+wFori2+HMcNLIsGmxkjS5Fn0QPlqypgIGaeiBPNKQ
# GBMyMDI2MDUyMjE1MjEyOC45MTVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MjEyOFowLwYJKoZI
# hvcNAQkEMSIEIFircyvgNpxWzJMCd+OKJXAqUu06kyoDGBTe4zG3HL8DMIG5Bgsq
...
# 9w0BAQEFAASCAgCkBoR3K/PrGNIx0d8QnGcGIl56bpg0hFd1yGhkdUH3jjoO7Ia7
# MLhuP+PJhjtyq3N6vDxvOu1uKJ8Y8CpTxl4X3uaEwgPeqgKqFr4MGqydUw7yOS1V
# FZf3pldduWBb/2lRvUQp6nIkWJ/y6CeFApu0eNpkFKF8WPTv+hoSl1+X00agT48w
# FlmJm+SnLgy3EuWoUPvuLNkfTVd4ZD9OqDt9fdYuKnvzoJOvKu8klNiRJywQZNSD
# UTYdYkYUNNvUKTspTUHkDx/K8WVhDnEfyPHF8xpKGpEy+6b0YTOqPHGDCBqS5vQV
# HO5obhU+ZWoEnbhG+3DGG5O7Q0sjvVkj0A9ePFWt4AXWUEbfKJM082JFpvru/qWU
# ntj7597PTR7NODCOgCjRfTRbS1v//HAqzeolO6OhWRYBtAOwXu0YWG0g4vCKeEif
# wSDVmhb25fXsiVgmyjBLL2GV29cRODQb0oOe3r+4cAHlUhec41dXIGwdHp0S7yzK
# yhLfgMQDQmHIU0UDJtKEioShIZgrg/+hckyypgL4cLEKREYrAZY05aWE0kI9WM6w
# PvemomgBkiCWDoD0LPuNicZxNfzd/nVwxydWdGOuZlPBxKV/FTcy/5Vyjmt09s5X
# DrMYvPN8MX7t5UIqdGuU21R2p+Km6ItKFV3voJ2j7n3UQYQ+obKRjd9wSg==
