# CIS 9.5.3 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="9.5.3";Title="File share root squash configured";Severity="Medium";Automated=$true;Check={param($D)
    $fs=$D.FileShares;if($null -eq $fs -or @($fs).Count -eq 0){return @()}
    $nfs=@($fs|Where-Object{$_.PSObject.Properties['enabledProtocols'] -and $_.enabledProtocols -eq 'NFS'})
    $bad=@($nfs|Where-Object{-not $_.PSObject.Properties['rootSquash'] -or $_.rootSquash -eq 'NoRootSquash'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.storageAccount)/$($_.shareName)"});Description="$($bad.Count) NFS file share(s) without root squash."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBRRajNzWsWTI9+
# jeUxQNVqUI+Qv7Z6m17qjBSDYxn8F6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIAHBpO1/Zdc5VSD7hz25TUqUnRYs8I6GZeU38GLd
# qyDZMA0GCSqGSIb3DQEBAQUABIIBgE/X0gT2/mwo4pNg3qd+Txk5L8bWP+qe9iRp
# pB86iaRdVjYo/gZTEaiAOj9efMfhK5nln2kBOaqoJSya2m7vmtOKJOKrGa07WDqb
# VVUcceYdo7yM9cdCmqSWDGe7F8DpKvhzRarAyAfAdjrLUwxH6NDdCghsQy53Tfnm
# vKTNMoOVsAVQd4UbmvcDy/JWTk87m3rSW0YOzXdrt7j5Fqh2pLR5/Pn5sFxPwt2U
# NesZDP+75N+Ns9ofQ9Ii/1msOY6oJctLgJ6GmtlRze6JUuR3vR2JmRrkJYqeYlPW
# 0310Xm16Z1n9fv3UBNfJal0YtnzJcmAcAu1R3gbCM1ZTI4EqEumF/L+Y1DwezTU8
# aVoGj15ar2Eje6oldbInutKuYZJHqkJFy/Tus4sHKJpJfi2lPxJxY1Y13c+3Mxgk
# 93OVbjk4krUEgmZQQLaqTKeGrC6YVxrADkRT+Dsfnoo9BjKTvCZYP3g5SQQEbaPx
# q8cNsO9Vi6H3kGVanF8F1c0+6kTdUqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCChLGsPWVc80bDuIBJ1LFY+Rs29O3udyOM+ZhxxrJhq0gIGagxE2azw
# GBMyMDI2MDUyMzAyNDU0NS42MjVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNDU0NVowLwYJKoZI
# hvcNAQkEMSIEIH+AA8nXTwO5AqwQiycMhPMHqKx6pRe/VT5QPQ/VLiALMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAwifjTBSwWe4Osf0GDS4WnC74p9n3husX2gwp52XhtvJx2
# NccsdsCWrj3ynSInoPe245Z/DPfmZ85xM7a1WYplDV1wtpBMELGb26jE1ohnnTBJ
# OWiFxw6tHPEaR3L1kmBhl5I6N1Z60gX/o9GIHaJpBev8Y0/Vo35AYj52+KAUvpG2
# cQmVhWivEuIvxALuf4fhkAkt5oVPxa3MHKlAYyAxdhoAP60rIap+f/QcXM+SPp/m
# ERWMCG5BJPy1J2zdLYfXylDPumQr5MfiJvOsQ5pM6shvWxdyE6pYC8RMRmIs5gE3
# ceEmjn0qn9YJHFeDbtMfRnKOvQluMhHZWub5YkrBPlKC1DWWNj2JdmbIvAD2b+YE
# l/aIAaeuDbdx6+E4MLPbQaZejdijczzbsTEZ4VEe1wOMalGZMdA/56HRfL5JOqSx
# nkB0kZWY2dakfkkj5IsjA6i9KPYBQwcjOUnv6VXhNrwkQkRILC1unPghP2LqlZTl
# ht3ObZrXDYpyDpLfp95pHf68yRL0szyx2nnjlvVv47zc64XRyyaDDL3qeTCEvCoR
# sibcQccKrGhWc8pCJnwR46YPVIjfYSmgaIcXuJVNzxntas+r0AOnOpHJ+4C3HGzf
# FZ0OT2Xwu2CqtEbe7z9ETguyzxIWb6gmW6gLgR3kEqv2eSzT11dHM8/TtUuiPw==
