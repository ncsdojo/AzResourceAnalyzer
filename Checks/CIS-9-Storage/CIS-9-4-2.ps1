# CIS 9.4.2 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="9.4.2";Title="Blob containers immutability for compliance";Severity="Medium";Automated=$true;Check={param($D)
    $bc=$D.BlobContainers;if($null -eq $bc -or @($bc).Count -eq 0){return @()}
    $noPolicy=@($bc|Where-Object{$_.PSObject.Properties['hasImmutabilityPolicy'] -and -not $_.hasImmutabilityPolicy -and (-not $_.PSObject.Properties['immutableStorageEnabled'] -or -not $_.immutableStorageEnabled)})
    if($noPolicy.Count -gt 0 -and $noPolicy.Count -eq @($bc).Count){return @(@{AffectedResources=@("$($noPolicy.Count) containers without immutability");Description="No blob containers have immutability policies. Consider for compliance data."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCuCkQ+z2YgOi8Y
# 7wWt9wbYXLrvdpoEQDZDWNPGdqwr+aCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIPGBUmGJrPeVGTKG1PIa1tRjZovi7dB4JOZfYC+e
# cVLZMA0GCSqGSIb3DQEBAQUABIIBgC6qDCT0+oQqwfnYhadG+T/lU//PHjpP9S6n
# cEYLGoxquu8o7MMGUZwYzXnSPB4zkZ+uQFdRyRkDmpiAWR1Jr4ThDi3IKQoM/LJN
# pAfCJALlQNFs+EXfcInuHvPmMinXvLXtU5nrrpnhg/dKinbwvH1xRxKMM0j4iOof
# Q2F6l4eMXqqpqHKtuvpwQUBqZn9LYYhKDqPte28Q1rTlvH9l1k/vpiIea9UzU6Ev
# QZMftrmk3HcLp6t4U2M92MFldZ3oM4EYt6EhNZ5aTO9u8dRwAbaVf01KNEo5lvhJ
# zUDgjFhbdZTxvqXs1pYD2F1xTW65hO2KvlIRJrd+VxlBXqBUUG9hXRin3HvKbc/k
# HGMqoQXL/34ZbDmjnqWPNiuNsjtFvvFzRITyQ1qR2sXCP3g19KsZQUY7pnhY2GPn
# H3kZQM6f7tOLhyo2wjUxG5nHhMefsqbQ1EOaohgbRzm9t4PdvEP6ss2+Sqp22+My
# Pg9G+a35yM+z9BkBNIAmYUaWwQUsJKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCD32M8sMKbF2N+FPy0gtsaRSHqx5YNu1U88AT7kd7de2wIGagxE14ht
# GBMyMDI2MDUyMjE1MjY1Ni4zNTZaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MjY1NlowLwYJKoZI
# hvcNAQkEMSIEIH5kNrGPgYDLabrBxw3KiSGuzgCrPPVPY810qoMNLd24MIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAfkE6ZqsQlis4YJVvY1o5gSWdh5wHNqtJK211siCI9Fznd
# MuJYCw/HE7gB4quqnu8nY0MbSWwN2omMFS/eeg6Wuq/a5EiodR7hkpUBmMHTEbXN
# qoWKj1f81acVtAbK8tBQFDlVcL9jc5x+yZc7YW5fJotMjY6iSllCwnucC5sSvwDD
# zYxpneEAbn4I3YvSZJqAfz4PqsctrsmDcLa5JreMpImiTI9lmmovVo0omQdv97Ul
# Ahl+WwAhQxpfUJF0fCZq6/gjIFhBttT3zaMExSgWWMiAxqOU5B9FVvdJzs6iV7YV
# jH/AcoyJlExJyLwgSY/T9QTumswTdOX0Vzbhlmb/5GDseX0oQoPwIDFoOdgkY5cm
# TBBJ9sTpCnTdBQBdF6L0ewbx45e4/IX17dx9zoQRQYLM8YrYe1D1KXrhh53h0D4m
# MSeHJQrAwaAbJe1/qRJAeXAV9iFnbGCF36myDpNSwnczFHqDlz0yC8+FAfhaZPHn
# ciLkTMlUF/eSWLs/SEvRQx2vxYhsNIk+LAUFQowGWHt2uPw2HE6eldWoaMiiWLih
# bKpZ53msjCeMaFvVGXdxrBaihE4o2pYdXLBzoIq5ShREzzobbikuBmlh0jeGHxvO
# raGiOZ4WUuUjF0CeazUzClLYGUdbUhfdXhCeUmxVdV5Ua85lQeNE9CB6IX9FDQ==
