# CIS 9.5.1 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="9.5.1";Title="File share access tier reviewed";Severity="Low";Automated=$true;Check={param($D)
    $fs=$D.FileShares;if($null -eq $fs -or @($fs).Count -eq 0){return @()}
    $hot=@($fs|Where-Object{$_.PSObject.Properties['accessTier'] -and $_.accessTier -eq 'Hot'})
    if($hot.Count -gt 0){return @(@{AffectedResources=@($hot|ForEach-Object{"$($_.storageAccount)/$($_.shareName): Hot tier"});Description="$($hot.Count) file share(s) on Hot tier. Review for cost optimization."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBtm4MaYPLXF8bo
# JQYgScJBfPhMu5nHDJPKZ7B6XiyD7aCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIBBjfwakPqdQJZiH2m2EsKWbueDjgz+N/GTlaQ1L
# ywysMA0GCSqGSIb3DQEBAQUABIIBgGiSQx/978EaPDXOBgepbzP57ktpTRTe3eZR
# /hzMY8Lw02nHhqEsFf7yyBj34WW3P21SldYtpwdFWTVOC0ul9DDZalGVEfAVspOS
# GX+sfo/KyCPLdw6ddHK8oKeVZmUWkleRKmb0Code8E0Z3mrCJMA2y+5jAZXF52sS
# EGfZPdlKWoXRyENvJOc/8JVwUxaEQcD7s//NxdcXmxQuU1WhMLHNUMMZenAHEh9V
# /1qLFTecJUrV0QbB3psF26X0qmV9sO2m6LmliSkiPD6qXj3LHDBZRkoJLDVV7Yw2
# 7vxrSOAu3lz+6LOqdhABUwOoLHsCNRtD8VpQVgCuiT95yGAH0fjOkW1g+xgMAKcQ
# evrjCUHoJxPEek13C+QL7C602D87mN5IYtIf8WbhfVNE58Y4e8vmFKhCRuwzJ0UE
# O88lol10QW6TwwICJr3Fyk6hn3rfLGJXaSRrukr9OlqCSyePWPatq2BspgHKK4KY
# 8jC8ercWUAjogmpF5U/MNlEO6b67r6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBSL56wE1dQo36lSL+dTjzxm4YXxiU1tW3DRQcEqAlmSQIGagxE14k3
# GBMyMDI2MDUyMjE1MjcyOC42MjhaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1MjcyOFowLwYJKoZI
# hvcNAQkEMSIEIDZ8u+SwwTK6uajNVWoxggOd7goo4i3PK7RYPtFJPDDwMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCgxe1tra74sdNXcvoudfRi2dmARdNgmcppjtGgh5pkx9Gb
# q1cN2ANvHqHN7c1Tt3Ok9LH/vkNP+2dLWRt1y00gI0IZTrVYe7mj2OF3975hrzHs
# Cjbs60/jnM3cLKzLThcklfYXfZJO4FyB7byB5wOFcIfgcO2cyjh0uxQY6tw/NexV
# rfznhY77OO9ImueR07FNdEXDH5NN0N9Aoe6v8RNTo16P17oG13T/Ra5gBZTT97x/
# atsvwpucK5Q3769bkCKiylgzmDIdxa9KgYXHZQlqq1CMgvWHZbffZhmzjoS3Ta93
# K11jwRTaYvuYhsCl2QftrXSDZt8wsPLHMcXYapvJ92y8SVn+IAubZnz4pukKmsOV
# wU0YtBaTchsjwtfyaNq8v2OwdiMdmITtEJ/vx+XfC5jE00t5iNwpO85mArlr4s/A
# kB9/n2LrB8cYn8K/PXHUdLfBMTms6Q1l1l7i3c2WxEqKjKIOT2FB/FDWsSSygItQ
# H5FbSSFqM7aNpm9uF+1TZAMQyTun6Qpt0BlI7BhqTOanH2OUvlO/C0oW3Nq7bBsa
# CbdDj8U7KIM6OSkE6xGk+j66PuCum+eEmuAwKHPkUDiocicCLsxNdWW304n99fgJ
# NiW5xddt0TJrHYsA28RH+DGjRct+eKd4vtEpdhznEgmZrxX+1/RRnh/ap1h73w==
