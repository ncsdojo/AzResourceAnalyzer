# CIS 9.5.2 — Copyright (c) NCS Dojo. All Rights Reserved.
@{CIS="9.5.2";Title="File share SMB protocol version";Severity="Medium";Automated=$true;Check={param($D)
    $fs=$D.FileShares;if($null -eq $fs -or @($fs).Count -eq 0){return @()}
    $bad=@($fs|Where-Object{$_.PSObject.Properties['enabledProtocols'] -and $_.enabledProtocols -eq 'NFS'})
    if($bad.Count -gt 0){return @(@{AffectedResources=@($bad|ForEach-Object{"$($_.storageAccount)/$($_.shareName): NFS"});Description="$($bad.Count) file share(s) using NFS protocol. Verify NFS security requirements."})}
    return @()}}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBv3nutCWRfwU8c
# 4Re+o6hES9b028pNjEZXsVUa34OO4qCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIG/tQc5Hj3Y0dyaK3imYfuSBnSefkausbrFejiQz
# e8MwMA0GCSqGSIb3DQEBAQUABIIBgAJ9+eDLIG+gzzzZAoxUbEB7dqlvZMnfTcni
# yQfb0qffuNf02BGRnlUsTtxV+IliAF2X5KUYMk8rACeJQ9KsYVRkN7dr+lLLPHic
# s6ZUMcjLWu9HrJJ+E4Lu+LbwreWo9eTI4wdrcg5GLS3svaJk1JPVGNBfR6yTpJZV
# BxjwTJrhwKw/1NxNnR+Jae1qZyXGQe5iHOnhem40R1Kh0cTVoSoV9qkwKq8AEYyP
# lzSzziFua4Um88AWgZrZHmSkmMxRgsSlqfFw59vmn5xTH6/EOh6hWavjml40cPc4
# Rc2gY64YwQ7Q+U9Rhxvow6hNlYdiZRHGiW3eBrzZDm+jjGFUExHFyqMxSLuvJhHW
# R37e6JIVpjrXyAzgonDMEjXcih6z1eGIfVOfGXd+O3DygrMDv25nzL63Wbt+pLS0
# lyCcL45vIl37YOM5yrT61EmdfI49TjSIPQRAngsjMaZw2sG5xMq3GSHbhVUVivxY
# BiTVkeL80/GG9Qpiz1MbLsBLMpEQzqGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAFQHa7ui9HQywNX8PdMvbX+G6XAq65rP85qV5EgZ39LgIGagxE2azV
# GBMyMDI2MDUyMzAyNDUyOS4xMTZaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyNDUyOVowLwYJKoZI
# hvcNAQkEMSIEIAMpiYwxSgs8mEjNJdfZdwfy3IemL62IvETajK18gBKEMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgArs8QJubJT1I3NgjYky5Vc5bwoN7I7AjOSHnzBn7H79LOS
# uAxv0YkxT5b1Ekl3mYuUC9bgI1yCQGmbNZR/dbUa35wHp4Xl0oH7fzt2DVKL243R
# vKcu+aDhdlnNf6AiR8cIj2JQnJkwM1cPFNdM6NkVqdpXyKeLdVTGleoDRGgQFoFn
# FzHRckO+zGVw5kIWKd5wEG7lTyWmtgO4cUbXwmmjK0DelhI5uTVQkInTVOoxxfUk
# m4R2HlCakC49whV9j2vGGdApxpSBFCzJBM/xyxz9dlk2E9QJt+yxJ/wvFLZu9W5A
# HZX5HRtC/CdMAoSO1f4hwpL/SRJdBVYGz2G2nFLpBcETEMDvNDHSn9uVaCqNT1vb
# VoLBN58Ov74Lew7L5PKIwdK3N3G8h75h0Tt37ZkVr2RuPffpaYfWG3R4kzO9sevQ
# +Xl+3r7oUeimJWftiFRbM2G2lwXsJqX2XWyLzeNjwLnDlxyrIGRuK9JMXnRz+LSh
# NlXTzCO+R6KCDFN53Tq2HAu+J/iZF1WhNL5NXKd6uXC1I1AMCBWFASU7cMPjfDkn
# qf/cw+TwlgrzGDdX9RZld0IriQ2An8F68Bw78EiueErz0luiaLP2X4dP9S9JKY2Y
# ida+SKLZN1vKMAXjFvNofHWkXAdCOZXl0ckBpol/VI/tBzYlWgdRKzrZTC8jHQ==
