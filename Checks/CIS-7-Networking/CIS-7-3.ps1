# CIS 7.3 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "7.3"
        Title       = "UDP from internet restricted"
        Severity    = "High"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $nsgs = $D.NSGs
        ...
        $bad = @($nsgs | Where-Object {
            ...
            ($_.destPortRange -eq '*') -and
            ($_.PSObject.Properties['ruleProtocol'] -and ($_.ruleProtocol -eq '*' -or $_.ruleProtocol -eq 'UDP'))
        })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { "$($_.nsgName): $($_.ruleName)" } | Select-Object -First 500); Description="$($bad.Count) NSG rule(s) allow UDP from the internet." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAOSiAWroY1AHEa
# MS285n5H9V7W5wDldsICUTCFUuRK0aCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEINBDU5ybzsUDq64g/c8JVLYgSrUPYlp79GrZmVk6
# 4EpCMA0GCSqGSIb3DQEBAQUABIIBgAMucSjrMPFKoM0rglnoCsC+mWPEQqMCS3On
# fMwhrSvNMbmAkNN24uzVbGEHCisenqh+RluGyW6xK5Bnotglr1YGnc2ktmxq+3Gc
# HJ5AA2quSi7shEnC6tnnOgjXeDGOt+2vN87fSSYwNU0YPNxuOKgG8O/2ExRAdYsx
# blfuqtrvfp4nnrpYSn7tgMtai8HzdRjLW/i/ndXGPImXNfX+qx1NDjcY1UlX2atk
# 7SqdpDBTVIhY3OMUbhOol1qUl5ynSlxkOnK9N6wzpfEZin/gh06ZdNgjeHXhRvRJ
# dDlX/N7DVMH9qZ7HHzZLXpCxL0g24t9OyX8OA7Uvu5kmJNxarNAzh3l1FSgMWQBS
# kqbR/R32/3inR1ZqMcVDAZQ6U+oz7YnyDX2hT9xkNpCspS4s7S1jnobnOhnrACgZ
# 9408NMxIVzf0z6tvoWvjisiBSIRlW7tX82ohIc/pXJiGglLk6xbbuUmOGDpjgmiT
# NothAxjXWO0TX/HaoVJtQ9D7UlIAxqGCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCBVh4TgGsz4tveU+AxU9my2pRdQjZX+ladrwphtrtRXyAIGaeiBPK/X
# GBMyMDI2MDUyMjE0NTM1Ni42MjJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NTM1NlowLwYJKoZI
# hvcNAQkEMSIEIN3hzfFi37G2JO60gDMfs1s2Ki0K0ERz1ewiO7YbWKOLMIG5Bgsq
...
# 9w0BAQEFAASCAgAf6ynP6A7bDp3+i9ZA1I/M6ZZMW7rlQT4BsPu4X9gKZ2dr8E0L
# EkcDJtfK0grKgLS5m2NMORr/lQG3qD0/+1qB5G+p2S9Q6BYA49dZ87wfWWL1YB16
# EDxGEDztTx6IsiJaTFHHT0PhKtypK9Eik9pgifknwmeeSTpQSn8w8lmkLoCo3qZV
# UalOUivrA6GvVFSzyz0y1uA1+6g4sQFsBOOybOD0bNl1zXz6bwMDon8bPD3WZYSq
# ijVy6IGwcrRqTtcI/AdYV/UPZLL2QPgeuWYE32fdCTzPY4DLK93TKsYhmjR6Ioh4
# I7QBsPVBDT4SFJkuPdvZ/mC/ejwwZMlHxek84WkhTgvGMb3VEX5z0cUEYRMJZNNb
# TY8JTDGR1m/+ytMfk52IhDfyhueYNNuMEq9XtQ9e/W/1oNHQeOY6ndkyVsw3AyHW
# 8YDCkaA7282Rz6Zx0LyB5A3+vpmrop4FRnZcCsxsCz0/f+vQZ1g/PqVPWh2vnkIt
# /pBUqeJT1azBEux6mSC/hzGT6jomv563j7Ow0Vy2+Vc+WJtNzvUXBluV6jb+7ZZ/
# b5Sb0+Yf1LbkXjbsOOwFvhLxJt6rPlntn4yewllz3lGDg0PmCEhh6IbNJDJr0vqE
# LHlGWFttcGWRvUBoLoJemAi7BCiezhEHA9Fx1GW6GubPSpmfiaVlobHr1g==
