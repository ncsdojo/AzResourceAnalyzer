# CIS 7.20 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "7.20"
        Title       = "VNet peerings reviewed"
        Severity    = "Medium"
        Automated   = $true
        Check       = {
            param($D)
    $peerings = $D.Peerings
        ...
        $crossSub = @($peerings | Where-Object {
            $_.PSObject.Properties['localSubscriptionId'] -and $_.PSObject.Properties['remoteSubscriptionId'] -and
            $_.localSubscriptionId -ne $_.remoteSubscriptionId
        })
        if ($crossSub.Count -gt 0) {
            return @(@{ AffectedResources=@($crossSub | ForEach-Object { "$($_.peeringName): cross-subscription" } | Select-Object -First 100); Description="$($crossSub.Count) cross-subscription VNet peering(s) detected. Review for least-privilege network access." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC6ib9a+aYiuUR/
# 9kGajAjPMl42EE97G4CrAPOhtjY09aCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIF1LN+zulLBHJvq9oX7wpBYQv2TJ/+QPIx2NGdG9
# yY82MA0GCSqGSIb3DQEBAQUABIIBgHMvoVYc+66/offq1m/fPqBzXssbqUwX56Am
# AUi/epUJ52Yr68s6JwTu6a/Sg6Uh6RPWraOroSbnc+ZUPHUpJxFkVKdkxvmgrE/S
# yYu7zPzgwFa59VlCsLfKYNq7fBgyP3fiQzl27SanMCvYLI81CJe2rNTK17TPgUk5
# tV+PiFkpjN6i/u3wXq6J4ew/AFuEeWrgYiRlPZcZwq5y7OljXjOvl5vpCOiPvwLb
# Btw8Mci4kssHOysrPamVX0qe3rRqnft30F3knQqPJqpEueXCYCHlcfP8Pfs0/7XC
# 5lYd39N6Tw23sT9MASpcUhbQm0ECZHmhGlUimt7fc2sHtwtpc5BEhtXsbounOaNA
# xAWSvAixgq9Zg7a4Hn31OElSdg3wmBs34/OlM4cuz4KkiviaaCjPuvQA4xJkz9WP
# L4HjFR3voxYxogpFSbvGC+N6utmtJOnaq/Ta/wFFw2bux2X1O6SOK1WSVHayAm+M
# duKxLhPP6b4e7O9Zfxd4sBVyISAf5KGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCAAwYeXEfKWvOXaX1+dKZ5vgwpxDLPB6tnhMElJP42nHgIGagxE2Zo6
# GBMyMDI2MDUyMzAyMDc0NC40NDdaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMDc0NFowLwYJKoZI
# hvcNAQkEMSIEINXTh7FvrM+Ir3qP9vc8/IWXQOHotJmwJVVJDMD9Aki2MIG5Bgsq
...
# hkiG9w0BAQEFAASCAgARiNeuXWdLH24K0i4gB448v6qiDYgD03eaHbmPhKssi5GC
# +AzTGKYM/91UO7c1sxHpzQoGn7Y/zqDuDxEh1z5pREAdfzuN88chOtcn4SxZ8Fjx
# AMjUMYVkLk9NtH5pzA+mAXx3U1qV12pSRaaLpt+1k6xF3bx9d0vKgnDWV4ACzm17
# aR0Alq9AZfQYvtptUWQVfqo04ECK5Kr+lKYUvYs+fDh+P7XBpOzwSkZvY2LqygUt
# sh2hbTH7NYoCwwepdGGBiPa3Qauo/rqYoQKTP9eccdQtMUeQ5KE6cb9UYTc5SvYK
# FMZF5o52FNmSp0AF5jL9NwlFhPEx4KJjQLorvYleTCAlUJvAb3uRl3zyEGsdgESM
# vMgETwv2zYDTT2Rq8Rh3OrphpkV571TiBOjYx4UZKny72Xq45nRfEdiXbPiZF6NT
# Xd+s7GaRPbqQEDMgvhgXFHDPr22NJUbmphRry0V8ebWWcSUmygw6+q2miQ/5CgE1
# NcatrxFaXc443zFWYGgO6iybiFLKjXWYpIVZgn7DX9C3tumM8u9KgpHEsvMEu9VQ
# e+xKZTUeOc86J4PngmEjCLChS62S5FR4bBnx0R233uHlte8SmlHBBn7T4C5kmsO6
# 2u6hHG00/Gf23m2r829qe7DV63/HJqpkE+3f4uGPcZumSJXZjU4ts4SoOBTCtA==
