# CIS 7.9 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "7.9"
        Title       = "VPN Gateway AAD authentication"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $vpns = $D.VPNGateways
        if (-not $vpns) { return @() }
        $p2s = @($vpns | Where-Object { $_.vpnClientProtocols })
        $noAad = @($p2s | Where-Object { $_.vpnAuthTypes -notmatch 'AAD' -and -not $_.aadTenantUri })
        if ($noAad.Count -gt 0) {
            return @(@{ AffectedResources=@($noAad | ForEach-Object { $_.gatewayName }); Description="$($noAad.Count) P2S VPN gateway(s) without Entra ID authentication." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAj0SwWMKAk8Gdi
# WjiDuWuz4SG1JXIdEfBdOUSRSgA9zqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIOZyxj9g+fI+qMw2FeRXPbqiL9bFeS8/YTjL3jM6
# mcX6MA0GCSqGSIb3DQEBAQUABIIBgBJKmxwwcLDbcOxWAgijEkk07mMqvkIbB1Kv
# 3LLCQXkRTRGCnducFZSxlL83B77tXNUm3fBtUAVCw0VeZmQrElSrsgYj3SLCBmt4
# zIs4ZofkxvVqdDWcbr6t6R7c5F61qCV8LbC/SVqhTPt/YDoE2m2+Ia/cMJdAC/dk
# chAPGAPTOmfHiAP6hkL8xKgPxDO83r+FJkTHpCJ9mk4ytzCxX8p5jDER3Ak2U214
# 9O2lPfJNI12XDOHJ/M+wPj45OBKqr5+19xzPRtWTAsZ3OAyQTsYULdEjXjL/FAmL
# MCTiuxpNxrFJaLmOhrAoGP6BMQCrnKrlSNkHXWor5w9rCkFYu/wBQbfF065CuBgU
# Nj17HRJx8egyyYJWwQM9eSQ7GzKSpl0yRvQt8HlY7wopRij6I+j+4Zhm0vKbIZpC
# n+lprkIA+PmiQXl6cPZxjapCMGA5L8iMxLICyCNlW52pZ/dO7AGKRreDx7/Ul2CN
# ji0JacqH5RXtHnxGVVbIMITlvYGNfaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCDXbwKyRQO/5zu3bTGN6C5jk9TmE9pb2MTPg/rx4qJAIAIGagxE11+a
# GBMyMDI2MDUyMjE0NTY1OC4zMDJaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NTY1OFowLwYJKoZI
# hvcNAQkEMSIEIGI/HoEsNWKFU/AsJP9rCtbAVWhhk9SuReNq+flI7P1PMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAZBHhe1foIcH7v8Eumwf/HDGDlPxfhI7iU9SlskWu4i7Tz
# ZAV+Tnq9Mvw83aj61v4jAtLF4qv8Fw2XYv4ryCgMqZepJYZF+VUQSpQU2WpbmrBQ
# t5hlTbiCJULRmfFScd7ozMcnE3Nhsd1nZv2YG1GAtoJFE9thYYMrdzs1iVduCUyu
# Rl1guLATfHk+2hpPI3vORhJoJ/gr19L6WBgO7oaRIngaRN+GYE/Lbdjzs4lb1U0W
# mg7CnM02LxTykmhtc0CrH9Hil+yaKuXYo0uCBzAXwR3mQATUT24oXdsnH+15G7bC
# CEWACI5UynFyIPyxwMcY3LJrsMazZ8DvHJ8gwYCKUxZIDAeza3y0FfpVkG7T3Se/
# JLpHKITi0aSEcO7gGOlsfXsq81rWGNEd6TLg9ZwEVmbpN6WAXWBIfdRs6VM12hW6
# 3KQbCjno4GSMs3yWVDacXGuJIWwuJK2OaoTSnjhzoa7iE3lsCQWX4vBgg3PWK1Mj
# UqmeWdEzUiwv2wgAC+8IayJ2OyJqJ8SyibgRnYGTzUS06omcLjY2O4ucQIoEmaDG
# 6r1BvqAW8GZVg7pJPMMPK68SeSkvIRVppMtd+FQtGdVNhxz+5MFXJXUZf6vA0pf9
# wofMPm4Y+m44plneDg5M7FagaQm7N62Wj+SxZGtpiiiqhQHfGOPRxD4uVGm+7g==
