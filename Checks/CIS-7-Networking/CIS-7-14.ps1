# CIS 7.14 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "7.14"
        Title       = "WAF request body inspection enabled"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $waf = $D.WAFPolicies
        if (-not $waf) { return @() }
        $bad = @($waf | Where-Object { -not $_.requestBodyCheck })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { $_.policyName }); Description="$($bad.Count) WAF policy/policies without request body inspection." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCn4oVEl9p9qAaX
# OlEgnk/1n6zFRXSs/949iiT/5nIkNKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIIAz7cpcbsJKAgjeOh3aLvjwEwNi0i3nGzokB0eT
# OCr0MA0GCSqGSIb3DQEBAQUABIIBgG7qfsMIAlyPopjw70hTGZTwYaUyxIBbBdnk
# Nh+5n/3zVZYAGZOScw8WW2+lIRmlIkXdpfJvw7rSm00JDCy4D2QF5lTKv9yjd5Tp
# bay4XDfPbE+VTa/Z8+NSNghK7UkAtRR5c3Po67n5rkwi2R52+QF4UOx2cuvER8+l
# Ub+8GJSzk4uFbH5T1x1c3n91Mjxx9/dKwYfdUC13JbpohcIhyiEECQk+uq6c0RzY
# KoJB3tgRtETIfxiq5JZg60mkMaHIL5KkEwD3/jGGwZb16hNwUqdzvAraG3+6STYj
# MD6kBeWgo9brrmyGtYo6qoNkwei/n/DrrhZAGP9pHan+c1UNzrCnNN2/TxdmBq49
# Rhgfu0TVpGijvqcrB/BYtnNKROQXuhO4R/Gk21yXZz0AA0vA5Mao3SjzjBsH3sPu
# gTv486jhVFCrUf2cUt5i+V/62WSu5FbImsmpSgWPqTGrh1UN4DC0z6Hms388ualr
# txo6ZDELt1tf0fOkjNc+OxflEA/F2aGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCS010jHm2pRkiiLM1syVB1vOoBcvdWpo8iKwnmaDppagIGagxE2Zhv
# GBMyMDI2MDUyMzAyMDYwNS43NTNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMDYwNVowLwYJKoZI
# hvcNAQkEMSIEIJcYcJNdoTzChjCa0LZZe3UlZ63KKTWp92CiwOP1NYZbMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBeeZFoQhxKqDaqE4eULvXh9kUqBngqN8gMEYmjRyWVphWg
# tPFztfKzOaiwUL3+OvIwfNICfQoW4lObhjsSxA1bpS+oA52ZgSCj+9BkWoon763C
# 2z2+BzYmwOD16nJ6HN5ftIiphUyOWKThDpIYduKMpjGLOv7SFMpHWDkwY3kOKitO
# yFJtyYRWp3sXIBsuD+vPD2cEqfm1BaoMBvCjOy5PG4F324SFU1A9LsqZ2xP2mLEm
# D8zaedCC4HeOqv+9QrMJKvnHyT3+YRrq7uQ/KWIHOxqMGl4YbgkFLBZ1JaHyzxPn
# v6c+kiB1b3HzuWvYb0yfNm9eSRrcNTK6ezJhmU32b929FJ+3Z6wqsfMnZLsxrilr
# rAn45LVLKpYfscRPbcAKPkBCquEAKSP2t1l3T+WAImN8AkWzmLfIXVW/Y7Oju2My
# rN1JjYhF39SRBDCoMYb/DEq+RHMEJN2ZNzrAj8X0L1z8hAVx438DFUR3QRGylcVF
# ugKyQYpFnXPeJl6ZlJQQWHVte8NmcifJI5M65NZaROhTnhm/rmIneXbU8NJ4nBqh
# vWF0rParMcJtnw730TLzX/3MJGVFM55YXRk2YaS0TU/r/L//geEHqUWzL0fTlUP5
# bhy8avsTslRfaK8zimGXnvcZ4vidEK3C5g/GIbyXdFyeewNJbAmGUvDud8xXjA==
