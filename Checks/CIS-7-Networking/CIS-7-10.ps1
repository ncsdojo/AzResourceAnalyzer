# CIS 7.10 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "7.10"
        Title       = "WAF enabled on Application Gateway"
        Severity    = "High"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $appGws = $D.ApplicationGateways
        ...
        $noWaf = @($appGws | Where-Object { -not $_.wafEnabled -and -not $_.firewallPolicyId })
        if ($noWaf.Count -gt 0) {
            return @(@{ AffectedResources=@($noWaf | ForEach-Object { $_.gatewayName }); Description="$($noWaf.Count) App Gateway(s) without WAF." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCc1ohEEz9d0pxD
# IvQC84vxS15AhJFnOhGmH5PI73NvvqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIPUcNeGmjyX7bAczT9p0fQ6x5nSH3RVcp8xGuscs
# C0CbMA0GCSqGSIb3DQEBAQUABIIBgComnecbuwYcezv8oTF2G5YH0jvx2vZW2f8m
# 0molc5ApKAm27V+HdoMxSODef8jIuoHt1yF5AAh65YqX6z57LzEmfM037pFxyNOW
# Ru5bEnhc8ls/yuCOaTMIcT8VMwKTK3HG3NQM/Q4JEkhmuCgGM5MoSt0BJWVG3x26
# twN2rUCpCqK/y4xlWB0NIzknzCSkESQzYtZf2F8OApikVQ40flaD2lxZ2Y/Jf6AW
# b1JmATwwp4DHQhhyIhCmwHcE1xLlinoTD9Nob9Ni6dQEOTJ81s0YmnGlwt5ZuWEN
# sYQPL0uVlySwJZLJF7kYYXQqvgOZbPUVKiM3AA7Ps1axl9BmyozckLM1ZTZ7K/Ln
# swfJP/Z8CpO9ezLHFpKRGFWFc0QqdPn79IQxHx/kmteta+S0ckIXGCfTzWDxKVj8
# WwcdpYZ8hV/Cu4y5MdMAw5+il8A7ddt4hVvJaHUwTytKnSpGD/1+WSQIEyspa4ii
# pJFSgASJiW391zYwOyZWGlrS+qkwk6GCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCCmrsTGgXAELwz2HYT3yGx4TtKEDg/k5lxqPLaXaiVQBQIGaeiBPKq9
# GBMyMDI2MDUyMjE0NDgyNy40MTRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NDgyN1owLwYJKoZI
# hvcNAQkEMSIEINkPHBwkPy9EIe3GVG8101SgGTJ1RAEhjQOXT0yC3SNXMIG5Bgsq
...
# 9w0BAQEFAASCAgB3uhFN1ugZ55p86ykQ1jfSHPjNuxNDKE/SQ5iMI8jaOmMfJFD3
# AV1Sx7qReZd73ewTG1xQOc5dBlWlOdlWkmCvfa3TCWl1ocYrNAiM3wudcG057DSX
# S3cF7i81E5bHbScHYW3mWwv2rTQqddr8KO9VxogE2v9gKu5NvsZr5K2bFxg+q6Ou
# 8t8wr4hqjLcxIukH11lHhe5OmrjNeNvKJPyTfBqXz+9mtUQnkvxfIhgZE6JE/c3A
# 7rVjTp9wEObBex3k19Zz2QFdIkGJC34CqWjVEHd/vkcjz/qZRhvgdm46l3mJywYn
# EfDtmcdmwFBsobvvivmN1Qh9KmWQ43hZWUATqTnDejHthLyK5KJXVerRlxgpGrCJ
# dJ3lu0XVKnx2urC1IXGgk0CFpAkqj/d8xFbfC5/c2oK1xmUm/qlJW797yrX2TdcI
# 61a80herkBPyfDBMJgOvQxB8O4xvs011lefnp0AazBeYwKLixOL+8rutIeGPWhPk
# kl8u0s0nr8he7VoWQs5T10I01pcQwIjcYbRUN7IvfqHEQSW26goFpCP03YWLoowh
# xU07/IRzu5zGBrcn26srqDqkYQNi+4xE3BWZ2TlLZAkPZX6A/nbaEORMGn+Qx7aL
# NGg78c0OMSjHkDji4SRaOoUhmp47EtrPnYwSSCYNZlBnjmpZv3EUzO9zQA==
