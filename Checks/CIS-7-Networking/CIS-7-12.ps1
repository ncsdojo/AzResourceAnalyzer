# CIS 7.12 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "7.12"
        Title       = "App Gateway TLS 1.2+"
        Severity    = "High"
        Automated   = $true
        Recommendation = ""
        Check       = {
            param($D)
    $appGws = $D.ApplicationGateways
        if (-not $appGws) { return @() }
        $bad = @($appGws | Where-Object { $_.minProtocol -and $_.minProtocol -notin @('TLSv1_2','TLSv1_3') })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { "$($_.gatewayName) — $($_.minProtocol)" }); Description="$($bad.Count) App Gateway(s) with TLS below 1.2." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDN9ykQrYyjf9/Y
# hm+D5ks6AQMdyOGXcdM+UJ3KJzA6KqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIAc5SiYIh8kKiS8XFo8zGDcnbjJ3TcBT7newdTFW
# qUlcMA0GCSqGSIb3DQEBAQUABIIBgCUeDOe50fQ9vZo9k8YauCy/qFlz0nqB2Oou
# dOgrMptn/r3TGhbjPJObRrbgIWrzw18uLQqETUpn3HToUHfTe96w3tEU5WCwPKqX
# S/mc22+Pj3CzQCQt5xR8gS5YF371YiwyxXP7BjWkpcjIMkWMtbq3krTnYq6y/SOA
# xjxSk2YNJEMeu5hpLUb3m1+HGwerI3n4aVN1vo2MT+PaIBgSnLdozD0eTfxoq0Zl
# g+OtU+TVk7E/rHOZmM3vLc6HDHJLK2BrBevOqLV8tNByd1UQk5Ke0z4YccwS5Djb
# P+aYTxQ/ccUtw/nslCjM75T+Lz1f3PxuR/71/xi/BmMbez3dvsQPnUEhQsSLVx9q
# MYIXQ3fGtWg/uZvobN/Fhwptd+U/YFAf320XWEZP7kZPXu6x0emSIb0a37Yes196
# RvkI0Fp3JtCXRdbKWjStY2laTieWqk6Kh4Nw5D23skTg9wGshr7QvZICtfk2NxKV
# pNHI8Fi4sBz5b+8OnSpXqN5H0wkwS6GCGBEwghgNBgorBgEEAYI3AwMBMYIX/TCC
...
# AwQCAQUABCAe5edTLEZ+l3twefXfodbkRY0fj54WR+8ny7vFkF0NEgIGaeiBPKsk
# GBMyMDI2MDUyMjE0NDg1Ni4yNzFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NDg1NlowLwYJKoZI
# hvcNAQkEMSIEIBhIndMEZJ17qmC9We7KyO7W5xOsZoOOJuRaQnq8dJmOMIG5Bgsq
...
# 9w0BAQEFAASCAgB2KpOjTGMClcwP2nu1Fhl+G/LaQzVjhIfnIN2sj1hoFLENU2OK
# bbTOY5WHx6mD7IG6E1ZmsCzWZf85yPK+U0abCftQN6OaFVn80TGzg2D57+FcZFas
# kMQc8Z3umrVpfkHok2/3OPjAUh1rZRUU/dXkes+z9ijFNJh5umkYi6L+/6HTVmK+
# FFb8UCe8jy8FzXDdZqI01PT4ch5RH8oVYaCcENx9zIeISAOtOW0GtfHR+gYXAsvL
# /QTE1PR8RCR0T/TYKeAh0rJqXza4whMi+3mHlEYdvFuUTQ0jZ2MrA4ljwzLSF9DG
# xg8abt62FPscl7ZDJqh0dI7cP5/eD/LZirDt/fL4DfkDCKzYH9v8Make3cu6Dpgh
# ekw2OmiTRpBp2FvziVKGGuzAwhauPUE/a7dxcwUQNzgUnMHsCEkNw920OimLE6pz
# v4rWZqPPvHtChJlv6Iln8AV0sUaHKmT26vbqqQiiVRqOmMKc6FZ57t2GOBFXwltS
# y2ZNRXHyTXIlgb5Ew09lTC8Inv/cMSeXTwkOxOty9lLI0xEHFhAoGERtDwhZ0z9d
# PucLYZ2Q71d/lC0Yt6a9VE/8zZKUWtbhXoqCL9qM4CTxvKxEb5yVqm6aQddohX4f
# 26+LmFUup0sc674kihYHpgfOFLpEj3lSjM+SAx6/28b6MbXvim+Eu/GGkQ==
