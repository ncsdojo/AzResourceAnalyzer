# CIS 7.18 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "7.18"
        Title       = "NSGs restrict high-risk inbound ports"
        Severity    = "High"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $nsgs = $D.NSGs
        ...
        $highRiskPorts = @('1433','3306','5432','1521','27017','6379','9042','445','135','139')
        $bad = @($nsgs | Where-Object {
            ...
            ($_.sourceAddressPrefix -in @('*','0.0.0.0/0','Internet','Any','0.0.0.0','<nw>/0','/0')) -and
            ($_.destPortRange -in $highRiskPorts)
        })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { "$($_.nsgName): $($_.ruleName) — port $($_.destPortRange)" } | Select-Object -First 500); Description="$($bad.Count) NSG rule(s) allow high-risk ports (DB, SMB, RPC) from the internet." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDErZbbvIGia8qX
# oW57Q47RKkiOngWODFC5ud6jG0mfaaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIIro+dYrX/JL8PpKufbRlnQOv17Otlgu7F6mxKSR
# E3s4MA0GCSqGSIb3DQEBAQUABIIBgJS4NAa0SmmfZVkficGMK9uHY724013WeQXz
# or0KyNOydDsU7IqarT7VHo9Hkj0ki9qFsmjtGL3TGz7jXIEcUPTqtaQltIQTO02D
# 2D0ct+LntcUyrPpPhhitRJsH3X0g217YlVDCUT1Qs1eKCI5YXV1KoqHyJRdtsw1p
# yMxHfZsUFj6LNsi6zhpuRFEecD0r2AnNjWoXeRBgD/RS10CxogEeodWtREVfBqeg
# sM89b/MdF7NcZkk0iAht55+gASlIwP5mQIpYJTUO7ivVQEeeIuobc91ERVxLPe0n
# EIO3aIQozufUJorUB4uB95/Rbn66cx2liAP/Y1DGfzqr4GmALw9TYbo+2RzoHAue
# kmGmwlpmQTvPuIioUSS9zBABTnGDdDI2IWBh3wTODZcDQtQpvtkhM8/x3fuN4zy/
# EAjiaXwOx/xSvxeS6gmV64WajfQ2P7Oi/DE6fp8+wEn2zvAIlTDRYWhzY8uHWOKQ
# ICAoI3XRJSWE11+2ClOlvlzAVkg7B6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCmi1KMzeEfI/WmBpYsjOiJ9wD8SnDXVgH0wpCPSWx/5AIGagxE2Zlg
# GBMyMDI2MDUyMzAyMDcwNS40MDRaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMDcwNVowLwYJKoZI
# hvcNAQkEMSIEIJ56FLKcVQF04wtTZ7pmuMe4J8YlLyWWiEDar3cQUIsvMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCp2TZDWIuPz1W57gFLGiyz6CdM0TqcNWc+aK7+gxFQt8Te
# FZIxw4sWQY/HBtbWx4YZYcCJZwcHPyfr6JgS+9Ugej8BkAhSRfaJHLI7YDxSZPsd
# wyAjqVQilwhOSjAnzVO1f1sUHsKIuBnSv+EpV+19AMQRKQTbxBjeRZVCT53Hb35Y
# G81Og0jk/nn5r2jj0hiilxZ6EGMZ8ldCkXpyPMO2fhvVIqg3cy+9ed1q4dIqXLeS
# 3FxYei56NDKHNQHs8V3U9t/0IqxSWzR5AEpm2HjbMIOt0RW6QXItk7v2r9tlug44
# zzrSAss/wuLxqd8tJRS3KEorS5LeJJZ5jdg4MEGpN/aWgzjWeftUsS2jfLVyM34P
# M9T/bDGE/Bv+5f6BXm8IIiCdjBhc7rzGbHsk4zD+9YiXBmH6oe1b5tgpG1Bf/b15
# hmfVnbsMTNdq0QZKWet6F0Mmjb2/IIrF0GjXUG9UEnkxitTxoWriIruusLwE+pVP
# szXir7wCOj9mWEKkzgZ9hLuXAirPF3r/o+48Yb0ftrIxzoRqyQ4ug6c+rLLtMDFL
# A84XTNAzE9m94qL61kuf12mhSjpalbfLvlh3+ieUH5BFrD1/WdJgWGSYbXkAPKzG
# 6+FKhTG6V1lpAC9LYrg/TVjB6GJqaIClPR0m7l44x3RggOYoLzvQRtyFHOxqLQ==
