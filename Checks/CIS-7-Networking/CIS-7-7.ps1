# CIS 7.7 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "7.7"
        Title       = "Public IPs evaluated periodically"
        Severity    = "Info"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $pips = $D.PublicIPs
        if (-not $pips) { return @() }
        $unassoc = @($pips | Where-Object { -not $_.associatedTo })
        if ($unassoc.Count -gt 0) {
            return @(@{ AffectedResources=@($unassoc | ForEach-Object { "$($_.pipName) ($($_.ipAddress))" } | Select-Object -First 500); Description="$($unassoc.Count) unassociated public IP(s)." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCeT6VQZwD76err
# /l5TQfeeN9v6NDGM58We+W6rU8tvRqCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIDPq9m0mno2T8rBaU75qZATU9c91u8nUI8/DiqJz
# DNBMMA0GCSqGSIb3DQEBAQUABIIBgGDmSAyuvZF6Ai+CZlidxwftp2nSW73mg+KX
# DPlAI/uJ8Q13J1DQTuLFZdTO0/Lapwfiw8UdeKIbd5gFHbS+h3UbTiMWHejuJHq7
# JamV2Tht+itUjU0OyxuYyPu/0ppS9bM2D5NBBdDnCJl/Jvw6rGnfNAcAsOAsK2Nd
# 2LYxK8CrdjUkCsBtCEsOZ07bfDqk/K0VJGg1ntk5kC4u+BoOx0eE+HmY93z14Z6X
# +0rHaGqiNoHrwQiUY8wdLgc+HjoEL58EL3kj+bdyZYMscvCB7uvNoaawGPJQ916l
# /Pl8j3lf0lr4uIZY2W9oYN324eKMrcWsHEogQ7Lg+GZ1F3YwkWTT3LCt3rG9t74b
# XExgUNA6pAE1OWrPyWLS/LN3z3tDhKNk6X7VLy1TNe9+IR/++Vcmqc4/A7ZQPfGI
# CNQWJ7MQbTPoGPinR4g+fn2qqdQL3lLFQJMt/XOnxL28Z+fZ44XMzHI1EFnMSsG/
# aU0nMEbVKY+xAR6WWSUaEw1RN2hJ2aGCGBAwghgMBgorBgEEAYI3AwMBMYIX/DCC
...
# AwQCAQUABCAWueymPCizybKCgwWE0wbfkU83PvO6YF8hIlOfdnIRHwIGaeiBPLNK
# GBIyMDI2MDUyMjE0NTYyOC44NVowBIACAfSggeGkgd4wgdsxCzAJBgNVBAYTAlVT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjYwNTIyMTQ1NjI4WjAvBgkqhkiG
# 9w0BCQQxIgQgk0866qXYuFOXYI2CxNbl7/oPBsPZzW1wfUHLU7bWFuMwgbkGCyqG
...
# DQEBAQUABIICAJUzKFtZoP3LaVnjVeAliHxyvkOUHeB5/StHi0M2CIJuUCOvQJAM
# oZFbedP+RhwwFnZgjsY48eLpU74RlmCUcsjTscRXe3BQFOKw4J36LlKa+7BIWJep
# XzEDe9VYtJrft/Qzxnnbr9JtdC3yDPJpvxcDtwzs1pKhv9aftvGBDrWtC5CHskXB
# L4nkhwkakBqxdGESSEgOHkfmJEGNSfKZj5WiC5a+996OZj2pxP/KhLLwEuSb/qtN
# iABAHmrGDVu4o02WmBJbz9J/yvAPFVOOGSjOzvTbAlTQ6Q/3qvZvvDssD9Juf4Yx
# oN1gbx1PEQ3/nyRbPI5OVns49HSFSlNc8ASnJzxnMkaYboF9LyJaoYMEqwV6wWD9
# NFt2PEE34b6x06mBzIPmoVZtu+Ojv6qMhUlTEaZVKwQamApK63nC7ZVbXYr3N59O
# HgGyq+Kcb4Xbux2QiNVNJoPp4Ky/ls2S69ckpCherKiN3zCOjXWkCCKmdqPhxoRB
# OdzCWfPCCH9rXDRXY/yD3xt4xMncQF4jbbXUmq8cWMzA+54Z+kyJyPLZ2w1fbOvz
# FLIuS8/nCMiWHC7ABVGm/ExZdQVy2PkL9t4A03H34CAo8NhWtSQmI/D3NR0tudox
# /8411ZG60nQSD+O0D8grjoLEycGLK+YRyczNVXFiil5kVTOy/rPbRuGc
