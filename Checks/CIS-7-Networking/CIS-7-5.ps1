# CIS 7.5 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "7.5"
        Title       = "NSG flow log retention >= 90 days"
        Severity    = "Medium"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $flowLogs = $D.FlowLogs
        ...
        $nsgFlows = @($flowLogs | Where-Object { $_.targetResourceId -match 'networkSecurityGroups' })
        $bad = @($nsgFlows | Where-Object { -not $_.retentionEnabled -or $_.retentionDays -lt 90 })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { "$($_.flowLogName) — $($_.retentionDays)d" } | Select-Object -First 500); Description="$($bad.Count) NSG flow log(s) with retention below 90 days." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAuN6MMFlT5kspR
# 1KW0BsmGk2XkYMUNlcivZ47EXrslI6CCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIB9U7mk9LMUNVh8DXaofwPgQqlucLRf2FKlIoI4R
# U/u7MA0GCSqGSIb3DQEBAQUABIIBgIap29o1sUUldz6yfyVR88XIF5dBmRdmLmBG
# RBKnOvBONQaWq4/ELX9vkz/O+uGtIFyxYNTVXGk5Pootae9R1i5/smWPFgE3iUyR
# jdcWa/cRXBAUwlOd5oMUH1jDMlIVzMO3SGqNzT64h+0jqKEsgBCKexLzS/5GL7fy
# 028UNxy/h63slWwdig41OcsGyBWZaPuU4Iemud4WDfTbdfm6wBwKo1bpo0pE++v7
# x7CJFRTTTYmyEH1jcBr3dMflnxWPR1Ileg828L7mknpc76hKB8axW+FsQiSXDxXD
# ysscQfTlkbAXLymjttWClgNz+aA8kquT1ScAKLiLUUdDiv71TuVIOPftHwQslQcx
# lA3mK5wCFdDx7qqpKzOcckYbjK1H15Vyv46wLoDg8aVXsK3IuuLtp6NdCAmeQTDv
# xRt4v/FC8PD3um/KpbEn3oqPalUYqPY+2uP7nT2aFtumMJR3n7bnzUT00W7EwRKn
# U8USP4LSj9OR4vWyimYVLUzOHc9eR6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCC2GbRkwFjRqPp08UvGfYEJB5/VLYAoNerK2D6BHEoTRwIGagxE114B
# GBMyMDI2MDUyMjE0NTU1Ny4zNzNaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE0NTU1N1owLwYJKoZI
# hvcNAQkEMSIEICPikOfFWc4tZc1dN/GiEg7tebooDyIyT/EZp5Q2UpliMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgACqHZm4JdAeHAmVm4VzfqpNeQKEB1Kel40BlEFZ1vc6jdC
# eJD3saLYyHPfRdQMRrqqbMx0xhh2gsRiY7j/FbgPHQKOyCWb7JSfOjItJeGo8Mxl
# rS9+I0YWgHfuuEp9sQT0S+obxIENcrc7Jc9uituQPR/eTghuT0N7uEvtszNpg+UR
# t0DnlNh9T1FGGpgCETq6fyohPzgpOm3syZhdFgZnSpij9ak4Pwdi397xjU1cVwmQ
# LTYHkWFqPTbJcWnXBMb2sVM3DfpNuM1i6fzDJzZ9zWjITM8NneH2HGNtiHT0YkTs
# 8iS0+3LFrB6vzDZTPdAOdC2pnuv5nQSvUU7732WtlyHpnX0jg4sqycvp61dvOpUs
# Uzt3Jkmfuh+GlCgjJHArPp4zem4+gGzGZhSJFSov2mX9WTf/wSg5sTU4vdSseJUc
# p/MDnJRXZwl0KmWLx0w7Gva2MbkHAqqiZ1lDx0orRqnHB2dQojzaXoYizZnNs99+
# +jY4suSnJ/hRx32ZAeQ97E+L9I0TNdPf+OuIEG8DGEzG+E8nlUyWNgp4+Gj2gyCR
# 1+W6Dz02gm4PsJvCRl1arYLwa2h8ngTT4GfzhphMSylSndcoBK7Eees7JtZxaBl2
# T4uw7n1WA8MX4/3qfyJK1ei+ATYylfru3tXyX9Lxp7VQCvsOMN1fCVT7ld0M+Q==
