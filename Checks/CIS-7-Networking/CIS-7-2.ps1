# CIS 7.2 — Copyright (c) NCS Dojo. All Rights Reserved.
@{
        CIS         = "7.2"
        Title       = "SSH from internet restricted"
        Severity    = "Critical"
        Automated   = $true
        Recommendation = ""
        Check       = {
    ...
    $nsgs = $D.NSGs
        ...
        $bad = @($nsgs | Where-Object {
            ...
            ($_.destPortRange -eq '*' -or $_.destPortRange -match '22') 
        })
        if ($bad.Count -gt 0) {
            return @(@{ AffectedResources=@($bad | ForEach-Object { "$($_.nsgName): $($_.ruleName)" } | Select-Object -First 500); Description="$($bad.Count) NSG rule(s) allow SSH from the internet." })
        }
        return @()
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA1XW+jAaQGxokb
# lnz+iqm7jCwkSAiOWfgXRqztIA4amKCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIEOeuxJLSMYqPJrV8kNh4hfAbt7kAvNNU4rZcdlj
# 3QgGMA0GCSqGSIb3DQEBAQUABIIBgC0QezFjkW+8Tz/5Hf5b+zcgdG4c/h2g3Ahn
# 1fUMeXaBmf+WUylaPAR81EJQTQ7UQ/Dz3RI548JCyv2+HjDrkE4rJsqV7yS5ACFc
# 5lXw5kNLKp7gBWFCcpL7dRqWWKG48eGNAOD96jo+XBcij0Bm5xsvIcO4aBxURvVb
# 3VDC+vieUItU+Msj8vIO+YS7x5j0cNa/r+3Q3bJwCgnj/Va3oWq21pVTufr+pisM
# FhWKlByCvLvNa9gGT5H6oCZMz6PXYh34p9IVimzc0Wrh4D1huFZMWX6T5xQNcInv
# IzvJpsXUftJVIbZYue4FuoSHohrxkt1/lFfYq+EmqXQpZzYKLRQzMSO26BArDjTk
# 2kOerfnKToECl+7rZlmWtTrVEvEZ01eF3NF3dgbCMasyXVVj/W5eCPSz3XeZk0N0
# ZTEvLsbUNciZoeAGLVdP7ErCRdvYf1hppZY/Z1698rhy7otEv/peBoEh/R1gTxP/
# f0wy2O6M0oTgF9c1sREkkWmMsnK+X6GCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCBoD+8cPiqhrSsFk6H0Vn++q7gtPHvkRq78NXKrsZnobwIGagxE2ZnU
# GBMyMDI2MDUyMzAyMDczMi4xNjVaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAyMDczMlowLwYJKoZI
# hvcNAQkEMSIEIO3dMSa/MY2uIoBtzZu8XNL+Rp13qXmvTtj5hQeyuD0cMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgCXKtImk9o1REXtLRcD678Jf/wfKpsd3qdJzzWoQFvFlTqa
# Nre0vbq/BMQ8XY5DrBEPTdvijfivqx4V38z3rF20Nq4xZDFSo3XZYQfOFIc6LhJl
# vDrbufp9pk4Q7OzmNGF4QYyoH8Q1MI9yDUAfaNmZmbjvxPnq3qhy/7LcwTPP36+V
# d3xTaMsYJJwxDCp+tori+UoJsvNiHYvwV9YaAx+XK1IDK7d0F6D2x0TuAi2KcCtC
# 0UH6fMm35zP6gqYhSrZXEqcQYJnYoI+N58OZk/GI3gW0ToVkxg5bXYmyYibUiS9B
# iSnIeYwh/LQNakeRMJ3T6YxzqHBIrYGz1sfYiPqZMXzXEyPHlt2o6nkWjKuJY5GP
# nxL8qrmFu9a6+HFiQXIyHhoLgu0Rb36NHFo6vMoFTYgraxKbste9Z5J1YQyl/HkU
# VQ9iU12TFrQKpl7BsfcXwDGncxystdSlP7GSQqqa7rgJU/9UY608vlu12evokWpj
# R9Kle3sWCpXj/XXouydZlSHINrzReJQLiJzST1mUOGyHk180iZVAGoPbqnPpEc01
# VlJCovsw5Q1gi0ihkvUu+sezE4rO7dhVSj2/EXzAabru+sSe6oeOZJZ83CE4aYdk
# ScXsX8vcIMoU3rLbg+Be8rnlZl8EvcUhXocD2zyLrJX+B8FeCHjbYM+3v2T9Yw==
