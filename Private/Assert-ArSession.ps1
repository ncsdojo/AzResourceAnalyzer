# Session guard and token accessors — Copyright (c) NCS Dojo. All Rights Reserved.

function Assert-ArSession {
...
function Get-ArmToken {
    if (-not (Assert-ArSession)) { return $null }
    return (Get-ArMarshaledToken -Store $script:_ArSession -Scope $script:_ArScopes.Arm)
}

function Get-GraphToken {
    if (-not (Assert-ArSession)) { return $null }
    return (Get-ArMarshaledToken -Store $script:_ArSession -Scope $script:_ArScopes.Graph)
}

function Get-VaultToken {
    if (-not (Assert-ArSession)) { return $null }
    return (Get-ArMarshaledToken -Store $script:_ArSession -Scope $script:_ArScopes.Vault)
}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCxdwbAy8ho3ndQ
# tdOQNRumc8eRhrKY4CNRNtCEJKtzZaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIPVyEhTgBGTPjsKfXE8DRYnmFsEgRRsxVYU5Tck6
# ZyB+MA0GCSqGSIb3DQEBAQUABIIBgAi44ZPAFSQN4sS4WWf+ta3L1RgxiPpxLcvM
# orLsAvzuAp0yX8uGtZto/Qt19NAEDe1UEGVQktoSeu1hSOHvWPGQ2b95LFBLU/Uf
# njNjEJUYYAvau158f+Jaa8F+XgP7v+p5+zjObocBFOmE8ruzOzH9ArmMYavMpbDE
# ittsqK3eYgOoP9C0aLfridBL71WgG07eHuV6ro/N13Y1AN8g7/dqQ0UAzpnbTGkw
# sN6yaVrdXEVoTPIRnG+ntqcaGe4ByOFyxzbzWOK0l7BcKyyus365pwTUElCi2V7U
# S8C6bahXomLh53jUDl317i8Ej1WqZhyYCaGWoNxE0+Cmek80gwTIJn5p5XiSPcvJ
# inuzykN2dCEWV0dUI2mRYxS5XYE14sVH07FUyPYIvGqn6CeOeUClHMjU0agNeXvI
# hNEtdEnx1aWASmRadYjm1A97pRrtLOr6sP4vUWkIXd+7YMxrRfCuW+iElJJB4Qt7
# bhKqEuNyhW6xnBZM5sW/CGXTy4uVaaGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCC60sHITHvF+I7P+ySpRDMyduu4Y39K5Z+lUZKPCiLZfwIGagxE2bIx
# GBMyMDI2MDUyMzAzMDU1NS41ODFaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMzAzMDU1NVowLwYJKoZI
# hvcNAQkEMSIEILAAQb6a7yXAN+wPYdb+SP03cx7A7XnZwqB1aVcJi8IUMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgBuGwMbIff6Fli/5pQOlOR7OjbEgOc6ARTtKNdizaZbdBaq
# OtnGrsuASa7NNGG/4f85aH6kFUGvDhJIpN1QxwiHr7Fpu32FCzrqirOE7PSLWpAL
# eqdmXk72HPsrALy/rHAakkAN8yyhwHS4b2sxsXR5kM/5JplPoHACG+4N1LNw5wwp
# CVCZWBg+ahUaH63gOsqYboOCtAtlNyFqMWbdq2lrpLUxHAtuKoYC1vc6vWQq80hX
# 5PJVVeuTvjZx4iVnJboi+Gw6ia3mvmSEzxA+FOqee4wO4y8S5lbd9dbc8X4bNGOW
# O+j2RFTQ60bZId9gFSgQGMpKdHuuvxOZIY+P2eKzEb0x1l8JmEAW70Wcp8zrk64l
# i/xm2NIBOpzrfUccewOkU1CC+6EYyemlRXUbI5UGvdGcWyOcIQXsCVFPOTh4x2K1
# 1sRZNnULUnMijC8N3l/bfMemMDcihju66fSjdMXm52+xEYzRLZMOO0jNELU2SUqt
# OFdGPhHTAwTj/AQwvp+f6WX/gTS6md++M8WRumoG3zbzdYdDJMxo1hpmo78B2w+H
# NiKzioALCOjCq0SNaVVr2MhXQZpOZ7F5yPnYJFA98UW1ERZfSNSmLlP7GHcDIITY
# ZJaWVCoGgowy2b9fvlGjSeuNIr96dC3gMzPxWXeB/prq2EdyWkEsqcReqTvsZQ==
