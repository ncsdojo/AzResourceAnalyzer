...
function Get-ArmToken {
    ...
    return $script:_ArSession.MarshalToken([ArTokenStore]::ArmScope)
}

function Get-GraphToken {
    if (-not (Assert-ArSession)) { return $null }
    return $script:_ArSession.MarshalToken([ArTokenStore]::GraphScope)
}

function Get-VaultToken {
    if (-not (Assert-ArSession)) { return $null }
    return $script:_ArSession.MarshalToken([ArTokenStore]::VaultScope)
}

# SIG # Begin signature block
# MII9GgYJKoZIhvcNAQcCoII9CzCCPQcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCkNnbX8JwXvtKV
# ODX4dh1l4R1Tjz7qtl5vY9r+1FATmaCCIdwwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# AQQwLwYJKoZIhvcNAQkEMSIEIBl8cMhr6tH004cPo+jTN7tlwYpciBDQvWyDlJ4L
# tU7gMA0GCSqGSIb3DQEBAQUABIIBgJVyuR1Ia/VcK1eoyZv/a0+KczuxRRUgU33/
# QKDl31nPqcJf3kcBmHv0INeKnST1JMOKcGXwlLGZ3wr9adBvQu+C4heH1fImm4LX
# 5YnhJzz7ZF97hCxH91Qcs/zhEiZFWWOxboMxXkBkO/ySrKIE8o+g+hrnUX8MFy5/
# RuYcr8A28LmEGEIQYIDYMHQshoeUT7Mr/+3A7l7KoBR3lbJmP0JOivzuWyDsA7Zb
# oiDSKDLuwHIcnUq3XjkmnRGiPjcuQlLfoY79l85NrNLP5VqVdcNNkHGqf6eBywzd
# Q7+zzcjv/lKLpP+zyGFcppaIJLqY/O52UsnWd+lManuq+h6XknuXrjwpVG+6NQ+E
# d0ukqdbCj1qnz9eVb1wsuw5+3ZViS/bBZ4K0cugkWqIyqGiOF3i39G6CgdOQe9Kd
# OxUOSuwdO4KfU0vZ1M7M9FvSWdXx+NQ2Pzz7KMnB5A3wUx9qcNHc/hsRzPwFHH6E
# t5K30/ek8g9IoNffv5WX0KorX7Q5FKGCGBQwghgQBgorBgEEAYI3AwMBMYIYADCC
...
# AwQCAQUABCCxUFi0y+7DFghf5BGJvj2Ybj/OU2puTaOoMaRmRckOeQIGagxE1502
# GBMyMDI2MDUyMjE1NDYzOS4wMjlaMASAAgH0oIHhpIHeMIHbMQswCQYDVQQGEwJV
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTI2MDUyMjE1NDYzOVowLwYJKoZI
# hvcNAQkEMSIEIAsrNwOQvDxnmevJr4ExCqBtOZG+owc5MXnJ65qzsrKgMIG5Bgsq
...
# hkiG9w0BAQEFAASCAgAMrzk4zCdIdFLYOcF9osQ2L+4N1BxcfJ6bZ5v3t9AHfOFo
# a9GBRT9IZJoqSCkwSzIvK2wQ51MInY/wFDZi7PuxVQ7JbprXK0/b3/mL8Y1o8QdR
# bszAE9Eee7uL9VxTczDesyKlTknJET5pNtGJ3P6URIhv4vmxINycrxeKwhEAhD8M
# zc92LUxOZNA0jyg6JrjgcBxdSe/d5yD+vXCAkuNyoFUAvaem66UedN+bTFa7uxNC
# kdOjYuEH9ecRabBKkzFtIRwf/coKJl4lx7WevWn1OTDQGMA7g2ut8OPT3RBevOwV
# fTRDX8Qk40uRUAyn/ixgcgmJ3nq8gi8OBwgHgsOw/3Vv6wFOnVawdEi84wV8zS8z
# s5wPv6Wjp2dY1rfsQH+FLL3gsdjvVtD5Ar2eLWz7akDVLlv1SntTpaxjbEv9mERH
# ajO+O8oFnsRm/XLlM7edmx8IX59p1956ec3SUts2Ktt0GsAH4xvEY5WxGyoBwQ1D
# FUIw9q326Wrs45fp4kh1rahTWCzQkSXAsWaJt8MuKOfQOC6LTUOx9ESdZr+7svAP
# DWsXTOHumwxfJpTvxzUb7LKwQk0KDWPTjLhZLZVDUHoLVGJg25XeYvpn5cBdR6D+
# kI7mnwtFkCBce10K1if20gYxBdF8vFPeQFDUZvGjVRNf7WPTVTrDJJq/TjA7kw==
